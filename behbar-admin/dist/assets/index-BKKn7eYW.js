...
`).map(e=>e.trim()).filter(Boolean),n=t.filter(e=>!e.startsWith(`- `)),r=t.filter(e=>e.startsWith(`- `)).map(e=>e.slice(2).trim());return{paragraphs:n,list:r.length?r:void 0}}function Fi(e){let t=`https://behbarapp.ir/p/${encodeURIComponent(e.slug)}`;return`
  ...
  `}function Sa(e){let t=x(e,`content`)||x(e,`stories`)||x(e,`seo`)||x(e,`settings`),n=x(e,`staff`)||x(e,`recruitment`)||x(e,`roles`)||x(e,`wallet`),r=x(e,`settings`)||x(e,`homepage`),i=x(e,`pipeline`)||x(e,`map`),a=[];return i&&a.push(xa(`requests`,u.columns,`درخواست‌ها`)),x(e,`dashboard`)&&a.push(xa(`dashboard`,u.chart,`داشبورد`)),x(e,`chat`)&&a.push(xa(`chat`,u.chat,`چت پشتیبانی`)),t&&a.push(xa(`content`,u.grid,`مدیریت محتوا`)),n&&a.push(xa(`personnel`,u.users,`مدیریت پرسنل`)),x(e,`staff`)&&a.push(xa(`fleet`,u.truck,`مدیریت ناوگان حمل‌ونقل`)),x(e,`plugins`)&&a.push(xa(`plugins`,u.plugin,`افزونه‌ها`)),r&&a.push(xa(`settings`,u.settings,`تنظیمات سایت`)),`<div class="home-grid">${a.join(``)}</div>`}function Ca(e){let t=[];return x(e,`pipeline`)&&t.push(xa(`pipeline`,u.columns,`مراحل درخواست‌ها`)),x(e,`map`)&&t.push(xa(`map`,u.map,`نقشه درخواست‌ها`)),`<div class="home-grid">${t.join(``)}</div>`}function wa(e){let t=[];return x(e,`content`)&&t.push(xa(`magazine`,u.article,`مجله`)),x(e,`content`)&&t.push(xa(`testimonials`,u.message,`نظرات مشتریان`)),x(e,`stories`)&&t.push(xa(`stories`,u.story,`استوری‌ها`)),x(e,`seo`)&&t.push(xa(`seo`,u.seo,`مدیریت سئو`)),(x(e,`content`)||x(e,`settings`))&&t.push(xa(`media`,u.image,`مدیریت فایل`)),`<div class="home-grid">${t.join(``)}</div>`}function Ta(e){let t=[];return x(e,`staff`)&&t.push(xa(`staff`,u.users,`کارمندان`)),x(e,`recruitment`)&&t.push(xa(`jobApplications`,u.briefcase,`فرصت‌های شغلی`)),x(e,`roles`)&&t.push(xa(`roles`,u.lock,`نقش‌ها و اختیارات`)),(x(e,`staff`)||x(e,`roles`))&&t.push(xa(`activityLog`,u.history,`گزارش فعالیت`)),x(e,`wallet`)&&t.push(xa(`payroll`,u.wallet,`حقوق و دستمزد`)),`<div class="home-grid">${t.join(``)}</div>`}function Ea(e,t){e.querySelectorAll(`[data-home-tile]`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.homeTile??``))})}async function Da(){try{let e=(await Te()).site_name?.fa?.trim();if(!e||e===`بهبار`)return;document.querySelectorAll(`#login-brand-text, .admin-logo-title, #staff-portal-brand-text`).forEach(t=>{t.textContent?.includes(`بهبار`)&&(t.textContent=t.textContent.replace(/بهبار/g,e))})}catch{}}function Oa(e){return e===`dashboard`||e===`pipeline`?null:e===`home`?`dashboard`:e===`requests`||e===`content`||e===`personnel`?`home`:e===`map`?`dashboard`:e===`magazine`||e===`testimonials`||e===`stories`||e===`seo`||e===`media`?`content`:e===`staff`||e===`jobApplications`||e===`roles`||e===`activityLog`||e===`payroll`?`personnel`:e===`staffHistory`?`staff`:e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`?`dashboard`:e===`magazine-editor`?`magazine`:e===`page-editor`||e===`pages`?`settings`:`dashboard`}function ka(){let e=document.querySelector(`#app`);if(!e)throw Error(`#app not found`);return e}function Aa(){let e=ka();e.innerHTML=jt(),Mt(Ra),Da()}var ja=`dashboard`,Ma=null;function $(e,t=null){let n=document.getElementById(`view-container`),r=document.getElementById(`admin-back-btn`),i=g();if(!(!n||!i)){if(ja=e,r&&(r.hidden=e===`dashboard`||e===`pipeline`),v({screen:e,extra:e===`magazine-editor`||e===`page-editor`?t:e===`staffHistory`?Ma:void 0}),document.querySelectorAll(`#admin-topbar-nav .admin-topbar-tab`).forEach(t=>{let n=t.dataset.adminTab,r=n===`dashboard`&&(e===`dashboard`||e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`)||n===`pipeline`&&e===`pipeline`;t.classList.toggle(`is-active`,!!r)}),e===`home`)n.innerHTML=Sa(i),Ea(n,e=>$(e));else if(e===`requests`)n.innerHTML=Ca(i),Ea(n,e=>$(e));else if(e===`content`)n.innerHTML=wa(i),Ea(n,e=>$(e));else if(e===`personnel`)n.innerHTML=Ta(i),Ea(n,e=>$(e));else if(e===`dashboard`)n.innerHTML=yn(),bn(e=>$(e));else if(e===`dashboardOrders`)n.innerHTML=xn();else if(e===`dashboardVisitors`)n.innerHTML=Sn();else if(e===`dashboardStaff`)n.innerHTML=Cn();else if(e===`pipeline`)n.innerHTML=fn(),pn();else if(e===`map`)n.innerHTML=On(),kn();else if(e===`staff`)n.innerHTML=Nn(),Pn(e=>{Ma=e,$(`staffHistory`)});else if(e===`staffHistory`){if(!Ma){$(`staff`);return}n.innerHTML=In(Ma),Ln(Ma)}else if(e===`fleet`)n.innerHTML=tr(),nr();else if(e===`magazine`)n.innerHTML=vr(),yr(e=>$(`magazine-editor`,e));else if(e===`magazine-editor`)n.innerHTML=Ir(),Lr(t,()=>$(`magazine`));else if(e===`pages`){$(`settings`);return}else e===`page-editor`?(n.innerHTML=Ur(),Wr(t,()=>$(`settings`))):e===`testimonials`?(n.innerHTML=Yr(),Xr()):e===`chat`?(n.innerHTML=ri(),ii()):e===`stories`?(n.innerHTML=ci(),li()):e===`jobApplications`?(n.innerHTML=_i(),vi()):e===`settings`?(n.innerHTML=Wi(),Gi((e,t)=>$(e,t??null))):e===`plugins`?(n.innerHTML=Yi(),$i()):e===`seo`?(n.innerHTML=la(),ua(e=>$(`magazine-editor`,e))):e===`media`?(n.innerHTML=Rn(),zn()):e===`roles`?(n.innerHTML=Vn(),Hn()):e===`activityLog`?(n.innerHTML=xi(),Si()):e===`accountSecurity`?(n.innerHTML=da(),fa()):e===`myWallet`?(n.innerHTML=sr(),ur()):e===`payroll`?(n.innerHTML=ha(),ba()):(n.innerHTML=Sa(i),Ea(n,e=>$(e)))}}function Na(e,t=!1){let n=ka();n.innerHTML=zt(e),document.getElementById(`admin-back-btn`)?.addEventListener(`click`,()=>{let e=Oa(ja);e&&$(e)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{j(),_(),Aa()}),document.getElementById(`admin-account-btn`)?.addEventListener(`click`,()=>$(`accountSecurity`)),document.getElementById(`admin-wallet-btn`)?.addEventListener(`click`,()=>$(`myWallet`));function r(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`,t=document.getElementById(`admin-theme-sun`),n=document.getElementById(`admin-theme-moon`);t&&n&&(t.hidden=!e,n.hidden=e)}r(),document.getElementById(`admin-theme-toggle-btn`)?.addEventListener(`click`,()=>{document.documentElement.getAttribute(`data-theme`)===`dark`?(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`behbar_admin_theme`,`light`)):(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`behbar_admin_theme`,`dark`)),r()}),document.querySelectorAll(`#admin-topbar-nav .admin-topbar-tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.adminTab;t&&$(t)})}),document.getElementById(`admin-logo-btn`)?.addEventListener(`click`,()=>{$(`dashboard`)}),x(e,`settings`)&&Fa(),Pa(),Gn(),Da(),x(e,`ai`)&&It();let i=t?y():null;i?.screen===`staffHistory`&&i.extra?(Ma=i.extra,$(`staffHistory`)):i?.screen===`magazine-editor`?$(`magazine-editor`,i.extra??null):i?.screen===`page-editor`?$(`page-editor`,i.extra??null):i?.screen?$(i.screen):$(`dashboard`)}async function Pa(){try{let e=await Te(),t=e.branding,n=t?.logoUrl;n&&document.querySelectorAll(`.admin-logo-mark`).forEach(e=>e.src=n);let r=t?.faviconUrl||n;r&&document.querySelectorAll(`link[rel="icon"]`).forEach(e=>e.href=r);let i=e.site_name;i?.fa?.trim()&&(document.title=`${i.fa.trim()} - پنل مدیریت`,document.querySelectorAll(`.admin-logo-title`).forEach(e=>e.textContent=i.fa.trim()))}catch{}}async function Fa(){let e=document.getElementById(`admin-sidebar-version`);if(e)try{let t=await gt();e.textContent=t.updateAvailable?`نسخه ${t.current} · نسخه جدید موجود است`:`نسخه ${t.current}`,e.classList.toggle(`has-update`,t.updateAvailable),e.hidden=!1}catch{}}function Ia(e){let t=ka();t.innerHTML=mr(e),Da(),gr(()=>{j(),_(),Aa()})}function La(e){let t=ka();t.innerHTML=aa(),Da(),oa(e,()=>Na(e))}function Ra(e,t=!1){if(!S(e)){Ia(e);return}if(!x(e,`settings`)){Na(e,t);return}Te().then(n=>{ra(n)?La(e):Na(e,t)}).catch(()=>Na(e,t))}function za(){if(T(Aa),!b()){Aa();return}let e=g();e?Ra(e,!0):Aa(),te().then(t=>{let n=h();n&&(m(n,t),(!e||e.role!==t.role)&&Ra(t,!0))}).catch(()=>{})}za();