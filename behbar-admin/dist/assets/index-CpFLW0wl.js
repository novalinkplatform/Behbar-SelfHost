var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,o)=>(o=n==null?{}:e(i(n)),s(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=`viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"`,u={route:`<svg ${l}><circle cx="5.5" cy="6" r="2"/><circle cx="18.5" cy="18" r="2"/><path d="M5.5 8v3a3 3 0 0 0 3 3h7a3 3 0 0 1 3 3"/></svg>`,grid:`<svg ${l}><rect x="3.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="3.5" y="13.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="13.5" width="7" height="7" rx="1.5"/></svg>`,chart:`<svg ${l}><path d="M4 20V10M12 20V4M20 20v-7"/><path d="M2 20h20"/></svg>`,columns:`<svg ${l}><rect x="3.5" y="4" width="5" height="16" rx="1"/><rect x="9.5" y="4" width="5" height="10" rx="1"/><rect x="15.5" y="4" width="5" height="13" rx="1"/></svg>`,phone:`<svg ${l}><path d="M5.5 4h2.8l1.2 4-2 1.3a11 11 0 0 0 5.2 5.2l1.3-2 4 1.2v2.8c0 1-.9 1.7-1.8 1.5-6-1.1-10.6-5.7-11.7-11.7C4.3 5.4 5 4 5.5 4Z"/></svg>`,pin:`<svg ${l}><path d="M12 21s-6.5-5.6-6.5-11a6.5 6.5 0 0 1 13 0c0 5.4-6.5 11-6.5 11Z"/><circle cx="12" cy="10" r="2.3"/></svg>`,flag:`<svg ${l}><path d="M6 21V4"/><path d="M6 4.5h10.5L14 8l2.5 3.5H6"/></svg>`,calendar:`<svg ${l}><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 9.5h17M8 3v4M16 3v4"/></svg>`,logout:`<svg ${l}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/></svg>`,lock:`<svg ${l}><rect x="4.5" y="10.5" width="15" height="10" rx="2"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/></svg>`,close:`<svg ${l}><path d="m5 5 14 14M19 5 5 19"/></svg>`,chevronDown:`<svg ${l}><path d="m6 9 6 6 6-6"/></svg>`,refresh:`<svg ${l}><path d="M3.5 12a8.5 8.5 0 0 1 14.5-6M20.5 12a8.5 8.5 0 0 1-14.5 6"/><path d="M18 3v4h-4M6 21v-4h4"/></svg>`,map:`<svg ${l}><path d="M9 4 4 6v14l5-2 6 2 5-2V4l-5 2-6-2Z"/><path d="M9 4v14M15 6v14"/></svg>`,users:`<svg ${l}><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0 1 12 0"/><circle cx="17" cy="9" r="2.3"/><path d="M15.5 20a4.5 4.5 0 0 1 5.5-4.4"/></svg>`,plusCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="M12 8v8M8 12h8"/></svg>`,checkCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="m8.5 12.3 2.3 2.3 4.7-5"/></svg>`,user:`<svg ${l}><circle cx="12" cy="8" r="3.5"/><path d="M5 20a7 7 0 0 1 14 0"/></svg>`,article:`<svg ${l}><rect x="5" y="3.5" width="14" height="17" rx="1.5"/><path d="M8.5 8h7M8.5 12h7M8.5 16h4"/></svg>`,settings:`<svg ${l}><circle cx="12" cy="12" r="3.2"/><path d="M12 3v2.4M12 18.6V21M21 12h-2.4M5.4 12H3M18.4 5.6l-1.7 1.7M7.3 16.7l-1.7 1.7M18.4 18.4l-1.7-1.7M7.3 7.3 5.6 5.6"/></svg>`,message:`<svg ${l}><path d="M4 5.5h16a1 1 0 0 1 1 1V16a1 1 0 0 1-1 1H9l-4.5 3.5V17H4a1 1 0 0 1-1-1V6.5a1 1 0 0 1 1-1Z"/><path d="M7.5 9.5h9M7.5 13h6"/></svg>`,chat:`<svg ${l}><path d="M3.5 6.5A2.5 2.5 0 0 1 6 4h9a2.5 2.5 0 0 1 2.5 2.5v6A2.5 2.5 0 0 1 15 15H9l-4 3.5v-3.5H6a2.5 2.5 0 0 1-2.5-2.5v-6Z"/><circle cx="7.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="11.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="15" cy="9.5" r="0.9" fill="currentColor" stroke="none"/></svg>`,story:`<svg ${l}><rect x="7" y="3" width="10" height="17" rx="2.2"/><circle cx="12" cy="7.2" r="1.5" fill="currentColor" stroke="none"/></svg>`,briefcase:`<svg ${l}><rect x="3" y="7.5" width="18" height="12" rx="2"/><path d="M8.5 7.5V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1.5"/><path d="M3 12.5h18M10.5 12.5v2h3v-2"/></svg>`,download:`<svg ${l}><path d="M12 3.5v11M8 10.5l4 4 4-4"/><path d="M4.5 17v2a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-2"/></svg>`,truck:`<svg ${l}><rect x="2" y="7" width="11" height="7" rx="1"/><path d="M13 10h4l3 3v1h-2"/><path d="M7.8 17h6.9"/><circle cx="6" cy="17" r="1.8"/><circle cx="16.5" cy="17" r="1.8"/></svg>`,seo:`<svg ${l}><circle cx="10.5" cy="10.5" r="6.5"/><path d="m20 20-4.8-4.8"/><path d="M7.5 10.5h6M10.5 7.5v6"/></svg>`,ai:`<svg ${l}><path d="M11 3 12.7 8 17.5 9.7 12.7 11.4 11 16.4 9.3 11.4 4.5 9.7 9.3 8Z"/><path d="M18 15.5 18.8 17.7 21 18.5 18.8 19.3 18 21.5 17.2 19.3 15 18.5 17.2 17.7Z"/></svg>`,image:`<svg ${l}><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m5 17 5-5 3 3 3-4 3 6"/></svg>`,video:`<svg ${l}><rect x="3" y="6" width="12" height="12" rx="2"/><path d="m15 10 6-3v10l-6-3Z"/></svg>`,audio:`<svg ${l}><path d="M9 18V6l8-2v12"/><circle cx="7" cy="18" r="2.2"/><circle cx="17" cy="16" r="2.2"/></svg>`,arrowRight:`<svg ${l}><path d="M5 12h14M13 6l6 6-6 6"/></svg>`,arrowLeft:`<svg ${l}><path d="M19 12H5M11 18l-6-6 6-6"/></svg>`,maleAvatar:`<svg ${l}><circle cx="12" cy="8" r="4"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,femaleAvatar:`<svg ${l}><circle cx="12" cy="7.5" r="4"/><path d="M12 11.5v6M9 15h6"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,eye:`<svg ${l}><path d="M2 12s3.8-7 10-7 10 7 10 7-3.8 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>`,history:`<svg ${l}><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/><path d="M12 8v4l3 2"/></svg>`,link:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.6 4.9a3.7 3.7 0 0 1 5.2 5.2L16 12"/><path d="M13 17.5 11.4 19.1a3.7 3.7 0 0 1-5.2-5.2L8 12"/></svg>`,externalLink:`<svg ${l}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`,unlink:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.2 5.3a3.7 3.7 0 0 1 5.2 5.2L16.2 11.7"/><path d="M13 17.5 11.8 18.7a3.7 3.7 0 0 1-5.2-5.2L7.8 12.3"/><path d="m4 4 16 16"/></svg>`,quote:`<svg ${l}><path d="M7.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/><path d="M16.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/></svg>`,undo:`<svg ${l}><path d="M4 12a8 8 0 1 1 2.6 5.9"/><path d="M4 6.5V12h5.5"/></svg>`,redo:`<svg ${l}><path d="M20 12a8 8 0 1 0-2.6 5.9"/><path d="M20 6.5V12h-5.5"/></svg>`,minus:`<svg ${l}><path d="M4 12h16"/></svg>`,eraser:`<svg ${l}><path d="m17.5 8.5-9 9H4l-1-1L14 5.5a2 2 0 0 1 2.8 0l2 2a2 2 0 0 1-.3 2.9L9.5 19"/></svg>`,alignLeft:`<svg ${l}><path d="M4 6h16M4 12h10M4 18h13"/></svg>`,alignCenter:`<svg ${l}><path d="M4 6h16M7 12h10M5.5 18h13"/></svg>`,alignRight:`<svg ${l}><path d="M4 6h16M10 12h10M7 18h13"/></svg>`,listBullet:`<svg ${l}><circle cx="4.5" cy="6" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="18" r="1" fill="currentColor" stroke="none"/><path d="M9 6h11M9 12h11M9 18h11"/></svg>`,listNumber:`<svg ${l}><path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 5v3M3.3 5H4.7M3 11.5h1.6c.5 0 .9.4.9.9 0 .3-.2.5-.4.7L3 15h2.6M3.3 19h1.4c.5 0 .9-.4.9-.9s-.4-.9-.9-.9H3.3"/></svg>`,plugin:`<svg ${l}><path d="M12 3 4 7v10l8 4 8-4V7Z"/><path d="M4 7l8 4 8-4M12 11v10"/></svg>`,wallet:`<svg ${l}><path d="M3 7a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v1"/><path d="M3 7v10a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2H5"/><circle cx="16" cy="13" r="1.2" fill="currentColor" stroke="none"/></svg>`,finance:`<svg ${l}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2.5"/><path d="M6 12h.01M18 12h.01"/></svg>`,fileSpreadsheet:`<svg ${l}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h8M8 17h8M12 13v8"/></svg>`,printer:`<svg ${l}><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>`,shield:`<svg ${l}><path d="M12 3.5 19 6.5v5c0 5-3 8-7 9-4-1-7-4-7-9v-5l7-3Z"/><path d="m9.3 12 1.9 1.9L15 10"/></svg>`,clock:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="M12 7.5V12l3 2"/></svg>`,sun:`<svg ${l}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>`,moon:`<svg ${l}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>`},d=`behbar_admin_token`,f=`behbar_admin_staff`,p=`behbar_admin_screen`;function m(e,t){localStorage.setItem(d,e),localStorage.setItem(f,JSON.stringify(t))}function h(){return localStorage.getItem(d)}function g(){let e=localStorage.getItem(f);if(!e)return null;try{let t=JSON.parse(e);return Array.isArray(t.permissions)?t:(_(),null)}catch{return null}}function _(){localStorage.removeItem(d),localStorage.removeItem(f),localStorage.removeItem(p)}function v(e){localStorage.setItem(p,JSON.stringify(e))}function y(){let e=localStorage.getItem(p);if(!e)return null;try{return JSON.parse(e)}catch{return null}}function b(){return h()!==null&&g()!==null}function x(e,t){return(e.permissions??[]).includes(t)}function S(e){return(e.permissions??[]).some(e=>e!==`assignments`)}var C=class extends Error{},w=null;function T(e){w=e}async function E(e,t={}){let n=h(),r=await fetch(`${e}`,{...t,headers:{...t.headers,...n?{Authorization:`Bearer ${n}`}:{}}});if(r.status===401)throw _(),w?.(),new C(`نشست شما منقضی شده است.`);return r}async function D(e,t){let n=await fetch(`/api/staff/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ورود ناموفق بود.`);return r?.needsTwoFactor?{needsTwoFactor:!0,challengeToken:r.challengeToken}:{needsTwoFactor:!1,token:r.token,staff:r.staff}}async function O(e,t){let n=await fetch(`/api/staff/login/verify-2fa`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({challengeToken:e,code:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`کد نامعتبر است.`);return r}async function ee(){let e=await E(`/api/staff/2fa/sms/setup`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال کد ناموفق بود.`)}async function k(e){let t=await E(`/api/staff/2fa/sms/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({code:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید کد ناموفق بود.`)}async function A(e){let t=await E(`/api/staff/2fa/disable`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`غیرفعال‌سازی ناموفق بود.`)}async function j(e,t){let n=await E(`/api/staff/change-password`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({newPassword:e,currentPassword:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`تغییر رمز عبور ناموفق بود.`)}async function te(){await E(`/api/staff/logout`,{method:`POST`}).catch(()=>{})}async function M(){let e=await E(`/api/staff/me`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات ناموفق بود.`);return{...t.staff,licenseLocked:!!t.licenseLocked,licenseSummary:t.licenseSummary}}async function N(e){let t=await E(`/api/admin/requests${e?`?status=${encodeURIComponent(e)}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌ها ناموفق بود.`);return n.requests??[]}async function P(e,t){let n=await E(`/api/admin/requests/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function F(e){let t=await E(`/api/admin/requests/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function I(){let e=await E(`/api/admin/requests/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت خروجی ناموفق بود.`)}let t=await e.blob(),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`behbar-requests-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)}async function R(){let e=await E(`/api/admin/activity-log`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گزارش فعالیت ناموفق بود.`);return t.entries??[]}async function z(e,t){let n=await E(`/api/admin/requests/${e}/assign`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({staffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اختصاص ناموفق بود.`)}async function B(){let e=await E(`/api/admin/stats`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار ناموفق بود.`);return t}async function ne(){let e=await E(`/api/admin/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کارمندان ناموفق بود.`);return t.staff??[]}async function re(e){let t=await E(`/api/admin/staff`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد کارمند ناموفق بود.`);return n.staff}async function ie(){let e=await E(`/api/admin/roles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نقش‌ها ناموفق بود.`);return{roles:t.roles??[],permissions:t.permissions??[]}}async function ae(e){let t=await E(`/api/admin/roles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نقش ناموفق بود.`);return n.role}async function oe(e,t){let n=await E(`/api/admin/roles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نقش ناموفق بود.`);return r.role}async function se(e){let t=await E(`/api/admin/roles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نقش ناموفق بود.`)}async function ce(e,t){let n=await E(`/api/admin/staff/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی کارمند ناموفق بود.`);return r.staff}async function le(e){let t=await E(`/api/admin/staff/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف کارمند ناموفق بود.`)}async function ue(){let e=await E(`/api/staff/requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌ها ناموفق بود.`);return t.requests??[]}async function de(e,t){let n=await E(`/api/staff/requests/${e}/status`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function fe(){let e=await E(`/api/admin/articles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت مقالات ناموفق بود.`);return t.articles??[]}async function pe(e){let t=await E(`/api/admin/articles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد مقاله ناموفق بود.`);return n.article}async function me(e,t){let n=await E(`/api/admin/articles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی مقاله ناموفق بود.`);return r.article}async function he(e,t){let n=await E(`/api/admin/articles/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.article}async function ge(e){let t=await E(`/api/admin/articles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف مقاله ناموفق بود.`)}async function _e(){let e=await E(`/api/admin/pages`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت برگه‌ها ناموفق بود.`);return t.pages??[]}async function ve(e){let t=await E(`/api/admin/pages/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت برگه ناموفق بود.`);return n.page}async function ye(e){let t=await E(`/api/admin/pages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد برگه ناموفق بود.`);return n.page}async function be(e,t){let n=await E(`/api/admin/pages/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی برگه ناموفق بود.`);return r.page}async function xe(e,t){let n=await E(`/api/admin/pages/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت برگه ناموفق بود.`);return r.page}async function Se(e){let t=await E(`/api/admin/pages/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف برگه ناموفق بود.`)}async function Ce(e){let t=h(),n=await fetch(`/api/admin/upload`,{method:`POST`,headers:{"Content-Type":e.type,...t?{Authorization:`Bearer ${t}`}:{}},body:e}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`آپلود تصویر ناموفق بود.`);return`${r.url}`}async function we(e){let t=await E(`/api/admin/media${e?`?folder=${e}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت فهرست فایل‌ها ناموفق بود.`);return n.files??[]}async function Te(e){let t=await E(`/api/admin/media/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف فایل ناموفق بود.`)}async function Ee(){let e=await fetch(`/api/settings`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت تنظیمات ناموفق بود.`);return t.settings??{}}async function V(e,t){let n=await E(`/api/admin/settings`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({key:e,value:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی تنظیمات ناموفق بود.`)}async function De(e,t,n){let r=await E(`/api/admin/ai/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,apiKey:t,model:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اتصال ناموفق بود.`);return i}async function Oe(e,t){let n=await E(`/api/admin/sms/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اتصال ناموفق بود.`);return r}async function ke(){let e=await E(`/api/admin/testimonials`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نظرات ناموفق بود.`);return t.testimonials??[]}async function Ae(e){let t=await E(`/api/admin/testimonials`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نظر ناموفق بود.`);return n.testimonial}async function je(e,t){let n=await E(`/api/admin/testimonials/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نظر ناموفق بود.`);return r.testimonial}async function Me(e){let t=await E(`/api/admin/testimonials/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نظر ناموفق بود.`)}async function Ne(){let e=await E(`/api/admin/license`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات لایسنس ناموفق بود.`);return t.license??null}async function Pe(e){let t=await E(`/api/admin/license/activate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({licenseKey:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`فعال‌سازی لایسنس ناموفق بود.`);return n.license}async function Fe(){let e=await E(`/api/admin/chat/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گفتگوها ناموفق بود.`);return t.conversations??[]}async function Ie(e){let t=await E(`/api/admin/chat/conversations/${e}/messages`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیام‌ها ناموفق بود.`);return n.messages??[]}async function Le(e,t){let n=await E(`/api/admin/chat/conversations/${e}/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({text:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارسال پیام ناموفق بود.`)}async function Re(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`)}async function ze(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({assignedStaffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`واگذاری گفتگو ناموفق بود.`)}async function Be(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({archived:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`بایگانی گفتگو ناموفق بود.`)}async function Ve(e){let t=await E(`/api/admin/chat/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function He(e){let t=await E(`/api/admin/requests?phone=${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های مرتبط ناموفق بود.`);return n.requests??[]}async function Ue(e){let t=await E(`/api/admin/requests?staffId=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.requests??[]}async function We(e){let t=await E(`/api/admin/requests/${e}/events`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.events??[]}async function Ge(){let e=await E(`/api/admin/chat/agents`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت پشتیبان‌ها ناموفق بود.`);return t.agents??[]}async function Ke(){let e=await E(`/api/admin/stories`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت استوری‌ها ناموفق بود.`);return t.stories??[]}async function qe(e){let t=await E(`/api/admin/stories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد استوری ناموفق بود.`);return n.story}async function H(e,t){let n=await E(`/api/admin/stories/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی استوری ناموفق بود.`);return r.story}async function Je(e){let t=await E(`/api/admin/stories/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف استوری ناموفق بود.`)}async function Ye(){let e=await E(`/api/admin/job-applications`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های همکاری ناموفق بود.`);return t.applications??[]}async function Xe(e,t){let n=await E(`/api/admin/job-applications/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.application}async function Ze(e){let t=await E(`/api/admin/job-applications/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function Qe(){let e=await E(`/api/admin/fleet-vehicles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت وسایل نقلیه ناموفق بود.`);return t.vehicles??[]}async function $e(e){let t=await E(`/api/admin/fleet-vehicles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد وسیله نقلیه ناموفق بود.`);return n.vehicle}async function et(e,t){let n=await E(`/api/admin/fleet-vehicles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وسیله نقلیه ناموفق بود.`);return r.vehicle}async function tt(e){let t=await E(`/api/admin/fleet-vehicles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف وسیله نقلیه ناموفق بود.`)}async function nt(){let e=await E(`/api/admin/plugins`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت افزونه‌ها ناموفق بود.`);return t.plugins??{}}async function rt(e){let t=await E(`/api/admin/requests/${e}/reports`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت گزارش‌ها ناموفق بود.`);return n.reports??[]}async function it(e,t){let n=await E(`/api/admin/requests/${e}/reports`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({message:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت گزارش ناموفق بود.`);return r}async function at(){let e=await E(`/api/admin/analytics`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار بازدید ناموفق بود.`);return t}async function ot(){let e=await E(`/api/admin/backup/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت فایل پشتیبان ناموفق بود.`)}let t=(e.headers.get(`Content-Disposition`)??``).match(/filename="([^"]+)"/)?.[1]??`behbar-backup.sql`,n=await e.blob(),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function st(e){let t=await E(`/api/admin/backup/import`,{method:`POST`,headers:{"Content-Type":`application/sql`},body:e}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`بازیابی پشتیبان ناموفق بود.`)}async function ct(){let e=await E(`/api/admin/backup/drive-test`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال آزمایشی به گوگل درایو ناموفق بود.`)}async function lt(){let e=await E(`/api/admin/backup/drive-oauth/prepare`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`آماده‌سازی اتصال به گوگل ناموفق بود.`);return t.authUrl}async function ut(){let e=await E(`/api/admin/backup/drive-disconnect`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`قطع اتصال ناموفق بود.`)}async function dt(e,t){let n=await E(`/api/admin/ai/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,conversationId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارتباط با دستیار هوش مصنوعی ناموفق بود.`);return r}async function ft(e,t,n){let r=await E(`/api/admin/ai/execute`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,toolCallId:t.toolCallId,tool:t.tool,args:t.args,conversationId:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اجرای اقدام ناموفق بود.`);return i}async function pt(){let e=await E(`/api/admin/ai/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`فهرست گفتگوها دریافت نشد.`);return t.conversations??[]}async function mt(e){let t=await E(`/api/admin/ai/conversations/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`گفتگو دریافت نشد.`);return n}async function ht(){let e=await E(`/api/admin/ai/conversations`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ساخت گفتگوی جدید ناموفق بود.`);return t.id}async function gt(e){let t=await E(`/api/admin/ai/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function _t(){let e=await E(`/api/admin/version`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات نسخه ناموفق بود.`);return t}async function vt(){let e=await E(`/api/admin/selfhost/update`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`به‌روزرسانی ناموفق بود.`)}async function U(){let e=await E(`/api/staff/wallet`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول ناموفق بود.`);return t}async function W(e,t){let n=await E(`/api/staff/wallet/transactions?limit=${e}&offset=${t}`),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:r.transactions??[],total:r.total??0}}async function yt(){let e=await E(`/api/staff/wallet/payout-requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return t.payoutRequests??[]}async function bt(e,t){let n=await E(`/api/staff/wallet/payout-requests`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({amount:e,note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت درخواست تسویه ناموفق بود.`)}async function xt(){let e=await E(`/api/admin/wallet/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول‌ها ناموفق بود.`);return t.wallets??[]}async function St(e,t,n){let r=await E(`/api/admin/wallet/staff/${e}/transactions?limit=${t}&offset=${n}`),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:i.transactions??[],total:i.total??0}}async function G(e,t,n,r){let i=await E(`/api/admin/wallet/staff/${e}/adjustments`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({direction:t,amount:n,description:r})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(typeof a?.error==`string`?a.error:`ثبت اصلاحیه ناموفق بود.`)}async function K(e,t){let n=await E(`/api/admin/wallet/staff/${e}/rate-override`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ ناموفق بود.`)}async function Ct(e,t){let n=await E(`/api/admin/roles/${e}/pay-rate`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ نقش ناموفق بود.`)}async function wt(e=`pending`){let t=await E(`/api/admin/wallet/payout-requests?status=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return n.payoutRequests??[]}async function Tt(e){let t=await E(`/api/admin/wallet/payout-requests/${e}/approve`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید درخواست ناموفق بود.`)}async function Et(e,t){let n=await E(`/api/admin/wallet/payout-requests/${e}/reject`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`رد درخواست ناموفق بود.`)}async function Dt(e){let t=await E(`/api/admin/wallet/payroll/preview?month=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیش‌نمایش حقوق ناموفق بود.`);return n.entries??[]}async function Ot(e,t){let n=await E(`/api/admin/wallet/payroll/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({month:e,entries:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`پردازش حقوق ناموفق بود.`);return r}function q(e,t=6){return`
  ...
  `}function Ft(){let e=document.getElementById(`ai-widget-toggle`),t=document.getElementById(`ai-widget-close`),n=document.getElementById(`ai-widget-panel`),r=document.getElementById(`ai-widget-error`),i=document.getElementById(`ai-widget-messages`),a=document.getElementById(`ai-widget-form`),o=document.getElementById(`ai-widget-input`),s=document.getElementById(`ai-widget-send-btn`),c=document.getElementById(`ai-widget-new-chat-btn`),l=document.getElementById(`ai-widget-conversation-list`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l)return;let d=[],f=null,p=[],m=null,h=!1;function g(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}function _(){l.innerHTML=d.length?d.map(e=>`
      ...
      `),i.innerHTML=e.join(``),i.scrollTop=i.scrollHeight,document.getElementById(`ai-widget-confirm-btn`)?.addEventListener(`click`,()=>void w()),document.getElementById(`ai-widget-cancel-btn`)?.addEventListener(`click`,T)}function y(e){o.disabled=e,s.disabled=e,e?s.textContent=`در حال پاسخ...`:s.innerHTML=`<span class="icon">${u.ai}</span>ارسال`}async function b(e){r.hidden=!0,m=null,f=e,_();try{p=(await mt(e)).messages,v()}catch(e){g(e)}}async function x(){r.hidden=!0;try{let e=await ht();d=[{id:e,title:``,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString()},...d],f=e,p=[],m=null,_(),v(),o.focus()}catch(e){g(e)}}async function S(){if(!h){h=!0;try{d=await pt(),_(),d.length?await b(d[0].id):await x()}catch(e){g(e)}}}e.addEventListener(`click`,()=>{n.hidden=!n.hidden,n.hidden||(S(),o.focus())}),t.addEventListener(`click`,()=>{n.hidden=!0}),c.addEventListener(`click`,()=>void x()),l.addEventListener(`click`,e=>{let t=e.target.closest(`[data-select-conversation]`);if(t){let e=Number(t.dataset.selectConversation);e!==f&&b(e);return}let n=e.target.closest(`[data-delete-conversation]`);if(n){let e=Number(n.dataset.deleteConversation);if(!window.confirm(`این گفتگو برای همیشه حذف شود؟`))return;(async()=>{try{await gt(e),d=d.filter(t=>t.id!==e),_(),e===f&&(d.length?await b(d[0].id):await x())}catch(e){g(e)}})()}});async function C(e){f||await x(),r.hidden=!0,p=[...p,{role:`user`,content:e}],v(),y(!0);try{let e=await dt(p,f);p=e.messages,m=e.pendingAction,v(),d=await pt().catch(()=>d),_()}catch(e){g(e)}finally{y(!1)}}async function w(){if(!m||!f)return;r.hidden=!0;let e=m;m=null,y(!0);try{let t=await ft(p,e,f);p=t.messages,m=t.pendingAction,v()}catch(e){g(e)}finally{y(!1)}}function T(){m&&(p=[...p,{role:`tool`,tool_call_id:m.toolCallId,content:`کارمند این اقدام را لغو کرد.`}],m=null,v())}a.addEventListener(`submit`,e=>{e.preventDefault();let t=o.value.trim();t&&(o.value=``,C(t))}),o.addEventListener(`keydown`,e=>{e.key===`Enter`&&!e.shiftKey&&(e.preventDefault(),a.requestSubmit())})}function It(){return`
  ...
  `}var zt=[{id:`pending`,label:`در انتظار بررسی`,color:`var(--muted)`},{id:`contacted`,label:`تماس گرفته شده`,color:`var(--warning)`},{id:`scheduled`,label:`زمان‌بندی شده`,color:`var(--secondary)`},{id:`in_progress`,label:`در حال انجام`,color:`var(--primary)`},{id:`completed`,label:`انجام شده`,color:`var(--success)`},{id:`cancelled`,label:`لغو شده`,color:`var(--danger)`}],Bt=Object.fromEntries(zt.map(e=>[e.id,e.label])),Vt=Object.fromEntries(zt.map(e=>[e.id,e.color])),Ht=[`۰`,`۱`,`۲`,`۳`,`۴`,`۵`,`۶`,`۷`,`۸`,`۹`];function J(e){return String(e).replace(/[0-9]/g,e=>Ht[Number(e)])}function Y(e){return`${J(Math.round(e).toLocaleString(`en-US`))} تومان`}function X(e,t){return~~(e/t)}function Ut(e,t){return e-~~(e/t)*t}var Wt=[-61,9,38,199,426,686,756,818,1111,1181,1210,1635,2060,2097,2192,2262,2324,2394,2456,3178];function Gt(e){let t=Wt.length,n=e+621,r=-14,i=Wt[0];if(e<i||e>=Wt[t-1])throw Error(`Invalid Jalaali year ${e}`);let a=0;for(let n=1;n<t;n+=1){let t=Wt[n];if(a=t-i,e<t)break;r=r+X(a,33)*8+X(Ut(a,33),4),i=t}let o=e-i;r=r+X(o,33)*8+X(Ut(o,33)+3,4),Ut(a,33)===4&&a-o===4&&(r+=1);let s=X(n,4)-X((X(n,100)+1)*3,4)-150,c=20+r-s;a-o<6&&(o=o-a+X(a,33)*33);let l=Ut(Ut(o+1,33)-1,4);return l===-1&&(l=4),{leap:l,gy:n,march:c}}function Kt(e,t,n){let r=X((e+X(t-8,6)+100100)*1461,4)+X(153*Ut(t+9,12)+2,5)+n-34840408;return r=r-X(X(e+100100+X(t-8,6),100)*3,4)+752,r}function qt(e){let t=4*e+139361631;t=t+X(X(4*e+183187720,146097)*3,4)*4-3908;let n=X(Ut(t,1461),4)*5+308,r=X(Ut(n,153),5)+1,i=Ut(X(n,153),12)+1;return{gy:X(t,1461)-100100+X(8-i,6),gm:i,gd:r}}function Jt(e){let t=qt(e).gy-621,n=Gt(t),r=e-Kt(n.gy,3,n.march),i,a;if(r>=0){if(r<=185)return i=1+X(r,31),a=Ut(r,31)+1,{jy:t,jm:i,jd:a};r-=186}else--t,r+=179,n.leap===1&&(r+=1);return i=7+X(r,30),a=Ut(r,30)+1,{jy:t,jm:i,jd:a}}function Yt(e){return Jt(Kt(e.getFullYear(),e.getMonth()+1,e.getDate()))}var Xt=[`فروردین`,`اردیبهشت`,`خرداد`,`تیر`,`مرداد`,`شهریور`,`مهر`,`آبان`,`آذر`,`دی`,`بهمن`,`اسفند`],Zt=[`۰`,`۱`,`۲`,`۳`,`۴`,`۵`,`۶`,`۷`,`۸`,`۹`];function Qt(e){return String(e).replace(/[0-9]/g,e=>Zt[Number(e)])}function $t(e){return`${Xt[e.jm-1]} ${Qt(e.jd)}، ${Qt(e.jy)}`}function en(e){return new Date(e.replace(` `,`T`)+`Z`)}function tn(e){let t=en(e),n=Yt(new Date),r=Yt(t),i=`${Qt(String(t.getHours()).padStart(2,`0`))}:${Qt(String(t.getMinutes()).padStart(2,`0`))}`;return n.jy===r.jy&&n.jm===r.jm&&n.jd===r.jd?`امروز، ${i}`:`${$t(r)}، ${i}`}var nn=3e4,rn=`pending`,an;function Z(e){return zt.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${t.label}</option>`).join(``)}function on(e,t){return`<option value="">اختصاص‌نیافته</option>${t.map(t=>{let n=t.onActiveService&&t.id!==e,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``)}`}function sn(e,t){return!t||`${e.trackingCode} ${e.phone} ${e.originCity} ${e.destinationCity} ${e.customerName}`.toLowerCase().includes(t.toLowerCase())}function cn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ln(e){return e?e.length?e.map(e=>`
      <div class="pipeline-report-item">
        <div class="pipeline-report-item-head">
          <span>${cn(e.staffName)}</span>
    ...
    `).join(``):`<p class="pipeline-report-empty">هنوز گزارشی ثبت نشده است.</p>`:``}function un(e){return e?e.length?`
      ...
      ${e.map(e=>`
        <li class="pipeline-timeline-item pipeline-timeline-${e.type}">
          ...
          <div class="pipeline-timeline-body">
            <p>${cn(e.description)}</p>
            <span class="pipeline-timeline-meta">${e.staffName?`${cn(e.staffName)} — `:``}${tn(e.createdAt)}</span>
          </div>
        </li>
      `).join(``)}
    </ol>
  `:`<p class="pipeline-report-empty">هنوز رویدادی ثبت نشده است.</p>`:``}function dn(e,t,n,r,i,a,o){return`
    <div class="pipeline-card" data-card-id="${e.id}" style="--card-accent:${Vt[e.status]??`var(--muted)`}">
      ...
      ${e.originNotes?`<p class="pipeline-note"><strong>یادداشت مبدأ:</strong> ${cn(e.originNotes)}</p>`:``}
      ${e.destinationNotes?`<p class="pipeline-note"><strong>یادداشت مقصد:</strong> ${cn(e.destinationNotes)}</p>`:``}
      ...
      <div class="pipeline-report">
        ...
        <div class="pipeline-report-body" data-report-body-id="${e.id}" ${n?``:`hidden`}>
          <div class="pipeline-report-list" data-report-list-id="${e.id}">${ln(r)}</div>
          <textarea class="pipeline-report-textarea" data-report-textarea-id="${e.id}" rows="2" placeholder="متنی که برای مشتری پیامک می‌شود...">${cn(i)}</textarea>
      ...
      <div class="pipeline-report">
        ...
        <div class="pipeline-report-body" data-history-body-id="${e.id}" ${a?``:`hidden`}>
          <div data-history-list-id="${e.id}">${un(o)}</div>
        </div>
      </div>
    </div>
  `}function fn(){return`
    ...
    <div class="pipeline-tabs" id="pipeline-tabs">
      ${zt.map(e=>`
          <button type="button" class="pipeline-tab ${e.id===rn?`is-active`:``}" data-pipeline-tab="${e.id}" style="--tab-accent:${e.color}">
            <span>${e.label}</span>
  ...
  `}function hn(e){if(e.length===0)return`<p class="chart-empty">داده‌ای موجود نیست.</p>`;let t=Math.max(...e.map(e=>e.value),1),n=e.length>1?576/(e.length-1):0,r=e.map((e,r)=>({x:32+r*n,y:168-e.value/t*136})),i=r.map((e,t)=>`${t===0?`M`:`L`}${e.x},${e.y}`).join(` `);return`
  ...
  `}var gn={mobile:`موبایل`,desktop:`رایانه`};function _n(e){let t=e.split(`-`);return t.length===3?J(`${t[1]}/${t[2]}`):J(e)}function vn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function yn(){return`
    <div class="dash-view">
  ...
  `}function bn(e){let t=document.getElementById(`dash-body`),n=document.getElementById(`dash-error`),r=document.getElementById(`dash-refresh-btn`),i=document.querySelectorAll(`#dash-subnav [data-dash-tab]`);if(!t)return;let a=`overview`;async function o(){if(t){t.innerHTML=`
      <div class="dash-loading">
        <span class="dash-spinner"></span>
        <span>در حال پایش اطلاعات عملیات...</span>
      </div>
    `;try{let[n,r,i,a]=await Promise.allSettled([B(),at(),Qe(),N()]),o=n.status===`fulfilled`?n.value:null,s=r.status===`fulfilled`?r.value:null,c=i.status===`fulfilled`?i.value:[],l=a.status===`fulfilled`?a.value:[],d=o?.byStatus?.find(e=>e.status===`pending`)?.count??0,f=o?.byStatus?.find(e=>e.status===`in_progress`)?.count??0,p=o?.byStatus?.find(e=>e.status===`completed`)?.count??0,m=o?.completedRevenue??0,h=o?.avgOrderValue??0,g=c.filter(e=>e.status===`active`).length,_=c.length,v=s?.totalViews??0,y=s?.uniqueVisitors??0,b=s?.activeOnline??0,x=s?.conversionRate??0,S=l.slice(0,8),C=`
        <!-- KPI Cards Grid -->
        ...
        <div class="dash-charts-grid">
          <div class="dash-card">
            ...
            <div class="dash-card-body">
              ${o?.daily?.length?hn(o.daily.map(e=>({label:_n(e.day),value:e.count}))):`<p class="dash-empty">داده‌ای ثبت نشده است.</p>`}
            </div>
          </div>
          ...
          <div class="dash-card">
            ...
            <div class="dash-card-body">
              ${o?.byStatus?.length?mn(o.byStatus.map(e=>({label:Bt[e.status]??e.status,value:e.count}))):`<p class="dash-empty">داده‌ای ثبت نشده است.</p>`}
            </div>
          </div>
        </div>
            ...
            <div class="dash-table-wrapper">
              ${S.length===0?`<p class="dash-empty">هنوز سفارشی در سامانه بهبار ثبت نشده است.</p>`:`
                <table class="dash-table">
                  ...
                  <tbody>
                    ${S.map(e=>{let t=Vt[e.status]??`var(--muted)`,n=Bt[e.status]??e.status,r=`${vn(e.originCity||`—`)} به ${vn(e.destinationCity||`—`)}`;return`
                        <tr>
                          <td><span class="dash-code">${vn(e.trackingCode)}</span></td>
                          <td>
                            <div class="dash-customer-cell">
                              <span class="dash-customer-name">${vn(e.customerName||`بدون نام`)}</span>
                              <span class="dash-customer-phone">${J(e.phone||``)}</span>
                            </div>
                          </td>
                          <td><span class="dash-service-tag">${vn(e.serviceLabel||`حمل بار`)}</span></td>
    ...
    `;try{let e=await B(),n=e.byStatus.find(e=>e.status===`in_progress`)?.count??0,r=e.byStatus.find(e=>e.status===`completed`)?.count??0;t.innerHTML=`
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card">
        ...
        <div class="dash-charts-grid">
          <div class="dash-card">
            ...
            <div class="dash-card-body">${hn(e.daily.map(e=>({label:_n(e.day),value:e.count})))}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">وضعیت درخواست‌ها</h2></div>
            <div class="dash-card-body">${mn(e.byStatus.map(e=>({label:Bt[e.status]??e.status,value:e.count})))}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">نوع خدمات</h2></div>
            <div class="dash-card-body">${mn(e.byService.map(e=>({label:e.service_label,value:e.count})))}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">پرتقاضاترین شهرهای مبدأ</h2></div>
            <div class="dash-card-body">${e.topCities.length?mn(e.topCities.map(e=>({label:e.city,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">درخواست‌ها به تفکیک استان مبدأ</h2></div>
            <div class="dash-card-body">${e.topProvinces.length?mn(e.topProvinces.map(e=>({label:e.province,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
        </div>
    ...
    `;try{let e=await at();t.innerHTML=`
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card">
            <div class="dash-kpi-header">
              <span class="dash-kpi-label">کاربران آنلاین لحظه‌ای</span>
        ...
        <div class="dash-charts-grid">
          <div class="dash-card">
            ...
            <div class="dash-card-body">${e.daily.length?hn(e.daily.map(e=>({label:_n(e.day),value:e.count}))):`<p class="dash-empty">هنوز بازدیدی ثبت نشده است.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">صفحات پربازدید</h2></div>
            <div class="dash-card-body">${e.topPages.length?mn(e.topPages.map(e=>({label:e.path,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">منابع ورودی</h2></div>
            <div class="dash-card-body">${e.topReferrers.length?mn(e.topReferrers.map(e=>({label:e.referrer,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">دستگاه‌ها</h2></div>
            <div class="dash-card-body">${e.byDevice.length?mn(e.byDevice.map(e=>({label:gn[e.device]??e.device,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
        </div>
            ...
            <table class="dash-table">
              ...
              <tbody>
                ${e.staffPerformance.length?e.staffPerformance.map(e=>`
                    <tr>
                      <td><strong>${vn(e.name)}</strong></td>
                      <td><span class="dash-service-tag">${vn(e.role_label)}</span></td>
                      <td>${J(e.total)}</td>
  ...
  </svg>`,iconSize:[30,38],iconAnchor:[15,36]});function On(){return`
    <div class="view-header">
  ...
  `}function kn(){let e=document.getElementById(`map-error`),t=document.getElementById(`map-refresh`),n=document.getElementById(`admin-map`);if(!e||!t||!n)return;let r=wn.default.map(`admin-map`,{center:Tn,zoom:11});wn.default.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`© OpenStreetMap contributors`,maxZoom:19}).addTo(r);let i=[];function a(e,t){let n=t.map(t=>{let n=t.onActiveService&&t.id!==e.assignedStaffId,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e.assignedStaffId?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``);return`
  ...
  `}function Ln(e){let t=document.getElementById(`staff-history-error`),n=document.getElementById(`staff-history-stats`),r=document.getElementById(`staff-history-list`),i=document.getElementById(`staff-history-refresh`);if(!t||!n||!r||!i)return;async function a(){t.hidden=!0;try{let t=await Ue(e.id),i=t.filter(e=>e.status===`completed`).length,a=t.filter(e=>e.status===`in_progress`).length;n.innerHTML=`
        <div class="stat-card">
      ...
      `,r.innerHTML=t.length?t.map(Fn).join(``):`<p class="portal-empty">هنوز کاری به این کارمند اختصاص داده نشده است.</p>`}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}i.addEventListener(`click`,()=>void a()),a()}function Rn(){return`
    <div class="view-header">
      <h1>مدیریت فایل</h1>
      <div>
  ...
  `}function zn(){function e(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(1)} MB`}function t(e){return e.startsWith(`videos/`)?u.video:e.startsWith(`audio/`)?u.audio:u.image}let n=``;async function r(){let i=document.getElementById(`media-list`),a=document.getElementById(`media-error`);if(!(!i||!a)){a.hidden=!0;try{let o=await we(n||void 0);i.innerHTML=o.length?o.map(n=>`
  ...
  `}function Vn(){let e=document.getElementById(`roles-error`);if(!e)return;function t(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`,Q(t instanceof Error?t.message:`خطایی پیش آمد.`,`error`)}let n=[],r=[],i=null;function a(e){let t=e.isSystem;return`
  ...
  `}function rr(){let e=document.getElementById(`vehicle-add-toggle`),t=document.getElementById(`vehicle-form-card`),n=document.getElementById(`vehicle-form-title`),r=document.getElementById(`vehicle-form-cancel`),i=document.getElementById(`vehicle-form-error`),a=document.getElementById(`vehicle-form-submit`),o=document.getElementById(`vehicle-form-id`),s=document.getElementById(`vehicle-label`),c=document.getElementById(`vehicle-type`),l=document.getElementById(`vehicle-plate`),u=document.getElementById(`vehicle-model`),d=document.getElementById(`vehicle-year`),f=document.getElementById(`vehicle-status`),p=document.getElementById(`vehicle-driver`),m=document.getElementById(`vehicle-notes`),h=document.getElementById(`vehicles-error`),g=document.getElementById(`vehicles-table-body`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!u||!d||!f||!p||!m||!h||!g)return;let _=[],v=[],y=Object.fromEntries(Yn.map(e=>[e.id,e.label])),b=[],x={},S=[],C={city:``,cityEn:``,province:``,provinceEn:``},w=`all`,T=!0,E=!0,D=!1;Wn().then(()=>Kn(document.getElementById(`view-container`)??document.body)),document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-fleet-panel]`).forEach(t=>{t.hidden=t.dataset.fleetPanel!==e.dataset.fleetTab})})});function O(){let e=document.getElementById(`vehicle-types-list`);e&&(e.innerHTML=b.map((e,t)=>`
    ...
    `).join(``),Kn(e))}function ee(){b=Array.from(document.querySelectorAll(`[data-vehicle-type-index]`)).map((e,t)=>({id:b[t]?.id??`vehicle-${crypto.randomUUID().slice(0,8)}`,label:e.querySelector(`[data-field="label"]`).value,labelEn:e.querySelector(`[data-field="labelEn"]`).value,icon:e.querySelector(`[data-field="icon"]`).value,basePrice:Number(e.querySelector(`[data-field="basePrice"]`).value)||0,perKmRate:Number(e.querySelector(`[data-field="perKmRate"]`).value)||0,floorCostExempt:b[t]?.floorCostExempt??!1,active:e.querySelector(`[data-field="active"]`).checked,sortOrder:t+1}))}document.getElementById(`vehicle-types-list`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-remove-vehicle-type]`);t&&(ee(),b.splice(Number(t.dataset.removeVehicleType),1),O())}),document.getElementById(`vehicle-type-add-btn`)?.addEventListener(`click`,()=>{ee(),b.push({id:`vehicle-${crypto.randomUUID().slice(0,8)}`,label:``,labelEn:``,icon:`van`,basePrice:0,perKmRate:0,floorCostExempt:!1,active:!0,sortOrder:b.length+1}),O()}),document.getElementById(`vehicle-type-save-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget,n=document.getElementById(`vehicle-types-saved-note`),r=document.getElementById(`vehicle-types-error`);r&&(r.hidden=!0);try{await qn(t,async()=>{ee(),await V(`vehicle_types`,b)}),n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`)}});function k(){let e=document.getElementById(`cities-list`);e.innerHTML=S.map((e,t)=>`
  ...
  `}function dr(){let e=document.getElementById(`my-wallet-summary-card`),t=document.getElementById(`my-wallet-tx-list`),n=document.getElementById(`my-wallet-load-more`),r=document.getElementById(`my-payout-requests-list`),i=0,a=0,o=[];async function s(){if(e)try{let t=await U(),n=t.bonus.type===`percent`?`${t.bonus.amount}٪ برآورد هر درخواست`:Y(t.bonus.amount);e.innerHTML=`
      ...
      `}catch(t){e.innerHTML=`<p class="error-text">${t instanceof Error?t.message:`خطایی پیش آمد.`}</p>`}}async function c(){if(t)try{let{transactions:e,total:r}=await W(ir,i);o=[...o,...e],a=r,i+=e.length,t.innerHTML=o.length?o.map(lr).join(``):`<p class="settings-panel-hint">هنوز تراکنشی ثبت نشده.</p>`,n&&(n.hidden=i>=a)}catch(e){t.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}async function l(){if(r)try{let e=await yt();r.innerHTML=e.length?e.map(ur).join(``):`<p class="settings-panel-hint">هنوز درخواستی ثبت نکرده‌اید.</p>`}catch(e){r.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}n?.addEventListener(`click`,()=>void c()),document.getElementById(`payout-request-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`payout-request-amount`),n=document.getElementById(`payout-request-note`),r=document.getElementById(`payout-request-error`),i=document.getElementById(`payout-request-success`),a=document.getElementById(`payout-request-submit`);r.hidden=!0,i.hidden=!0;let o=Number(t.value);if(!Number.isFinite(o)||o<=0){r.hidden=!1,r.textContent=`مبلغ نامعتبر است.`;return}a.disabled=!0,(async()=>{try{await bt(o,n.value.trim()||void 0),i.hidden=!1,t.value=``,n.value=``,await Promise.all([s(),l()])}catch(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}finally{a.disabled=!1}})()}),s(),c(),l()}var fr={pending:{next:`in_progress`,label:`شروع کار`},contacted:{next:`in_progress`,label:`شروع کار`},scheduled:{next:`in_progress`,label:`شروع کار`},in_progress:{next:`completed`,label:`پایان کار`}};function pr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function mr(e){let t=fr[e.status],n=e.originLat!=null&&e.originLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.originLat},${e.originLng}`:null,r=e.destinationLat!=null&&e.destinationLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.destinationLat},${e.destinationLng}`:null;return`
...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function te(e){ee=e,e?(x.src=e,x.hidden=!1,S.hidden=!0,T&&(T.hidden=!1)):(x.hidden=!0,S.hidden=!1,T&&(T.hidden=!0))}function M(e,t){if(!e){i.hidden=!0,v.hidden=!0,y&&(y.hidden=!0);return}if(i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,v.hidden=e!==`published`,y&&b){let e=t||u.value.trim();if(e){y.hidden=!1;let t=`https://behbarapp.ir/p/${encodeURIComponent(e)}`;b.href=t,b.textContent=`/p/${e}`}else y.hidden=!0}}async function N(){if(e===null){r.textContent=`برگه جدید`,O=[Br(`richtext`)],A(),M(null),E&&(E.checked=!1),D&&(D.checked=!1);return}try{let t=await ve(e);if(!t){n.hidden=!1,n.textContent=`برگه پیدا نشد.`;return}k=t,r.textContent=t.title||`ویرایش برگه`,o.value=t.title,s.value=t.titleEn||``,c.value=t.excerpt||``,l.value=t.excerptEn||``,u.value=t.slug,d.value=t.metaTitle??``,f.value=t.metaDescription??``,E&&(E.checked=!!t.showInHeader),D&&(D.checked=!!t.showInFooter),te(t.coverImageUrl),O=t.content&&t.content.length?t.content:[Br(`richtext`)],A(),M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی در بارگذاری برگه پیش آمد.`}}function P(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),coverImageUrl:ee,content:j(),metaTitle:d.value.trim()||void 0,metaDescription:f.value.trim()||void 0,slug:u.value.trim()||void 0,showInHeader:E?.checked??!1,showInFooter:D?.checked??!1}}async function F(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان برگه الزامی است.`,null;let t=P();try{let n=k?await be(k.id,t):await ye(t);return k=n,e=n.id,u.value=n.slug,r.textContent=n.title,M(n.status,n.slug),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره برگه ناموفق بود.`,null}}p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;O=j();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?O.splice(n,1):r===`up`&&n>0?[O[n-1],O[n]]=[O[n],O[n-1]]:r===`down`&&n<O.length-1&&([O[n+1],O[n]]=[O[n],O[n+1]]),A()}),p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),p.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await Ce(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر ناموفق بود.`}}),h.addEventListener(`click`,()=>{O=j(),O.push(Br(m.value)),A()}),w.addEventListener(`click`,()=>C.click()),T&&T.addEventListener(`click`,()=>te(null)),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{te(await Ce(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر شاخص ناموفق بود.`}}),g.addEventListener(`click`,async()=>{g.disabled=!0,g.textContent=`در حال ذخیره...`,await F(),g.disabled=!1,g.textContent=`ذخیره پیش‌نویس`}),_.addEventListener(`click`,async()=>{_.disabled=!0;let e=await F();if(e)try{let t=await xe(e.id,!0);M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار برگه ناموفق بود.`}_.disabled=!1}),v.addEventListener(`click`,async()=>{if(k){v.disabled=!0;try{let e=await xe(k.id,!1);M(e.status,e.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`تغییر به پیش‌نویس ناموفق بود.`}v.disabled=!1}}),a.addEventListener(`click`,t),N()}function Kr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function qr(e){return Array.from({length:5},(t,n)=>n<e?`★`:`☆`).join(``)}function Jr(e){return`
  ...
  `}function ai(){let e=document.getElementById(`chat-error`),t=document.getElementById(`chat-filter-tabs`),n=document.getElementById(`chat-conversation-list`),r=document.getElementById(`chat-thread-empty`),i=document.getElementById(`chat-thread-active`),a=document.getElementById(`chat-thread-name`),o=document.getElementById(`chat-thread-phone`),s=document.getElementById(`chat-assign-select`),c=document.getElementById(`chat-thread-status-btn`),l=document.getElementById(`chat-thread-archive-btn`),d=document.getElementById(`chat-thread-delete-btn`),f=document.getElementById(`chat-responders-row`),p=document.getElementById(`chat-info-panel`),m=document.getElementById(`chat-request-card`),h=document.getElementById(`chat-thread-messages`),_=document.getElementById(`chat-thread-form`),v=document.getElementById(`chat-thread-input`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!d||!f||!p||!m||!h||!_||!v)return;let y=g(),b=[],x=[],S=null,C=`all`;function w(){if(C===`archived`)return b.filter(e=>e.archivedAt!==null);let e=b.filter(e=>e.archivedAt===null);return C===`mine`?e.filter(e=>e.assignedStaffId===y?.id):C===`unassigned`?e.filter(e=>e.assignedStaffId===null):e}function T(){let t=w();n.innerHTML=t.length?t.map(e=>`
        <div class="chat-conversation-item ${e.id===S?`is-active`:``}" data-conversation-id="${e.id}" role="button" tabindex="0">
          <div class="chat-conversation-item-top">
            ...
            <span class="chat-conversation-item-top-end">
              <span class="chat-conversation-time">${tn(e.lastMessageAt)}</span>
      ...
      <div class="chat-bubble-admin chat-bubble-admin-${e.sender}">
        ...
        ${ni(e)}
        <span class="chat-bubble-timestamp">${tn(e.createdAt)}</span>
      </div>
    `).join(``),h.scrollTop=h.scrollHeight,k(e)}function k(e){let t=[],n=new Set;for(let r of e)r.sender!==`staff`||!r.staffName||n.has(r.staffName)||(n.add(r.staffName),t.push({name:r.staffName,avatar:r.staffAvatar}));if(!t.length){f.hidden=!0,f.innerHTML=``;return}f.hidden=!1,f.innerHTML=`<span class="chat-responders-label">پاسخ‌دهندگان:</span>`+t.map(e=>`<span class="chat-responder-chip">${ri(e.name,e.avatar,`sm`)}<span>${ei(e.name)}</span></span>`).join(``)}async function A(){if(S!==null)try{ee(await Ie(S))}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function j(e){if(!e.length){m.innerHTML=`<h3>درخواست‌های ثبت‌شده</h3><p class="chat-request-empty">درخواستی برای این شماره ثبت نشده است.</p>`;return}let[t,...n]=e;m.innerHTML=`
      ...
      <div class="chat-request-latest">
        ...
        <div class="chat-request-row"><span>زمان</span><span>${ei(t.scheduledDate)} — ${J(t.scheduledTime)}</span></div>
        <div class="chat-request-row"><span>وضعیت</span><span>${ei(Bt[t.status]??t.status)}</span></div>
    ...
    `}async function te(e){if(!e){j([]);return}try{j(await He(e))}catch{m.innerHTML=`<h3>درخواست‌های ثبت‌شده</h3><p class="chat-request-empty">دریافت اطلاعات ناموفق بود.</p>`}}function M(e){S=e,r.hidden=!0,i.hidden=!1,p.hidden=!1;let t=b.find(t=>t.id===e);a.textContent=t?.customerName||`مهمان`,o.textContent=t?.customerPhone||``,c.textContent=t?.status===`open`?`بستن گفتگو`:`بازکردن گفتگو`,l.textContent=t?.archivedAt?`خروج از بایگانی`:`بایگانی`,E(t),T(),A(),te(t?.customerPhone??null)}t.querySelectorAll(`[data-filter]`).forEach(e=>{e.addEventListener(`click`,()=>{C=e.dataset.filter,t.querySelectorAll(`[data-filter]`).forEach(t=>t.classList.toggle(`is-active`,t===e)),T()})}),s.addEventListener(`change`,async()=>{if(S===null)return;let t=s.value,n=t?Number(t):null;s.disabled=!0;try{await ze(S,n),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}finally{s.disabled=!1}}),c.addEventListener(`click`,async()=>{if(S===null)return;let t=b.find(e=>e.id===S)?.status===`open`?`closed`:`open`;try{await Re(S,t),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}),l.addEventListener(`click`,async()=>{if(S===null)return;let t=!b.find(e=>e.id===S)?.archivedAt;try{await Be(S,t),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}),d.addEventListener(`click`,async()=>{if(S!==null&&window.confirm(`این گفتگو برای همیشه حذف شود؟`))try{await Ve(S),S=null,r.hidden=!1,i.hidden=!0,p.hidden=!0,await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`حذف ناموفق بود.`}}),_.addEventListener(`submit`,async t=>{if(t.preventDefault(),S===null)return;let n=v.value.trim();if(n){v.value=``;try{await Le(S,n),await A(),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`ارسال ناموفق بود.`}}}),D(),O(),$r!==void 0&&window.clearInterval($r),$r=window.setInterval(()=>{O(),S!==null&&A()},Qr)}function oi(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function si(e){return`
  ...
  `}function Ci(){let e=document.getElementById(`activity-log-list`),t=document.getElementById(`activity-log-error`),n=document.getElementById(`activity-log-refresh`);if(!e||!t||!n)return;async function r(){t.hidden=!0;try{let t=await R();e.innerHTML=t.length?t.map(xi).join(``):`<p class="portal-empty">هنوز فعالیتی ثبت نشده است.</p>`}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}n.addEventListener(`click`,()=>void r()),r()}function wi(){return`
    <div class="editor-sidebar-card">
      <h3>به‌روزرسانی</h3>
...
`).map(e=>e.trim()).filter(Boolean),n=t.filter(e=>!e.startsWith(`- `)),r=t.filter(e=>e.startsWith(`- `)).map(e=>e.slice(2).trim());return{paragraphs:n,list:r.length?r:void 0}}function Ii(e){let t=`https://behbarapp.ir/p/${encodeURIComponent(e.slug)}`;return`
  ...
  `}function ya(e){return`
    <div class="editor-sidebar-card">
      <div class="plugin-card-head">
        <h3>${ma(e.staffName)} — ${Y(e.amount)}</h3>
      </div>
  ...
  `}function ka(){let e=document.querySelectorAll(`[data-finance-tab]`),t=document.getElementById(`finance-tab-overview`),n=document.getElementById(`finance-tab-documents`);e.forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.financeTab;e.forEach(e=>e.classList.remove(`active`)),r.classList.add(`active`),i===`overview`?(t&&(t.style.display=`block`),n&&(n.style.display=`none`)):i===`documents`&&(t&&(t.style.display=`none`),n&&(n.style.display=`block`))})});let r=[],i=Ca();async function a(){try{let[e]=await Promise.allSettled([N(),B()]);e.status===`fulfilled`&&(r=e.value),i=Ca(),s(),c()}catch(e){Q(e instanceof Error?e.message:`خطا در بارگذاری داده‌های مالی`,`error`)}}function o(){let e=[];for(let t of r){let n=`pending`;n=t.status===`completed`?`settled`:t.status===`canceled`?`canceled`:`pending`,e.push({id:t.id,isCustom:!1,trackingCode:t.trackingCode||`BB-${t.id}`,customerName:t.customerName||`مشتری سامانه`,phone:t.phone||`—`,serviceLabel:t.serviceLabel||`حمل بار`,originCity:t.originCity||`—`,destinationCity:t.destinationCity||`—`,amount:t.estimateAvg||t.estimateMin||0,settlementStatus:n,createdAt:t.createdAt||new Date().toISOString(),notes:t.originNotes||``})}for(let t of i)e.push({id:t.id,isCustom:!0,trackingCode:t.trackingCode,customerName:t.customerName,phone:t.phone,serviceLabel:t.serviceLabel,originCity:t.originCity,destinationCity:t.destinationCity,amount:t.amount,settlementStatus:t.settlementStatus,createdAt:t.createdAt,notes:t.notes});return e.sort((e,t)=>new Date(t.createdAt).getTime()-new Date(e.createdAt).getTime()),e}function s(){let e=o(),t=0,n=0,r=0,i=0,a={},s={settled:0,pending:0,credit:0,canceled:0};for(let o of e){let e=Number(o.amount)||0;t+=e,o.settlementStatus===`settled`?(n+=e,s.settled++):o.settlementStatus===`pending`?(r+=e,s.pending++):o.settlementStatus===`credit`?(i+=e,s.credit++):o.settlementStatus===`canceled`&&s.canceled++;let c=o.serviceLabel||`سایر`;a[c]||(a[c]={count:0,total:0}),a[c].count++,a[c].total+=e}let c=Math.max(0,n-i),l=document.getElementById(`kpi-gross-turnover`);l&&(l.textContent=Ea(t));let u=document.getElementById(`kpi-realized-revenue`);u&&(u.textContent=Ea(n));let d=document.getElementById(`kpi-pending-settlements`);d&&(d.textContent=Ea(r));let f=document.getElementById(`kpi-total-expenses`);f&&(f.textContent=Ea(i));let p=document.getElementById(`kpi-estimated-profit`);p&&(p.textContent=Ea(c));let m=document.getElementById(`kpi-docs-count`);m&&(m.textContent=Ta(e.length));let h=document.getElementById(`finance-services-breakdown`);if(h){let e=Object.entries(a).sort((e,t)=>t[1].total-e[1].total);h.innerHTML=e.length?e.map(([e,n])=>{let r=t>0?Math.round(n.total/t*100):0;return`
        ...
        <div style="display: flex; flex-direction: column; gap: 10px;">
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-settled">تسویه‌شده: ${Ta(s.settled)} سند</span>
              <span>%${Ta(Math.round(s.settled/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
          ...
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-pending">در انتظار تسویه: ${Ta(s.pending)} سند</span>
              <span>%${Ta(Math.round(s.pending/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
          ...
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-credit">بستانکار / هزینه‌ها: ${Ta(s.credit)} سند</span>
              <span>%${Ta(Math.round(s.credit/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
      ...
      `;return}e.innerHTML=a.map(e=>{let t=Da[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`},n=e.originCity&&e.destinationCity?`${e.originCity} ➔ ${e.destinationCity}`:`—`,r=e.createdAt?e.createdAt.slice(0,10):`—`;return`
          <tr data-doc-id="${e.id}">
            <td style="font-weight: 700; font-family: monospace; direction: ltr; text-align: right;">${e.trackingCode}</td>
            <td style="white-space: nowrap;">${Ta(r)}</td>
            <td style="font-weight: 600;">${e.customerName}</td>
            <td style="direction: ltr; text-align: right;">${Ta(e.phone)}</td>
            <td>${e.serviceLabel}</td>
            <td style="font-size: 0.8rem; color: var(--color-text-muted);">${n}</td>
            <td style="font-weight: 700; color: #059669;">${Ea(e.amount)}</td>
            <td>
        ...
        `}).join(``),e.querySelectorAll(`.btn-view-invoice`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.docCode,n=a.find(e=>e.trackingCode===t);n&&l(n)})}),e.querySelectorAll(`.btn-toggle-settlement`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.docId;if(e.dataset.isCustom===`true`){let e=i.find(e=>String(e.id)===t);e&&(e.settlementStatus=e.settlementStatus===`settled`?`pending`:`settled`,wa(i),Q(`وضعیت تسویه سند دستی به‌روزرسانی شد.`,`success`),s(),c())}else{let e=r.find(e=>String(e.id)===t);if(e){let t=e.status===`completed`?`in_progress`:`completed`;try{await P(e.id,t),e.status=t,Q(`وضعیت تسویه سفارش به‌روزرسانی شد.`,`success`),s(),c()}catch{Q(`خطا در به‌روزرسانی وضعیت تسویه`,`error`)}}}})})}function l(e){let t=document.getElementById(`finance-modal-container`);if(!t)return;let n=e.createdAt?e.createdAt.slice(0,10):new Date().toISOString().slice(0,10),r=Da[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`};t.innerHTML=`
            ...
            <div class="behbar-invoice-sheet" id="behbar-printable-invoice">
              <div class="behbar-invoice-head">
                ...
                <div class="behbar-invoice-meta">
                  ...
                  <div><strong>تاریخ صدور:</strong> ${Ta(n)}</div>
              ...
              <div class="behbar-invoice-parties">
                ...
                <div>
                  ...
                  <div style="color: #6b7280; font-size: 0.78rem;">شماره تماس: ${Ta(e.phone)}</div>
                </div>
              </div>
              ...
              <div class="behbar-invoice-total">
                ...
                <span style="font-size: 1.25rem;">${Ea(e.amount)} تومان</span>
              </div>
...
`),a=new Blob([i],{type:`text/csv;charset=utf-8;`}),s=URL.createObjectURL(a),c=document.createElement(`a`);c.href=s,c.download=`behbar-financial-report-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(c),c.click(),document.body.removeChild(c),URL.revokeObjectURL(s),Q(`فایل اکسل گزارش مالی بهبار با موفقیت ایجاد و دانلود شد.`,`success`)}document.getElementById(`finance-export-excel-btn`)?.addEventListener(`click`,f),document.getElementById(`finance-add-doc-btn`)?.addEventListener(`click`,d),document.getElementById(`finance-refresh-btn`)?.addEventListener(`click`,()=>{a(),Q(`اطلاعات مالی به‌روز شد.`,`success`)}),document.getElementById(`finance-search-input`)?.addEventListener(`input`,()=>c()),document.getElementById(`finance-status-filter`)?.addEventListener(`change`,()=>c()),a()}var Aa=`behbar_waybill_records`,ja=[{id:`wb-1`,waybillNumber:`IR-1403-882190`,issueDate:`۱۴۰۳/۰۶/۲۴`,status:`active`,sender:{name:`شرکت پتروشیمی آریا`,phone:`02188765432`,city:`تهران`,address:`بزرگراه فتح، کیلومتر ۸، انبار مرکزی`,nationalId:`10103498210`},receiver:{name:`صنایع پلاستیک اروند`,phone:`06153219876`,city:`اهواز`,address:`شهرک صنعتی شماره ۲، فاز دوم، خیابان تلاش ۳`,nationalId:`10861234509`},driver:{name:`محمدعلی رستمی`,nationalId:`1289456712`,licenseNumber:` پایه یک ۴۹۸۲۱`,phone:`09123456789`,smartCardNumber:`9823412`},fleet:{vehicleType:`تریلی چادری (ترانزیت)`,plateNumber:`۱۲ ع ۷۸۹ ایران ۴۴`,smartCardNumber:`3489102`},cargo:{description:`گرانول پلی‌اتیلن پتروشیمی در پالت بسته‌بندی شده`,weightKg:22e3,packaging:`پالت و شیرینگ پلاستیکی`,declaredValueToman:185e7},insurance:{policyNumber:`INS-403-99214`,insurerName:`بیمه ایران`,coverageType:`پوشش کامل تمام‌خطر (کلوز A) + مسئولیت مدنی متصدی حمل`,coverageCeilingToman:2e9,premiumToman:55e5},freightCostToman:38e6,notes:`حمل فوری، تحویل با ارائه حواله انبار و مهر مقصد`},{id:`wb-2`,waybillNumber:`IR-1403-882185`,issueDate:`۱۴۰۳/۰۶/۲۳`,status:`active`,sender:{name:`تجهیزات پزشکی بهمن`,phone:`02166543210`,city:`کرج`,address:`بلوار جمهوری، نبش کوچه یاس`,nationalId:`10105544332`},receiver:{name:`بیمارستان امام رضا (ع)`,phone:`05138543210`,city:`مشهد`,address:`میدان بیمارستان، خیابان ابن‌سینا`,nationalId:`14008765432`},driver:{name:`حسین صادقی`,nationalId:`0943218765`,licenseNumber:`پایه دو ۳۲۱۴۵`,phone:`09151122334`,smartCardNumber:`7612984`},fleet:{vehicleType:`خاور مسقف مجهز به مهاربند`,plateNumber:`۳۴ ب ۵۶۷ ایران ۱۲`,smartCardNumber:`4455667`},cargo:{description:`دستگاه‌های تشخیصی و مانیتور علائم حیاتی آزمایشگاهی`,weightKg:3500,packaging:`کارتن پالت‌بندی شده ضدضربه`,declaredValueToman:95e7},insurance:{policyNumber:`INS-403-99180`,insurerName:`بیمه آسیا`,coverageType:`بیمه‌نامه رسمی راهداری + الحاقیه شکست و نوسان`,coverageCeilingToman:1e9,premiumToman:32e5},freightCostToman:185e5,notes:`بار حساس و نیازمند سرعت مطمئنه و عدم تکان شدید`},{id:`wb-3`,waybillNumber:`IR-1403-881950`,issueDate:`۱۴۰۳/۰۶/۲۱`,status:`delivered`,sender:{name:`بازرگانی پارس سرام`,phone:`03536214589`,city:`یزد`,address:`بلوار آزادگان، روبروی پارک صنعتی`,nationalId:`10840019283`},receiver:{name:`پروژه برج سپهر تبریز`,phone:`04133445566`,city:`تبریز`,address:`بلوار ائل‌گلی، کوی فردوس`,nationalId:`14002345678`},driver:{name:`رضا کریمیان`,nationalId:`1198765432`,licenseNumber:`پایه یک ۶۵۴۳۲`,phone:`09139876543`,smartCardNumber:`8877665`},fleet:{vehicleType:`کامیون ده چرخ جفت`,plateNumber:`۶۵ ج ۲۳۴ ایران ۵۵`,smartCardNumber:`9988112`},cargo:{description:`سرامیک و پرسلان کف ساختمانی صادراتی`,weightKg:14500,packaging:`پالت چوبی با استرچ`,declaredValueToman:62e7},insurance:{policyNumber:`INS-403-98910`,insurerName:`بیمه دانا`,coverageType:`پوشش مسئولیت مدنی متصدی حمل کالا`,coverageCeilingToman:7e8,premiumToman:19e5},freightCostToman:24e6,notes:`تحویل صحیح و سالم بدون هیچ‌گونه شکستگی تایید شد`},{id:`wb-4`,waybillNumber:`IR-1403-882205`,issueDate:`۱۴۰۳/۰۶/۲۴`,status:`pending`,sender:{name:`فولاد غرب پارس`,phone:`03133887766`,city:`اصفهان`,address:`شهرک صنعتی مورچه‌خورت، خیابان ابوریحان`,nationalId:`10260384910`},receiver:{name:`اسکلت فلزی شمال`,phone:`01132233445`,city:`ساری`,address:`جاده دریا، کیلومتر ۴`,nationalId:`10760192837`},driver:{name:`ابراهیم قاسمی`,nationalId:`1276543219`,licenseNumber:`پایه یک ۷۷۶۶۵`,phone:`09132211445`,smartCardNumber:`3344551`},fleet:{vehicleType:`تریلی کفی ۱۲ متری`,plateNumber:`۸۸ د ۴۵۶ ایران ۳۳`,smartCardNumber:`1122334`},cargo:{description:`تیرآهن سنگین و میلگرد ساختمانی شاخه ۱۲ متری`,weightKg:24e3,packaging:`بندیل تسمه‌کشی شده`,declaredValueToman:12e8},insurance:{policyNumber:`INS-403-99302`,insurerName:`بیمه ایران`,coverageType:`بیمه‌نامه جامع باربری راهداری کلوز A`,coverageCeilingToman:13e8,premiumToman:38e5},freightCostToman:31e6,notes:`در انتظار تایید بارگیری و مهاربندی ایمن روی کفی`}];function Ma(){try{let e=localStorage.getItem(Aa);if(!e)return Na(ja),ja;let t=JSON.parse(e);return Array.isArray(t)&&t.length>0?t:ja}catch{return ja}}function Na(e){try{localStorage.setItem(Aa,JSON.stringify(e))}catch{}}function Pa(e){return String(e).replace(/\d/g,e=>`۰۱۲۳۴۵۶۷۸۹`[Number(e)])}function Fa(e){return Pa(Math.round(e).toString().replace(/\B(?=(\d{3})+(?!\d))/g,`،`))}var Ia={active:{label:`در مسیر حمل`,badgeClass:`waybill-badge-active`},delivered:{label:`تحویل‌شده`,badgeClass:`waybill-badge-delivered`},pending:{label:`در انتظار صدور`,badgeClass:`waybill-badge-pending`},canceled:{label:`باطله`,badgeClass:`waybill-badge-canceled`}};function La(e){return`
  ...
  `}function Ra(){let e=Ma(),t=[];N().then(e=>{Array.isArray(e)&&(t=e)});let n=document.getElementById(`wb-search-input`),r=document.getElementById(`wb-status-filter`),i=document.getElementById(`wb-insurer-filter`),a=document.getElementById(`wb-table-body`),o=document.getElementById(`wb-add-btn`),s=document.getElementById(`wb-export-excel-btn`);function c(){let t=e.length,n=e.filter(e=>e.status===`active`).length,r=e.filter(e=>e.status===`pending`).length,i=e.reduce((e,t)=>e+(t.cargo.declaredValueToman||0),0),a=document.getElementById(`stat-total-count`),o=document.getElementById(`stat-active-count`),s=document.getElementById(`stat-pending-count`),c=document.getElementById(`stat-insurance-value`);a&&(a.textContent=`${Pa(t)} فقره`),o&&(o.textContent=`${Pa(n)} فقره`),s&&(s.textContent=`${Pa(r)} فقره`),c&&(c.textContent=`${Fa(i)} تومان`)}function l(){if(!a)return;let t=(n?.value||``).trim().toLowerCase(),o=r?.value||`all`,s=i?.value||`all`,c=e.filter(e=>!(o!==`all`&&e.status!==o||s!==`all`&&!e.insurance.insurerName.includes(s)||t&&!`
      ...
      `;return}a.innerHTML=c.map(e=>{let t=Ia[e.status]||{label:e.status,badgeClass:`waybill-badge-pending`};return`
          <tr>
            <td>
            ...
            <td>
              <div style="display: flex; flex-direction: column; gap: 2px;">
                ...
                <span style="font-size: 0.78rem; color: #64748b;">${e.fleet.vehicleType} (${Pa(e.fleet.plateNumber)})</span>
              </div>
            </td>
            <td>
              <span style="font-weight: 800; color: #047857;">${Fa(e.cargo.declaredValueToman)}</span>
            </td>
            <td>
              <span style="font-size: 0.84rem;">${Pa(e.issueDate)}</span>
            </td>
            <td>
            ...
            <div class="official-waybill-sheet" id="official-sheet-content">
              ...
              <div class="sheet-header">
                ...
                <div class="sheet-meta-area">
                  ...
                  <div>تاریخ صدور: <strong>${Pa(e.issueDate)}</strong></div>
                </div>
              </div>
              ...
              <div class="sheet-insurance-highlight">
                ...
                <div class="item">
                  ...
                  <span class="val">${Fa(e.insurance.coverageCeilingToman)} تومان</span>
                </div>
                <div class="item">
                  <span class="title">ارزش اظهارشده کالا:</span>
                  <span class="val">${Fa(e.cargo.declaredValueToman)} تومان</span>
                </div>
              </div>
              ...
              <div class="sheet-section">
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Pa(e.sender.phone)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">شناسه ملی / کد ملی:</span>
                    <span class="sheet-item-value">${Pa(e.sender.nationalId||`---`)}</span>
                  </div>
                </div>
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Pa(e.receiver.phone)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">شناسه ملی / کد ملی:</span>
                    <span class="sheet-item-value">${Pa(e.receiver.nationalId||`---`)}</span>
                  </div>
                </div>
                <div style="padding: 0 12px 8px 12px; font-size: 0.8rem; color: #475569;">
              ...
              <div class="sheet-section">
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Pa(e.driver.nationalId)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">کارت هوشمند راننده:</span>
                    <span class="sheet-item-value">${Pa(e.driver.smartCardNumber)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">شماره تماس راننده:</span>
                    <span class="sheet-item-value">${Pa(e.driver.phone)}</span>
                  </div>
                </div>
                <div class="sheet-grid-row" style="border-top: 1px dashed #cbd5e1;">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Pa(e.fleet.plateNumber)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">کارت هوشمند ناوگان:</span>
                    <span class="sheet-item-value">${Pa(e.fleet.smartCardNumber)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">کرایه کل حمل:</span>
                    <span class="sheet-item-value" style="color: #047857;">${Fa(e.freightCostToman)} تومان</span>
                  </div>
                </div>
              </div>
              ...
              <div class="sheet-section">
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Pa(e.cargo.weightKg)} کیلوگرم</span>
                  </div>
                  <div class="sheet-item">
    ...
    `;let i=()=>{n.innerHTML=``};document.getElementById(`wb-add-close`)?.addEventListener(`click`,i),document.getElementById(`wb-add-cancel`)?.addEventListener(`click`,i);let a=document.getElementById(`wb-quick-select-order`);a&&a.addEventListener(`change`,()=>{let e=Number(a.value),n=t.find(t=>t.id===e);n&&(document.getElementById(`wb-sender-name`).value=n.customerName||``,document.getElementById(`wb-sender-city`).value=n.originCity||``,document.getElementById(`wb-sender-phone`).value=n.phone||``,document.getElementById(`wb-sender-address`).value=n.originNotes||``,document.getElementById(`wb-receiver-city`).value=n.destinationCity||``,document.getElementById(`wb-receiver-address`).value=n.destinationNotes||``,document.getElementById(`wb-cargo-desc`).value=n.serviceLabel||`کالای عمومی تجاری`,document.getElementById(`wb-cargo-value`).value=String(n.estimateAvg?n.estimateAvg*10:2e8),document.getElementById(`wb-freight-cost`).value=String(n.estimateAvg||15e6))}),document.getElementById(`wb-add-submit`)?.addEventListener(`click`,()=>{let t=document.getElementById(`wb-sender-name`).value.trim(),n=document.getElementById(`wb-sender-city`).value.trim(),r=document.getElementById(`wb-receiver-name`).value.trim(),a=document.getElementById(`wb-receiver-city`).value.trim(),o=document.getElementById(`wb-driver-name`).value.trim(),s=document.getElementById(`wb-cargo-desc`).value.trim(),u=Number(document.getElementById(`wb-cargo-value`).value)||1e8;if(!t||!n||!r||!a||!o||!s){Q(`لطفاً مشخصات الزامی فرستنده، گیرنده، راننده و محموله را تکمیل فرمایید.`,`error`);return}let d=Math.floor(1e5+Math.random()*9e5),p={id:`wb-${Date.now()}`,waybillNumber:`IR-1403-${d}`,issueDate:`۱۴۰۳/۰۶/۲۴`,status:`active`,sender:{name:t,city:n,phone:document.getElementById(`wb-sender-phone`).value.trim(),address:document.getElementById(`wb-sender-address`).value.trim()||`تهران، بارگیری مرکزی`,nationalId:document.getElementById(`wb-sender-nid`).value.trim()},receiver:{name:r,city:a,phone:document.getElementById(`wb-receiver-phone`).value.trim(),address:document.getElementById(`wb-receiver-address`).value.trim()||`مقصد تحویل سراسری`,nationalId:document.getElementById(`wb-receiver-nid`).value.trim()},driver:{name:o,nationalId:document.getElementById(`wb-driver-nid`).value.trim()||`1234567890`,licenseNumber:`پایه یک راهداری`,phone:document.getElementById(`wb-driver-phone`).value.trim()||`09120000000`,smartCardNumber:document.getElementById(`wb-driver-smart`).value.trim()||String(d)},fleet:{vehicleType:document.getElementById(`wb-fleet-type`).value,plateNumber:document.getElementById(`wb-fleet-plate`).value.trim()||`۲۱ ع ۷۸۹ ایران ۳۳`,smartCardNumber:String(d+1e3)},cargo:{description:s,weightKg:Number(document.getElementById(`wb-cargo-weight`).value)||5e3,packaging:document.getElementById(`wb-cargo-pack`).value.trim()||`پالت استاندارد`,declaredValueToman:u},insurance:{policyNumber:`INS-403-${d}`,insurerName:document.getElementById(`wb-insurer-select`).value,coverageType:`پوشش مسئولیت مدنی متصدی و کلوز جامع باربری راهداری`,coverageCeilingToman:u,premiumToman:Math.round(u*.003)},freightCostToman:Number(document.getElementById(`wb-freight-cost`).value)||2e7};e.unshift(p),Na(e),c(),l(),i(),Q(`بارنامه و بیمه‌نامه شماره ${p.waybillNumber} با موفقیت صادر گردید.`,`success`),f(p)})}function m(){if(e.length===0){Q(`هیچ داده‌ای برای خروجی اکسل موجود نیست.`,`error`);return}let t=[`شماره بارنامه`,`تاریخ صدور`,`وضعیت`,`شرکت بیمه‌گر`,`شماره بیمه‌نامه`,`سقف تعهد بیمه (تومان)`,`فرستنده`,`شهر مبدا`,`تلفن فرستنده`,`گیرنده`,`شهر مقصد`,`تلفن گیرنده`,`راننده`,`کد ملی راننده`,`تلفن راننده`,`نوع ناوگان`,`پلاک انتظامی`,`شرح محموله`,`وزن (کیلوگرم)`,`ارزش اعلامی محموله (تومان)`,`کرایه حمل (تومان)`],n=e.map(e=>[e.waybillNumber,e.issueDate,Ia[e.status]?.label||e.status,e.insurance.insurerName,e.insurance.policyNumber,e.insurance.coverageCeilingToman,e.sender.name,e.sender.city,e.sender.phone,e.receiver.name,e.receiver.city,e.receiver.phone,e.driver.name,e.driver.nationalId,e.driver.phone,e.fleet.vehicleType,e.fleet.plateNumber,`"${(e.cargo.description||``).replace(/"/g,`""`)}"`,e.cargo.weightKg,e.cargo.declaredValueToman,e.freightCostToman]),r=`﻿`+[t.join(`,`),...n.map(e=>e.join(`,`))].join(`\r
`),i=new Blob([r],{type:`text/csv;charset=utf-8;`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.setAttribute(`href`,a),o.setAttribute(`download`,`behbar_waybills_insurance_${Date.now()}.csv`),document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a),Q(`فایل اکسل بارنامه‌ها و بیمه‌نامه‌ها با موفقیت دریافت شد.`,`success`)}n?.addEventListener(`input`,l),r?.addEventListener(`change`,l),i?.addEventListener(`change`,l),o?.addEventListener(`click`,p),s?.addEventListener(`click`,m),c(),l()}function za(e,t,n){return`
    <button type="button" class="home-tile" data-home-tile="${e}">
      <span class="home-tile-icon">${t}</span>
      <span class="home-tile-label">${n}</span>
    </button>
  `}function Ba(e){let t=x(e,`content`)||x(e,`stories`)||x(e,`seo`)||x(e,`settings`),n=x(e,`staff`)||x(e,`recruitment`)||x(e,`roles`)||x(e,`wallet`),r=x(e,`settings`)||x(e,`homepage`),i=x(e,`pipeline`)||x(e,`map`),a=x(e,`dashboard`)||x(e,`wallet`)||x(e,`roles`)||x(e,`staff`),o=[];return o.push(za(`dashboard`,u.chart,`داشبورد`)),i&&o.push(za(`requests`,u.columns,`درخواست‌ها`)),(x(e,`pipeline`)||x(e,`staff`)||x(e,`dashboard`))&&o.push(za(`waybills`,u.shield,`بیمه‌نامه و بارنامه`)),a&&o.push(za(`finance`,u.finance,`مدیریت مالی`)),x(e,`staff`)&&o.push(za(`fleet`,u.truck,`مدیریت ناوگان حمل‌ونقل`)),r&&o.push(za(`settings`,u.settings,`تنظیمات سایت`)),x(e,`chat`)&&o.push(za(`chat`,u.chat,`چت پشتیبانی`)),t&&o.push(za(`content`,u.grid,`مدیریت محتوا`)),n&&o.push(za(`personnel`,u.users,`مدیریت پرسنل`)),x(e,`plugins`)&&o.push(za(`plugins`,u.plugin,`افزونه‌ها`)),`<div class="home-grid">${o.join(``)}</div>`}function Va(e){let t=[];return x(e,`pipeline`)&&t.push(za(`pipeline`,u.columns,`مراحل درخواست‌ها`)),x(e,`map`)&&t.push(za(`map`,u.map,`نقشه درخواست‌ها`)),`<div class="home-grid">${t.join(``)}</div>`}function Ha(e){let t=[];return x(e,`content`)&&t.push(za(`magazine`,u.article,`مجله`)),x(e,`content`)&&t.push(za(`testimonials`,u.message,`نظرات مشتریان`)),x(e,`stories`)&&t.push(za(`stories`,u.story,`استوری‌ها`)),x(e,`seo`)&&t.push(za(`seo`,u.seo,`مدیریت سئو`)),(x(e,`content`)||x(e,`settings`))&&t.push(za(`media`,u.image,`مدیریت فایل`)),`<div class="home-grid">${t.join(``)}</div>`}function Ua(e){let t=[];return x(e,`staff`)&&t.push(za(`staff`,u.users,`کارمندان`)),x(e,`recruitment`)&&t.push(za(`jobApplications`,u.briefcase,`فرصت‌های شغلی`)),x(e,`roles`)&&t.push(za(`roles`,u.lock,`نقش‌ها و اختیارات`)),(x(e,`staff`)||x(e,`roles`))&&t.push(za(`activityLog`,u.history,`گزارش فعالیت`)),x(e,`wallet`)&&t.push(za(`payroll`,u.wallet,`حقوق و دستمزد`)),`<div class="home-grid">${t.join(``)}</div>`}function Wa(e,t){e.querySelectorAll(`[data-home-tile]`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.homeTile??``))})}async function Ga(){try{let e=(await Ee()).site_name?.fa?.trim();if(!e||e===`بهبار`)return;document.querySelectorAll(`#login-brand-text, .admin-logo-title, #staff-portal-brand-text`).forEach(t=>{t.textContent?.includes(`بهبار`)&&(t.textContent=t.textContent.replace(/بهبار/g,e))})}catch{}}function Ka(e){return e===`home`?null:e===`requests`||e===`content`||e===`personnel`||e===`dashboard`||e===`settings`||e===`plugins`||e===`chat`||e===`fleet`||e===`finance`||e===`waybills`?`home`:e===`pipeline`||e===`map`?`requests`:e===`magazine`||e===`testimonials`||e===`stories`||e===`seo`||e===`media`?`content`:e===`staff`||e===`jobApplications`||e===`roles`||e===`activityLog`||e===`payroll`?`personnel`:e===`staffHistory`?`staff`:e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`?`dashboard`:e===`magazine-editor`?`magazine`:e===`page-editor`||e===`pages`?`settings`:`home`}function qa(){let e=document.querySelector(`#app`);if(!e)throw Error(`#app not found`);return e}function Ja(){let e=qa();e.innerHTML=At(),jt(oo),Ga()}var Ya={home:``,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,jobApplications:`job-applications`,activityLog:`activity-log`,accountSecurity:`account-security`,myWallet:`wallet`,payroll:`payroll`,finance:`finance`,waybills:`waybills`,magazine:`magazine`,"magazine-editor":`magazine-editor`,pages:`settings`,"page-editor":`page-editor`,dashboardOrders:`dashboard/orders`,dashboardVisitors:`dashboard/visitors`,dashboardStaff:`dashboard/staff`,staffHistory:`staff/history`},Xa={"":`home`,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,finance:`finance`,waybills:`waybills`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,"job-applications":`jobApplications`,"activity-log":`activityLog`,"account-security":`accountSecurity`,wallet:`myWallet`,payroll:`payroll`,magazine:`magazine`,"magazine-editor":`magazine-editor`,"page-editor":`page-editor`,"dashboard/orders":`dashboardOrders`,"dashboard/visitors":`dashboardVisitors`,"dashboard/staff":`dashboardStaff`,"staff/history":`staffHistory`};function Za(){let e=window.location.pathname.replace(/^\/management\/?/,``).replace(/\/+$/,``);if(!e)return{screen:`home`};if(Xa[e])return{screen:Xa[e]};let t=e.split(`/`);if(t.length===2&&(t[0]===`magazine-editor`||t[0]===`page-editor`)){let e=t[0],n=parseInt(t[1],10);return{screen:e,detailId:isNaN(n)?null:n}}return null}function Qa(e,t=null){let n=Ya[e]??``,r=n;(e===`magazine-editor`||e===`page-editor`)&&t&&(r=`${n}/${t}`);let i=r?`/management/${r}`:`/management/`;window.location.pathname!==i&&window.history.pushState({screen:e,editingDetailId:t},``,i)}var $a=`home`,eo=null;function $(e,t=null,n=!0){let r=document.getElementById(`view-container`),i=document.getElementById(`admin-back-btn`),a=g();if(!(!r||!a)){if($a=e,i&&(i.hidden=e===`home`),v({screen:e,extra:e===`magazine-editor`||e===`page-editor`?t:e===`staffHistory`?eo:void 0}),n&&Qa(e,t),e===`home`)r.innerHTML=Ba(a),Wa(r,e=>$(e));else if(e===`requests`)r.innerHTML=Va(a),Wa(r,e=>$(e));else if(e===`content`)r.innerHTML=Ha(a),Wa(r,e=>$(e));else if(e===`personnel`)r.innerHTML=Ua(a),Wa(r,e=>$(e));else if(e===`dashboard`)r.innerHTML=yn(),bn(e=>$(e));else if(e===`dashboardOrders`)r.innerHTML=xn();else if(e===`dashboardVisitors`)r.innerHTML=Sn();else if(e===`dashboardStaff`)r.innerHTML=Cn();else if(e===`pipeline`)r.innerHTML=fn(),pn();else if(e===`map`)r.innerHTML=On(),kn();else if(e===`staff`)r.innerHTML=Nn(),Pn(e=>{eo=e,$(`staffHistory`)});else if(e===`staffHistory`){if(!eo){$(`staff`);return}r.innerHTML=In(eo),Ln(eo)}else if(e===`fleet`)r.innerHTML=nr(),rr();else if(e===`magazine`)r.innerHTML=yr(),br(e=>$(`magazine-editor`,e));else if(e===`magazine-editor`)r.innerHTML=Lr(),Rr(t,()=>$(`magazine`));else if(e===`pages`){$(`settings`);return}else e===`page-editor`?(r.innerHTML=Wr(),Gr(t,()=>$(`settings`))):e===`testimonials`?(r.innerHTML=Xr(),Zr()):e===`chat`?(r.innerHTML=ii(),ai()):e===`stories`?(r.innerHTML=li(),ui()):e===`jobApplications`?(r.innerHTML=vi(),yi()):e===`settings`?(r.innerHTML=Gi(),Ki((e,t)=>$(e,t??null))):e===`plugins`?(r.innerHTML=Xi(),ea()):e===`seo`?(r.innerHTML=ua(),da(e=>$(`magazine-editor`,e))):e===`media`?(r.innerHTML=Rn(),zn()):e===`roles`?(r.innerHTML=Bn(),Vn()):e===`activityLog`?(r.innerHTML=Si(),Ci()):e===`accountSecurity`?(r.innerHTML=fa(),pa()):e===`myWallet`?(r.innerHTML=cr(),dr()):e===`payroll`?(r.innerHTML=ga(),xa()):e===`finance`?(r.innerHTML=Oa(a),ka()):e===`waybills`?(r.innerHTML=La(a),Ra()):(r.innerHTML=Ba(a),Wa(r,e=>$(e)))}}function to(e,t=!1){let n=qa();n.innerHTML=Rt(e),document.getElementById(`admin-back-btn`)?.addEventListener(`click`,()=>{let e=Ka($a);e&&$(e)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{te(),_(),Ja()}),document.getElementById(`admin-account-btn`)?.addEventListener(`click`,()=>$(`accountSecurity`));function r(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`,t=document.getElementById(`admin-theme-sun`),n=document.getElementById(`admin-theme-moon`);t&&n&&(t.hidden=!e,n.hidden=e)}r(),document.getElementById(`admin-theme-toggle-btn`)?.addEventListener(`click`,()=>{document.documentElement.getAttribute(`data-theme`)===`dark`?(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`behbar_admin_theme`,`light`)):(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`behbar_admin_theme`,`dark`)),r()}),document.getElementById(`admin-logo-btn`)?.addEventListener(`click`,()=>{$(`home`)}),window.addEventListener(`popstate`,e=>{let t=e.state;if(t?.screen)$(t.screen,t.editingDetailId??null,!1);else{let e=Za();e?$(e.screen,e.detailId??null,!1):$(`home`,null,!1)}}),x(e,`settings`)&&ro(),no(),Wn(),Ga(),x(e,`ai`)&&Ft();let i=Za(),a=t?y():null;i&&i.screen!==`home`?$(i.screen,i.detailId??null,!1):a?.screen===`staffHistory`&&a.extra?(eo=a.extra,$(`staffHistory`)):a?.screen===`magazine-editor`?$(`magazine-editor`,a.extra??null):a?.screen===`page-editor`?$(`page-editor`,a.extra??null):a?.screen&&a.screen!==`home`?$(a.screen):$(`home`,null,!0)}async function no(){try{let e=await Ee(),t=e.branding,n=t?.logoUrl;n&&document.querySelectorAll(`.admin-logo-mark`).forEach(e=>e.src=n);let r=t?.faviconUrl||n;r&&document.querySelectorAll(`link[rel="icon"]`).forEach(e=>e.href=r);let i=e.site_name;i?.fa?.trim()&&(document.title=`${i.fa.trim()} - پنل مدیریت`,document.querySelectorAll(`.admin-logo-title`).forEach(e=>e.textContent=i.fa.trim()))}catch{}}async function ro(){let e=document.getElementById(`admin-sidebar-version`);if(e)try{let t=await _t();e.textContent=t.updateAvailable?`نسخه ${t.current} · نسخه جدید موجود است`:`نسخه ${t.current}`,e.classList.toggle(`has-update`,t.updateAvailable),e.hidden=!1}catch{}}function io(e){let t=qa();t.innerHTML=hr(e),Ga(),_r(()=>{te(),_(),Ja()})}function ao(e){let t=qa();t.innerHTML=oa(),Ga(),sa(e,()=>to(e))}function oo(e,t=!1){if(!S(e)){io(e);return}if(!x(e,`settings`)){to(e,t);return}Ee().then(n=>{ia(n)?ao(e):to(e,t)}).catch(()=>to(e,t))}function so(){if(T(Ja),!b()){Ja();return}let e=g();e?oo(e,!0):Ja(),M().then(t=>{let n=h();n&&(m(n,t),(!e||e.role!==t.role)&&oo(t,!0))}).catch(()=>{})}so();