var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,o)=>(o=n==null?{}:e(i(n)),s(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=`viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"`,u={route:`<svg ${l}><circle cx="5.5" cy="6" r="2"/><circle cx="18.5" cy="18" r="2"/><path d="M5.5 8v3a3 3 0 0 0 3 3h7a3 3 0 0 1 3 3"/></svg>`,grid:`<svg ${l}><rect x="3.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="3.5" y="13.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="13.5" width="7" height="7" rx="1.5"/></svg>`,chart:`<svg ${l}><path d="M4 20V10M12 20V4M20 20v-7"/><path d="M2 20h20"/></svg>`,columns:`<svg ${l}><rect x="3.5" y="4" width="5" height="16" rx="1"/><rect x="9.5" y="4" width="5" height="10" rx="1"/><rect x="15.5" y="4" width="5" height="13" rx="1"/></svg>`,phone:`<svg ${l}><path d="M5.5 4h2.8l1.2 4-2 1.3a11 11 0 0 0 5.2 5.2l1.3-2 4 1.2v2.8c0 1-.9 1.7-1.8 1.5-6-1.1-10.6-5.7-11.7-11.7C4.3 5.4 5 4 5.5 4Z"/></svg>`,pin:`<svg ${l}><path d="M12 21s-6.5-5.6-6.5-11a6.5 6.5 0 0 1 13 0c0 5.4-6.5 11-6.5 11Z"/><circle cx="12" cy="10" r="2.3"/></svg>`,flag:`<svg ${l}><path d="M6 21V4"/><path d="M6 4.5h10.5L14 8l2.5 3.5H6"/></svg>`,calendar:`<svg ${l}><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 9.5h17M8 3v4M16 3v4"/></svg>`,logout:`<svg ${l}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/></svg>`,lock:`<svg ${l}><rect x="4.5" y="10.5" width="15" height="10" rx="2"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/></svg>`,close:`<svg ${l}><path d="m5 5 14 14M19 5 5 19"/></svg>`,chevronDown:`<svg ${l}><path d="m6 9 6 6 6-6"/></svg>`,refresh:`<svg ${l}><path d="M3.5 12a8.5 8.5 0 0 1 14.5-6M20.5 12a8.5 8.5 0 0 1-14.5 6"/><path d="M18 3v4h-4M6 21v-4h4"/></svg>`,map:`<svg ${l}><path d="M9 4 4 6v14l5-2 6 2 5-2V4l-5 2-6-2Z"/><path d="M9 4v14M15 6v14"/></svg>`,users:`<svg ${l}><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0 1 12 0"/><circle cx="17" cy="9" r="2.3"/><path d="M15.5 20a4.5 4.5 0 0 1 5.5-4.4"/></svg>`,plusCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="M12 8v8M8 12h8"/></svg>`,checkCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="m8.5 12.3 2.3 2.3 4.7-5"/></svg>`,user:`<svg ${l}><circle cx="12" cy="8" r="3.5"/><path d="M5 20a7 7 0 0 1 14 0"/></svg>`,article:`<svg ${l}><rect x="5" y="3.5" width="14" height="17" rx="1.5"/><path d="M8.5 8h7M8.5 12h7M8.5 16h4"/></svg>`,settings:`<svg ${l}><circle cx="12" cy="12" r="3.2"/><path d="M12 3v2.4M12 18.6V21M21 12h-2.4M5.4 12H3M18.4 5.6l-1.7 1.7M7.3 16.7l-1.7 1.7M18.4 18.4l-1.7-1.7M7.3 7.3 5.6 5.6"/></svg>`,message:`<svg ${l}><path d="M4 5.5h16a1 1 0 0 1 1 1V16a1 1 0 0 1-1 1H9l-4.5 3.5V17H4a1 1 0 0 1-1-1V6.5a1 1 0 0 1 1-1Z"/><path d="M7.5 9.5h9M7.5 13h6"/></svg>`,chat:`<svg ${l}><path d="M3.5 6.5A2.5 2.5 0 0 1 6 4h9a2.5 2.5 0 0 1 2.5 2.5v6A2.5 2.5 0 0 1 15 15H9l-4 3.5v-3.5H6a2.5 2.5 0 0 1-2.5-2.5v-6Z"/><circle cx="7.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="11.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="15" cy="9.5" r="0.9" fill="currentColor" stroke="none"/></svg>`,story:`<svg ${l}><rect x="7" y="3" width="10" height="17" rx="2.2"/><circle cx="12" cy="7.2" r="1.5" fill="currentColor" stroke="none"/></svg>`,briefcase:`<svg ${l}><rect x="3" y="7.5" width="18" height="12" rx="2"/><path d="M8.5 7.5V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1.5"/><path d="M3 12.5h18M10.5 12.5v2h3v-2"/></svg>`,download:`<svg ${l}><path d="M12 3.5v11M8 10.5l4 4 4-4"/><path d="M4.5 17v2a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-2"/></svg>`,truck:`<svg ${l}><rect x="2" y="7" width="11" height="7" rx="1"/><path d="M13 10h4l3 3v1h-2"/><path d="M7.8 17h6.9"/><circle cx="6" cy="17" r="1.8"/><circle cx="16.5" cy="17" r="1.8"/></svg>`,seo:`<svg ${l}><circle cx="10.5" cy="10.5" r="6.5"/><path d="m20 20-4.8-4.8"/><path d="M7.5 10.5h6M10.5 7.5v6"/></svg>`,ai:`<svg ${l}><path d="M11 3 12.7 8 17.5 9.7 12.7 11.4 11 16.4 9.3 11.4 4.5 9.7 9.3 8Z"/><path d="M18 15.5 18.8 17.7 21 18.5 18.8 19.3 18 21.5 17.2 19.3 15 18.5 17.2 17.7Z"/></svg>`,image:`<svg ${l}><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m5 17 5-5 3 3 3-4 3 6"/></svg>`,video:`<svg ${l}><rect x="3" y="6" width="12" height="12" rx="2"/><path d="m15 10 6-3v10l-6-3Z"/></svg>`,audio:`<svg ${l}><path d="M9 18V6l8-2v12"/><circle cx="7" cy="18" r="2.2"/><circle cx="17" cy="16" r="2.2"/></svg>`,arrowRight:`<svg ${l}><path d="M5 12h14M13 6l6 6-6 6"/></svg>`,arrowLeft:`<svg ${l}><path d="M19 12H5M11 18l-6-6 6-6"/></svg>`,maleAvatar:`<svg ${l}><circle cx="12" cy="8" r="4"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,femaleAvatar:`<svg ${l}><circle cx="12" cy="7.5" r="4"/><path d="M12 11.5v6M9 15h6"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,eye:`<svg ${l}><path d="M2 12s3.8-7 10-7 10 7 10 7-3.8 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>`,history:`<svg ${l}><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/><path d="M12 8v4l3 2"/></svg>`,link:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.6 4.9a3.7 3.7 0 0 1 5.2 5.2L16 12"/><path d="M13 17.5 11.4 19.1a3.7 3.7 0 0 1-5.2-5.2L8 12"/></svg>`,externalLink:`<svg ${l}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`,unlink:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.2 5.3a3.7 3.7 0 0 1 5.2 5.2L16.2 11.7"/><path d="M13 17.5 11.8 18.7a3.7 3.7 0 0 1-5.2-5.2L7.8 12.3"/><path d="m4 4 16 16"/></svg>`,quote:`<svg ${l}><path d="M7.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/><path d="M16.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/></svg>`,undo:`<svg ${l}><path d="M4 12a8 8 0 1 1 2.6 5.9"/><path d="M4 6.5V12h5.5"/></svg>`,redo:`<svg ${l}><path d="M20 12a8 8 0 1 0-2.6 5.9"/><path d="M20 6.5V12h-5.5"/></svg>`,minus:`<svg ${l}><path d="M4 12h16"/></svg>`,eraser:`<svg ${l}><path d="m17.5 8.5-9 9H4l-1-1L14 5.5a2 2 0 0 1 2.8 0l2 2a2 2 0 0 1-.3 2.9L9.5 19"/></svg>`,alignLeft:`<svg ${l}><path d="M4 6h16M4 12h10M4 18h13"/></svg>`,alignCenter:`<svg ${l}><path d="M4 6h16M7 12h10M5.5 18h13"/></svg>`,alignRight:`<svg ${l}><path d="M4 6h16M10 12h10M7 18h13"/></svg>`,listBullet:`<svg ${l}><circle cx="4.5" cy="6" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="18" r="1" fill="currentColor" stroke="none"/><path d="M9 6h11M9 12h11M9 18h11"/></svg>`,listNumber:`<svg ${l}><path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 5v3M3.3 5H4.7M3 11.5h1.6c.5 0 .9.4.9.9 0 .3-.2.5-.4.7L3 15h2.6M3.3 19h1.4c.5 0 .9-.4.9-.9s-.4-.9-.9-.9H3.3"/></svg>`,plugin:`<svg ${l}><path d="M12 3 4 7v10l8 4 8-4V7Z"/><path d="M4 7l8 4 8-4M12 11v10"/></svg>`,wallet:`<svg ${l}><path d="M3 7a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v1"/><path d="M3 7v10a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2H5"/><circle cx="16" cy="13" r="1.2" fill="currentColor" stroke="none"/></svg>`,finance:`<svg ${l}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2.5"/><path d="M6 12h.01M18 12h.01"/></svg>`,fileSpreadsheet:`<svg ${l}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h8M8 17h8M12 13v8"/></svg>`,printer:`<svg ${l}><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>`,sun:`<svg ${l}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>`,moon:`<svg ${l}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>`},d=`behbar_admin_token`,f=`behbar_admin_staff`,p=`behbar_admin_screen`;function m(e,t){localStorage.setItem(d,e),localStorage.setItem(f,JSON.stringify(t))}function h(){return localStorage.getItem(d)}function g(){let e=localStorage.getItem(f);if(!e)return null;try{let t=JSON.parse(e);return Array.isArray(t.permissions)?t:(_(),null)}catch{return null}}function _(){localStorage.removeItem(d),localStorage.removeItem(f),localStorage.removeItem(p)}function v(e){localStorage.setItem(p,JSON.stringify(e))}function y(){let e=localStorage.getItem(p);if(!e)return null;try{return JSON.parse(e)}catch{return null}}function b(){return h()!==null&&g()!==null}function x(e,t){return(e.permissions??[]).includes(t)}function S(e){return(e.permissions??[]).some(e=>e!==`assignments`)}var C=class extends Error{},w=null;function T(e){w=e}async function E(e,t={}){let n=h(),r=await fetch(`${e}`,{...t,headers:{...t.headers,...n?{Authorization:`Bearer ${n}`}:{}}});if(r.status===401)throw _(),w?.(),new C(`نشست شما منقضی شده است.`);return r}async function D(e,t){let n=await fetch(`/api/staff/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ورود ناموفق بود.`);return r?.needsTwoFactor?{needsTwoFactor:!0,challengeToken:r.challengeToken}:{needsTwoFactor:!1,token:r.token,staff:r.staff}}async function O(e,t){let n=await fetch(`/api/staff/login/verify-2fa`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({challengeToken:e,code:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`کد نامعتبر است.`);return r}async function ee(){let e=await E(`/api/staff/2fa/sms/setup`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال کد ناموفق بود.`)}async function k(e){let t=await E(`/api/staff/2fa/sms/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({code:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید کد ناموفق بود.`)}async function A(e){let t=await E(`/api/staff/2fa/disable`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`غیرفعال‌سازی ناموفق بود.`)}async function j(e,t){let n=await E(`/api/staff/change-password`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({newPassword:e,currentPassword:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`تغییر رمز عبور ناموفق بود.`)}async function te(){await E(`/api/staff/logout`,{method:`POST`}).catch(()=>{})}async function M(){let e=await E(`/api/staff/me`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات ناموفق بود.`);return{...t.staff,licenseLocked:!!t.licenseLocked,licenseSummary:t.licenseSummary}}async function N(e){let t=await E(`/api/admin/requests${e?`?status=${encodeURIComponent(e)}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌ها ناموفق بود.`);return n.requests??[]}async function P(e,t){let n=await E(`/api/admin/requests/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function F(e){let t=await E(`/api/admin/requests/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function I(){let e=await E(`/api/admin/requests/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت خروجی ناموفق بود.`)}let t=await e.blob(),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`behbar-requests-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)}async function R(){let e=await E(`/api/admin/activity-log`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گزارش فعالیت ناموفق بود.`);return t.entries??[]}async function z(e,t){let n=await E(`/api/admin/requests/${e}/assign`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({staffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اختصاص ناموفق بود.`)}async function B(){let e=await E(`/api/admin/stats`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار ناموفق بود.`);return t}async function ne(){let e=await E(`/api/admin/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کارمندان ناموفق بود.`);return t.staff??[]}async function re(e){let t=await E(`/api/admin/staff`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد کارمند ناموفق بود.`);return n.staff}async function ie(){let e=await E(`/api/admin/roles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نقش‌ها ناموفق بود.`);return{roles:t.roles??[],permissions:t.permissions??[]}}async function ae(e){let t=await E(`/api/admin/roles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نقش ناموفق بود.`);return n.role}async function oe(e,t){let n=await E(`/api/admin/roles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نقش ناموفق بود.`);return r.role}async function se(e){let t=await E(`/api/admin/roles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نقش ناموفق بود.`)}async function ce(e,t){let n=await E(`/api/admin/staff/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی کارمند ناموفق بود.`);return r.staff}async function le(e){let t=await E(`/api/admin/staff/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف کارمند ناموفق بود.`)}async function ue(){let e=await E(`/api/staff/requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌ها ناموفق بود.`);return t.requests??[]}async function de(e,t){let n=await E(`/api/staff/requests/${e}/status`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function fe(){let e=await E(`/api/admin/articles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت مقالات ناموفق بود.`);return t.articles??[]}async function pe(e){let t=await E(`/api/admin/articles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد مقاله ناموفق بود.`);return n.article}async function me(e,t){let n=await E(`/api/admin/articles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی مقاله ناموفق بود.`);return r.article}async function he(e,t){let n=await E(`/api/admin/articles/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.article}async function ge(e){let t=await E(`/api/admin/articles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف مقاله ناموفق بود.`)}async function _e(){let e=await E(`/api/admin/pages`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت برگه‌ها ناموفق بود.`);return t.pages??[]}async function ve(e){let t=await E(`/api/admin/pages/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت برگه ناموفق بود.`);return n.page}async function ye(e){let t=await E(`/api/admin/pages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد برگه ناموفق بود.`);return n.page}async function be(e,t){let n=await E(`/api/admin/pages/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی برگه ناموفق بود.`);return r.page}async function xe(e,t){let n=await E(`/api/admin/pages/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت برگه ناموفق بود.`);return r.page}async function Se(e){let t=await E(`/api/admin/pages/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف برگه ناموفق بود.`)}async function Ce(e){let t=h(),n=await fetch(`/api/admin/upload`,{method:`POST`,headers:{"Content-Type":e.type,...t?{Authorization:`Bearer ${t}`}:{}},body:e}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`آپلود تصویر ناموفق بود.`);return`${r.url}`}async function we(e){let t=await E(`/api/admin/media${e?`?folder=${e}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت فهرست فایل‌ها ناموفق بود.`);return n.files??[]}async function Te(e){let t=await E(`/api/admin/media/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف فایل ناموفق بود.`)}async function Ee(){let e=await fetch(`/api/settings`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت تنظیمات ناموفق بود.`);return t.settings??{}}async function V(e,t){let n=await E(`/api/admin/settings`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({key:e,value:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی تنظیمات ناموفق بود.`)}async function De(e,t,n){let r=await E(`/api/admin/ai/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,apiKey:t,model:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اتصال ناموفق بود.`);return i}async function Oe(e,t){let n=await E(`/api/admin/sms/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اتصال ناموفق بود.`);return r}async function ke(){let e=await E(`/api/admin/testimonials`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نظرات ناموفق بود.`);return t.testimonials??[]}async function Ae(e){let t=await E(`/api/admin/testimonials`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نظر ناموفق بود.`);return n.testimonial}async function je(e,t){let n=await E(`/api/admin/testimonials/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نظر ناموفق بود.`);return r.testimonial}async function Me(e){let t=await E(`/api/admin/testimonials/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نظر ناموفق بود.`)}async function Ne(){let e=await E(`/api/admin/license`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات لایسنس ناموفق بود.`);return t.license??null}async function Pe(e){let t=await E(`/api/admin/license/activate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({licenseKey:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`فعال‌سازی لایسنس ناموفق بود.`);return n.license}async function Fe(){let e=await E(`/api/admin/chat/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گفتگوها ناموفق بود.`);return t.conversations??[]}async function Ie(e){let t=await E(`/api/admin/chat/conversations/${e}/messages`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیام‌ها ناموفق بود.`);return n.messages??[]}async function Le(e,t){let n=await E(`/api/admin/chat/conversations/${e}/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({text:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارسال پیام ناموفق بود.`)}async function Re(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`)}async function ze(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({assignedStaffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`واگذاری گفتگو ناموفق بود.`)}async function Be(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({archived:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`بایگانی گفتگو ناموفق بود.`)}async function Ve(e){let t=await E(`/api/admin/chat/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function He(e){let t=await E(`/api/admin/requests?phone=${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های مرتبط ناموفق بود.`);return n.requests??[]}async function Ue(e){let t=await E(`/api/admin/requests?staffId=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.requests??[]}async function We(e){let t=await E(`/api/admin/requests/${e}/events`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.events??[]}async function Ge(){let e=await E(`/api/admin/chat/agents`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت پشتیبان‌ها ناموفق بود.`);return t.agents??[]}async function Ke(){let e=await E(`/api/admin/stories`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت استوری‌ها ناموفق بود.`);return t.stories??[]}async function qe(e){let t=await E(`/api/admin/stories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد استوری ناموفق بود.`);return n.story}async function H(e,t){let n=await E(`/api/admin/stories/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی استوری ناموفق بود.`);return r.story}async function Je(e){let t=await E(`/api/admin/stories/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف استوری ناموفق بود.`)}async function Ye(){let e=await E(`/api/admin/job-applications`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های همکاری ناموفق بود.`);return t.applications??[]}async function Xe(e,t){let n=await E(`/api/admin/job-applications/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.application}async function Ze(e){let t=await E(`/api/admin/job-applications/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function Qe(){let e=await E(`/api/admin/fleet-vehicles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت وسایل نقلیه ناموفق بود.`);return t.vehicles??[]}async function $e(e){let t=await E(`/api/admin/fleet-vehicles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد وسیله نقلیه ناموفق بود.`);return n.vehicle}async function et(e,t){let n=await E(`/api/admin/fleet-vehicles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وسیله نقلیه ناموفق بود.`);return r.vehicle}async function tt(e){let t=await E(`/api/admin/fleet-vehicles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف وسیله نقلیه ناموفق بود.`)}async function nt(){let e=await E(`/api/admin/plugins`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت افزونه‌ها ناموفق بود.`);return t.plugins??{}}async function rt(e){let t=await E(`/api/admin/requests/${e}/reports`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت گزارش‌ها ناموفق بود.`);return n.reports??[]}async function it(e,t){let n=await E(`/api/admin/requests/${e}/reports`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({message:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت گزارش ناموفق بود.`);return r}async function at(){let e=await E(`/api/admin/analytics`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار بازدید ناموفق بود.`);return t}async function ot(){let e=await E(`/api/admin/backup/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت فایل پشتیبان ناموفق بود.`)}let t=(e.headers.get(`Content-Disposition`)??``).match(/filename="([^"]+)"/)?.[1]??`behbar-backup.sql`,n=await e.blob(),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function st(e){let t=await E(`/api/admin/backup/import`,{method:`POST`,headers:{"Content-Type":`application/sql`},body:e}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`بازیابی پشتیبان ناموفق بود.`)}async function ct(){let e=await E(`/api/admin/backup/drive-test`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال آزمایشی به گوگل درایو ناموفق بود.`)}async function lt(){let e=await E(`/api/admin/backup/drive-oauth/prepare`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`آماده‌سازی اتصال به گوگل ناموفق بود.`);return t.authUrl}async function ut(){let e=await E(`/api/admin/backup/drive-disconnect`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`قطع اتصال ناموفق بود.`)}async function dt(e,t){let n=await E(`/api/admin/ai/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,conversationId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارتباط با دستیار هوش مصنوعی ناموفق بود.`);return r}async function ft(e,t,n){let r=await E(`/api/admin/ai/execute`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,toolCallId:t.toolCallId,tool:t.tool,args:t.args,conversationId:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اجرای اقدام ناموفق بود.`);return i}async function pt(){let e=await E(`/api/admin/ai/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`فهرست گفتگوها دریافت نشد.`);return t.conversations??[]}async function mt(e){let t=await E(`/api/admin/ai/conversations/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`گفتگو دریافت نشد.`);return n}async function ht(){let e=await E(`/api/admin/ai/conversations`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ساخت گفتگوی جدید ناموفق بود.`);return t.id}async function gt(e){let t=await E(`/api/admin/ai/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function _t(){let e=await E(`/api/admin/version`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات نسخه ناموفق بود.`);return t}async function vt(){let e=await E(`/api/admin/selfhost/update`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`به‌روزرسانی ناموفق بود.`)}async function U(){let e=await E(`/api/staff/wallet`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول ناموفق بود.`);return t}async function W(e,t){let n=await E(`/api/staff/wallet/transactions?limit=${e}&offset=${t}`),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:r.transactions??[],total:r.total??0}}async function yt(){let e=await E(`/api/staff/wallet/payout-requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return t.payoutRequests??[]}async function bt(e,t){let n=await E(`/api/staff/wallet/payout-requests`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({amount:e,note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت درخواست تسویه ناموفق بود.`)}async function xt(){let e=await E(`/api/admin/wallet/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول‌ها ناموفق بود.`);return t.wallets??[]}async function St(e,t,n){let r=await E(`/api/admin/wallet/staff/${e}/transactions?limit=${t}&offset=${n}`),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:i.transactions??[],total:i.total??0}}async function G(e,t,n,r){let i=await E(`/api/admin/wallet/staff/${e}/adjustments`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({direction:t,amount:n,description:r})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(typeof a?.error==`string`?a.error:`ثبت اصلاحیه ناموفق بود.`)}async function K(e,t){let n=await E(`/api/admin/wallet/staff/${e}/rate-override`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ ناموفق بود.`)}async function Ct(e,t){let n=await E(`/api/admin/roles/${e}/pay-rate`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ نقش ناموفق بود.`)}async function wt(e=`pending`){let t=await E(`/api/admin/wallet/payout-requests?status=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return n.payoutRequests??[]}async function Tt(e){let t=await E(`/api/admin/wallet/payout-requests/${e}/approve`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید درخواست ناموفق بود.`)}async function Et(e,t){let n=await E(`/api/admin/wallet/payout-requests/${e}/reject`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`رد درخواست ناموفق بود.`)}async function Dt(e){let t=await E(`/api/admin/wallet/payroll/preview?month=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیش‌نمایش حقوق ناموفق بود.`);return n.entries??[]}async function Ot(e,t){let n=await E(`/api/admin/wallet/payroll/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({month:e,entries:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`پردازش حقوق ناموفق بود.`);return r}function q(e,t=6){return`
  ...
  `}function ir(){let e=document.getElementById(`vehicle-add-toggle`),t=document.getElementById(`vehicle-form-card`),n=document.getElementById(`vehicle-form-title`),r=document.getElementById(`vehicle-form-cancel`),i=document.getElementById(`vehicle-form-error`),a=document.getElementById(`vehicle-form-submit`),o=document.getElementById(`vehicle-form-id`),s=document.getElementById(`vehicle-label`),c=document.getElementById(`vehicle-type`),l=document.getElementById(`vehicle-plate`),u=document.getElementById(`vehicle-model`),d=document.getElementById(`vehicle-year`),f=document.getElementById(`vehicle-status`),p=document.getElementById(`vehicle-driver`),m=document.getElementById(`vehicle-notes`),h=document.getElementById(`vehicles-error`),g=document.getElementById(`vehicles-table-body`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!u||!d||!f||!p||!m||!h||!g)return;let _=[],v=[],y=Object.fromEntries(Xn.map(e=>[e.id,e.label])),b=[],x={},S=[],C={city:``,cityEn:``,province:``,provinceEn:``},w=`all`,T=!0,E=!0,D=!1;Gn().then(()=>qn(document.getElementById(`view-container`)??document.body)),document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-fleet-panel]`).forEach(t=>{t.hidden=t.dataset.fleetPanel!==e.dataset.fleetTab})})});function O(){let e=document.getElementById(`vehicle-types-list`);e&&(e.innerHTML=b.map((e,t)=>`
    ...
    `).join(``),qn(e))}function ee(){b=Array.from(document.querySelectorAll(`[data-vehicle-type-index]`)).map((e,t)=>({id:b[t]?.id??`vehicle-${crypto.randomUUID().slice(0,8)}`,label:e.querySelector(`[data-field="label"]`).value,labelEn:e.querySelector(`[data-field="labelEn"]`).value,icon:e.querySelector(`[data-field="icon"]`).value,basePrice:Number(e.querySelector(`[data-field="basePrice"]`).value)||0,perKmRate:Number(e.querySelector(`[data-field="perKmRate"]`).value)||0,floorCostExempt:b[t]?.floorCostExempt??!1,active:e.querySelector(`[data-field="active"]`).checked,sortOrder:t+1}))}document.getElementById(`vehicle-types-list`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-remove-vehicle-type]`);t&&(ee(),b.splice(Number(t.dataset.removeVehicleType),1),O())}),document.getElementById(`vehicle-type-add-btn`)?.addEventListener(`click`,()=>{ee(),b.push({id:`vehicle-${crypto.randomUUID().slice(0,8)}`,label:``,labelEn:``,icon:`van`,basePrice:0,perKmRate:0,floorCostExempt:!1,active:!0,sortOrder:b.length+1}),O()}),document.getElementById(`vehicle-type-save-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget,n=document.getElementById(`vehicle-types-saved-note`),r=document.getElementById(`vehicle-types-error`);r&&(r.hidden=!0);try{await Jn(t,async()=>{ee(),await V(`vehicle_types`,b)}),n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`)}});function k(){let e=document.getElementById(`cities-list`);e.innerHTML=S.map((e,t)=>`
  ...
  `}function fr(){let e=document.getElementById(`my-wallet-summary-card`),t=document.getElementById(`my-wallet-tx-list`),n=document.getElementById(`my-wallet-load-more`),r=document.getElementById(`my-payout-requests-list`),i=0,a=0,o=[];async function s(){if(e)try{let t=await U(),n=t.bonus.type===`percent`?`${t.bonus.amount}٪ برآورد هر درخواست`:Y(t.bonus.amount);e.innerHTML=`
      ...
      `}catch(t){e.innerHTML=`<p class="error-text">${t instanceof Error?t.message:`خطایی پیش آمد.`}</p>`}}async function c(){if(t)try{let{transactions:e,total:r}=await W(ar,i);o=[...o,...e],a=r,i+=e.length,t.innerHTML=o.length?o.map(ur).join(``):`<p class="settings-panel-hint">هنوز تراکنشی ثبت نشده.</p>`,n&&(n.hidden=i>=a)}catch(e){t.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}async function l(){if(r)try{let e=await yt();r.innerHTML=e.length?e.map(dr).join(``):`<p class="settings-panel-hint">هنوز درخواستی ثبت نکرده‌اید.</p>`}catch(e){r.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}n?.addEventListener(`click`,()=>void c()),document.getElementById(`payout-request-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`payout-request-amount`),n=document.getElementById(`payout-request-note`),r=document.getElementById(`payout-request-error`),i=document.getElementById(`payout-request-success`),a=document.getElementById(`payout-request-submit`);r.hidden=!0,i.hidden=!0;let o=Number(t.value);if(!Number.isFinite(o)||o<=0){r.hidden=!1,r.textContent=`مبلغ نامعتبر است.`;return}a.disabled=!0,(async()=>{try{await bt(o,n.value.trim()||void 0),i.hidden=!1,t.value=``,n.value=``,await Promise.all([s(),l()])}catch(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}finally{a.disabled=!1}})()}),s(),c(),l()}var pr={pending:{next:`in_progress`,label:`شروع کار`},contacted:{next:`in_progress`,label:`شروع کار`},scheduled:{next:`in_progress`,label:`شروع کار`},in_progress:{next:`completed`,label:`پایان کار`}};function mr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function hr(e){let t=pr[e.status],n=e.originLat!=null&&e.originLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.originLat},${e.originLng}`:null,r=e.destinationLat!=null&&e.destinationLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.destinationLat},${e.destinationLng}`:null;return`
...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function te(e){ee=e,e?(x.src=e,x.hidden=!1,S.hidden=!0,T&&(T.hidden=!1)):(x.hidden=!0,S.hidden=!1,T&&(T.hidden=!0))}function M(e,t){if(!e){i.hidden=!0,v.hidden=!0,y&&(y.hidden=!0);return}if(i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,v.hidden=e!==`published`,y&&b){let e=t||u.value.trim();if(e){y.hidden=!1;let t=`https://behbarapp.ir/p/${encodeURIComponent(e)}`;b.href=t,b.textContent=`/p/${e}`}else y.hidden=!0}}async function N(){if(e===null){r.textContent=`برگه جدید`,O=[Vr(`richtext`)],A(),M(null),E&&(E.checked=!1),D&&(D.checked=!1);return}try{let t=await ve(e);if(!t){n.hidden=!1,n.textContent=`برگه پیدا نشد.`;return}k=t,r.textContent=t.title||`ویرایش برگه`,o.value=t.title,s.value=t.titleEn||``,c.value=t.excerpt||``,l.value=t.excerptEn||``,u.value=t.slug,d.value=t.metaTitle??``,f.value=t.metaDescription??``,E&&(E.checked=!!t.showInHeader),D&&(D.checked=!!t.showInFooter),te(t.coverImageUrl),O=t.content&&t.content.length?t.content:[Vr(`richtext`)],A(),M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی در بارگذاری برگه پیش آمد.`}}function P(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),coverImageUrl:ee,content:j(),metaTitle:d.value.trim()||void 0,metaDescription:f.value.trim()||void 0,slug:u.value.trim()||void 0,showInHeader:E?.checked??!1,showInFooter:D?.checked??!1}}async function F(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان برگه الزامی است.`,null;let t=P();try{let n=k?await be(k.id,t):await ye(t);return k=n,e=n.id,u.value=n.slug,r.textContent=n.title,M(n.status,n.slug),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره برگه ناموفق بود.`,null}}p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;O=j();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?O.splice(n,1):r===`up`&&n>0?[O[n-1],O[n]]=[O[n],O[n-1]]:r===`down`&&n<O.length-1&&([O[n+1],O[n]]=[O[n],O[n+1]]),A()}),p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),p.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await Ce(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر ناموفق بود.`}}),h.addEventListener(`click`,()=>{O=j(),O.push(Vr(m.value)),A()}),w.addEventListener(`click`,()=>C.click()),T&&T.addEventListener(`click`,()=>te(null)),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{te(await Ce(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر شاخص ناموفق بود.`}}),g.addEventListener(`click`,async()=>{g.disabled=!0,g.textContent=`در حال ذخیره...`,await F(),g.disabled=!1,g.textContent=`ذخیره پیش‌نویس`}),_.addEventListener(`click`,async()=>{_.disabled=!0;let e=await F();if(e)try{let t=await xe(e.id,!0);M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار برگه ناموفق بود.`}_.disabled=!1}),v.addEventListener(`click`,async()=>{if(k){v.disabled=!0;try{let e=await xe(k.id,!1);M(e.status,e.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`تغییر به پیش‌نویس ناموفق بود.`}v.disabled=!1}}),a.addEventListener(`click`,t),N()}function qr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Jr(e){return Array.from({length:5},(t,n)=>n<e?`★`:`☆`).join(``)}function Yr(e){return`
  ...
  `}function oi(){let e=document.getElementById(`chat-error`),t=document.getElementById(`chat-filter-tabs`),n=document.getElementById(`chat-conversation-list`),r=document.getElementById(`chat-thread-empty`),i=document.getElementById(`chat-thread-active`),a=document.getElementById(`chat-thread-name`),o=document.getElementById(`chat-thread-phone`),s=document.getElementById(`chat-assign-select`),c=document.getElementById(`chat-thread-status-btn`),l=document.getElementById(`chat-thread-archive-btn`),d=document.getElementById(`chat-thread-delete-btn`),f=document.getElementById(`chat-responders-row`),p=document.getElementById(`chat-info-panel`),m=document.getElementById(`chat-request-card`),h=document.getElementById(`chat-thread-messages`),_=document.getElementById(`chat-thread-form`),v=document.getElementById(`chat-thread-input`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!d||!f||!p||!m||!h||!_||!v)return;let y=g(),b=[],x=[],S=null,C=`all`;function w(){if(C===`archived`)return b.filter(e=>e.archivedAt!==null);let e=b.filter(e=>e.archivedAt===null);return C===`mine`?e.filter(e=>e.assignedStaffId===y?.id):C===`unassigned`?e.filter(e=>e.assignedStaffId===null):e}function T(){let t=w();n.innerHTML=t.length?t.map(e=>`
    ...
    `).join(``),h.scrollTop=h.scrollHeight,k(e)}function k(e){let t=[],n=new Set;for(let r of e)r.sender!==`staff`||!r.staffName||n.has(r.staffName)||(n.add(r.staffName),t.push({name:r.staffName,avatar:r.staffAvatar}));if(!t.length){f.hidden=!0,f.innerHTML=``;return}f.hidden=!1,f.innerHTML=`<span class="chat-responders-label">پاسخ‌دهندگان:</span>`+t.map(e=>`<span class="chat-responder-chip">${ii(e.name,e.avatar,`sm`)}<span>${ti(e.name)}</span></span>`).join(``)}async function A(){if(S!==null)try{ee(await Ie(S))}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function j(e){if(!e.length){m.innerHTML=`<h3>درخواست‌های ثبت‌شده</h3><p class="chat-request-empty">درخواستی برای این شماره ثبت نشده است.</p>`;return}let[t,...n]=e;m.innerHTML=`
      ...
      <div class="chat-request-latest">
        ...
        <div class="chat-request-row"><span>زمان</span><span>${ti(t.scheduledDate)} — ${J(t.scheduledTime)}</span></div>
        <div class="chat-request-row"><span>وضعیت</span><span>${ti(Bt[t.status]??t.status)}</span></div>
  ...
  `}function ki(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Ai(){let e=document.getElementById(`update-panel-current`),t=document.getElementById(`update-panel-current-changelog`),n=document.getElementById(`update-panel-result`),r=document.getElementById(`update-scan-btn`),i=document.getElementById(`update-panel-manual-guide`);!e||!t||!n||!r||!i||(_t().then(n=>{e.textContent=`نسخه‌ی فعلی: ${n.current}`,n.currentChangelog.length&&(t.innerHTML=`
          ...
          ${Di()}
        `,t.hidden=!1),i.innerHTML=Oi(),i.hidden=!1}).catch(()=>{e.textContent=``}),r.addEventListener(`click`,async()=>{r.disabled=!0;let t=r.textContent;r.textContent=`در حال بررسی...`,n.innerHTML=``;try{let t=await _t();if(e.textContent=`نسخه‌ی فعلی: ${t.current}`,!t.updateAvailable){Bn(`نسخه‌ی شما به‌روز است.`);return}let r=t.changelog.length?`<ul class="update-modal-changelog">${t.changelog.map(e=>`<li>${ki(e)}</li>`).join(``)}</ul>`:``;if(t.runtime!==`selfhost`){n.innerHTML=`
...
`).map(e=>e.trim()).filter(Boolean),n=t.filter(e=>!e.startsWith(`- `)),r=t.filter(e=>e.startsWith(`- `)).map(e=>e.slice(2).trim());return{paragraphs:n,list:r.length?r:void 0}}function Li(e){let t=`https://behbarapp.ir/p/${encodeURIComponent(e.slug)}`;return`
  ...
  `}function qi(e,t){let n=document.getElementById(`settings-error`),r=document.getElementById(`settings-saved-note`);if(!n||!r)return;if(zi(t=>e?.(`page-editor`,t)),t){let e=document.querySelector(`[data-settings-tab="${t}"]`);e&&(document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(e=>{e.hidden=e.dataset.settingsPanel!==t}))}let i=g();Gn().then(()=>qn(document.body));function a(){r.hidden=!1,window.setTimeout(()=>r.hidden=!0,2500)}function o(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}document.querySelectorAll(`[data-settings-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(t=>{t.hidden=t.dataset.settingsPanel!==e.dataset.settingsTab})})}),document.querySelectorAll(`[data-backup-subtab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-backup-subtab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-backup-subpanel]`).forEach(t=>{t.hidden=t.dataset.backupSubpanel!==e.dataset.backupSubtab})})});let s={},c={};function l(e){let t=document.getElementById(`settings-${e}-preview`),n=document.getElementById(`settings-${e}-url`)?.value.trim();t&&(t.innerHTML=n?`<img src="${n}" alt="" />`:``)}function u(e){let t=document.getElementById(`settings-${e}-url`),n=document.getElementById(`settings-${e}-upload-btn`),r=document.getElementById(`settings-${e}-file-input`),i=document.getElementById(`settings-branding-upload-error`);!t||!n||!r||(t.addEventListener(`input`,()=>l(e)),n.addEventListener(`click`,()=>r.click()),r.addEventListener(`change`,async()=>{let a=r.files?.[0];if(!a)return;i&&(i.hidden=!0),n.disabled=!0;let o=n.textContent;n.textContent=`در حال آپلود...`;try{let n=await Ce(a);t.value=n,l(e)}catch(e){i&&(i.hidden=!1,i.textContent=e instanceof Error?e.message:`آپلود عکس ناموفق بود.`)}finally{r.value=``,n.disabled=!1,n.textContent=o}}))}u(`logo`),u(`favicon`);function d(){let e=s.site_name??{fa:``,en:``},t=e.fa?.trim()||``,n=e.en?.trim()||``,r=document.getElementById(`settings-site-name-fa`),i=document.getElementById(`settings-site-name-en`);r.value=t,i.value=n,document.getElementById(`settings-language-mode`).value=s.language_mode??`both`;let a=s.branding??{};document.getElementById(`settings-logo-url`).value=a.logoUrl??``,document.getElementById(`settings-favicon-url`).value=a.faviconUrl??``,l(`logo`),l(`favicon`);let o=s.footer??{seoParagraphs:[],copyright:{fa:``,en:``}},c=document.getElementById(`settings-footer-paragraphs`);c.innerHTML=o.seoParagraphs.map((e,t)=>`
        ...
        </div>`).join(``),qn(c);let u=t?`همه حقوق برای ${t} محفوظ است.`:`همه حقوق محفوظ است.`,d=n?`All rights reserved for ${n}.`:`All rights reserved.`,f=document.getElementById(`settings-copyright-fa`),p=document.getElementById(`settings-copyright-en`);f.placeholder=u,p.placeholder=d;let m=o.copyright?.fa?.trim()??``,h=o.copyright?.en?.trim()??``;t&&t!==`بهبار`&&m&&m.includes(`بهبار`)&&(m=m.replace(/بهبار/g,t)),m||=u,n&&n!==`Behbar`&&h&&h.includes(`Behbar`)&&(h=h.replace(/Behbar/g,n)),h||=d,f.value=m,p.value=h,r.oninput=()=>{let e=r.value.trim(),t=e?`همه حقوق برای ${e} محفوظ است.`:`همه حقوق محفوظ است.`;f.placeholder=t;let n=f.value.trim();(!n||n.startsWith(`همه حقوق برای `)||n===`همه حقوق محفوظ است.`)&&(f.value=t)},i.oninput=()=>{let e=i.value.trim(),t=e?`All rights reserved for ${e}.`:`All rights reserved.`;p.placeholder=t;let n=p.value.trim();(!n||n.startsWith(`All rights reserved for `)||n===`All rights reserved.`)&&(p.value=t)};let g=s.hero_slogan??{};document.getElementById(`settings-hero-slogan-enabled`).checked=g.enabled!==!1,document.getElementById(`settings-hero-slogan-headline-fa`).value=g.headline?.fa??``,document.getElementById(`settings-hero-slogan-headline-en`).value=g.headline?.en??``,document.getElementById(`settings-hero-slogan-subtitle-fa`).value=g.subtitle?.fa??``,document.getElementById(`settings-hero-slogan-subtitle-en`).value=g.subtitle?.en??``}document.querySelectorAll(`[data-save-setting="site_name"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await Jn(e,async()=>{let e=document.getElementById(`settings-site-name-fa`).value,t=document.getElementById(`settings-site-name-en`).value;await V(`site_name`,{fa:e,en:t}),s.site_name={fa:e,en:t}}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="language_mode"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await Jn(e,async()=>{let e=document.getElementById(`settings-language-mode`).value;await V(`language_mode`,e),s.language_mode=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="branding"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await Jn(e,async()=>{let e={logoUrl:document.getElementById(`settings-logo-url`).value.trim(),faviconUrl:document.getElementById(`settings-favicon-url`).value.trim()};await V(`branding`,e),s.branding=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="footer"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await Jn(e,async()=>{let e={seoParagraphs:Array.from(document.querySelectorAll(`[data-footer-paragraph]`)).map(e=>({fa:e.querySelector(`[data-field="fa"]`).value,en:e.querySelector(`[data-field="en"]`).value})),copyright:{fa:document.getElementById(`settings-copyright-fa`).value,en:document.getElementById(`settings-copyright-en`).value}};await V(`footer`,e),s.footer=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="hero_slogan"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await Jn(e,async()=>{let e={enabled:document.getElementById(`settings-hero-slogan-enabled`).checked,headline:{fa:document.getElementById(`settings-hero-slogan-headline-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-headline-en`).value.trim()},subtitle:{fa:document.getElementById(`settings-hero-slogan-subtitle-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-subtitle-en`).value.trim()}};await V(`hero_slogan`,e),s.hero_slogan=e}),a()}catch(e){o(e)}})});let f=[],p={enabled:!1,links:[]},m={enabled:!1,badges:[]};function h(){let e=document.getElementById(`social-links-list`);e&&(e.innerHTML=f.map((e,t)=>`
  ...
  `}function ba(e){return`
    <div class="editor-sidebar-card">
      <div class="plugin-card-head">
        <h3>${ha(e.staffName)} — ${Y(e.amount)}</h3>
      </div>
  ...
  `}function Aa(){let e=document.querySelectorAll(`[data-finance-tab]`),t=document.getElementById(`finance-tab-overview`),n=document.getElementById(`finance-tab-documents`);e.forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.financeTab;e.forEach(e=>e.classList.remove(`active`)),r.classList.add(`active`),i===`overview`?(t&&(t.style.display=`block`),n&&(n.style.display=`none`)):i===`documents`&&(t&&(t.style.display=`none`),n&&(n.style.display=`block`))})});let r=[],i=wa();async function a(){try{let[e]=await Promise.allSettled([N(),B()]);e.status===`fulfilled`&&(r=e.value),i=wa(),s(),c()}catch(e){Bn(e instanceof Error?e.message:`خطا در بارگذاری داده‌های مالی`,`error`)}}function o(){let e=[];for(let t of r){let n=`pending`;n=t.status===`completed`?`settled`:t.status===`canceled`?`canceled`:`pending`,e.push({id:t.id,isCustom:!1,trackingCode:t.trackingCode||`BB-${t.id}`,customerName:t.customerName||`مشتری سامانه`,phone:t.phone||`—`,serviceLabel:t.serviceLabel||`حمل بار`,originCity:t.originCity||`—`,destinationCity:t.destinationCity||`—`,amount:t.estimateAvg||t.estimateMin||0,settlementStatus:n,createdAt:t.createdAt||new Date().toISOString(),notes:t.originNotes||``})}for(let t of i)e.push({id:t.id,isCustom:!0,trackingCode:t.trackingCode,customerName:t.customerName,phone:t.phone,serviceLabel:t.serviceLabel,originCity:t.originCity,destinationCity:t.destinationCity,amount:t.amount,settlementStatus:t.settlementStatus,createdAt:t.createdAt,notes:t.notes});return e.sort((e,t)=>new Date(t.createdAt).getTime()-new Date(e.createdAt).getTime()),e}function s(){let e=o(),t=0,n=0,r=0,i=0,a={},s={settled:0,pending:0,credit:0,canceled:0};for(let o of e){let e=Number(o.amount)||0;t+=e,o.settlementStatus===`settled`?(n+=e,s.settled++):o.settlementStatus===`pending`?(r+=e,s.pending++):o.settlementStatus===`credit`?(i+=e,s.credit++):o.settlementStatus===`canceled`&&s.canceled++;let c=o.serviceLabel||`سایر`;a[c]||(a[c]={count:0,total:0}),a[c].count++,a[c].total+=e}let c=Math.max(0,n-i),l=document.getElementById(`kpi-gross-turnover`);l&&(l.textContent=Da(t));let u=document.getElementById(`kpi-realized-revenue`);u&&(u.textContent=Da(n));let d=document.getElementById(`kpi-pending-settlements`);d&&(d.textContent=Da(r));let f=document.getElementById(`kpi-total-expenses`);f&&(f.textContent=Da(i));let p=document.getElementById(`kpi-estimated-profit`);p&&(p.textContent=Da(c));let m=document.getElementById(`kpi-docs-count`);m&&(m.textContent=Ea(e.length));let h=document.getElementById(`finance-services-breakdown`);if(h){let e=Object.entries(a).sort((e,t)=>t[1].total-e[1].total);h.innerHTML=e.length?e.map(([e,n])=>{let r=t>0?Math.round(n.total/t*100):0;return`
      ...
      `;return}e.innerHTML=a.map(e=>{let t=Oa[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`},n=e.originCity&&e.destinationCity?`${e.originCity} ➔ ${e.destinationCity}`:`—`,r=e.createdAt?e.createdAt.slice(0,10):`—`;return`
        ...
        `}).join(``),e.querySelectorAll(`.btn-view-invoice`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.docCode,n=a.find(e=>e.trackingCode===t);n&&l(n)})}),e.querySelectorAll(`.btn-toggle-settlement`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.docId;if(e.dataset.isCustom===`true`){let e=i.find(e=>String(e.id)===t);e&&(e.settlementStatus=e.settlementStatus===`settled`?`pending`:`settled`,Ta(i),Bn(`وضعیت تسویه سند دستی به‌روزرسانی شد.`,`success`),s(),c())}else{let e=r.find(e=>String(e.id)===t);if(e){let t=e.status===`completed`?`in_progress`:`completed`;try{await P(e.id,t),e.status=t,Bn(`وضعیت تسویه سفارش به‌روزرسانی شد.`,`success`),s(),c()}catch{Bn(`خطا در به‌روزرسانی وضعیت تسویه`,`error`)}}}})})}function l(e){let t=document.getElementById(`finance-modal-container`);if(!t)return;let n=e.createdAt?e.createdAt.slice(0,10):new Date().toISOString().slice(0,10),r=Oa[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`};t.innerHTML=`
    ...
    `,document.getElementById(`finance-add-modal-close`)?.addEventListener(`click`,t),document.getElementById(`btn-cancel-add-doc`)?.addEventListener(`click`,t),document.getElementById(`finance-add-modal-backdrop`)?.addEventListener(`click`,e=>{e.target===e.currentTarget&&t()}),document.getElementById(`finance-add-doc-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let n=document.getElementById(`doc-customer-input`).value.trim(),r=document.getElementById(`doc-phone-input`).value.trim()||`—`,a=document.getElementById(`doc-service-input`).value.trim(),o=document.getElementById(`doc-origin-input`).value.trim()||`تهران`,l=document.getElementById(`doc-dest-input`).value.trim()||`تهران`,u=Number(document.getElementById(`doc-amount-input`).value)||0,d=document.getElementById(`doc-status-select`).value,f=Math.floor(1e4+Math.random()*9e4),p={id:`custom_${Date.now()}`,trackingCode:`BB-FIN-${f}`,customerName:n,phone:r,serviceLabel:a,originCity:o,destinationCity:l,amount:u,settlementStatus:d,createdAt:new Date().toISOString()};i.push(p),Ta(i),Bn(`سند مالی جدید با موفقیت ثبت شد.`,`success`),t(),s(),c()});function t(){e&&(e.innerHTML=``)}}function f(){let e=o();if(!e.length){Bn(`سند مالی برای صدور فایل اکسل موجود نیست.`,`error`);return}let t=[`شماره سند مالی`,`تاریخ صدور`,`طرف حساب`,`شماره تماس`,`عنوان خدمت`,`شهر مبدا`,`شهر مقصد`,`مبلغ کل (تومان)`,`وضعیت تسویه`,`توضیحات`];function n(e){let t=e==null?``:String(e);return/[",\n]/.test(t)?`"${t.replace(/"/g,`""`)}"`:t}let r=[t.map(n).join(`,`)];for(let t of e){let e=Oa[t.settlementStatus]?.label||t.settlementStatus,i=t.createdAt?t.createdAt.slice(0,10):``;r.push([t.trackingCode,i,t.customerName,t.phone,t.serviceLabel,t.originCity,t.destinationCity,t.amount,e,t.notes||``].map(n).join(`,`))}let i=`﻿`+r.join(`\r
`),a=new Blob([i],{type:`text/csv;charset=utf-8;`}),s=URL.createObjectURL(a),c=document.createElement(`a`);c.href=s,c.download=`behbar-financial-report-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(c),c.click(),document.body.removeChild(c),URL.revokeObjectURL(s),Bn(`فایل اکسل گزارش مالی بهبار با موفقیت ایجاد و دانلود شد.`,`success`)}document.getElementById(`finance-export-excel-btn`)?.addEventListener(`click`,f),document.getElementById(`finance-add-doc-btn`)?.addEventListener(`click`,d),document.getElementById(`finance-refresh-btn`)?.addEventListener(`click`,()=>{a(),Bn(`اطلاعات مالی به‌روز شد.`,`success`)}),document.getElementById(`finance-search-input`)?.addEventListener(`input`,()=>c()),document.getElementById(`finance-status-filter`)?.addEventListener(`change`,()=>c()),a()}function Q(e,t,n){return`
    <button type="button" class="home-tile" data-home-tile="${e}">
      <span class="home-tile-icon">${t}</span>
      <span class="home-tile-label">${n}</span>
    </button>
  `}function ja(e){let t=x(e,`content`)||x(e,`stories`)||x(e,`seo`)||x(e,`settings`),n=x(e,`staff`)||x(e,`recruitment`)||x(e,`roles`)||x(e,`wallet`),r=x(e,`settings`)||x(e,`homepage`),i=x(e,`pipeline`)||x(e,`map`),a=x(e,`dashboard`)||x(e,`wallet`)||x(e,`roles`)||x(e,`staff`),o=[];return o.push(Q(`dashboard`,u.chart,`داشبورد`)),i&&o.push(Q(`requests`,u.columns,`درخواست‌ها`)),a&&o.push(Q(`finance`,u.finance,`مدیریت مالی`)),x(e,`staff`)&&o.push(Q(`fleet`,u.truck,`مدیریت ناوگان حمل‌ونقل`)),r&&o.push(Q(`settings`,u.settings,`تنظیمات سایت`)),x(e,`chat`)&&o.push(Q(`chat`,u.chat,`چت پشتیبانی`)),t&&o.push(Q(`content`,u.grid,`مدیریت محتوا`)),n&&o.push(Q(`personnel`,u.users,`مدیریت پرسنل`)),x(e,`plugins`)&&o.push(Q(`plugins`,u.plugin,`افزونه‌ها`)),`<div class="home-grid">${o.join(``)}</div>`}function Ma(e){let t=[];return x(e,`pipeline`)&&t.push(Q(`pipeline`,u.columns,`مراحل درخواست‌ها`)),x(e,`map`)&&t.push(Q(`map`,u.map,`نقشه درخواست‌ها`)),`<div class="home-grid">${t.join(``)}</div>`}function Na(e){let t=[];return x(e,`content`)&&t.push(Q(`magazine`,u.article,`مجله`)),x(e,`content`)&&t.push(Q(`testimonials`,u.message,`نظرات مشتریان`)),x(e,`stories`)&&t.push(Q(`stories`,u.story,`استوری‌ها`)),x(e,`seo`)&&t.push(Q(`seo`,u.seo,`مدیریت سئو`)),(x(e,`content`)||x(e,`settings`))&&t.push(Q(`media`,u.image,`مدیریت فایل`)),`<div class="home-grid">${t.join(``)}</div>`}function Pa(e){let t=[];return x(e,`staff`)&&t.push(Q(`staff`,u.users,`کارمندان`)),x(e,`recruitment`)&&t.push(Q(`jobApplications`,u.briefcase,`فرصت‌های شغلی`)),x(e,`roles`)&&t.push(Q(`roles`,u.lock,`نقش‌ها و اختیارات`)),(x(e,`staff`)||x(e,`roles`))&&t.push(Q(`activityLog`,u.history,`گزارش فعالیت`)),x(e,`wallet`)&&t.push(Q(`payroll`,u.wallet,`حقوق و دستمزد`)),`<div class="home-grid">${t.join(``)}</div>`}function Fa(e,t){e.querySelectorAll(`[data-home-tile]`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.homeTile??``))})}async function Ia(){try{let e=(await Ee()).site_name?.fa?.trim();if(!e||e===`بهبار`)return;document.querySelectorAll(`#login-brand-text, .admin-logo-title, #staff-portal-brand-text`).forEach(t=>{t.textContent?.includes(`بهبار`)&&(t.textContent=t.textContent.replace(/بهبار/g,e))})}catch{}}function La(e){return e===`home`?null:e===`requests`||e===`content`||e===`personnel`||e===`dashboard`||e===`settings`||e===`plugins`||e===`chat`||e===`fleet`||e===`finance`?`home`:e===`pipeline`||e===`map`?`requests`:e===`magazine`||e===`testimonials`||e===`stories`||e===`seo`||e===`media`?`content`:e===`staff`||e===`jobApplications`||e===`roles`||e===`activityLog`||e===`payroll`?`personnel`:e===`staffHistory`?`staff`:e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`?`dashboard`:e===`magazine-editor`?`magazine`:e===`page-editor`||e===`pages`?`settings`:`home`}function Ra(){let e=document.querySelector(`#app`);if(!e)throw Error(`#app not found`);return e}function za(){let e=Ra();e.innerHTML=At(),jt(Za),Ia()}var Ba={home:``,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,jobApplications:`job-applications`,activityLog:`activity-log`,accountSecurity:`account-security`,myWallet:`wallet`,payroll:`payroll`,finance:`finance`,magazine:`magazine`,"magazine-editor":`magazine-editor`,pages:`settings`,"page-editor":`page-editor`,dashboardOrders:`dashboard/orders`,dashboardVisitors:`dashboard/visitors`,dashboardStaff:`dashboard/staff`,staffHistory:`staff/history`},Va={"":`home`,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,finance:`finance`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,"job-applications":`jobApplications`,"activity-log":`activityLog`,"account-security":`accountSecurity`,wallet:`myWallet`,payroll:`payroll`,magazine:`magazine`,"magazine-editor":`magazine-editor`,"page-editor":`page-editor`,"dashboard/orders":`dashboardOrders`,"dashboard/visitors":`dashboardVisitors`,"dashboard/staff":`dashboardStaff`,"staff/history":`staffHistory`};function Ha(){let e=window.location.pathname.replace(/^\/management\/?/,``).replace(/\/+$/,``);if(!e)return{screen:`home`};if(Va[e])return{screen:Va[e]};let t=e.split(`/`);if(t.length===2&&(t[0]===`magazine-editor`||t[0]===`page-editor`)){let e=t[0],n=parseInt(t[1],10);return{screen:e,detailId:isNaN(n)?null:n}}return null}function Ua(e,t=null){let n=Ba[e]??``,r=n;(e===`magazine-editor`||e===`page-editor`)&&t&&(r=`${n}/${t}`);let i=r?`/management/${r}`:`/management/`;window.location.pathname!==i&&window.history.pushState({screen:e,editingDetailId:t},``,i)}var Wa=`home`,Ga=null;function $(e,t=null,n=!0){let r=document.getElementById(`view-container`),i=document.getElementById(`admin-back-btn`),a=g();if(!(!r||!a)){if(Wa=e,i&&(i.hidden=e===`home`),v({screen:e,extra:e===`magazine-editor`||e===`page-editor`?t:e===`staffHistory`?Ga:void 0}),n&&Ua(e,t),e===`home`)r.innerHTML=ja(a),Fa(r,e=>$(e));else if(e===`requests`)r.innerHTML=Ma(a),Fa(r,e=>$(e));else if(e===`content`)r.innerHTML=Na(a),Fa(r,e=>$(e));else if(e===`personnel`)r.innerHTML=Pa(a),Fa(r,e=>$(e));else if(e===`dashboard`)r.innerHTML=yn(),bn(e=>$(e));else if(e===`dashboardOrders`)r.innerHTML=xn();else if(e===`dashboardVisitors`)r.innerHTML=Sn();else if(e===`dashboardStaff`)r.innerHTML=Cn();else if(e===`pipeline`)r.innerHTML=fn(),pn();else if(e===`map`)r.innerHTML=On(),kn();else if(e===`staff`)r.innerHTML=Nn(),Pn(e=>{Ga=e,$(`staffHistory`)});else if(e===`staffHistory`){if(!Ga){$(`staff`);return}r.innerHTML=In(Ga),Ln(Ga)}else if(e===`fleet`)r.innerHTML=rr(),ir();else if(e===`magazine`)r.innerHTML=br(),xr(e=>$(`magazine-editor`,e));else if(e===`magazine-editor`)r.innerHTML=Rr(),zr(t,()=>$(`magazine`));else if(e===`pages`){$(`settings`);return}else e===`page-editor`?(r.innerHTML=Gr(),Kr(t,()=>$(`settings`))):e===`testimonials`?(r.innerHTML=Zr(),Qr()):e===`chat`?(r.innerHTML=ai(),oi()):e===`stories`?(r.innerHTML=ui(),di()):e===`jobApplications`?(r.innerHTML=yi(),bi()):e===`settings`?(r.innerHTML=Ki(),qi((e,t)=>$(e,t??null))):e===`plugins`?(r.innerHTML=Zi(),ta()):e===`seo`?(r.innerHTML=da(),fa(e=>$(`magazine-editor`,e))):e===`media`?(r.innerHTML=Rn(),zn()):e===`roles`?(r.innerHTML=Vn(),Hn()):e===`activityLog`?(r.innerHTML=Ci(),wi()):e===`accountSecurity`?(r.innerHTML=pa(),ma()):e===`myWallet`?(r.innerHTML=lr(),fr()):e===`payroll`?(r.innerHTML=_a(),Sa()):e===`finance`?(r.innerHTML=ka(a),Aa()):(r.innerHTML=ja(a),Fa(r,e=>$(e)))}}function Ka(e,t=!1){let n=Ra();n.innerHTML=Rt(e),document.getElementById(`admin-back-btn`)?.addEventListener(`click`,()=>{let e=La(Wa);e&&$(e)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{te(),_(),za()}),document.getElementById(`admin-account-btn`)?.addEventListener(`click`,()=>$(`accountSecurity`));function r(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`,t=document.getElementById(`admin-theme-sun`),n=document.getElementById(`admin-theme-moon`);t&&n&&(t.hidden=!e,n.hidden=e)}r(),document.getElementById(`admin-theme-toggle-btn`)?.addEventListener(`click`,()=>{document.documentElement.getAttribute(`data-theme`)===`dark`?(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`behbar_admin_theme`,`light`)):(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`behbar_admin_theme`,`dark`)),r()}),document.getElementById(`admin-logo-btn`)?.addEventListener(`click`,()=>{$(`home`)}),window.addEventListener(`popstate`,e=>{let t=e.state;if(t?.screen)$(t.screen,t.editingDetailId??null,!1);else{let e=Ha();e?$(e.screen,e.detailId??null,!1):$(`home`,null,!1)}}),x(e,`settings`)&&Ja(),qa(),Gn(),Ia(),x(e,`ai`)&&Ft();let i=Ha(),a=t?y():null;i&&i.screen!==`home`?$(i.screen,i.detailId??null,!1):a?.screen===`staffHistory`&&a.extra?(Ga=a.extra,$(`staffHistory`)):a?.screen===`magazine-editor`?$(`magazine-editor`,a.extra??null):a?.screen===`page-editor`?$(`page-editor`,a.extra??null):a?.screen&&a.screen!==`home`?$(a.screen):$(`home`,null,!0)}async function qa(){try{let e=await Ee(),t=e.branding,n=t?.logoUrl;n&&document.querySelectorAll(`.admin-logo-mark`).forEach(e=>e.src=n);let r=t?.faviconUrl||n;r&&document.querySelectorAll(`link[rel="icon"]`).forEach(e=>e.href=r);let i=e.site_name;i?.fa?.trim()&&(document.title=`${i.fa.trim()} - پنل مدیریت`,document.querySelectorAll(`.admin-logo-title`).forEach(e=>e.textContent=i.fa.trim()))}catch{}}async function Ja(){let e=document.getElementById(`admin-sidebar-version`);if(e)try{let t=await _t();e.textContent=t.updateAvailable?`نسخه ${t.current} · نسخه جدید موجود است`:`نسخه ${t.current}`,e.classList.toggle(`has-update`,t.updateAvailable),e.hidden=!1}catch{}}function Ya(e){let t=Ra();t.innerHTML=gr(e),Ia(),vr(()=>{te(),_(),za()})}function Xa(e){let t=Ra();t.innerHTML=sa(),Ia(),ca(e,()=>Ka(e))}function Za(e,t=!1){if(!S(e)){Ya(e);return}if(!x(e,`settings`)){Ka(e,t);return}Ee().then(n=>{aa(n)?Xa(e):Ka(e,t)}).catch(()=>Ka(e,t))}function Qa(){if(T(za),!b()){za();return}let e=g();e?Za(e,!0):za(),M().then(t=>{let n=h();n&&(m(n,t),(!e||e.role!==t.role)&&Za(t,!0))}).catch(()=>{})}Qa();