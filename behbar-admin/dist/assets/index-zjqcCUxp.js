var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,o)=>(o=n==null?{}:e(i(n)),s(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=`viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"`,u={route:`<svg ${l}><circle cx="5.5" cy="6" r="2"/><circle cx="18.5" cy="18" r="2"/><path d="M5.5 8v3a3 3 0 0 0 3 3h7a3 3 0 0 1 3 3"/></svg>`,grid:`<svg ${l}><rect x="3.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="3.5" y="13.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="13.5" width="7" height="7" rx="1.5"/></svg>`,chart:`<svg ${l}><path d="M4 20V10M12 20V4M20 20v-7"/><path d="M2 20h20"/></svg>`,columns:`<svg ${l}><rect x="3.5" y="4" width="5" height="16" rx="1"/><rect x="9.5" y="4" width="5" height="10" rx="1"/><rect x="15.5" y="4" width="5" height="13" rx="1"/></svg>`,phone:`<svg ${l}><path d="M5.5 4h2.8l1.2 4-2 1.3a11 11 0 0 0 5.2 5.2l1.3-2 4 1.2v2.8c0 1-.9 1.7-1.8 1.5-6-1.1-10.6-5.7-11.7-11.7C4.3 5.4 5 4 5.5 4Z"/></svg>`,pin:`<svg ${l}><path d="M12 21s-6.5-5.6-6.5-11a6.5 6.5 0 0 1 13 0c0 5.4-6.5 11-6.5 11Z"/><circle cx="12" cy="10" r="2.3"/></svg>`,flag:`<svg ${l}><path d="M6 21V4"/><path d="M6 4.5h10.5L14 8l2.5 3.5H6"/></svg>`,calendar:`<svg ${l}><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 9.5h17M8 3v4M16 3v4"/></svg>`,logout:`<svg ${l}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/></svg>`,lock:`<svg ${l}><rect x="4.5" y="10.5" width="15" height="10" rx="2"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/></svg>`,close:`<svg ${l}><path d="m5 5 14 14M19 5 5 19"/></svg>`,chevronDown:`<svg ${l}><path d="m6 9 6 6 6-6"/></svg>`,refresh:`<svg ${l}><path d="M3.5 12a8.5 8.5 0 0 1 14.5-6M20.5 12a8.5 8.5 0 0 1-14.5 6"/><path d="M18 3v4h-4M6 21v-4h4"/></svg>`,map:`<svg ${l}><path d="M9 4 4 6v14l5-2 6 2 5-2V4l-5 2-6-2Z"/><path d="M9 4v14M15 6v14"/></svg>`,users:`<svg ${l}><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0 1 12 0"/><circle cx="17" cy="9" r="2.3"/><path d="M15.5 20a4.5 4.5 0 0 1 5.5-4.4"/></svg>`,plusCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="M12 8v8M8 12h8"/></svg>`,checkCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="m8.5 12.3 2.3 2.3 4.7-5"/></svg>`,fileText:`<svg ${l}><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><line x1="10" y1="9" x2="8" y2="9"/></svg>`,user:`<svg ${l}><circle cx="12" cy="8" r="3.5"/><path d="M5 20a7 7 0 0 1 14 0"/></svg>`,article:`<svg ${l}><rect x="5" y="3.5" width="14" height="17" rx="1.5"/><path d="M8.5 8h7M8.5 12h7M8.5 16h4"/></svg>`,settings:`<svg ${l}><circle cx="12" cy="12" r="3.2"/><path d="M12 3v2.4M12 18.6V21M21 12h-2.4M5.4 12H3M18.4 5.6l-1.7 1.7M7.3 16.7l-1.7 1.7M18.4 18.4l-1.7-1.7M7.3 7.3 5.6 5.6"/></svg>`,message:`<svg ${l}><path d="M4 5.5h16a1 1 0 0 1 1 1V16a1 1 0 0 1-1 1H9l-4.5 3.5V17H4a1 1 0 0 1-1-1V6.5a1 1 0 0 1 1-1Z"/><path d="M7.5 9.5h9M7.5 13h6"/></svg>`,chat:`<svg ${l}><path d="M3.5 6.5A2.5 2.5 0 0 1 6 4h9a2.5 2.5 0 0 1 2.5 2.5v6A2.5 2.5 0 0 1 15 15H9l-4 3.5v-3.5H6a2.5 2.5 0 0 1-2.5-2.5v-6Z"/><circle cx="7.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="11.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="15" cy="9.5" r="0.9" fill="currentColor" stroke="none"/></svg>`,story:`<svg ${l}><rect x="7" y="3" width="10" height="17" rx="2.2"/><circle cx="12" cy="7.2" r="1.5" fill="currentColor" stroke="none"/></svg>`,briefcase:`<svg ${l}><rect x="3" y="7.5" width="18" height="12" rx="2"/><path d="M8.5 7.5V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1.5"/><path d="M3 12.5h18M10.5 12.5v2h3v-2"/></svg>`,download:`<svg ${l}><path d="M12 3.5v11M8 10.5l4 4 4-4"/><path d="M4.5 17v2a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-2"/></svg>`,truck:`<svg ${l}><rect x="2" y="7" width="11" height="7" rx="1"/><path d="M13 10h4l3 3v1h-2"/><path d="M7.8 17h6.9"/><circle cx="6" cy="17" r="1.8"/><circle cx="16.5" cy="17" r="1.8"/></svg>`,seo:`<svg ${l}><circle cx="10.5" cy="10.5" r="6.5"/><path d="m20 20-4.8-4.8"/><path d="M7.5 10.5h6M10.5 7.5v6"/></svg>`,ai:`<svg ${l}><path d="M11 3 12.7 8 17.5 9.7 12.7 11.4 11 16.4 9.3 11.4 4.5 9.7 9.3 8Z"/><path d="M18 15.5 18.8 17.7 21 18.5 18.8 19.3 18 21.5 17.2 19.3 15 18.5 17.2 17.7Z"/></svg>`,image:`<svg ${l}><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m5 17 5-5 3 3 3-4 3 6"/></svg>`,video:`<svg ${l}><rect x="3" y="6" width="12" height="12" rx="2"/><path d="m15 10 6-3v10l-6-3Z"/></svg>`,audio:`<svg ${l}><path d="M9 18V6l8-2v12"/><circle cx="7" cy="18" r="2.2"/><circle cx="17" cy="16" r="2.2"/></svg>`,arrowRight:`<svg ${l}><path d="M5 12h14M13 6l6 6-6 6"/></svg>`,arrowLeft:`<svg ${l}><path d="M19 12H5M11 18l-6-6 6-6"/></svg>`,maleAvatar:`<svg ${l}><circle cx="12" cy="8" r="4"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,femaleAvatar:`<svg ${l}><circle cx="12" cy="7.5" r="4"/><path d="M12 11.5v6M9 15h6"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,eye:`<svg ${l}><path d="M2 12s3.8-7 10-7 10 7 10 7-3.8 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>`,eyeOff:`<svg ${l}><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" y1="2" x2="22" y2="22"/></svg>`,history:`<svg ${l}><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/><path d="M12 8v4l3 2"/></svg>`,link:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.6 4.9a3.7 3.7 0 0 1 5.2 5.2L16 12"/><path d="M13 17.5 11.4 19.1a3.7 3.7 0 0 1-5.2-5.2L8 12"/></svg>`,externalLink:`<svg ${l}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`,unlink:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.2 5.3a3.7 3.7 0 0 1 5.2 5.2L16.2 11.7"/><path d="M13 17.5 11.8 18.7a3.7 3.7 0 0 1-5.2-5.2L7.8 12.3"/><path d="m4 4 16 16"/></svg>`,quote:`<svg ${l}><path d="M7.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/><path d="M16.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/></svg>`,undo:`<svg ${l}><path d="M4 12a8 8 0 1 1 2.6 5.9"/><path d="M4 6.5V12h5.5"/></svg>`,redo:`<svg ${l}><path d="M20 12a8 8 0 1 0-2.6 5.9"/><path d="M20 6.5V12h-5.5"/></svg>`,minus:`<svg ${l}><path d="M4 12h16"/></svg>`,eraser:`<svg ${l}><path d="m17.5 8.5-9 9H4l-1-1L14 5.5a2 2 0 0 1 2.8 0l2 2a2 2 0 0 1-.3 2.9L9.5 19"/></svg>`,alignLeft:`<svg ${l}><path d="M4 6h16M4 12h10M4 18h13"/></svg>`,alignCenter:`<svg ${l}><path d="M4 6h16M7 12h10M5.5 18h13"/></svg>`,alignRight:`<svg ${l}><path d="M4 6h16M10 12h10M7 18h13"/></svg>`,listBullet:`<svg ${l}><circle cx="4.5" cy="6" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="18" r="1" fill="currentColor" stroke="none"/><path d="M9 6h11M9 12h11M9 18h11"/></svg>`,listNumber:`<svg ${l}><path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 5v3M3.3 5H4.7M3 11.5h1.6c.5 0 .9.4.9.9 0 .3-.2.5-.4.7L3 15h2.6M3.3 19h1.4c.5 0 .9-.4.9-.9s-.4-.9-.9-.9H3.3"/></svg>`,plugin:`<svg ${l}><path d="M12 3 4 7v10l8 4 8-4V7Z"/><path d="M4 7l8 4 8-4M12 11v10"/></svg>`,wallet:`<svg ${l}><path d="M3 7a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v1"/><path d="M3 7v10a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2H5"/><circle cx="16" cy="13" r="1.2" fill="currentColor" stroke="none"/></svg>`,finance:`<svg ${l}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2.5"/><path d="M6 12h.01M18 12h.01"/></svg>`,fileSpreadsheet:`<svg ${l}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h8M8 17h8M12 13v8"/></svg>`,printer:`<svg ${l}><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>`,shield:`<svg ${l}><path d="M12 3.5 19 6.5v5c0 5-3 8-7 9-4-1-7-4-7-9v-5l7-3Z"/><path d="m9.3 12 1.9 1.9L15 10"/></svg>`,clock:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="M12 7.5V12l3 2"/></svg>`,sun:`<svg ${l}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>`,moon:`<svg ${l}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>`},d=`https://api.behbarapp.ir`,f=`behbar_admin_token`,p=`behbar_admin_staff`,m=`behbar_admin_screen`;function h(e,t){localStorage.setItem(f,e),localStorage.setItem(p,JSON.stringify(t))}function g(){return localStorage.getItem(f)}function _(){let e=localStorage.getItem(p);if(!e)return null;try{let t=JSON.parse(e);return Array.isArray(t.permissions)?t:(v(),null)}catch{return null}}function v(){localStorage.removeItem(f),localStorage.removeItem(p),localStorage.removeItem(m)}function y(e){localStorage.setItem(m,JSON.stringify(e))}function b(){let e=localStorage.getItem(m);if(!e)return null;try{return JSON.parse(e)}catch{return null}}function x(){return g()!==null&&_()!==null}function S(e,t){return(e.permissions??[]).includes(t)}function C(e){return(e.permissions??[]).some(e=>e!==`assignments`)}var w=class extends Error{},T=null;function E(e){T=e}async function D(e,t={}){let n=g(),r=await fetch(`${d}${e}`,{...t,headers:{...t.headers,...n?{Authorization:`Bearer ${n}`}:{}}});if(r.status===401)throw v(),T?.(),new w(`نشست شما منقضی شده است.`);return r}async function O(e,t){let n=await fetch(`${d}/api/staff/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ورود ناموفق بود.`);return r?.needsTwoFactor?{needsTwoFactor:!0,challengeToken:r.challengeToken}:{needsTwoFactor:!1,token:r.token,staff:r.staff}}async function ee(e,t){let n=await fetch(`${d}/api/staff/login/verify-2fa`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({challengeToken:e,code:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`کد نامعتبر است.`);return r}async function k(){let e=await D(`/api/staff/2fa/sms/setup`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال کد ناموفق بود.`)}async function A(e){let t=await D(`/api/staff/2fa/sms/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({code:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید کد ناموفق بود.`)}async function j(e){let t=await D(`/api/staff/2fa/disable`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`غیرفعال‌سازی ناموفق بود.`)}async function te(e,t){let n=await D(`/api/staff/change-password`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({newPassword:e,currentPassword:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`تغییر رمز عبور ناموفق بود.`)}async function M(){await D(`/api/staff/logout`,{method:`POST`}).catch(()=>{})}async function N(){let e=await D(`/api/staff/me`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات ناموفق بود.`);return{...t.staff,licenseLocked:!!t.licenseLocked,licenseSummary:t.licenseSummary}}async function P(e){let t=await D(`/api/admin/requests${e?`?status=${encodeURIComponent(e)}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌ها ناموفق بود.`);return n.requests??[]}async function F(e,t){let n=await D(`/api/admin/requests/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function I(e){let t=await D(`/api/admin/requests/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function R(){let e=await D(`/api/admin/requests/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت خروجی ناموفق بود.`)}let t=await e.blob(),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`behbar-requests-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)}async function z(){let e=await D(`/api/admin/activity-log`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گزارش فعالیت ناموفق بود.`);return t.entries??[]}async function B(e,t){let n=await D(`/api/admin/requests/${e}/assign`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({staffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اختصاص ناموفق بود.`)}async function ne(){let e=await D(`/api/admin/stats`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار ناموفق بود.`);return t}async function re(){let e=await D(`/api/admin/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کارمندان ناموفق بود.`);return t.staff??[]}async function ie(e){let t=await D(`/api/admin/staff`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد کارمند ناموفق بود.`);return n.staff}async function ae(){let e=await D(`/api/admin/roles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نقش‌ها ناموفق بود.`);return{roles:t.roles??[],permissions:t.permissions??[]}}async function oe(e){let t=await D(`/api/admin/roles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نقش ناموفق بود.`);return n.role}async function se(e,t){let n=await D(`/api/admin/roles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نقش ناموفق بود.`);return r.role}async function ce(e){let t=await D(`/api/admin/roles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نقش ناموفق بود.`)}async function le(e,t){let n=await D(`/api/admin/staff/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی کارمند ناموفق بود.`);return r.staff}async function ue(e){let t=await D(`/api/admin/staff/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف کارمند ناموفق بود.`)}async function de(){let e=await D(`/api/staff/requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌ها ناموفق بود.`);return t.requests??[]}async function fe(e,t){let n=await D(`/api/staff/requests/${e}/status`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function pe(){let e=await D(`/api/admin/articles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت مقالات ناموفق بود.`);return t.articles??[]}async function me(e){let t=await D(`/api/admin/articles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد مقاله ناموفق بود.`);return n.article}async function he(e,t){let n=await D(`/api/admin/articles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی مقاله ناموفق بود.`);return r.article}async function ge(e,t){let n=await D(`/api/admin/articles/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.article}async function _e(e){let t=await D(`/api/admin/articles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف مقاله ناموفق بود.`)}async function ve(){let e=await D(`/api/admin/pages`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت برگه‌ها ناموفق بود.`);return t.pages??[]}async function ye(e){let t=await D(`/api/admin/pages/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت برگه ناموفق بود.`);return n.page}async function be(e){let t=await D(`/api/admin/pages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد برگه ناموفق بود.`);return n.page}async function xe(e,t){let n=await D(`/api/admin/pages/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی برگه ناموفق بود.`);return r.page}async function Se(e,t){let n=await D(`/api/admin/pages/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت برگه ناموفق بود.`);return r.page}async function Ce(e){let t=await D(`/api/admin/pages/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف برگه ناموفق بود.`)}async function we(e){let t=g(),n=await fetch(`${d}/api/admin/upload`,{method:`POST`,headers:{"Content-Type":e.type,...t?{Authorization:`Bearer ${t}`}:{}},body:e}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`آپلود تصویر ناموفق بود.`);return`${d}${r.url}`}async function Te(e){let t=await D(`/api/admin/media${e?`?folder=${e}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت فهرست فایل‌ها ناموفق بود.`);return n.files??[]}async function Ee(e){let t=await D(`/api/admin/media/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف فایل ناموفق بود.`)}async function De(){let e=await fetch(`${d}/api/settings`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت تنظیمات ناموفق بود.`);return t.settings??{}}async function V(e,t){let n=await D(`/api/admin/settings`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({key:e,value:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی تنظیمات ناموفق بود.`)}async function Oe(e,t,n){let r=await D(`/api/admin/ai/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,apiKey:t,model:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اتصال ناموفق بود.`);return i}async function ke(e,t){let n=await D(`/api/admin/sms/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اتصال ناموفق بود.`);return r}async function Ae(){let e=await D(`/api/admin/testimonials`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نظرات ناموفق بود.`);return t.testimonials??[]}async function je(e){let t=await D(`/api/admin/testimonials`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نظر ناموفق بود.`);return n.testimonial}async function Me(e,t){let n=await D(`/api/admin/testimonials/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نظر ناموفق بود.`);return r.testimonial}async function Ne(e){let t=await D(`/api/admin/testimonials/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نظر ناموفق بود.`)}async function Pe(){let e=await D(`/api/admin/license`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات لایسنس ناموفق بود.`);return t.license??null}async function Fe(e){let t=await D(`/api/admin/license/activate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({licenseKey:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`فعال‌سازی لایسنس ناموفق بود.`);return n.license}async function Ie(){let e=await D(`/api/admin/chat/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گفتگوها ناموفق بود.`);return t.conversations??[]}async function Le(e){let t=await D(`/api/admin/chat/conversations/${e}/messages`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیام‌ها ناموفق بود.`);return n.messages??[]}async function Re(e,t){let n=await D(`/api/admin/chat/conversations/${e}/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({text:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارسال پیام ناموفق بود.`)}async function ze(e,t){let n=await D(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`)}async function Be(e,t){let n=await D(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({assignedStaffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`واگذاری گفتگو ناموفق بود.`)}async function Ve(e,t){let n=await D(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({archived:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`بایگانی گفتگو ناموفق بود.`)}async function He(e){let t=await D(`/api/admin/chat/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function Ue(e){let t=await D(`/api/admin/requests?phone=${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های مرتبط ناموفق بود.`);return n.requests??[]}async function We(e){let t=await D(`/api/admin/requests?staffId=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.requests??[]}async function Ge(e){let t=await D(`/api/admin/requests/${e}/events`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.events??[]}async function Ke(){let e=await D(`/api/admin/chat/agents`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت پشتیبان‌ها ناموفق بود.`);return t.agents??[]}async function qe(){let e=await D(`/api/admin/stories`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت استوری‌ها ناموفق بود.`);return t.stories??[]}async function H(e){let t=await D(`/api/admin/stories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد استوری ناموفق بود.`);return n.story}async function Je(e,t){let n=await D(`/api/admin/stories/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی استوری ناموفق بود.`);return r.story}async function Ye(e){let t=await D(`/api/admin/stories/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف استوری ناموفق بود.`)}async function Xe(){let e=await D(`/api/admin/job-applications`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های همکاری ناموفق بود.`);return t.applications??[]}async function Ze(e,t){let n=await D(`/api/admin/job-applications/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.application}async function Qe(e){let t=await D(`/api/admin/job-applications/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function $e(){let e=await D(`/api/admin/fleet-vehicles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت وسایل نقلیه ناموفق بود.`);return t.vehicles??[]}async function et(e){let t=await D(`/api/admin/fleet-vehicles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد وسیله نقلیه ناموفق بود.`);return n.vehicle}async function tt(e,t){let n=await D(`/api/admin/fleet-vehicles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وسیله نقلیه ناموفق بود.`);return r.vehicle}async function nt(e){let t=await D(`/api/admin/fleet-vehicles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف وسیله نقلیه ناموفق بود.`)}async function rt(){let e=await D(`/api/admin/plugins`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت افزونه‌ها ناموفق بود.`);return t.plugins??{}}async function it(e){let t=await D(`/api/admin/requests/${e}/reports`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت گزارش‌ها ناموفق بود.`);return n.reports??[]}async function at(e,t){let n=await D(`/api/admin/requests/${e}/reports`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({message:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت گزارش ناموفق بود.`);return r}async function ot(){let e=await D(`/api/admin/analytics`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار بازدید ناموفق بود.`);return t}async function st(){let e=await D(`/api/admin/backup/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت فایل پشتیبان ناموفق بود.`)}let t=(e.headers.get(`Content-Disposition`)??``).match(/filename="([^"]+)"/)?.[1]??`behbar-backup.sql`,n=await e.blob(),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function ct(e){let t=await D(`/api/admin/backup/import`,{method:`POST`,headers:{"Content-Type":`application/sql`},body:e}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`بازیابی پشتیبان ناموفق بود.`)}async function lt(){let e=await D(`/api/admin/backup/drive-test`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال آزمایشی به گوگل درایو ناموفق بود.`)}async function ut(){let e=await D(`/api/admin/backup/drive-oauth/prepare`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`آماده‌سازی اتصال به گوگل ناموفق بود.`);return t.authUrl}async function dt(){let e=await D(`/api/admin/backup/drive-disconnect`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`قطع اتصال ناموفق بود.`)}async function ft(e,t){let n=await D(`/api/admin/ai/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,conversationId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارتباط با دستیار هوش مصنوعی ناموفق بود.`);return r}async function pt(e,t,n){let r=await D(`/api/admin/ai/execute`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,toolCallId:t.toolCallId,tool:t.tool,args:t.args,conversationId:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اجرای اقدام ناموفق بود.`);return i}async function mt(){let e=await D(`/api/admin/ai/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`فهرست گفتگوها دریافت نشد.`);return t.conversations??[]}async function ht(e){let t=await D(`/api/admin/ai/conversations/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`گفتگو دریافت نشد.`);return n}async function gt(){let e=await D(`/api/admin/ai/conversations`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ساخت گفتگوی جدید ناموفق بود.`);return t.id}async function _t(e){let t=await D(`/api/admin/ai/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function vt(){let e=await D(`/api/admin/version`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات نسخه ناموفق بود.`);return t}async function U(){let e=await D(`/api/admin/selfhost/update`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`به‌روزرسانی ناموفق بود.`)}async function W(){let e=await D(`/api/staff/wallet`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول ناموفق بود.`);return t}async function yt(e,t){let n=await D(`/api/staff/wallet/transactions?limit=${e}&offset=${t}`),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:r.transactions??[],total:r.total??0}}async function bt(){let e=await D(`/api/staff/wallet/payout-requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return t.payoutRequests??[]}async function xt(e,t){let n=await D(`/api/staff/wallet/payout-requests`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({amount:e,note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت درخواست تسویه ناموفق بود.`)}async function St(){let e=await D(`/api/admin/wallet/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول‌ها ناموفق بود.`);return t.wallets??[]}async function G(e,t,n){let r=await D(`/api/admin/wallet/staff/${e}/transactions?limit=${t}&offset=${n}`),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:i.transactions??[],total:i.total??0}}async function K(e,t,n,r){let i=await D(`/api/admin/wallet/staff/${e}/adjustments`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({direction:t,amount:n,description:r})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(typeof a?.error==`string`?a.error:`ثبت اصلاحیه ناموفق بود.`)}async function Ct(e,t){let n=await D(`/api/admin/wallet/staff/${e}/rate-override`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ ناموفق بود.`)}async function wt(e,t){let n=await D(`/api/admin/roles/${e}/pay-rate`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ نقش ناموفق بود.`)}async function Tt(e=`pending`){let t=await D(`/api/admin/wallet/payout-requests?status=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return n.payoutRequests??[]}async function Et(e){let t=await D(`/api/admin/wallet/payout-requests/${e}/approve`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید درخواست ناموفق بود.`)}async function Dt(e,t){let n=await D(`/api/admin/wallet/payout-requests/${e}/reject`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`رد درخواست ناموفق بود.`)}async function Ot(e){let t=await D(`/api/admin/wallet/payroll/preview?month=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیش‌نمایش حقوق ناموفق بود.`);return n.entries??[]}async function kt(e,t){let n=await D(`/api/admin/wallet/payroll/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({month:e,entries:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`پردازش حقوق ناموفق بود.`);return r}function At(e,t=6){return`
          ...
          <div class="behbar-invoice-sheet" id="admin-printable-invoice" style="background: white; border: 1px solid #e5e7eb; border-radius: 12px; padding: 28px; max-width: 760px; margin: 0 auto; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.04);">
            ...
            <div class="behbar-invoice-head" style="display: flex; justify-content: space-between; align-items: flex-start; border-bottom: 2px solid #059669; padding-bottom: 16px; margin-bottom: 20px;">
              ...
              <div class="behbar-invoice-meta" style="text-align: left; font-size: 0.82rem; line-height: 1.6; color: #4b5563;">
                <div><strong>شماره سند:</strong> <span style="font-family: monospace; direction: ltr; font-weight: 700;">#${J(i)}</span></div>
                <div><strong>تاریخ صدور:</strong> ${J(r)}</div>
            ...
            <div style="display: flex; justify-content: space-between; flex-wrap: wrap; gap: 12px; background: #ecfdf5; border: 1px solid #d1fae5; padding: 10px 14px; border-radius: 8px; margin-bottom: 16px; font-size: 0.84rem;">
              ...
              ${e.scheduledDate?`<div><span style="color: #059669; font-weight: 700;">زمان‌بندی:</span> ${e.scheduledDate} — ساعت ${J(e.scheduledTime||``)}</div>`:``}
              <div>
  ...
  `;let o=()=>{t.innerHTML=``};document.getElementById(`admin-invoice-close-btn`)?.addEventListener(`click`,o),document.getElementById(`btn-admin-close-modal`)?.addEventListener(`click`,o),document.getElementById(`admin-invoice-modal-backdrop`)?.addEventListener(`click`,e=>{e.target===document.getElementById(`admin-invoice-modal-backdrop`)&&o()}),document.getElementById(`btn-admin-print-invoice`)?.addEventListener(`click`,()=>{let e=document.getElementById(`admin-printable-invoice`);if(!e)return;let t=window.open(``,`_blank`,`width=850,height=900`);if(!t){window.print();return}t.document.write(`
      <!DOCTYPE html>
      <html lang="fa" dir="rtl">
      <head>
        <meta charset="utf-8" />
        <title>فاکتور رسمی بهبار - #${i}</title>
        <style>
    ...
    `),t.document.close()})}var un=3e4,dn=`pending`,fn;function pn(e){return Vt.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${t.label}</option>`).join(``)}function mn(e,t){return`<option value="">اختصاص‌نیافته</option>${t.map(t=>{let n=t.onActiveService&&t.id!==e,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``)}`}function hn(e,t){return!t||`${e.trackingCode} ${e.phone} ${e.originCity} ${e.destinationCity} ${e.customerName}`.toLowerCase().includes(t.toLowerCase())}function gn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function _n(e){return e?e.length?e.map(e=>`
      <div class="pipeline-report-item">
        <div class="pipeline-report-item-head">
          <span>${gn(e.staffName)}</span>
    ...
    `).join(``):`<p class="pipeline-report-empty">هنوز گزارشی ثبت نشده است.</p>`:``}function vn(e){return e?e.length?`
      ...
      ${e.map(e=>`
        <li class="pipeline-timeline-item pipeline-timeline-${e.type}">
          ...
          <div class="pipeline-timeline-body">
            <p>${gn(e.description)}</p>
            <span class="pipeline-timeline-meta">${e.staffName?`${gn(e.staffName)} — `:``}${nn(e.createdAt)}</span>
          </div>
        </li>
      `).join(``)}
    </ol>
  `:`<p class="pipeline-report-empty">هنوز رویدادی ثبت نشده است.</p>`:``}function yn(e,t,n,r,i,a,o){return`
    <div class="pipeline-card" data-card-id="${e.id}" style="--card-accent:${Ut[e.status]??`var(--muted)`}">
      ...
      ${e.originNotes?`<p class="pipeline-note"><strong>یادداشت مبدأ:</strong> ${gn(e.originNotes)}</p>`:``}
      ${e.destinationNotes?`<p class="pipeline-note"><strong>یادداشت مقصد:</strong> ${gn(e.destinationNotes)}</p>`:``}
      ...
      <div class="pipeline-report">
        ...
        <div class="pipeline-report-body" data-report-body-id="${e.id}" ${n?``:`hidden`}>
          <div class="pipeline-report-list" data-report-list-id="${e.id}">${_n(r)}</div>
          <textarea class="pipeline-report-textarea" data-report-textarea-id="${e.id}" rows="2" placeholder="متنی که برای مشتری پیامک می‌شود...">${gn(i)}</textarea>
      ...
      <div class="pipeline-report">
        ...
        <div class="pipeline-report-body" data-history-body-id="${e.id}" ${a?``:`hidden`}>
          <div data-history-list-id="${e.id}">${vn(o)}</div>
        </div>
      </div>
    </div>
  `}function bn(){return`
    ...
    <div class="pipeline-tabs" id="pipeline-tabs">
      ${Vt.map(e=>`
          <button type="button" class="pipeline-tab ${e.id===dn?`is-active`:``}" data-pipeline-tab="${e.id}" style="--tab-accent:${e.color}">
            <span>${e.label}</span>
  ...
  `}function Cn(e){if(e.length===0)return`<p class="chart-empty">داده‌ای موجود نیست.</p>`;let t=Math.max(...e.map(e=>e.value),1),n=e.length>1?576/(e.length-1):0,r=e.map((e,r)=>({x:32+r*n,y:168-e.value/t*136})),i=r.map((e,t)=>`${t===0?`M`:`L`}${e.x},${e.y}`).join(` `);return`
  ...
  `}var wn={mobile:`موبایل`,desktop:`رایانه`};function Tn(e){let t=e.split(`-`);return t.length===3?J(`${t[1]}/${t[2]}`):J(e)}function En(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Dn(){return`
    <div class="dash-view">
  ...
  `}function On(e){let t=document.getElementById(`dash-body`),n=document.getElementById(`dash-error`),r=document.getElementById(`dash-refresh-btn`),i=document.querySelectorAll(`#dash-subnav [data-dash-tab]`);if(!t)return;let a=`overview`;async function o(){if(t){t.innerHTML=`
      <div class="dash-loading">
        <span class="dash-spinner"></span>
        ...
        <div class="dash-charts-grid">
          <div class="dash-card">
            ...
            <div class="dash-card-body">
              ${o?.daily?.length?Cn(o.daily.map(e=>({label:Tn(e.day),value:e.count}))):`<p class="dash-empty">داده‌ای ثبت نشده است.</p>`}
            </div>
          </div>
          ...
          <div class="dash-card">
            ...
            <div class="dash-card-body">
              ${o?.byStatus?.length?Sn(o.byStatus.map(e=>({label:Ht[e.status]??e.status,value:e.count}))):`<p class="dash-empty">داده‌ای ثبت نشده است.</p>`}
            </div>
          </div>
        </div>
            ...
            <div class="dash-table-wrapper">
              ${S.length===0?`<p class="dash-empty">هنوز سفارشی در سامانه بهبار ثبت نشده است.</p>`:`
                <table class="dash-table">
                  ...
                  <tbody>
                    ${S.map(e=>{let t=Ut[e.status]??`var(--muted)`,n=Ht[e.status]??e.status,r=`${En(e.originCity||`—`)} به ${En(e.destinationCity||`—`)}`;return`
                        <tr>
                          <td><span class="dash-code">${En(e.trackingCode)}</span></td>
                          <td>
                            <div class="dash-customer-cell">
                              <span class="dash-customer-name">${En(e.customerName||`بدون نام`)}</span>
                              <span class="dash-customer-phone">${J(e.phone||``)}</span>
                            </div>
                          </td>
                          <td><span class="dash-service-tag">${En(e.serviceLabel||`حمل بار`)}</span></td>
    ...
    `;try{let e=await ne(),n=e.byStatus.find(e=>e.status===`in_progress`)?.count??0,r=e.byStatus.find(e=>e.status===`completed`)?.count??0;t.innerHTML=`
        ...
        <div class="dash-charts-grid">
          <div class="dash-card">
            ...
            <div class="dash-card-body">${Cn(e.daily.map(e=>({label:Tn(e.day),value:e.count})))}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">وضعیت درخواست‌ها</h2></div>
            <div class="dash-card-body">${Sn(e.byStatus.map(e=>({label:Ht[e.status]??e.status,value:e.count})))}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">نوع خدمات</h2></div>
            <div class="dash-card-body">${Sn(e.byService.map(e=>({label:e.service_label,value:e.count})))}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">پرتقاضاترین شهرهای مبدأ</h2></div>
            <div class="dash-card-body">${e.topCities.length?Sn(e.topCities.map(e=>({label:e.city,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">درخواست‌ها به تفکیک استان مبدأ</h2></div>
            <div class="dash-card-body">${e.topProvinces.length?Sn(e.topProvinces.map(e=>({label:e.province,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
        </div>
    ...
    `;try{let e=await ot();t.innerHTML=`
        ...
        <div class="dash-charts-grid">
          <div class="dash-card">
            ...
            <div class="dash-card-body">${e.daily.length?Cn(e.daily.map(e=>({label:Tn(e.day),value:e.count}))):`<p class="dash-empty">هنوز بازدیدی ثبت نشده است.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">صفحات پربازدید</h2></div>
            <div class="dash-card-body">${e.topPages.length?Sn(e.topPages.map(e=>({label:e.path,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">منابع ورودی</h2></div>
            <div class="dash-card-body">${e.topReferrers.length?Sn(e.topReferrers.map(e=>({label:e.referrer,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
          <div class="dash-card">
            <div class="dash-card-header"><h2 class="dash-card-title">دستگاه‌ها</h2></div>
            <div class="dash-card-body">${e.byDevice.length?Sn(e.byDevice.map(e=>({label:wn[e.device]??e.device,value:e.count}))):`<p class="dash-empty">داده‌ای وجود ندارد.</p>`}</div>
          </div>
        </div>
            ...
            <table class="dash-table">
              ...
              <tbody>
                ${e.staffPerformance.length?e.staffPerformance.map(e=>`
                    <tr>
                      <td><strong>${En(e.name)}</strong></td>
                      <td><span class="dash-service-tag">${En(e.role_label)}</span></td>
                      <td>${J(e.total)}</td>
  ...
  </svg>`,iconSize:[30,38],iconAnchor:[15,36]});function In(){return`
    <div class="view-header">
  ...
  `}function Ln(){let e=document.getElementById(`map-error`),t=document.getElementById(`map-refresh`),n=document.getElementById(`admin-map`);if(!e||!t||!n)return;let r=Mn.default.map(`admin-map`,{center:Nn,zoom:11});Mn.default.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`© OpenStreetMap contributors`,maxZoom:19}).addTo(r);let i=[];function a(e,t){let n=t.map(t=>{let n=t.onActiveService&&t.id!==e.assignedStaffId,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e.assignedStaffId?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``);return`
  ...
  `}function Gn(e){let t=document.getElementById(`staff-history-error`),n=document.getElementById(`staff-history-stats`),r=document.getElementById(`staff-history-list`),i=document.getElementById(`staff-history-refresh`);if(!t||!n||!r||!i)return;async function a(){t.hidden=!0;try{let t=await We(e.id),i=t.filter(e=>e.status===`completed`).length,a=t.filter(e=>e.status===`in_progress`).length;n.innerHTML=`
      ...
      `,r.innerHTML=t.length?t.map(Un).join(``):`<p class="portal-empty">هنوز کاری به این کارمند اختصاص داده نشده است.</p>`}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}i.addEventListener(`click`,()=>void a()),a()}function Kn(){return`
    <div class="view-header">
      <h1>مدیریت فایل</h1>
      <div>
  ...
  `}function qn(){function e(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(1)} MB`}function t(e){return e.startsWith(`videos/`)?u.video:e.startsWith(`audio/`)?u.audio:u.image}let n=``;async function r(){let i=document.getElementById(`media-list`),a=document.getElementById(`media-error`);if(!(!i||!a)){a.hidden=!0;try{let o=await Te(n||void 0);i.innerHTML=o.length?o.map(n=>`
  ...
  `}function Yn(){let e=document.getElementById(`roles-error`);if(!e)return;function t(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`,Q(t instanceof Error?t.message:`خطایی پیش آمد.`,`error`)}let n=[],r=[],i=null;function a(e){let t=e.isSystem;return`
    ...
    <tr data-vehicle-row="${e.id}">
      ...
      <td>${e.model??`—`}</td>
      <td>${e.driverName??`—`}</td>
      <td><span class="article-status-badge ${or(e.status)}">${ar[e.status]??e.status}</span></td>
      <td class="staff-table-actions">
      ...
      <div class="staff-form-grid">
        ...
        <div class="form-field">
          ...
          <select id="vehicle-status">
            ${ir.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``)}
          </select>
        </div>
        <div class="form-field">
  ...
  `}function dr(){let e=document.getElementById(`vehicle-add-toggle`),t=document.getElementById(`vehicle-form-card`),n=document.getElementById(`vehicle-form-title`),r=document.getElementById(`vehicle-form-cancel`),i=document.getElementById(`vehicle-form-error`),a=document.getElementById(`vehicle-form-submit`),o=document.getElementById(`vehicle-form-id`),s=document.getElementById(`vehicle-label`),c=document.getElementById(`vehicle-type`),l=document.getElementById(`vehicle-plate`),u=document.getElementById(`vehicle-model`),d=document.getElementById(`vehicle-year`),f=document.getElementById(`vehicle-status`),p=document.getElementById(`vehicle-driver`),m=document.getElementById(`vehicle-notes`),h=document.getElementById(`vehicles-error`),g=document.getElementById(`vehicles-table-body`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!u||!d||!f||!p||!m||!h||!g)return;let _=[],v=[],y=Object.fromEntries(rr.map(e=>[e.id,e.label])),b=[],x={},S=[],C={city:``,cityEn:``,province:``,provinceEn:``},w=`all`,T=!0,E=!0,D=!1;Qn().then(()=>er(document.getElementById(`view-container`)??document.body)),document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-fleet-panel]`).forEach(t=>{t.hidden=t.dataset.fleetPanel!==e.dataset.fleetTab})})});function O(){let e=document.getElementById(`vehicle-types-list`);e&&(e.innerHTML=b.map((e,t)=>`
          ...
          <div class="settings-form-grid">
            ...
            <div class="form-field"><label>آیکون</label>
              <select data-field="icon">
                ${nr.map(t=>`<option value="${t}" ${t===e.icon?`selected`:``}>${t}</option>`).join(``)}
              </select>
            </div>
    ...
    `).join(``),er(e))}function ee(){b=Array.from(document.querySelectorAll(`[data-vehicle-type-index]`)).map((e,t)=>({id:b[t]?.id??`vehicle-${crypto.randomUUID().slice(0,8)}`,label:e.querySelector(`[data-field="label"]`).value,labelEn:e.querySelector(`[data-field="labelEn"]`).value,icon:e.querySelector(`[data-field="icon"]`).value,basePrice:Number(e.querySelector(`[data-field="basePrice"]`).value)||0,perKmRate:Number(e.querySelector(`[data-field="perKmRate"]`).value)||0,floorCostExempt:b[t]?.floorCostExempt??!1,active:e.querySelector(`[data-field="active"]`).checked,sortOrder:t+1}))}document.getElementById(`vehicle-types-list`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-remove-vehicle-type]`);t&&(ee(),b.splice(Number(t.dataset.removeVehicleType),1),O())}),document.getElementById(`vehicle-type-add-btn`)?.addEventListener(`click`,()=>{ee(),b.push({id:`vehicle-${crypto.randomUUID().slice(0,8)}`,label:``,labelEn:``,icon:`van`,basePrice:0,perKmRate:0,floorCostExempt:!1,active:!0,sortOrder:b.length+1}),O()}),document.getElementById(`vehicle-type-save-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget,n=document.getElementById(`vehicle-types-saved-note`),r=document.getElementById(`vehicle-types-error`);r&&(r.hidden=!0);try{await tr(t,async()=>{ee(),await V(`vehicle_types`,b)}),n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`)}});function k(){let e=document.getElementById(`cities-list`);e.innerHTML=S.map((e,t)=>`
  ...
  `}function yr(){let e=document.getElementById(`my-wallet-summary-card`),t=document.getElementById(`my-wallet-tx-list`),n=document.getElementById(`my-wallet-load-more`),r=document.getElementById(`my-payout-requests-list`),i=0,a=0,o=[];async function s(){if(e)try{let t=await W(),n=t.bonus.type===`percent`?`${t.bonus.amount}٪ برآورد هر درخواست`:Y(t.bonus.amount);e.innerHTML=`
      ...
      `}catch(t){e.innerHTML=`<p class="error-text">${t instanceof Error?t.message:`خطایی پیش آمد.`}</p>`}}async function c(){if(t)try{let{transactions:e,total:r}=await yt(fr,i);o=[...o,...e],a=r,i+=e.length,t.innerHTML=o.length?o.map(_r).join(``):`<p class="settings-panel-hint">هنوز تراکنشی ثبت نشده.</p>`,n&&(n.hidden=i>=a)}catch(e){t.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}async function l(){if(r)try{let e=await bt();r.innerHTML=e.length?e.map(vr).join(``):`<p class="settings-panel-hint">هنوز درخواستی ثبت نکرده‌اید.</p>`}catch(e){r.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}n?.addEventListener(`click`,()=>void c()),document.getElementById(`payout-request-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`payout-request-amount`),n=document.getElementById(`payout-request-note`),r=document.getElementById(`payout-request-error`),i=document.getElementById(`payout-request-success`),a=document.getElementById(`payout-request-submit`);r.hidden=!0,i.hidden=!0;let o=Number(t.value);if(!Number.isFinite(o)||o<=0){r.hidden=!1,r.textContent=`مبلغ نامعتبر است.`;return}a.disabled=!0,(async()=>{try{await xt(o,n.value.trim()||void 0),i.hidden=!1,t.value=``,n.value=``,await Promise.all([s(),l()])}catch(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}finally{a.disabled=!1}})()}),s(),c(),l()}var br={pending:{next:`in_progress`,label:`شروع کار`},contacted:{next:`in_progress`,label:`شروع کار`},scheduled:{next:`in_progress`,label:`شروع کار`},in_progress:{next:`completed`,label:`پایان کار`}};function xr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Sr(e){let t=br[e.status],n=e.originLat!=null&&e.originLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.originLat},${e.originLng}`:null,r=e.destinationLat!=null&&e.destinationLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.destinationLat},${e.destinationLng}`:null;return`
    <div class="portal-card" data-portal-card-id="${e.id}">
      ...
      ${e.originNotes?`<p class="pipeline-note"><strong>یادداشت مبدأ:</strong> ${xr(e.originNotes)}</p>`:``}
      ${e.destinationNotes?`<p class="pipeline-note"><strong>یادداشت مقصد:</strong> ${xr(e.destinationNotes)}</p>`:``}
  ...
  `}var wr=new Set([`pending`,`contacted`,`scheduled`,`in_progress`]);function Tr(e){let t=document.getElementById(`portal-error`),n=document.getElementById(`portal-list`),r=document.getElementById(`portal-history-stats`),i=document.getElementById(`portal-history-list`),a=document.getElementById(`portal-refresh`),o=document.getElementById(`portal-logout-btn`);if(!t||!n||!r||!i||!a||!o)return;async function s(){t.hidden=!0;try{let e=await de(),t=e.filter(e=>wr.has(e.status)),a=e.filter(e=>!wr.has(e.status)),o=a.filter(e=>e.status===`completed`).length;n.innerHTML=t.length?t.map(Sr).join(``):`<p class="portal-empty">در حال حاضر کاری در جریان ندارید.</p>`,r.innerHTML=`
        <div class="stat-card">
      ...
      `,i.innerHTML=a.length?a.map(Sr).join(``):`<p class="portal-empty">هنوز کاری در تاریخچه‌ی شما ثبت نشده است.</p>`,c()}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function c(){n.querySelectorAll(`[data-advance-id]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=Number(e.dataset.advanceId),r=e.dataset.advanceStatus;e.disabled=!0;try{await fe(n,r),await s()}catch(n){t.hidden=!1,t.textContent=n instanceof Error?n.message:`به‌روزرسانی ناموفق بود.`,e.disabled=!1}})})}a.addEventListener(`click`,()=>void s()),o.addEventListener(`click`,e),s();let l=document.getElementById(`portal-jobs-container`),u=document.getElementById(`portal-wallet-container`),d=document.getElementById(`portal-wallet-mount`),f=document.getElementById(`portal-wallet-btn`),p=document.getElementById(`portal-back-to-jobs-btn`),m=!1;f?.addEventListener(`click`,()=>{!l||!u||!d||(l.hidden=!0,u.hidden=!1,m||(m=!0,d.innerHTML=gr(),yr()))}),p?.addEventListener(`click`,()=>{!l||!u||(u.hidden=!0,l.hidden=!1)})}function Er(e){return`
  ...
  `}function Or(e){let t=document.getElementById(`magazine-list-error`),n=document.getElementById(`magazine-table-body`),r=document.getElementById(`magazine-new-btn`);if(!t||!n||!r)return;async function i(){t.hidden=!0;try{let e=await pe();n.innerHTML=e.length?e.map(Er).join(``):`<tr><td colspan="5" class="staff-table-empty">هنوز مقاله‌ای ثبت نشده است.</td></tr>`,a()}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function a(){n.querySelectorAll(`[data-edit-article]`).forEach(t=>{t.addEventListener(`click`,()=>e(Number(t.dataset.editArticle)))}),n.querySelectorAll(`[data-delete-article]`).forEach(e=>{e.addEventListener(`click`,async()=>{if(window.confirm(`این مقاله برای همیشه حذف شود؟`)){e.disabled=!0;try{await _e(Number(e.dataset.deleteArticle)),await i()}catch(n){t.hidden=!1,t.textContent=n instanceof Error?n.message:`حذف ناموفق بود.`,e.disabled=!1}}})})}r.addEventListener(`click`,()=>e(null)),i()}var kr=[{value:`P`,label:`متن ساده`,labelEn:`Paragraph`},{value:`H1`,label:`سرتیتر ۱`,labelEn:`Heading 1`},{value:`H2`,label:`سرتیتر ۲`,labelEn:`Heading 2`},{value:`H3`,label:`سرتیتر ۳`,labelEn:`Heading 3`},{value:`H4`,label:`سرتیتر ۴`,labelEn:`Heading 4`},{value:`H5`,label:`سرتیتر ۵`,labelEn:`Heading 5`},{value:`H6`,label:`سرتیتر ۶`,labelEn:`Heading 6`},{value:`BLOCKQUOTE`,label:`نقل‌قول`,labelEn:`Quote`}];function Ar(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function jr(e,t,n){return`
    <div class="rte">
      <div class="rte-toolbar">
        <div class="rte-format-select-wrap">
          <select class="rte-format-select" data-rte-format title="${n===`rtl`?`قالب متن`:`Text format`}">
            ${kr.map(e=>`<option value="${e.value}">${n===`rtl`?e.label:e.labelEn}</option>`).join(``)}
          </select>
          <span class="rte-format-select-label" data-rte-format-label aria-hidden="true">${n===`rtl`?kr[0].label:kr[0].labelEn}</span>
        </div>
      ...
      <textarea data-field="${e}" hidden>${Ar(t)}</textarea>
      <div class="rte-content" contenteditable="true" dir="${n}" data-rte-content>${t||`<p><br></p>`}</div>
    </div>
  `}var Mr=new WeakMap;function Nr(e){return e?.closest(`.rte`)??null}function Pr(e){return e.querySelector(`[data-rte-content]`)}function Fr(e){let t=window.getSelection();t&&t.rangeCount>0&&e.contains(t.anchorNode)&&Mr.set(e,t.getRangeAt(0).cloneRange())}function Ir(e){let t=Mr.get(e);if(!t)return;let n=window.getSelection();n?.removeAllRanges(),n?.addRange(t)}function Lr(e){let t=Pr(e),n=e.querySelector(`textarea[data-field]`);t&&n&&(n.value=t.innerHTML===`<p><br></p>`?``:t.innerHTML)}function Rr(e){let t=window.getSelection();if(!t||!t.anchorNode)return null;let n=(t.anchorNode.nodeType===3?t.anchorNode.parentElement:t.anchorNode)?.closest(`a`)??null;return n&&e.contains(n)?n:null}function zr(e){e.addEventListener(`input`,e=>{let t=e.target.closest(`[data-rte-content]`);if(!t)return;let n=Nr(t);n&&Lr(n)}),e.addEventListener(`mouseup`,e=>{let t=e.target.closest(`[data-rte-content]`);t&&Fr(t)}),e.addEventListener(`keyup`,e=>{let t=e.target.closest(`[data-rte-content]`);t&&Fr(t)}),e.addEventListener(`mousedown`,e=>{let t=e.target;if(t.closest(`[data-rte-cmd], [data-rte-action]`)){e.preventDefault();return}let n=t.closest(`.rte-color-btn`);if(n){let e=Nr(n),t=e&&Pr(e);t&&Fr(t)}}),e.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-rte-cmd]`);if(n){let e=Nr(n),t=e&&Pr(e);if(!t)return;t.focus(),document.execCommand(n.dataset.rteCmd,!1,n.dataset.rteCmdValue??void 0),Lr(e);return}let r=t.closest(`[data-rte-link-cancel]`);if(r){Nr(r)?.querySelector(`[data-rte-link-popover]`)?.setAttribute(`hidden`,``);return}let i=t.closest(`[data-rte-link-apply]`);if(i){let e=Nr(i),t=e&&Pr(e),n=e?.querySelector(`[data-rte-link-popover]`);if(!e||!t||!n)return;let r=n.querySelector(`[data-rte-link-url]`),a=n.querySelector(`[data-rte-link-blank]`),o=n.querySelector(`[data-rte-link-nofollow]`),s=r.value.trim();if(n.hidden=!0,!s)return;t.focus(),Ir(t),document.execCommand(`createLink`,!1,s);let c=Rr(t)??Array.from(t.querySelectorAll(`a[href]`)).find(e=>e.getAttribute(`href`)===s);if(c){let e=[];a.checked?(c.setAttribute(`target`,`_blank`),e.push(`noopener`)):c.removeAttribute(`target`),o.checked&&e.push(`nofollow`),e.length?c.setAttribute(`rel`,e.join(` `)):c.removeAttribute(`rel`)}Lr(e);return}let a=t.closest(`[data-rte-action]`);if(a){let e=Nr(a),t=e&&Pr(e);if(!e||!t)return;if(a.dataset.rteAction===`link`){Fr(t);let n=e.querySelector(`[data-rte-link-popover]`),r=n.querySelector(`[data-rte-link-url]`),i=n.querySelector(`[data-rte-link-blank]`),a=n.querySelector(`[data-rte-link-nofollow]`),o=Rr(t);r.value=o?.getAttribute(`href`)??``,i.checked=o?.getAttribute(`target`)===`_blank`,a.checked=(o?.getAttribute(`rel`)??``).includes(`nofollow`),n.hidden=!1,r.focus()}else a.dataset.rteAction===`image`&&(Fr(t),e.querySelector(`[data-rte-image-input]`)?.click())}}),e.addEventListener(`change`,e=>{let t=e.target,n=t.closest(`[data-rte-format]`);if(n){let e=Nr(n),t=e&&Pr(e);if(!t)return;let r=e.querySelector(`[data-rte-format-label]`);r&&(r.textContent=n.options[n.selectedIndex]?.textContent??``),t.focus(),Ir(t),document.execCommand(`formatBlock`,!1,`<${n.value}>`),Lr(e);return}let r=t.closest(`[data-rte-color]`);if(r){let e=Nr(r),t=e&&Pr(e);if(!t)return;t.focus(),Ir(t),document.execCommand(r.dataset.rteColor,!1,r.value),Lr(e);return}let i=t.closest(`[data-rte-image-input]`);if(i){let e=Nr(i),t=e&&Pr(e),n=i.files?.[0];if(!e||!t||!n)return;we(n).then(n=>{t.focus(),Ir(t),document.execCommand(`insertImage`,!1,n),Lr(e)}).finally(()=>{i.value=``})}})}var Br={richtext:`متن`,heading:`سرتیتر`,paragraph:`پاراگراف`,list:`لیست`,image:`تصویر`,video:`ویدئو`};function Vr(e){return e===`richtext`?{type:`richtext`,html:``,htmlEn:``}:e===`heading`?{type:`heading`,text:``,textEn:``}:e===`paragraph`?{type:`paragraph`,text:``,textEn:``}:e===`list`?{type:`list`,items:[],itemsEn:[]}:e===`image`?{type:`image`,url:``,caption:``,captionEn:``}:{type:`video`,url:``}}function Hr(e,t){let n=`
    <div class="block-editor-head">
      <span class="block-editor-type">${Br[e.type]}</span>
      <div class="block-editor-actions">
  ...
  `,r=``;return e.type===`richtext`?r=`
      <div data-i18n="fa">${jr(`html`,e.html,`rtl`)}</div>
      <div data-i18n="en">${jr(`htmlEn`,e.htmlEn,`ltr`)}</div>
    `:e.type===`heading`?r=`
...
`))}</textarea>
    ...
    `:e.type===`video`&&(r=`
      <input type="url" data-field="url" dir="ltr" placeholder="https://www.youtube.com/watch?v=..." value="${Wr(e.url)}" />
...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function k(e){E=e,e?(x.src=e,x.hidden=!1,S.hidden=!0):(x.hidden=!0,S.hidden=!1)}function A(e){if(!e){i.hidden=!0,b.hidden=!0;return}i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,b.hidden=e!==`published`}async function j(){if(e===null){r.textContent=`مقاله جدید`,T=[Vr(`richtext`)],O(),A(null);return}try{let t=(await pe()).find(t=>t.id===e);if(!t){n.hidden=!1,n.textContent=`مقاله پیدا نشد.`;return}D=t,r.textContent=t.title||`ویرایش مقاله`,o.value=t.title,s.value=t.titleEn,c.value=t.excerpt,l.value=t.excerptEn,u.value=t.category,d.value=t.categoryEn,f.value=t.slug,p.value=t.metaTitle??``,m.value=t.metaDescription??``,k(t.coverImageUrl),T=t.content.length?t.content:[Vr(`richtext`)],O(),A(t.status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function te(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),category:u.value.trim(),categoryEn:d.value.trim(),coverImageUrl:E,content:ee(),metaTitle:p.value.trim(),metaDescription:m.value.trim(),slug:f.value.trim()||void 0}}async function M(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان مقاله الزامی است.`,null;let t=te();try{let n=D?await he(D.id,t):await me(t);return D=n,e=n.id,f.value=n.slug,r.textContent=n.title,A(n.status),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`,null}}h.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;T=ee();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?T.splice(n,1):r===`up`&&n>0?[T[n-1],T[n]]=[T[n],T[n-1]]:r===`down`&&n<T.length-1&&([T[n+1],T[n]]=[T[n],T[n+1]]),O()}),h.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),h.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await we(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود ناموفق بود.`}}),_.addEventListener(`click`,()=>{T=ee(),T.push(Vr(g.value)),O()}),w.addEventListener(`click`,()=>C.click()),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{k(await we(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود ناموفق بود.`}}),v.addEventListener(`click`,async()=>{v.disabled=!0,v.textContent=`در حال ذخیره...`,await M(),v.disabled=!1,v.textContent=`ذخیره پیش‌نویس`}),y.addEventListener(`click`,async()=>{y.disabled=!0;let e=await M();if(e)try{A((await ge(e.id,!0)).status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار ناموفق بود.`}y.disabled=!1}),b.addEventListener(`click`,async()=>{if(D){b.disabled=!0;try{A((await ge(D.id,!1)).status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`به‌روزرسانی ناموفق بود.`}b.disabled=!1}}),a.addEventListener(`click`,t),j()}var qr={richtext:`متن پیشرفته`,heading:`سرتیتر`,paragraph:`پاراگراف`,list:`لیست`,image:`تصویر`,video:`ویدئو`};function Jr(e){return e===`richtext`?{type:`richtext`,html:``,htmlEn:``}:e===`heading`?{type:`heading`,text:``,textEn:``}:e===`paragraph`?{type:`paragraph`,text:``,textEn:``}:e===`list`?{type:`list`,items:[],itemsEn:[]}:e===`image`?{type:`image`,url:``,caption:``,captionEn:``}:{type:`video`,url:``}}function Yr(e,t){let n=`
  ...
  `,r=``;return e.type===`richtext`?r=`
      ...
      <div data-i18n="en">${jr(`htmlEn`,e.htmlEn,`ltr`)}</div>
    `:e.type===`heading`?r=`
      <input type="text" data-field="text" data-i18n="fa" placeholder="متن سرتیتر (فارسی)" value="${Zr(e.text)}" />
      <input type="text" data-field="textEn" data-i18n="en" dir="ltr" placeholder="Heading text (English)" value="${Zr(e.textEn)}" />
    `:e.type===`paragraph`?r=`
      <textarea data-field="text" data-i18n="fa" placeholder="متن پاراگراف (فارسی)" rows="3">${Xr(e.text)}</textarea>
      <textarea data-field="textEn" data-i18n="en" dir="ltr" placeholder="Paragraph text (English)" rows="3">${Xr(e.textEn)}</textarea>
    `:e.type===`list`?r=`
      <textarea data-field="items" data-i18n="fa" placeholder="هر مورد در یک خط (فارسی)" rows="4">${Xr(e.items.join(`
`))}</textarea>
      <textarea data-field="itemsEn" data-i18n="en" dir="ltr" placeholder="One item per line (English)" rows="4">${Xr(e.itemsEn.join(`
`))}</textarea>
    `:e.type===`image`?r=`
      <div class="block-image-upload">
        ${e.url?`<img src="${Zr(e.url)}" alt="" class="block-image-preview" />`:`<span class="block-image-placeholder">تصویری انتخاب نشده</span>`}
        <input type="file" accept="image/*" data-image-upload hidden />
        <button type="button" class="btn btn-secondary btn-sm" data-image-upload-btn>انتخاب تصویر</button>
      </div>
      <input type="hidden" data-field="url" value="${Zr(e.url)}" />
      <input type="text" data-field="caption" data-i18n="fa" placeholder="زیرنویس تصویر (فارسی)" value="${Zr(e.caption)}" />
      <input type="text" data-field="captionEn" data-i18n="en" dir="ltr" placeholder="Image caption (English)" value="${Zr(e.captionEn)}" />
    `:e.type===`video`&&(r=`
      <input type="url" data-field="url" dir="ltr" placeholder="https://www.aparat.com/v/... یا https://www.youtube.com/watch?v=..." value="${Zr(e.url)}" />
    `),`<div class="block-editor" data-block-index="${t}" data-block-type="${e.type}">${n}<div class="block-editor-body">${r}</div></div>`}function Xr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Zr(e){return Xr(e).replace(/"/g,`&quot;`)}function Qr(){return`
    <div class="view-header">
      <div>
...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function te(e){ee=e,e?(x.src=e,x.hidden=!1,S.hidden=!0,T&&(T.hidden=!1)):(x.hidden=!0,S.hidden=!1,T&&(T.hidden=!0))}function M(e,t){if(!e){i.hidden=!0,v.hidden=!0,y&&(y.hidden=!0);return}if(i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,v.hidden=e!==`published`,y&&b){let e=t||u.value.trim();if(e){y.hidden=!1;let t=`https://behbarapp.ir/p/${encodeURIComponent(e)}`;b.href=t,b.textContent=`/p/${e}`}else y.hidden=!0}}async function N(){if(e===null){r.textContent=`برگه جدید`,O=[Jr(`richtext`)],A(),M(null),E&&(E.checked=!1),D&&(D.checked=!1);return}try{let t=await ye(e);if(!t){n.hidden=!1,n.textContent=`برگه پیدا نشد.`;return}k=t,r.textContent=t.title||`ویرایش برگه`,o.value=t.title,s.value=t.titleEn||``,c.value=t.excerpt||``,l.value=t.excerptEn||``,u.value=t.slug,d.value=t.metaTitle??``,f.value=t.metaDescription??``,E&&(E.checked=!!t.showInHeader),D&&(D.checked=!!t.showInFooter),te(t.coverImageUrl),O=t.content&&t.content.length?t.content:[Jr(`richtext`)],A(),M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی در بارگذاری برگه پیش آمد.`}}function P(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),coverImageUrl:ee,content:j(),metaTitle:d.value.trim()||void 0,metaDescription:f.value.trim()||void 0,slug:u.value.trim()||void 0,showInHeader:E?.checked??!1,showInFooter:D?.checked??!1}}async function F(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان برگه الزامی است.`,null;let t=P();try{let n=k?await xe(k.id,t):await be(t);return k=n,e=n.id,u.value=n.slug,r.textContent=n.title,M(n.status,n.slug),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره برگه ناموفق بود.`,null}}p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;O=j();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?O.splice(n,1):r===`up`&&n>0?[O[n-1],O[n]]=[O[n],O[n-1]]:r===`down`&&n<O.length-1&&([O[n+1],O[n]]=[O[n],O[n+1]]),A()}),p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),p.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await we(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر ناموفق بود.`}}),h.addEventListener(`click`,()=>{O=j(),O.push(Jr(m.value)),A()}),w.addEventListener(`click`,()=>C.click()),T&&T.addEventListener(`click`,()=>te(null)),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{te(await we(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر شاخص ناموفق بود.`}}),g.addEventListener(`click`,async()=>{g.disabled=!0,g.textContent=`در حال ذخیره...`,await F(),g.disabled=!1,g.textContent=`ذخیره پیش‌نویس`}),_.addEventListener(`click`,async()=>{_.disabled=!0;let e=await F();if(e)try{let t=await Se(e.id,!0);M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار برگه ناموفق بود.`}_.disabled=!1}),v.addEventListener(`click`,async()=>{if(k){v.disabled=!0;try{let e=await Se(k.id,!1);M(e.status,e.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`تغییر به پیش‌نویس ناموفق بود.`}v.disabled=!1}}),a.addEventListener(`click`,t),N()}function ei(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function ti(e){return Array.from({length:5},(t,n)=>n<e?`★`:`☆`).join(``)}function ni(e){return`
  ...
  `}function pi(){let e=document.getElementById(`chat-error`),t=document.getElementById(`chat-filter-tabs`),n=document.getElementById(`chat-conversation-list`),r=document.getElementById(`chat-thread-empty`),i=document.getElementById(`chat-thread-active`),a=document.getElementById(`chat-thread-name`),o=document.getElementById(`chat-thread-phone`),s=document.getElementById(`chat-assign-select`),c=document.getElementById(`chat-thread-status-btn`),l=document.getElementById(`chat-thread-archive-btn`),d=document.getElementById(`chat-thread-delete-btn`),f=document.getElementById(`chat-responders-row`),p=document.getElementById(`chat-info-panel`),m=document.getElementById(`chat-request-card`),h=document.getElementById(`chat-thread-messages`),g=document.getElementById(`chat-thread-form`),v=document.getElementById(`chat-thread-input`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!d||!f||!p||!m||!h||!g||!v)return;let y=_(),b=[],x=[],S=null,C=`all`;function w(){if(C===`archived`)return b.filter(e=>e.archivedAt!==null);let e=b.filter(e=>e.archivedAt===null);return C===`mine`?e.filter(e=>e.assignedStaffId===y?.id):C===`unassigned`?e.filter(e=>e.assignedStaffId===null):e}function T(){let t=w();n.innerHTML=t.length?t.map(e=>`
        <div class="chat-conversation-item ${e.id===S?`is-active`:``}" data-conversation-id="${e.id}" role="button" tabindex="0">
          <div class="chat-conversation-item-top">
            <span>${ci(e.customerName||`مهمان`)}</span>
            <span class="chat-conversation-item-top-end">
              <span class="chat-conversation-time">${nn(e.lastMessageAt)}</span>
          ...
          <p class="chat-conversation-preview">${ci(li(e))}</p>
    ...
    `).join(``),h.scrollTop=h.scrollHeight,k(e)}function k(e){let t=[],n=new Set;for(let r of e)r.sender!==`staff`||!r.staffName||n.has(r.staffName)||(n.add(r.staffName),t.push({name:r.staffName,avatar:r.staffAvatar}));if(!t.length){f.hidden=!0,f.innerHTML=``;return}f.hidden=!1,f.innerHTML=`<span class="chat-responders-label">پاسخ‌دهندگان:</span>`+t.map(e=>`<span class="chat-responder-chip">${di(e.name,e.avatar,`sm`)}<span>${ci(e.name)}</span></span>`).join(``)}async function A(){if(S!==null)try{ee(await Le(S))}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function j(e){if(!e.length){m.innerHTML=`<h3>درخواست‌های ثبت‌شده</h3><p class="chat-request-empty">درخواستی برای این شماره ثبت نشده است.</p>`;return}let[t,...n]=e;m.innerHTML=`
      ...
      <div class="chat-request-latest">
        ...
        <div class="chat-request-row"><span>خدمت</span><span>${ci(t.serviceLabel)}</span></div>
        <div class="chat-request-row"><span>مسیر</span><span>${ci(t.originCity)} ← ${ci(t.destinationCity)}</span></div>
        <div class="chat-request-row"><span>زمان</span><span>${ci(t.scheduledDate)} — ${J(t.scheduledTime)}</span></div>
        <div class="chat-request-row"><span>وضعیت</span><span>${ci(Ht[t.status]??t.status)}</span></div>
  ...
  `}function vi(){Qn().then(()=>er(document.getElementById(`view-container`)??document.body));let e=document.getElementById(`stories-list-error`),t=document.getElementById(`stories-list`),n=document.getElementById(`story-new-btn`),r=document.getElementById(`story-form-card`),i=document.getElementById(`story-form-title`),a=document.getElementById(`story-form-error`),o=document.getElementById(`story-cancel-btn`),s=document.getElementById(`story-save-btn`);if(!e||!t||!n||!r||!i||!a||!o||!s)return;let c=[];function l(e){a.hidden=!0,i.textContent=e?`ویرایش استوری`:`استوری جدید`,document.getElementById(`story-form-id`).value=e?String(e.id):``,document.getElementById(`story-image`).value=e?.imageUrl??``,document.getElementById(`story-caption`).value=e?.caption??``,document.getElementById(`story-caption-en`).value=e?.captionEn??``,document.getElementById(`story-link`).value=e?.linkUrl??``,document.getElementById(`story-sort`).value=String(e?.sortOrder??0),r.hidden=!1,r.scrollIntoView({behavior:`smooth`,block:`center`})}function u(){r.hidden=!0}async function d(){e.hidden=!0;try{c=await qe(),t.innerHTML=c.length?c.map(hi).join(``):`<p class="pipeline-empty">هنوز استوری‌ای ثبت نشده است.</p>`,f()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function f(){t.querySelectorAll(`[data-edit-story]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=c.find(t=>t.id===Number(e.dataset.editStory));t&&l(t)})}),t.querySelectorAll(`[data-delete-story]`).forEach(t=>{t.addEventListener(`click`,async()=>{if(window.confirm(`این استوری برای همیشه حذف شود؟`)){t.disabled=!0;try{await Ye(Number(t.dataset.deleteStory)),await d()}catch(n){e.hidden=!1,e.textContent=n instanceof Error?n.message:`حذف ناموفق بود.`,t.disabled=!1}}})})}n.addEventListener(`click`,()=>l(null)),o.addEventListener(`click`,u),s.addEventListener(`click`,async()=>{a.hidden=!0;let e=document.getElementById(`story-form-id`).value,t={imageUrl:document.getElementById(`story-image`).value.trim(),caption:document.getElementById(`story-caption`).value.trim(),captionEn:document.getElementById(`story-caption-en`).value.trim(),linkUrl:document.getElementById(`story-link`).value.trim()||null,sortOrder:Number(document.getElementById(`story-sort`).value)||0};if(!t.imageUrl){a.hidden=!1,a.textContent=`لینک تصویر الزامی است.`;return}s.disabled=!0;try{e?await Je(Number(e),t):await H(t),u(),await d()}catch(e){a.hidden=!1,a.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`}finally{s.disabled=!1}}),d()}var yi=[{id:`driver`,title:`راننده با خودرو`,titleEn:`Driver`,description:`رانندگان وانت، نیسان، خاور و کامیون با خودرو شخصی`,requiresVehicle:!0,active:!0},{id:`worker`,title:`کارگر اسباب‌کشی و باربری`,titleEn:`Moving Specialist`,description:`نیروی متخصص بسته‌بندی، چیدمان و حمل بارهای سنگین`,requiresVehicle:!1,active:!0},{id:`support`,title:`کارشناس پشتیبانی و هماهنگی`,titleEn:`Customer Support`,description:`پاسخگویی به تماس‌ها و پیگیری امور مشتریان و رانندگان`,requiresVehicle:!1,active:!0},{id:`other`,title:`سایر زمینه‌های همکاری`,titleEn:`Other`,description:`تخصص‌های دیگر لجستیک، اداری و بازاریابی`,requiresVehicle:!1,active:!0}],bi=[{id:`new`,label:`جدید`},{id:`reviewed`,label:`بررسی‌شده`},{id:`contacted`,label:`تماس گرفته شده`},{id:`hired`,label:`استخدام شده`},{id:`rejected`,label:`رد شده`}],xi=Object.fromEntries(bi.map(e=>[e.id,e.label]));function Si(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Ci(e){return bi.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${t.label}</option>`).join(``)}function wi(e){return`
    <div class="testimonial-row" data-application-row="${e.id}">
      <div class="testimonial-row-avatar"><span class="icon">${u.briefcase}</span></div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${Si(e.fullName)}</strong>
          <span class="article-status-badge article-status-${e.status}">${xi[e.status]??e.status}</span>
        </div>
        <div class="job-application-meta">
          <span>${Si(e.positionLabel)}</span>
          <a href="tel:${e.phone}" dir="ltr">${e.phone}</a>
          ${e.city?`<span>${Si(e.city)}</span>`:``}
          ${e.hasVehicle===!0?`<span>دارای وسیله نقلیه${e.vehicleType?` (${Si(e.vehicleType)})`:``}</span>`:``}
          ${e.hasVehicle===!1?`<span>بدون وسیله نقلیه</span>`:``}
          <span>${new Date(e.createdAt).toLocaleDateString(`fa-IR`)}</span>
        </div>
        ${e.message?`<p class="testimonial-row-text">${Si(e.message)}</p>`:``}
      </div>
      <div class="staff-table-actions">
        <select class="pipeline-status-select" data-status-select-id="${e.id}">
          ${Ci(e.status)}
  ...
  `}function Ti(e,t){return`
    <div class="testimonial-row" data-position-row="${Si(e.id)}">
      <div class="testimonial-row-avatar"><span class="icon">${u.briefcase}</span></div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
        ...
        <div class="job-application-meta">
          ${e.titleEn?`<span dir="ltr">${Si(e.titleEn)}</span>`:``}
          <span>${e.requiresVehicle?`نیاز به وسیله نقلیه دارد`:`بدون نیاز به وسیله نقلیه`}</span>
        </div>
        ${e.description?`<p class="testimonial-row-text">${Si(e.description)}</p>`:``}
      </div>
      <div class="staff-table-actions">
  ...
  `}function ji(){let e=document.getElementById(`activity-log-list`),t=document.getElementById(`activity-log-error`),n=document.getElementById(`activity-log-refresh`);if(!e||!t||!n)return;async function r(){t.hidden=!0;try{let t=await z();e.innerHTML=t.length?t.map(ki).join(``):`<p class="portal-empty">هنوز فعالیتی ثبت نشده است.</p>`}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}n.addEventListener(`click`,()=>void r()),r()}function Mi(){return`
    <div class="editor-sidebar-card">
      <h3>به‌روزرسانی</h3>
  ...
  `}var Ni=`sudo bash install.sh`;function Pi(){return`
  ...
  `}function Fi(){return`
    <div class="update-manual-guide">
      ...
      <div class="update-manual-step">
        ...
        <p class="update-manual-cmd-plain" dir="ltr">${Ni}</p>
      </div>
  ...
  `}function Ii(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Li(){let e=document.getElementById(`update-panel-current`),t=document.getElementById(`update-panel-current-changelog`),n=document.getElementById(`update-panel-result`),r=document.getElementById(`update-scan-btn`),i=document.getElementById(`update-panel-manual-guide`);!e||!t||!n||!r||!i||(vt().then(n=>{e.textContent=`نسخه‌ی فعلی: ${n.current}`,n.currentChangelog.length&&(t.innerHTML=`
      ...
      `,document.getElementById(`update-panel-backup-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.textContent=`در حال دانلود...`;try{await st()}catch(e){Q(e instanceof Error?e.message:`دانلود پشتیبان ناموفق بود.`,`error`)}finally{t.disabled=!1,t.textContent=`دانلود نسخه پشتیبان`}}),document.getElementById(`update-panel-apply-btn`)?.addEventListener(`click`,async e=>{if(!window.confirm(`به‌روزرسانی سرویس را برای حدود یک دقیقه مختل می‌کند. آیا از پشتیبان‌گیری مطمئن هستید و می‌خواهید ادامه دهید؟`))return;let t=e.currentTarget,r=document.getElementById(`update-panel-error`);t.disabled=!0,t.textContent=`در حال اعمال...`;try{await U(),n.innerHTML=`
          ...
          `}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`به‌روزرسانی ناموفق بود.`),t.disabled=!1,t.textContent=`اعمال به‌روزرسانی`}})}catch(e){Q(e instanceof Error?e.message:`بررسی به‌روزرسانی ناموفق بود.`,`error`)}finally{r.disabled=!1,r.textContent=t}}))}var Ri={text:`متن ساده`,steps:`مراحل شماره‌دار`,accordion:`آکاردئونی (پرسش و پاسخ)`,grid:`شبکه‌ی آیکون/عنوان`,slider:`اسلایدر`,quote:`نقل‌قول`,testimonials:`نظرات مشتریان (خودکار)`,stats:`آمار و ارقام`},zi=Object.keys(Ri),Bi=[{id:`hero`,type:`hero`,visible:!0}],Vi={about:{label:`صفحه درباره ما`,livePath:`/about`,hint:`ویرایش مشخصات، تاریخچه، اهداف و بخش‌های معرفی بهبار در نشانی /about`},terms:{label:`صفحه قوانین و مقررات`,livePath:`/terms`,hint:`مدیریت شرایط، ضوابط، تعهدات و مقررات استفاده از سامانه بهبار در نشانی /terms`},privacy:{label:`صفحه حریم خصوصی`,livePath:`/privacy`,hint:`تنظیم سیاست‌های حفاظت از داده‌ها و امنیت حریم خصوصی کاربران بهبار در نشانی /privacy`}};function Hi(e,t){let n=[...e];return t?.length&&n.push(...t.map(e=>`- ${e}`)),n.join(`
`)}function Ui(e){let t=e.split(`
`).map(e=>e.trim()).filter(Boolean),n=t.filter(e=>!e.startsWith(`- `)),r=t.filter(e=>e.startsWith(`- `)).map(e=>e.slice(2).trim());return{paragraphs:n,list:r.length?r:void 0}}function Wi(e){let t=`https://behbarapp.ir/p/${encodeURIComponent(e.slug)}`;return`
    ...
    <div class="settings-panel" data-page-panel="home">
      ...
      <div class="settings-panel-footer" style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
        <select id="homepage-section-add-type" style="height: 40px; padding: 0 12px; border-radius: var(--radius-md); border: 1px solid var(--border); background: var(--background);">
          ${zi.map(e=>`<option value="${e}">${Ri[e]}</option>`).join(``)}
        </select>
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Vi.about.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Vi.terms.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Vi.privacy.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
  ...
  `}function Ki(e){let t=document.getElementById(`pages-global-error`),n=document.getElementById(`pages-global-saved`);function r(){n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}function i(e){t&&(t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی رخ داد.`,window.scrollTo({top:0,behavior:`smooth`}))}Qn().then(()=>er(document.body));let a=document.querySelectorAll(`[data-page-nav-tab]`),o=document.querySelectorAll(`[data-page-panel]`);a.forEach(e=>{e.addEventListener(`click`,()=>{a.forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`);let t=e.dataset.pageNavTab;o.forEach(e=>{e.hidden=e.dataset.pagePanel!==t})})}),document.getElementById(`pages-top-add-btn`)?.addEventListener(`click`,()=>e(null)),document.getElementById(`page-custom-new-btn`)?.addEventListener(`click`,()=>e(null));let s={},c=[],l=!0,d={};function f(e,t,n){return`
    ...
    `}function p(e,t,n){let r=e.type===`hero`,i=e.layout??`text`,a=r?`هدر و بنر اصلی`:Ri[i],o=!r&&i!==`text`&&i!==`testimonials`;return`
          ...
          <div class="block-editor-body">
            <div class="form-field">
              ...
              <select data-field="layout">
                ${zi.map(e=>`<option value="${e}" ${e===i?`selected`:``}>${Ri[e]}</option>`).join(``)}
              </select>
            </div>
        ...
        ${n.sections.map((t,n)=>`
          <div class="block-editor" data-legal-section="${n}">
            ...
            <div class="block-editor-body">
              ...
              <textarea data-field="body" data-i18n="fa" rows="4" placeholder="هر پاراگراف در یک خط؛ برای مورد لیستی خط را با «- » شروع کنید">${Hi(t.paragraphs,t.list)}</textarea>
              <textarea data-field="bodyEn" data-i18n="en" dir="ltr" rows="4" placeholder="One paragraph per line; prefix list items with '- '">${Hi(t.paragraphsEn,t.listEn)}</textarea>
            </div>
          </div>
        `).join(``)}
      </div>
    ...
    <div class="settings-panel" data-settings-panel="theme" ${n(`theme`)}>
      ...
      ${Array.from(new Set(Yi.map(e=>e.group))).map(e=>`
        <div class="editor-sidebar-card">
          <div class="card-header-action">
            <h3>${e}</h3>
            <button type="button" class="btn btn-primary btn-sm" data-save-setting="theme">ذخیره</button>
  ...
  `}function ea(e,t){let n=document.getElementById(`settings-error`),r=document.getElementById(`settings-saved-note`);if(!n||!r)return;if(Ki(t=>e?.(`page-editor`,t)),t){let e=document.querySelector(`[data-settings-tab="${t}"]`);e&&(document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(e=>{e.hidden=e.dataset.settingsPanel!==t}))}let i=_();Qn().then(()=>er(document.body));function a(){r.hidden=!1,window.setTimeout(()=>r.hidden=!0,2500)}function o(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}document.querySelectorAll(`[data-settings-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(t=>{t.hidden=t.dataset.settingsPanel!==e.dataset.settingsTab})})}),document.querySelectorAll(`[data-backup-subtab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-backup-subtab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-backup-subpanel]`).forEach(t=>{t.hidden=t.dataset.backupSubpanel!==e.dataset.backupSubtab})})});let s={},c={};function l(e){let t=document.getElementById(`settings-${e}-preview`),n=document.getElementById(`settings-${e}-url`)?.value.trim();t&&(t.innerHTML=n?`<img src="${n}" alt="" />`:``)}function u(e){let t=document.getElementById(`settings-${e}-url`),n=document.getElementById(`settings-${e}-upload-btn`),r=document.getElementById(`settings-${e}-file-input`),i=document.getElementById(`settings-branding-upload-error`);!t||!n||!r||(t.addEventListener(`input`,()=>l(e)),n.addEventListener(`click`,()=>r.click()),r.addEventListener(`change`,async()=>{let a=r.files?.[0];if(!a)return;i&&(i.hidden=!0),n.disabled=!0;let o=n.textContent;n.textContent=`در حال آپلود...`;try{let n=await we(a);t.value=n,l(e)}catch(e){i&&(i.hidden=!1,i.textContent=e instanceof Error?e.message:`آپلود عکس ناموفق بود.`)}finally{r.value=``,n.disabled=!1,n.textContent=o}}))}u(`logo`),u(`favicon`);function d(){let e=s.site_name??{fa:``,en:``},t=e.fa?.trim()||``,n=e.en?.trim()||``,r=document.getElementById(`settings-site-name-fa`),i=document.getElementById(`settings-site-name-en`);r.value=t,i.value=n,document.getElementById(`settings-language-mode`).value=s.language_mode??`both`;let a=s.branding??{};document.getElementById(`settings-logo-url`).value=a.logoUrl??``,document.getElementById(`settings-favicon-url`).value=a.faviconUrl??``,l(`logo`),l(`favicon`);let o=s.footer??{seoParagraphs:[],copyright:{fa:``,en:``}},c=document.getElementById(`settings-footer-paragraphs`);c.innerHTML=o.seoParagraphs.map((e,t)=>`
        ...
        </div>`).join(``),er(c);let u=t?`همه حقوق برای ${t} محفوظ است.`:`همه حقوق محفوظ است.`,d=n?`All rights reserved for ${n}.`:`All rights reserved.`,f=document.getElementById(`settings-copyright-fa`),p=document.getElementById(`settings-copyright-en`);f.placeholder=u,p.placeholder=d;let m=o.copyright?.fa?.trim()??``,h=o.copyright?.en?.trim()??``;t&&t!==`بهبار`&&m&&m.includes(`بهبار`)&&(m=m.replace(/بهبار/g,t)),m||=u,n&&n!==`Behbar`&&h&&h.includes(`Behbar`)&&(h=h.replace(/Behbar/g,n)),h||=d,f.value=m,p.value=h,r.oninput=()=>{let e=r.value.trim(),t=e?`همه حقوق برای ${e} محفوظ است.`:`همه حقوق محفوظ است.`;f.placeholder=t;let n=f.value.trim();(!n||n.startsWith(`همه حقوق برای `)||n===`همه حقوق محفوظ است.`)&&(f.value=t)},i.oninput=()=>{let e=i.value.trim(),t=e?`All rights reserved for ${e}.`:`All rights reserved.`;p.placeholder=t;let n=p.value.trim();(!n||n.startsWith(`All rights reserved for `)||n===`All rights reserved.`)&&(p.value=t)};let g=s.hero_slogan??{};document.getElementById(`settings-hero-slogan-enabled`).checked=g.enabled!==!1,document.getElementById(`settings-hero-slogan-headline-fa`).value=g.headline?.fa??``,document.getElementById(`settings-hero-slogan-headline-en`).value=g.headline?.en??``,document.getElementById(`settings-hero-slogan-subtitle-fa`).value=g.subtitle?.fa??``,document.getElementById(`settings-hero-slogan-subtitle-en`).value=g.subtitle?.en??``}document.querySelectorAll(`[data-save-setting="site_name"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await tr(e,async()=>{let e=document.getElementById(`settings-site-name-fa`).value,t=document.getElementById(`settings-site-name-en`).value;await V(`site_name`,{fa:e,en:t}),s.site_name={fa:e,en:t}}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="language_mode"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await tr(e,async()=>{let e=document.getElementById(`settings-language-mode`).value;await V(`language_mode`,e),s.language_mode=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="branding"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await tr(e,async()=>{let e={logoUrl:document.getElementById(`settings-logo-url`).value.trim(),faviconUrl:document.getElementById(`settings-favicon-url`).value.trim()};await V(`branding`,e),s.branding=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="footer"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await tr(e,async()=>{let e={seoParagraphs:Array.from(document.querySelectorAll(`[data-footer-paragraph]`)).map(e=>({fa:e.querySelector(`[data-field="fa"]`).value,en:e.querySelector(`[data-field="en"]`).value})),copyright:{fa:document.getElementById(`settings-copyright-fa`).value,en:document.getElementById(`settings-copyright-en`).value}};await V(`footer`,e),s.footer=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="hero_slogan"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await tr(e,async()=>{let e={enabled:document.getElementById(`settings-hero-slogan-enabled`).checked,headline:{fa:document.getElementById(`settings-hero-slogan-headline-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-headline-en`).value.trim()},subtitle:{fa:document.getElementById(`settings-hero-slogan-subtitle-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-subtitle-en`).value.trim()}};await V(`hero_slogan`,e),s.hero_slogan=e}),a()}catch(e){o(e)}})});let f=[],p={enabled:!1,links:[]},m={enabled:!1,badges:[]};function h(){let e=document.getElementById(`social-links-list`);e&&(e.innerHTML=f.map((e,t)=>`
      <div class="settings-form-grid" data-social-link-index="${t}" style="grid-template-columns: 140px 140px 1fr 1fr auto; align-items: end; gap: 8px;">
        <div class="form-field">
          ...
          <select data-field="platform">
            ${qi.map(t=>`<option value="${t.value}" ${t.value===e.platform?`selected`:``}>${t.label}</option>`).join(``)}
          </select>
        </div>
          ...
          <div class="settings-form-grid">
            <div class="form-field">
              ...
              <select id="setup-origin-province">
                ...
                ${la.map(e=>`<option value="${e.name}">${e.name}</option>`).join(``)}
              </select>
            </div>
            <div class="form-field">
  ...
  `}function ha(e,t){let n=document.querySelector(`.setup-wizard-card`),r=document.getElementById(`setup-progress-fill`),i=document.getElementById(`setup-progress-text`),a=document.getElementById(`setup-back`),o=document.getElementById(`setup-next`),s=document.getElementById(`setup-skip-all`),c=document.getElementById(`setup-general-error`),l=document.getElementById(`setup-vehicle-list`);if(!n||!r||!i||!a||!o||!s||!c||!l)return;let d=0,f={},p=ua;function m(){l.innerHTML=p.map((e,t)=>`
    ...
    <div class="testimonial-row" data-audit-edit="${e.id}" role="button" tabindex="0">
      ...
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${ga(e.title)}</strong>
          <span class="article-status-badge article-status-draft">فاقد ${t.join(` و `)}</span>
        </div>
        <div class="job-application-meta"><span dir="ltr">/magazine/${ga(e.slug)}</span></div>
      </div>
    </div>
  `}function va(){return`
    <div class="view-header">
  ...
  `}function ya(e=()=>{}){let t=document.getElementById(`seo-error`),n=document.getElementById(`seo-audit-list`);if(!t||!n)return;let r=``;function i(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`,Q(e instanceof Error?e.message:`ذخیره ناموفق بود.`,`error`)}async function a(){let e=(await De()).seo??{};document.getElementById(`seo-search-console`).value=e.googleSiteVerification??``,document.getElementById(`seo-ga-id`).value=e.googleAnalyticsId??``,r=e.defaultOgImage??``}async function o(){let t=(await pe()).filter(e=>!e.metaTitle||!e.metaDescription);n.innerHTML=t.length?t.map(_a).join(``):`<p class="pipeline-empty">همه‌ی مقاله‌ها عنوان و توضیحات سئو دارند.</p>`,n.querySelectorAll(`[data-audit-edit]`).forEach(t=>{t.addEventListener(`click`,()=>e(Number(t.dataset.auditEdit)))})}function s(){return{googleSiteVerification:document.getElementById(`seo-search-console`).value.trim(),googleAnalyticsId:document.getElementById(`seo-ga-id`).value.trim(),defaultOgImage:r}}function c(e){document.getElementById(e)?.addEventListener(`click`,async e=>{let n=e.currentTarget;t.hidden=!0;try{await tr(n,async()=>{await V(`seo`,s())}),Q(`تنظیمات سئو ذخیره شد.`)}catch(e){i(e)}})}c(`seo-search-console-save-btn`),c(`seo-ga-save-btn`),Promise.all([a(),o()]).catch(i)}function ba(){return`
    <div class="settings-view">
      <div class="settings-panel">
  ...
  `}function Ta(e){return`
    <tr>
      <td>${Sa(e.fullName)}${e.isActive?``:` <span class="settings-panel-hint">(غیرفعال)</span>`}</td>
      <td>${Sa(e.roleLabel)}</td>
      <td><strong>${Y(e.balance)}</strong></td>
      <td>
        <div class="staff-table-actions">
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-view-tx="${e.staffId}" data-wallet-staff-name="${Sa(e.fullName)}">تراکنش‌ها</button>
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-adjust="${e.staffId}">ثبت اصلاحیه</button>
        </div>
      </td>
    </tr>
  `}function Ea(e){let t=e.direction===`credit`?`+`:`−`,n=e.direction===`credit`?`var(--success)`:`var(--danger)`;return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${Ca[e.type]??e.type}</span>
        <span class="activity-log-target">${Sa(e.description)}</span>
      </div>
  ...
  `}function Da(e){return`
    <div class="editor-sidebar-card">
      <div class="plugin-card-head">
        <h3>${Sa(e.staffName)} — ${Y(e.amount)}</h3>
      </div>
      ${e.staffNote?`<p class="settings-panel-hint">${Sa(e.staffNote)}</p>`:``}
      <div class="staff-table-actions">
  ...
  `}function Oa(e){return`
    <tr data-role-rate-row="${e.id}">
      <td>${Sa(e.label)}${e.isSystem?` <span class="settings-panel-hint">(سیستمی)</span>`:``}</td>
  ...
  `}function La(){let e=document.querySelectorAll(`[data-finance-tab]`),t=document.getElementById(`finance-tab-overview`),n=document.getElementById(`finance-tab-documents`);e.forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.financeTab;e.forEach(e=>e.classList.remove(`active`)),r.classList.add(`active`),i===`overview`?(t&&(t.style.display=`block`),n&&(n.style.display=`none`)):i===`documents`&&(t&&(t.style.display=`none`),n&&(n.style.display=`block`))})});let r=[],i=ja();async function a(){try{let[e]=await Promise.allSettled([P(),ne()]);e.status===`fulfilled`&&(r=e.value),i=ja(),s(),c()}catch(e){Q(e instanceof Error?e.message:`خطا در بارگذاری داده‌های مالی`,`error`)}}function o(){let e=[];for(let t of r){let n=`pending`;n=t.status===`completed`?`settled`:t.status===`canceled`?`canceled`:`pending`,e.push({id:t.id,isCustom:!1,trackingCode:t.trackingCode||`BB-${t.id}`,customerName:t.customerName||`مشتری سامانه`,phone:t.phone||`—`,serviceLabel:t.serviceLabel||`حمل بار`,originCity:t.originCity||`—`,destinationCity:t.destinationCity||`—`,amount:t.estimateAvg||t.estimateMin||0,settlementStatus:n,createdAt:t.createdAt||new Date().toISOString(),notes:t.originNotes||``})}for(let t of i)e.push({id:t.id,isCustom:!0,trackingCode:t.trackingCode,customerName:t.customerName,phone:t.phone,serviceLabel:t.serviceLabel,originCity:t.originCity,destinationCity:t.destinationCity,amount:t.amount,settlementStatus:t.settlementStatus,createdAt:t.createdAt,notes:t.notes});return e.sort((e,t)=>new Date(t.createdAt).getTime()-new Date(e.createdAt).getTime()),e}function s(){let e=o(),t=0,n=0,r=0,i=0,a={},s={settled:0,pending:0,credit:0,canceled:0};for(let o of e){let e=Number(o.amount)||0;t+=e,o.settlementStatus===`settled`?(n+=e,s.settled++):o.settlementStatus===`pending`?(r+=e,s.pending++):o.settlementStatus===`credit`?(i+=e,s.credit++):o.settlementStatus===`canceled`&&s.canceled++;let c=o.serviceLabel||`سایر`;a[c]||(a[c]={count:0,total:0}),a[c].count++,a[c].total+=e}let c=Math.max(0,n-i),l=document.getElementById(`kpi-gross-turnover`);l&&(l.textContent=Pa(t));let u=document.getElementById(`kpi-realized-revenue`);u&&(u.textContent=Pa(n));let d=document.getElementById(`kpi-pending-settlements`);d&&(d.textContent=Pa(r));let f=document.getElementById(`kpi-total-expenses`);f&&(f.textContent=Pa(i));let p=document.getElementById(`kpi-estimated-profit`);p&&(p.textContent=Pa(c));let m=document.getElementById(`kpi-docs-count`);m&&(m.textContent=Na(e.length));let h=document.getElementById(`finance-services-breakdown`);if(h){let e=Object.entries(a).sort((e,t)=>t[1].total-e[1].total);h.innerHTML=e.length?e.map(([e,n])=>{let r=t>0?Math.round(n.total/t*100):0;return`
        ...
        <div style="display: flex; flex-direction: column; gap: 10px;">
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-settled">تسویه‌شده: ${Na(s.settled)} سند</span>
              <span>%${Na(Math.round(s.settled/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
          ...
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-pending">در انتظار تسویه: ${Na(s.pending)} سند</span>
              <span>%${Na(Math.round(s.pending/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
          ...
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-credit">بستانکار / هزینه‌ها: ${Na(s.credit)} سند</span>
              <span>%${Na(Math.round(s.credit/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
      ...
      `;return}e.innerHTML=a.map(e=>{let t=Fa[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`},n=e.originCity&&e.destinationCity?`${e.originCity} ➔ ${e.destinationCity}`:`—`,r=e.createdAt?e.createdAt.slice(0,10):`—`;return`
          <tr data-doc-id="${e.id}">
            <td style="font-weight: 700; font-family: monospace; direction: ltr; text-align: right;">${e.trackingCode}</td>
            <td style="white-space: nowrap;">${Na(r)}</td>
            <td style="font-weight: 600;">${e.customerName}</td>
            <td style="direction: ltr; text-align: right;">${Na(e.phone)}</td>
            <td>${e.serviceLabel}</td>
            <td style="font-size: 0.8rem; color: var(--color-text-muted);">${n}</td>
            <td style="font-weight: 700; color: #059669;">${Pa(e.amount)}</td>
            <td>
        ...
        `}).join(``),e.querySelectorAll(`.btn-view-invoice`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.docCode,n=a.find(e=>e.trackingCode===t);n&&l(n)})}),e.querySelectorAll(`.btn-toggle-settlement`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.docId;if(e.dataset.isCustom===`true`){let e=i.find(e=>String(e.id)===t);e&&(e.settlementStatus=e.settlementStatus===`settled`?`pending`:`settled`,Ma(i),Q(`وضعیت تسویه سند دستی به‌روزرسانی شد.`,`success`),s(),c())}else{let e=r.find(e=>String(e.id)===t);if(e){let t=e.status===`completed`?`in_progress`:`completed`;try{await F(e.id,t),e.status=t,Q(`وضعیت تسویه سفارش به‌روزرسانی شد.`,`success`),s(),c()}catch{Q(`خطا در به‌روزرسانی وضعیت تسویه`,`error`)}}}})})}function l(e){let t=document.getElementById(`finance-modal-container`);if(!t)return;let n=e.createdAt?e.createdAt.slice(0,10):new Date().toISOString().slice(0,10),r=Fa[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`},i=cn({...e,estimateAvg:e.amount||e.estimateAvg||1e6});t.innerHTML=`
            ...
            <div class="behbar-invoice-sheet" id="behbar-printable-invoice">
              <div class="behbar-invoice-head">
                ...
                <div class="behbar-invoice-meta">
                  ...
                  <div><strong>تاریخ صدور:</strong> ${Na(n)}</div>
              ...
              <div class="behbar-invoice-parties">
                ...
                <div>
                  ...
                  <div style="color: #6b7280; font-size: 0.78rem;">شماره تماس: ${Na(e.phone)}</div>
                </div>
              </div>
              ...
              <table class="behbar-invoice-table">
                ...
                <tbody>
                  ${i.items.map((e,t)=>`
                    <tr>
                      <td style="text-align: center;">${Na(t+1)}</td>
                      <td>
                        <strong style="display: block; color: #1f2937; font-size: 0.92rem;">${e.title}</strong>
                        <span style="display: block; color: #6b7280; font-size: 0.78rem; margin-top: 2px;">${e.description}</span>
                      </td>
                      <td style="text-align: left; font-weight: 700; color: ${e.amount===0?`#9ca3af`:`#059669`}; white-space: nowrap;">
                        ${e.amount===0?`رایگان / بدون سفارش`:Pa(e.amount)}
                      </td>
                    </tr>
                  `).join(``)}
                </tbody>
              ...
              <div class="behbar-invoice-total">
                ...
                <span style="font-size: 1.25rem; font-weight: 800; color: #059669;">${Pa(i.total)} تومان</span>
              </div>
    ...
    `,document.getElementById(`finance-modal-close`)?.addEventListener(`click`,a),document.getElementById(`btn-close-invoice-modal`)?.addEventListener(`click`,a),document.getElementById(`finance-modal-backdrop`)?.addEventListener(`click`,e=>{e.target===e.currentTarget&&a()}),document.getElementById(`btn-print-invoice-sheet`)?.addEventListener(`click`,()=>{window.print()});function a(){t&&(t.innerHTML=``)}}function d(){let e=document.getElementById(`finance-modal-container`);if(!e)return;e.innerHTML=`
...
`),a=new Blob([i],{type:`text/csv;charset=utf-8;`}),s=URL.createObjectURL(a),c=document.createElement(`a`);c.href=s,c.download=`behbar-financial-report-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(c),c.click(),document.body.removeChild(c),URL.revokeObjectURL(s),Q(`فایل اکسل گزارش مالی بهبار با موفقیت ایجاد و دانلود شد.`,`success`)}document.getElementById(`finance-export-excel-btn`)?.addEventListener(`click`,f),document.getElementById(`finance-add-doc-btn`)?.addEventListener(`click`,d),document.getElementById(`finance-refresh-btn`)?.addEventListener(`click`,()=>{a(),Q(`اطلاعات مالی به‌روز شد.`,`success`)}),document.getElementById(`finance-search-input`)?.addEventListener(`input`,()=>c()),document.getElementById(`finance-status-filter`)?.addEventListener(`change`,()=>c()),a()}var Ra=`behbar_waybill_records`,za=[{id:`wb-1`,waybillNumber:`IR-1403-882190`,issueDate:`۱۴۰۳/۰۶/۲۴`,status:`active`,sender:{name:`شرکت پتروشیمی آریا`,phone:`02188765432`,city:`تهران`,address:`بزرگراه فتح، کیلومتر ۸، انبار مرکزی`,nationalId:`10103498210`},receiver:{name:`صنایع پلاستیک اروند`,phone:`06153219876`,city:`اهواز`,address:`شهرک صنعتی شماره ۲، فاز دوم، خیابان تلاش ۳`,nationalId:`10861234509`},driver:{name:`محمدعلی رستمی`,nationalId:`1289456712`,licenseNumber:` پایه یک ۴۹۸۲۱`,phone:`09123456789`,smartCardNumber:`9823412`},fleet:{vehicleType:`تریلی چادری (ترانزیت)`,plateNumber:`۱۲ ع ۷۸۹ ایران ۴۴`,smartCardNumber:`3489102`},cargo:{description:`گرانول پلی‌اتیلن پتروشیمی در پالت بسته‌بندی شده`,weightKg:22e3,packaging:`پالت و شیرینگ پلاستیکی`,declaredValueToman:185e7},insurance:{policyNumber:`INS-403-99214`,insurerName:`بیمه ایران`,coverageType:`پوشش کامل تمام‌خطر (کلوز A) + مسئولیت مدنی متصدی حمل`,coverageCeilingToman:2e9,premiumToman:55e5},freightCostToman:38e6,notes:`حمل فوری، تحویل با ارائه حواله انبار و مهر مقصد`},{id:`wb-2`,waybillNumber:`IR-1403-882185`,issueDate:`۱۴۰۳/۰۶/۲۳`,status:`active`,sender:{name:`تجهیزات پزشکی بهمن`,phone:`02166543210`,city:`کرج`,address:`بلوار جمهوری، نبش کوچه یاس`,nationalId:`10105544332`},receiver:{name:`بیمارستان امام رضا (ع)`,phone:`05138543210`,city:`مشهد`,address:`میدان بیمارستان، خیابان ابن‌سینا`,nationalId:`14008765432`},driver:{name:`حسین صادقی`,nationalId:`0943218765`,licenseNumber:`پایه دو ۳۲۱۴۵`,phone:`09151122334`,smartCardNumber:`7612984`},fleet:{vehicleType:`خاور مسقف مجهز به مهاربند`,plateNumber:`۳۴ ب ۵۶۷ ایران ۱۲`,smartCardNumber:`4455667`},cargo:{description:`دستگاه‌های تشخیصی و مانیتور علائم حیاتی آزمایشگاهی`,weightKg:3500,packaging:`کارتن پالت‌بندی شده ضدضربه`,declaredValueToman:95e7},insurance:{policyNumber:`INS-403-99180`,insurerName:`بیمه آسیا`,coverageType:`بیمه‌نامه رسمی راهداری + الحاقیه شکست و نوسان`,coverageCeilingToman:1e9,premiumToman:32e5},freightCostToman:185e5,notes:`بار حساس و نیازمند سرعت مطمئنه و عدم تکان شدید`},{id:`wb-3`,waybillNumber:`IR-1403-881950`,issueDate:`۱۴۰۳/۰۶/۲۱`,status:`delivered`,sender:{name:`بازرگانی پارس سرام`,phone:`03536214589`,city:`یزد`,address:`بلوار آزادگان، روبروی پارک صنعتی`,nationalId:`10840019283`},receiver:{name:`پروژه برج سپهر تبریز`,phone:`04133445566`,city:`تبریز`,address:`بلوار ائل‌گلی، کوی فردوس`,nationalId:`14002345678`},driver:{name:`رضا کریمیان`,nationalId:`1198765432`,licenseNumber:`پایه یک ۶۵۴۳۲`,phone:`09139876543`,smartCardNumber:`8877665`},fleet:{vehicleType:`کامیون ده چرخ جفت`,plateNumber:`۶۵ ج ۲۳۴ ایران ۵۵`,smartCardNumber:`9988112`},cargo:{description:`سرامیک و پرسلان کف ساختمانی صادراتی`,weightKg:14500,packaging:`پالت چوبی با استرچ`,declaredValueToman:62e7},insurance:{policyNumber:`INS-403-98910`,insurerName:`بیمه دانا`,coverageType:`پوشش مسئولیت مدنی متصدی حمل کالا`,coverageCeilingToman:7e8,premiumToman:19e5},freightCostToman:24e6,notes:`تحویل صحیح و سالم بدون هیچ‌گونه شکستگی تایید شد`},{id:`wb-4`,waybillNumber:`IR-1403-882205`,issueDate:`۱۴۰۳/۰۶/۲۴`,status:`pending`,sender:{name:`فولاد غرب پارس`,phone:`03133887766`,city:`اصفهان`,address:`شهرک صنعتی مورچه‌خورت، خیابان ابوریحان`,nationalId:`10260384910`},receiver:{name:`اسکلت فلزی شمال`,phone:`01132233445`,city:`ساری`,address:`جاده دریا، کیلومتر ۴`,nationalId:`10760192837`},driver:{name:`ابراهیم قاسمی`,nationalId:`1276543219`,licenseNumber:`پایه یک ۷۷۶۶۵`,phone:`09132211445`,smartCardNumber:`3344551`},fleet:{vehicleType:`تریلی کفی ۱۲ متری`,plateNumber:`۸۸ د ۴۵۶ ایران ۳۳`,smartCardNumber:`1122334`},cargo:{description:`تیرآهن سنگین و میلگرد ساختمانی شاخه ۱۲ متری`,weightKg:24e3,packaging:`بندیل تسمه‌کشی شده`,declaredValueToman:12e8},insurance:{policyNumber:`INS-403-99302`,insurerName:`بیمه ایران`,coverageType:`بیمه‌نامه جامع باربری راهداری کلوز A`,coverageCeilingToman:13e8,premiumToman:38e5},freightCostToman:31e6,notes:`در انتظار تایید بارگیری و مهاربندی ایمن روی کفی`}];function Ba(){try{let e=localStorage.getItem(Ra);if(!e)return Va(za),za;let t=JSON.parse(e);return Array.isArray(t)&&t.length>0?t:za}catch{return za}}function Va(e){try{localStorage.setItem(Ra,JSON.stringify(e))}catch{}}function Ha(e){return String(e).replace(/\d/g,e=>`۰۱۲۳۴۵۶۷۸۹`[Number(e)])}function Ua(e){return Ha(Math.round(e).toString().replace(/\B(?=(\d{3})+(?!\d))/g,`،`))}var Wa={active:{label:`در مسیر حمل`,badgeClass:`waybill-badge-active`},delivered:{label:`تحویل‌شده`,badgeClass:`waybill-badge-delivered`},pending:{label:`در انتظار صدور`,badgeClass:`waybill-badge-pending`},canceled:{label:`باطله`,badgeClass:`waybill-badge-canceled`}};function Ga(e){return`
  ...
  `}function Ka(){let e=Ba(),t=[];P().then(e=>{Array.isArray(e)&&(t=e)});let n=document.getElementById(`wb-search-input`),r=document.getElementById(`wb-status-filter`),i=document.getElementById(`wb-insurer-filter`),a=document.getElementById(`wb-table-body`),o=document.getElementById(`wb-add-btn`),s=document.getElementById(`wb-export-excel-btn`);function c(){let t=e.length,n=e.filter(e=>e.status===`active`).length,r=e.filter(e=>e.status===`pending`).length,i=e.reduce((e,t)=>e+(t.cargo.declaredValueToman||0),0),a=document.getElementById(`stat-total-count`),o=document.getElementById(`stat-active-count`),s=document.getElementById(`stat-pending-count`),c=document.getElementById(`stat-insurance-value`);a&&(a.textContent=`${Ha(t)} فقره`),o&&(o.textContent=`${Ha(n)} فقره`),s&&(s.textContent=`${Ha(r)} فقره`),c&&(c.textContent=`${Ua(i)} تومان`)}function l(){if(!a)return;let t=(n?.value||``).trim().toLowerCase(),o=r?.value||`all`,s=i?.value||`all`,c=e.filter(e=>!(o!==`all`&&e.status!==o||s!==`all`&&!e.insurance.insurerName.includes(s)||t&&!`
      ...
      `;return}a.innerHTML=c.map(e=>{let t=Wa[e.status]||{label:e.status,badgeClass:`waybill-badge-pending`};return`
          <tr>
            <td>
            ...
            <td>
              <div style="display: flex; flex-direction: column; gap: 2px;">
                ...
                <span style="font-size: 0.78rem; color: #64748b;">${e.fleet.vehicleType} (${Ha(e.fleet.plateNumber)})</span>
              </div>
            </td>
            <td>
              <span style="font-weight: 800; color: #047857;">${Ua(e.cargo.declaredValueToman)}</span>
            </td>
            <td>
              <span style="font-size: 0.84rem;">${Ha(e.issueDate)}</span>
            </td>
            <td>
            ...
            <div class="official-waybill-sheet" id="official-sheet-content">
              ...
              <div class="sheet-header">
                ...
                <div class="sheet-meta-area">
                  ...
                  <div>تاریخ صدور: <strong>${Ha(e.issueDate)}</strong></div>
                </div>
              </div>
              ...
              <div class="sheet-insurance-highlight">
                ...
                <div class="item">
                  ...
                  <span class="val">${Ua(e.insurance.coverageCeilingToman)} تومان</span>
                </div>
                <div class="item">
                  <span class="title">ارزش اظهارشده کالا:</span>
                  <span class="val">${Ua(e.cargo.declaredValueToman)} تومان</span>
                </div>
              </div>
              ...
              <div class="sheet-section">
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Ha(e.sender.phone)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">شناسه ملی / کد ملی:</span>
                    <span class="sheet-item-value">${Ha(e.sender.nationalId||`---`)}</span>
                  </div>
                </div>
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Ha(e.receiver.phone)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">شناسه ملی / کد ملی:</span>
                    <span class="sheet-item-value">${Ha(e.receiver.nationalId||`---`)}</span>
                  </div>
                </div>
                <div style="padding: 0 12px 8px 12px; font-size: 0.8rem; color: #475569;">
              ...
              <div class="sheet-section">
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Ha(e.driver.nationalId)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">کارت هوشمند راننده:</span>
                    <span class="sheet-item-value">${Ha(e.driver.smartCardNumber)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">شماره تماس راننده:</span>
                    <span class="sheet-item-value">${Ha(e.driver.phone)}</span>
                  </div>
                </div>
                <div class="sheet-grid-row" style="border-top: 1px dashed #cbd5e1;">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Ha(e.fleet.plateNumber)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">کارت هوشمند ناوگان:</span>
                    <span class="sheet-item-value">${Ha(e.fleet.smartCardNumber)}</span>
                  </div>
                  <div class="sheet-item">
                    <span class="sheet-item-label">کرایه کل حمل:</span>
                    <span class="sheet-item-value" style="color: #047857;">${Ua(e.freightCostToman)} تومان</span>
                  </div>
                </div>
              </div>
              ...
              <div class="sheet-section">
                ...
                <div class="sheet-grid-row">
                  ...
                  <div class="sheet-item">
                    ...
                    <span class="sheet-item-value">${Ha(e.cargo.weightKg)} کیلوگرم</span>
                  </div>
                  <div class="sheet-item">
    ...
    `;let i=()=>{n.innerHTML=``};document.getElementById(`wb-add-close`)?.addEventListener(`click`,i),document.getElementById(`wb-add-cancel`)?.addEventListener(`click`,i);let a=document.getElementById(`wb-quick-select-order`);a&&a.addEventListener(`change`,()=>{let e=Number(a.value),n=t.find(t=>t.id===e);n&&(document.getElementById(`wb-sender-name`).value=n.customerName||``,document.getElementById(`wb-sender-city`).value=n.originCity||``,document.getElementById(`wb-sender-phone`).value=n.phone||``,document.getElementById(`wb-sender-address`).value=n.originNotes||``,document.getElementById(`wb-receiver-city`).value=n.destinationCity||``,document.getElementById(`wb-receiver-address`).value=n.destinationNotes||``,document.getElementById(`wb-cargo-desc`).value=n.serviceLabel||`کالای عمومی تجاری`,document.getElementById(`wb-cargo-value`).value=String(n.estimateAvg?n.estimateAvg*10:2e8),document.getElementById(`wb-freight-cost`).value=String(n.estimateAvg||15e6))}),document.getElementById(`wb-add-submit`)?.addEventListener(`click`,()=>{let t=document.getElementById(`wb-sender-name`).value.trim(),n=document.getElementById(`wb-sender-city`).value.trim(),r=document.getElementById(`wb-receiver-name`).value.trim(),a=document.getElementById(`wb-receiver-city`).value.trim(),o=document.getElementById(`wb-driver-name`).value.trim(),s=document.getElementById(`wb-cargo-desc`).value.trim(),u=Number(document.getElementById(`wb-cargo-value`).value)||1e8;if(!t||!n||!r||!a||!o||!s){Q(`لطفاً مشخصات الزامی فرستنده، گیرنده، راننده و محموله را تکمیل فرمایید.`,`error`);return}let d=Math.floor(1e5+Math.random()*9e5),p={id:`wb-${Date.now()}`,waybillNumber:`IR-1403-${d}`,issueDate:`۱۴۰۳/۰۶/۲۴`,status:`active`,sender:{name:t,city:n,phone:document.getElementById(`wb-sender-phone`).value.trim(),address:document.getElementById(`wb-sender-address`).value.trim()||`تهران، بارگیری مرکزی`,nationalId:document.getElementById(`wb-sender-nid`).value.trim()},receiver:{name:r,city:a,phone:document.getElementById(`wb-receiver-phone`).value.trim(),address:document.getElementById(`wb-receiver-address`).value.trim()||`مقصد تحویل سراسری`,nationalId:document.getElementById(`wb-receiver-nid`).value.trim()},driver:{name:o,nationalId:document.getElementById(`wb-driver-nid`).value.trim()||`1234567890`,licenseNumber:`پایه یک راهداری`,phone:document.getElementById(`wb-driver-phone`).value.trim()||`09120000000`,smartCardNumber:document.getElementById(`wb-driver-smart`).value.trim()||String(d)},fleet:{vehicleType:document.getElementById(`wb-fleet-type`).value,plateNumber:document.getElementById(`wb-fleet-plate`).value.trim()||`۲۱ ع ۷۸۹ ایران ۳۳`,smartCardNumber:String(d+1e3)},cargo:{description:s,weightKg:Number(document.getElementById(`wb-cargo-weight`).value)||5e3,packaging:document.getElementById(`wb-cargo-pack`).value.trim()||`پالت استاندارد`,declaredValueToman:u},insurance:{policyNumber:`INS-403-${d}`,insurerName:document.getElementById(`wb-insurer-select`).value,coverageType:`پوشش مسئولیت مدنی متصدی و کلوز جامع باربری راهداری`,coverageCeilingToman:u,premiumToman:Math.round(u*.003)},freightCostToman:Number(document.getElementById(`wb-freight-cost`).value)||2e7};e.unshift(p),Va(e),c(),l(),i(),Q(`بارنامه و بیمه‌نامه شماره ${p.waybillNumber} با موفقیت صادر گردید.`,`success`),f(p)})}function m(){if(e.length===0){Q(`هیچ داده‌ای برای خروجی اکسل موجود نیست.`,`error`);return}let t=[`شماره بارنامه`,`تاریخ صدور`,`وضعیت`,`شرکت بیمه‌گر`,`شماره بیمه‌نامه`,`سقف تعهد بیمه (تومان)`,`فرستنده`,`شهر مبدا`,`تلفن فرستنده`,`گیرنده`,`شهر مقصد`,`تلفن گیرنده`,`راننده`,`کد ملی راننده`,`تلفن راننده`,`نوع ناوگان`,`پلاک انتظامی`,`شرح محموله`,`وزن (کیلوگرم)`,`ارزش اعلامی محموله (تومان)`,`کرایه حمل (تومان)`],n=e.map(e=>[e.waybillNumber,e.issueDate,Wa[e.status]?.label||e.status,e.insurance.insurerName,e.insurance.policyNumber,e.insurance.coverageCeilingToman,e.sender.name,e.sender.city,e.sender.phone,e.receiver.name,e.receiver.city,e.receiver.phone,e.driver.name,e.driver.nationalId,e.driver.phone,e.fleet.vehicleType,e.fleet.plateNumber,`"${(e.cargo.description||``).replace(/"/g,`""`)}"`,e.cargo.weightKg,e.cargo.declaredValueToman,e.freightCostToman]),r=`﻿`+[t.join(`,`),...n.map(e=>e.join(`,`))].join(`\r
`),i=new Blob([r],{type:`text/csv;charset=utf-8;`}),a=URL.createObjectURL(i),o=document.createElement(`a`);o.setAttribute(`href`,a),o.setAttribute(`download`,`behbar_waybills_insurance_${Date.now()}.csv`),document.body.appendChild(o),o.click(),document.body.removeChild(o),URL.revokeObjectURL(a),Q(`فایل اکسل بارنامه‌ها و بیمه‌نامه‌ها با موفقیت دریافت شد.`,`success`)}n?.addEventListener(`input`,l),r?.addEventListener(`change`,l),i?.addEventListener(`change`,l),o?.addEventListener(`click`,p),s?.addEventListener(`click`,m),c(),l()}function qa(e,t,n){return`
    <button type="button" class="home-tile" data-home-tile="${e}">
      <span class="home-tile-icon">${t}</span>
      <span class="home-tile-label">${n}</span>
    </button>
  `}function Ja(e){let t=S(e,`content`)||S(e,`stories`)||S(e,`seo`)||S(e,`settings`),n=S(e,`staff`)||S(e,`recruitment`)||S(e,`roles`)||S(e,`wallet`),r=S(e,`settings`)||S(e,`homepage`),i=S(e,`pipeline`)||S(e,`map`),a=S(e,`dashboard`)||S(e,`wallet`)||S(e,`roles`)||S(e,`staff`),o=[];return o.push(qa(`dashboard`,u.chart,`داشبورد`)),i&&o.push(qa(`requests`,u.columns,`درخواست‌ها`)),(S(e,`pipeline`)||S(e,`staff`)||S(e,`dashboard`))&&o.push(qa(`waybills`,u.shield,`بیمه‌نامه و بارنامه`)),a&&o.push(qa(`finance`,u.finance,`مدیریت مالی`)),S(e,`staff`)&&o.push(qa(`fleet`,u.truck,`مدیریت ناوگان حمل‌ونقل`)),r&&o.push(qa(`settings`,u.settings,`تنظیمات سایت`)),S(e,`chat`)&&o.push(qa(`chat`,u.chat,`چت پشتیبانی`)),t&&o.push(qa(`content`,u.grid,`مدیریت محتوا`)),n&&o.push(qa(`personnel`,u.users,`مدیریت پرسنل`)),S(e,`plugins`)&&o.push(qa(`plugins`,u.plugin,`افزونه‌ها`)),`<div class="home-grid">${o.join(``)}</div>`}function Ya(e){let t=[];return S(e,`pipeline`)&&t.push(qa(`pipeline`,u.columns,`مراحل درخواست‌ها`)),S(e,`map`)&&t.push(qa(`map`,u.map,`نقشه درخواست‌ها`)),`<div class="home-grid">${t.join(``)}</div>`}function Xa(e){let t=[];return S(e,`content`)&&t.push(qa(`magazine`,u.article,`مجله`)),S(e,`content`)&&t.push(qa(`testimonials`,u.message,`نظرات مشتریان`)),S(e,`stories`)&&t.push(qa(`stories`,u.story,`استوری‌ها`)),S(e,`seo`)&&t.push(qa(`seo`,u.seo,`مدیریت سئو`)),(S(e,`content`)||S(e,`settings`))&&t.push(qa(`media`,u.image,`مدیریت فایل`)),`<div class="home-grid">${t.join(``)}</div>`}function Za(e){let t=[];return S(e,`staff`)&&t.push(qa(`staff`,u.users,`کارمندان`)),S(e,`recruitment`)&&t.push(qa(`jobApplications`,u.briefcase,`فرصت‌های شغلی`)),S(e,`roles`)&&t.push(qa(`roles`,u.lock,`نقش‌ها و اختیارات`)),(S(e,`staff`)||S(e,`roles`))&&t.push(qa(`activityLog`,u.history,`گزارش فعالیت`)),S(e,`wallet`)&&t.push(qa(`payroll`,u.wallet,`حقوق و دستمزد`)),`<div class="home-grid">${t.join(``)}</div>`}function Qa(e,t){e.querySelectorAll(`[data-home-tile]`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.homeTile??``))})}async function $a(){try{let e=(await De()).site_name?.fa?.trim();if(!e||e===`بهبار`)return;document.querySelectorAll(`#login-brand-text, .admin-logo-title, #staff-portal-brand-text`).forEach(t=>{t.textContent?.includes(`بهبار`)&&(t.textContent=t.textContent.replace(/بهبار/g,e))})}catch{}}function eo(e){return e===`home`?null:e===`requests`||e===`content`||e===`personnel`||e===`dashboard`||e===`settings`||e===`plugins`||e===`chat`||e===`fleet`||e===`finance`||e===`waybills`?`home`:e===`pipeline`||e===`map`?`requests`:e===`magazine`||e===`testimonials`||e===`stories`||e===`seo`||e===`media`?`content`:e===`staff`||e===`jobApplications`||e===`roles`||e===`activityLog`||e===`payroll`?`personnel`:e===`staffHistory`?`staff`:e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`?`dashboard`:e===`magazine-editor`?`magazine`:e===`page-editor`||e===`pages`?`settings`:`home`}function to(){let e=document.querySelector(`#app`);if(!e)throw Error(`#app not found`);return e}function no(){let e=to();e.innerHTML=Mt(),Nt(ho),$a()}var ro={home:``,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,jobApplications:`job-applications`,activityLog:`activity-log`,accountSecurity:`account-security`,myWallet:`wallet`,payroll:`payroll`,finance:`finance`,waybills:`waybills`,magazine:`magazine`,"magazine-editor":`magazine-editor`,pages:`settings`,"page-editor":`page-editor`,dashboardOrders:`dashboard/orders`,dashboardVisitors:`dashboard/visitors`,dashboardStaff:`dashboard/staff`,staffHistory:`staff/history`},io={"":`home`,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,finance:`finance`,waybills:`waybills`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,"job-applications":`jobApplications`,"activity-log":`activityLog`,"account-security":`accountSecurity`,wallet:`myWallet`,payroll:`payroll`,magazine:`magazine`,"magazine-editor":`magazine-editor`,"page-editor":`page-editor`,"dashboard/orders":`dashboardOrders`,"dashboard/visitors":`dashboardVisitors`,"dashboard/staff":`dashboardStaff`,"staff/history":`staffHistory`};function ao(){let e=window.location.pathname.replace(/^\/management\/?/,``).replace(/\/+$/,``);if(!e)return{screen:`home`};if(io[e])return{screen:io[e]};let t=e.split(`/`);if(t.length===2&&(t[0]===`magazine-editor`||t[0]===`page-editor`)){let e=t[0],n=parseInt(t[1],10);return{screen:e,detailId:isNaN(n)?null:n}}return null}function oo(e,t=null){let n=ro[e]??``,r=n;(e===`magazine-editor`||e===`page-editor`)&&t&&(r=`${n}/${t}`);let i=r?`/management/${r}`:`/management/`;window.location.pathname!==i&&window.history.pushState({screen:e,editingDetailId:t},``,i)}var so=`home`,co=null;function $(e,t=null,n=!0){let r=document.getElementById(`view-container`),i=document.getElementById(`admin-back-btn`),a=_();if(!(!r||!a)){if(so=e,i&&(i.hidden=e===`home`),y({screen:e,extra:e===`magazine-editor`||e===`page-editor`?t:e===`staffHistory`?co:void 0}),n&&oo(e,t),e===`home`)r.innerHTML=Ja(a),Qa(r,e=>$(e));else if(e===`requests`)r.innerHTML=Ya(a),Qa(r,e=>$(e));else if(e===`content`)r.innerHTML=Xa(a),Qa(r,e=>$(e));else if(e===`personnel`)r.innerHTML=Za(a),Qa(r,e=>$(e));else if(e===`dashboard`)r.innerHTML=Dn(),On(e=>$(e));else if(e===`dashboardOrders`)r.innerHTML=kn();else if(e===`dashboardVisitors`)r.innerHTML=An();else if(e===`dashboardStaff`)r.innerHTML=jn();else if(e===`pipeline`)r.innerHTML=bn(),xn();else if(e===`map`)r.innerHTML=In(),Ln();else if(e===`staff`)r.innerHTML=Vn(),Hn(e=>{co=e,$(`staffHistory`)});else if(e===`staffHistory`){if(!co){$(`staff`);return}r.innerHTML=Wn(co),Gn(co)}else if(e===`fleet`)r.innerHTML=ur(),dr();else if(e===`magazine`)r.innerHTML=Dr(),Or(e=>$(`magazine-editor`,e));else if(e===`magazine-editor`)r.innerHTML=Gr(),Kr(t,()=>$(`magazine`));else if(e===`pages`){$(`settings`);return}else e===`page-editor`?(r.innerHTML=Qr(),$r(t,()=>$(`settings`))):e===`testimonials`?(r.innerHTML=ii(),ai()):e===`chat`?(r.innerHTML=fi(),pi()):e===`stories`?(r.innerHTML=_i(),vi()):e===`jobApplications`?(r.innerHTML=Ei(),Di()):e===`settings`?(r.innerHTML=$i(),ea((e,t)=>$(e,t??null))):e===`plugins`?(r.innerHTML=ia(),ca()):e===`seo`?(r.innerHTML=va(),ya(e=>$(`magazine-editor`,e))):e===`media`?(r.innerHTML=Kn(),qn()):e===`roles`?(r.innerHTML=Jn(),Yn()):e===`activityLog`?(r.innerHTML=Ai(),ji()):e===`accountSecurity`?(r.innerHTML=ba(),xa()):e===`myWallet`?(r.innerHTML=gr(),yr()):e===`payroll`?(r.innerHTML=wa(),ka()):e===`finance`?(r.innerHTML=Ia(a),La()):e===`waybills`?(r.innerHTML=Ga(a),Ka()):(r.innerHTML=Ja(a),Qa(r,e=>$(e)))}}function lo(e,t=!1){let n=to();n.innerHTML=Bt(e),document.getElementById(`admin-back-btn`)?.addEventListener(`click`,()=>{let e=eo(so);e&&$(e)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{M(),v(),no()}),document.getElementById(`admin-account-btn`)?.addEventListener(`click`,()=>$(`accountSecurity`));function r(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`,t=document.getElementById(`admin-theme-sun`),n=document.getElementById(`admin-theme-moon`);t&&n&&(t.hidden=!e,n.hidden=e)}r(),document.getElementById(`admin-theme-toggle-btn`)?.addEventListener(`click`,()=>{document.documentElement.getAttribute(`data-theme`)===`dark`?(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`behbar_admin_theme`,`light`)):(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`behbar_admin_theme`,`dark`)),r()}),document.getElementById(`admin-logo-btn`)?.addEventListener(`click`,()=>{$(`home`)}),window.addEventListener(`popstate`,e=>{let t=e.state;if(t?.screen)$(t.screen,t.editingDetailId??null,!1);else{let e=ao();e?$(e.screen,e.detailId??null,!1):$(`home`,null,!1)}}),S(e,`settings`)&&fo(),uo(),Qn(),$a(),S(e,`ai`)&&Lt();let i=ao(),a=t?b():null;i&&i.screen!==`home`?$(i.screen,i.detailId??null,!1):a?.screen===`staffHistory`&&a.extra?(co=a.extra,$(`staffHistory`)):a?.screen===`magazine-editor`?$(`magazine-editor`,a.extra??null):a?.screen===`page-editor`?$(`page-editor`,a.extra??null):a?.screen&&a.screen!==`home`?$(a.screen):$(`home`,null,!0)}async function uo(){try{let e=await De(),t=e.branding,n=t?.logoUrl;n&&document.querySelectorAll(`.admin-logo-mark`).forEach(e=>e.src=n);let r=t?.faviconUrl||n;r&&document.querySelectorAll(`link[rel="icon"]`).forEach(e=>e.href=r);let i=e.site_name;i?.fa?.trim()&&(document.title=`${i.fa.trim()} - پنل مدیریت`,document.querySelectorAll(`.admin-logo-title`).forEach(e=>e.textContent=i.fa.trim()))}catch{}}async function fo(){let e=document.getElementById(`admin-sidebar-version`);if(e)try{let t=await vt();e.textContent=t.updateAvailable?`نسخه ${t.current} · نسخه جدید موجود است`:`نسخه ${t.current}`,e.classList.toggle(`has-update`,t.updateAvailable),e.hidden=!1}catch{}}function po(e){let t=to();t.innerHTML=Cr(e),$a(),Tr(()=>{M(),v(),no()})}function mo(e){let t=to();t.innerHTML=ma(),$a(),ha(e,()=>lo(e))}function ho(e,t=!1){if(!C(e)){po(e);return}if(!S(e,`settings`)){lo(e,t);return}De().then(n=>{fa(n)?mo(e):lo(e,t)}).catch(()=>lo(e,t))}function go(){if(E(no),!x()){no();return}let e=_();e?ho(e,!0):no(),N().then(t=>{let n=g();n&&(h(n,t),(!e||e.role!==t.role)&&ho(t,!0))}).catch(()=>{})}go();