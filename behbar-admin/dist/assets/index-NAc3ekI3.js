...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function te(e){ee=e,e?(x.src=e,x.hidden=!1,S.hidden=!0,T&&(T.hidden=!1)):(x.hidden=!0,S.hidden=!1,T&&(T.hidden=!0))}function M(e,t){if(!e){i.hidden=!0,v.hidden=!0,y&&(y.hidden=!0);return}if(i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,v.hidden=e!==`published`,y&&b){let e=t||u.value.trim();if(e){y.hidden=!1;let t=`https://behbarapp.ir/p/${encodeURIComponent(e)}`;b.href=t,b.textContent=`/p/${e}`}else y.hidden=!0}}async function N(){if(e===null){r.textContent=`برگه جدید`,O=[Rr(`richtext`)],A(),M(null),E&&(E.checked=!1),D&&(D.checked=!1);return}try{let t=await _e(e);if(!t){n.hidden=!1,n.textContent=`برگه پیدا نشد.`;return}k=t,r.textContent=t.title||`ویرایش برگه`,o.value=t.title,s.value=t.titleEn||``,c.value=t.excerpt||``,l.value=t.excerptEn||``,u.value=t.slug,d.value=t.metaTitle??``,f.value=t.metaDescription??``,E&&(E.checked=!!t.showInHeader),D&&(D.checked=!!t.showInFooter),te(t.coverImageUrl),O=t.content&&t.content.length?t.content:[Rr(`richtext`)],A(),M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی در بارگذاری برگه پیش آمد.`}}function P(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),coverImageUrl:ee,content:j(),metaTitle:d.value.trim()||void 0,metaDescription:f.value.trim()||void 0,slug:u.value.trim()||void 0,showInHeader:E?.checked??!1,showInFooter:D?.checked??!1}}async function F(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان برگه الزامی است.`,null;let t=P();try{let n=k?await ye(k.id,t):await ve(t);return k=n,e=n.id,u.value=n.slug,r.textContent=n.title,M(n.status,n.slug),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره برگه ناموفق بود.`,null}}p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;O=j();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?O.splice(n,1):r===`up`&&n>0?[O[n-1],O[n]]=[O[n],O[n-1]]:r===`down`&&n<O.length-1&&([O[n+1],O[n]]=[O[n],O[n+1]]),A()}),p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),p.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await Se(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر ناموفق بود.`}}),h.addEventListener(`click`,()=>{O=j(),O.push(Rr(m.value)),A()}),w.addEventListener(`click`,()=>C.click()),T&&T.addEventListener(`click`,()=>te(null)),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{te(await Se(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر شاخص ناموفق بود.`}}),g.addEventListener(`click`,async()=>{g.disabled=!0,g.textContent=`در حال ذخیره...`,await F(),g.disabled=!1,g.textContent=`ذخیره پیش‌نویس`}),_.addEventListener(`click`,async()=>{_.disabled=!0;let e=await F();if(e)try{let t=await be(e.id,!0);M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار برگه ناموفق بود.`}_.disabled=!1}),v.addEventListener(`click`,async()=>{if(k){v.disabled=!0;try{let e=await be(k.id,!1);M(e.status,e.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`تغییر به پیش‌نویس ناموفق بود.`}v.disabled=!1}}),a.addEventListener(`click`,t),N()}function Wr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Gr(e){return Array.from({length:5},(t,n)=>n<e?`★`:`☆`).join(``)}function Kr(e){return`
  ...
  `}function hi(e,t){return`
    <div class="testimonial-row" data-position-row="${fi(e.id)}">
      <div class="testimonial-row-avatar"><span class="icon">${u.briefcase}</span></div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
        ...
        <div class="job-application-meta">
          ${e.titleEn?`<span dir="ltr">${fi(e.titleEn)}</span>`:``}
          <span>${e.requiresVehicle?`نیاز به وسیله نقلیه دارد`:`بدون نیاز به وسیله نقلیه`}</span>
        </div>
        ${e.description?`<p class="testimonial-row-text">${fi(e.description)}</p>`:``}
      </div>
      <div class="staff-table-actions">
  ...
  `}function xi(){let e=document.getElementById(`activity-log-list`),t=document.getElementById(`activity-log-error`),n=document.getElementById(`activity-log-refresh`);if(!e||!t||!n)return;async function r(){t.hidden=!0;try{let t=await I();e.innerHTML=t.length?t.map(yi).join(``):`<p class="portal-empty">هنوز فعالیتی ثبت نشده است.</p>`}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}n.addEventListener(`click`,()=>void r()),r()}function Si(){return`
    <div class="editor-sidebar-card">
      <h3>به‌روزرسانی</h3>
  ...
  `}var Ci=`sudo bash install.sh`;function wi(){return`
  ...
  `}function Ti(){return`
    <div class="update-manual-guide">
      ...
      <div class="update-manual-step">
        ...
        <p class="update-manual-cmd-plain" dir="ltr">${Ci}</p>
      </div>
  ...
  `}function Ei(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Di(){let e=document.getElementById(`update-panel-current`),t=document.getElementById(`update-panel-current-changelog`),n=document.getElementById(`update-panel-result`),r=document.getElementById(`update-scan-btn`),i=document.getElementById(`update-panel-manual-guide`);!e||!t||!n||!r||!i||(gt().then(n=>{e.textContent=`نسخه‌ی فعلی: ${n.current}`,n.currentChangelog.length&&(t.innerHTML=`
      ...
      `,document.getElementById(`update-panel-backup-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.textContent=`در حال دانلود...`;try{await at()}catch(e){zn(e instanceof Error?e.message:`دانلود پشتیبان ناموفق بود.`,`error`)}finally{t.disabled=!1,t.textContent=`دانلود نسخه پشتیبان`}}),document.getElementById(`update-panel-apply-btn`)?.addEventListener(`click`,async e=>{if(!window.confirm(`به‌روزرسانی سرویس را برای حدود یک دقیقه مختل می‌کند. آیا از پشتیبان‌گیری مطمئن هستید و می‌خواهید ادامه دهید؟`))return;let t=e.currentTarget,r=document.getElementById(`update-panel-error`);t.disabled=!0,t.textContent=`در حال اعمال...`;try{await _t(),n.innerHTML=`
          ...
          `}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`به‌روزرسانی ناموفق بود.`),t.disabled=!1,t.textContent=`اعمال به‌روزرسانی`}})}catch(e){zn(e instanceof Error?e.message:`بررسی به‌روزرسانی ناموفق بود.`,`error`)}finally{r.disabled=!1,r.textContent=t}}))}var Oi={text:`متن ساده`,steps:`مراحل شماره‌دار`,accordion:`آکاردئونی (پرسش و پاسخ)`,grid:`شبکه‌ی آیکون/عنوان`,slider:`اسلایدر`,quote:`نقل‌قول`,testimonials:`نظرات مشتریان (خودکار)`,stats:`آمار و ارقام`},ki=Object.keys(Oi),Ai=[{id:`hero`,type:`hero`,visible:!0},{id:`starter-steps`,type:`block`,layout:`steps`,visible:!0,items:[{id:`step-1`,title:`درخواست خود را ثبت کنید`,titleEn:`Submit your request`,text:`مبدأ، مقصد و نوع بار را مشخص کنید.`,textEn:`Specify the origin, destination, and type of load.`},{id:`step-2`,title:`با شما هماهنگ می‌کنیم`,titleEn:`We'll coordinate with you`,text:`در کوتاه‌ترین زمان تماس می‌گیریم و زمان دقیق را هماهنگ می‌کنیم.`,textEn:`We'll call you shortly to confirm the exact time.`},{id:`step-3`,title:`کار را انجام می‌دهیم`,titleEn:`We get it done`,text:`با دقت و مسئولیت، بار یا وسایل شما را جابه‌جا می‌کنیم.`,textEn:`We move your goods or belongings carefully and responsibly.`}]},{id:`starter-grid`,type:`block`,layout:`grid`,visible:!0,items:[{id:`trust-1`,title:`درخواست سریع و آسان`,titleEn:`Fast and easy request`},{id:`trust-2`,title:`هماهنگی مستقیم، بدون واسطه`,titleEn:`Direct coordination, no middlemen`},{id:`trust-3`,title:`انجام کار توسط خودمان`,titleEn:`The work is done by our own team`},{id:`trust-4`,title:`پوشش خدمات مختلف حمل`,titleEn:`Coverage of various moving services`},{id:`trust-5`,title:`طراحی ساده و شفاف`,titleEn:`Simple, transparent design`}]},{id:`starter-faq`,type:`block`,layout:`accordion`,visible:!0,items:[{id:`faq-1`,title:`سامانه دقیقاً چه خدماتی ارائه می‌دهد؟`,titleEn:`What services are offered exactly?`,text:`امکان ثبت آنلاین درخواست اسباب‌کشی، باربری و حمل بار را در سراسر کشور فراهم می‌کند. خدمات شامل جابه‌جایی با وانت، نیسان، خاور و کامیون، برای منازل مسکونی و همچنین واحدهای تجاری، اداری و انباری است.`,textEn:`Online requests for moving, hauling, and freight services across the country. Services include moving by pickup, van, light truck, and truck, for residential homes as well as commercial, office, and warehouse units.`},{id:`faq-2`,title:`هزینه‌ای که پیش از ثبت درخواست نمایش داده می‌شود قطعی است؟`,titleEn:`Is the price shown before submitting a request final?`,text:`خیر. عدد نمایش‌داده‌شده یک برآورد اولیه بر اساس اطلاعاتی است که در فرم وارد می‌کنید. قیمت نهایی پیش از شروع کار با کارشناسان هماهنگ و تأیید می‌شود.`,textEn:`No. The number shown is a preliminary estimate based on the information you enter in the form. The final price is confirmed before the work begins.`},{id:`faq-3`,title:`چقدر طول می‌کشد تا با من تماس بگیرید؟`,titleEn:`How long until you contact me?`,text:`پس از ثبت درخواست، تیم پشتیبانی در کوتاه‌ترین زمان ممکن با شماره‌ای که وارد کرده‌اید تماس می‌گیرد تا جزئیات کار و زمان دقیق اجرا را هماهنگ کند.`,textEn:`After you submit a request, our team calls the number you provided as soon as possible to confirm the details and exact time of the job.`},{id:`faq-4`,title:`آیا امکان جابه‌جایی بین‌شهری هم وجود دارد؟`,titleEn:`Is intercity moving available too?`,text:`بله. مبدأ و مقصد می‌توانند در دو شهر یا استان متفاوت باشند. در این حالت، برآورد هزینه بر اساس فاصله واقعی بین مبدأ و مقصد محاسبه می‌شود.`,textEn:`Yes. The origin and destination can be in two different cities or provinces. In that case, the cost estimate is calculated based on the actual distance between them.`},{id:`faq-5`,title:`اگر طبقه محل من آسانسور نداشته باشد چه می‌شود؟`,titleEn:`What if my building's floor has no elevator?`,text:`وضعیت آسانسور و شماره طبقه در فرآیند ثبت درخواست پرسیده می‌شود و در برآورد هزینه لحاظ می‌شود، زیرا حمل بار در طبقات بدون آسانسور معمولاً هزینه بیشتری دارد.`,textEn:`The elevator status and floor number are asked during the request process and factored into the cost estimate, since carrying loads on floors without an elevator usually costs more.`},{id:`faq-6`,title:`آیا خدمات بسته‌بندی هم ارائه می‌دهید؟`,titleEn:`Do you offer packing services?`,text:`بله. در فرآیند ثبت درخواست می‌توانید نیاز به خدمات بسته‌بندی را مشخص کنید تا این خدمت به‌عنوان بخشی از برآورد هزینه در نظر گرفته شود.`,textEn:`Yes. During the request process you can indicate that you need packing services, and it will be factored into the cost estimate.`},{id:`faq-7`,title:`چگونه می‌توانم وضعیت درخواست خود را پیگیری کنم؟`,titleEn:`How can I track the status of my request?`,text:`از طریق بخش «درخواست‌های من» و با وارد کردن شماره موبایلی که هنگام ثبت درخواست استفاده کرده‌اید، می‌توانید وضعیت سفارش خود را مشاهده کنید.`,textEn:`Go to the "My Requests" section and enter the mobile number you used when submitting the request to view its status.`},{id:`faq-8`,title:`آیا می‌توانم زمان درخواست را تغییر دهم یا آن را لغو کنم؟`,titleEn:`Can I change the time of my request or cancel it?`,text:`بله. برای تغییر زمان یا لغو یک درخواست ثبت‌شده کافی است از طریق شماره تماس با تیم پشتیبانی در ارتباط باشید.`,textEn:`Yes. To reschedule or cancel a submitted request, simply reach the support team via phone.`},{id:`faq-9`,title:`برای چه نوع مکان‌هایی می‌توانم درخواست ثبت کنم؟`,titleEn:`What types of locations can I submit a request for?`,text:`در فرآیند ثبت درخواست، نوع مکان مبدأ و مقصد—مسکونی، تجاری، اداری یا انباری—مشخص می‌شود، زیرا این موضوع در نحوه اجرای کار و برآورد هزینه اثرگذار است.`,textEn:`During the request process, the type of the origin and destination location — residential, commercial, office, or warehouse — is specified, since it affects how the job is carried out and the cost estimate.`},{id:`faq-10`,title:`آیا اطلاعات من محفوظ می‌ماند؟`,titleEn:`Is my information kept safe?`,text:`بله. اطلاعات ثبت‌شده صرفاً برای هماهنگی و اجرای درخواست شما استفاده می‌شود و در اختیار اشخاص ثالث قرار نمی‌گیرد. جزئیات کامل در صفحه حریم خصوصی درج شده است.`,textEn:`Yes. The information submitted is used solely to coordinate and carry out your request and is not shared with third parties. Full details are on the privacy page.`}]},{id:`starter-testimonials`,type:`block`,layout:`testimonials`,visible:!0}],ji={about:{label:`صفحه درباره ما`,livePath:`/about`,hint:`ویرایش مشخصات، تاریخچه، اهداف و بخش‌های معرفی بهبار در نشانی /about`},terms:{label:`صفحه قوانین و مقررات`,livePath:`/terms`,hint:`مدیریت شرایط، ضوابط، تعهدات و مقررات استفاده از سامانه بهبار در نشانی /terms`},privacy:{label:`صفحه حریم خصوصی`,livePath:`/privacy`,hint:`تنظیم سیاست‌های حفاظت از داده‌ها و امنیت حریم خصوصی کاربران بهبار در نشانی /privacy`}};function Mi(e,t){let n=[...e];return t?.length&&n.push(...t.map(e=>`- ${e}`)),n.join(`
`)}function Ni(e){let t=e.split(`
`).map(e=>e.trim()).filter(Boolean),n=t.filter(e=>!e.startsWith(`- `)),r=t.filter(e=>e.startsWith(`- `)).map(e=>e.slice(2).trim());return{paragraphs:n,list:r.length?r:void 0}}function Pi(e){let t=`https://behbarapp.ir/p/${encodeURIComponent(e.slug)}`;return`
    ...
    <div class="settings-panel" data-page-panel="home">
      ...
      <div class="settings-panel-footer" style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
        <select id="homepage-section-add-type" style="height: 40px; padding: 0 12px; border-radius: var(--radius-md); border: 1px solid var(--border); background: var(--background);">
          ${ki.map(e=>`<option value="${e}">${Oi[e]}</option>`).join(``)}
        </select>
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${ji.about.hint}</p>
          </div>
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${ji.terms.hint}</p>
          </div>
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${ji.privacy.hint}</p>
          </div>
  ...
  `}function Ii(e){let t=document.getElementById(`pages-global-error`),n=document.getElementById(`pages-global-saved`);function r(){n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}function i(e){t&&(t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی رخ داد.`,window.scrollTo({top:0,behavior:`smooth`}))}Wn().then(()=>Q(document.body));let a=document.querySelectorAll(`[data-page-nav-tab]`),o=document.querySelectorAll(`[data-page-panel]`);a.forEach(e=>{e.addEventListener(`click`,()=>{a.forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`);let t=e.dataset.pageNavTab;o.forEach(e=>{e.hidden=e.dataset.pagePanel!==t})})}),document.getElementById(`pages-top-add-btn`)?.addEventListener(`click`,()=>e(null)),document.getElementById(`page-custom-new-btn`)?.addEventListener(`click`,()=>e(null));let s={},c=[],l=!0,d={};function f(e,t,n){return`
    ...
    `}function p(e,t,n){let r=e.type===`hero`,i=e.layout??`text`,a=r?`هدر و بنر اصلی`:Oi[i],o=!r&&i!==`text`&&i!==`testimonials`;return`
          ...
          <div class="block-editor-body">
            <div class="form-field">
              ...
              <select data-field="layout">
                ${ki.map(e=>`<option value="${e}" ${e===i?`selected`:``}>${Oi[e]}</option>`).join(``)}
              </select>
            </div>
        ...
        ${n.sections.map((t,n)=>`
          <div class="block-editor" data-legal-section="${n}">
            ...
            <div class="block-editor-body">
              ...
              <textarea data-field="body" data-i18n="fa" rows="4" placeholder="هر پاراگراف در یک خط؛ برای مورد لیستی خط را با «- » شروع کنید">${Mi(t.paragraphs,t.list)}</textarea>
              <textarea data-field="bodyEn" data-i18n="en" dir="ltr" rows="4" placeholder="One paragraph per line; prefix list items with '- '">${Mi(t.paragraphsEn,t.listEn)}</textarea>
            </div>
          </div>
        `).join(``)}
      </div>
    ...
    <div class="settings-panel" data-settings-panel="theme" ${n(`theme`)}>
      ${Array.from(new Set(zi.map(e=>e.group))).map(e=>`
        <div class="editor-sidebar-card">
          <h3>${e}</h3>
          <div class="theme-color-grid">
            ${zi.filter(t=>t.group===e).map(e=>`
  ...
  `}function Wi(e,t){let n=document.getElementById(`settings-error`),r=document.getElementById(`settings-saved-note`);if(!n||!r)return;if(Ii(t=>e?.(`page-editor`,t)),t){let e=document.querySelector(`[data-settings-tab="${t}"]`);e&&(document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(e=>{e.hidden=e.dataset.settingsPanel!==t}))}let i=g();Wn().then(()=>Q(document.body));function a(){r.hidden=!1,window.setTimeout(()=>r.hidden=!0,2500)}function o(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}document.querySelectorAll(`[data-settings-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(t=>{t.hidden=t.dataset.settingsPanel!==e.dataset.settingsTab})})});let s={},c={};function l(e){let t=document.getElementById(`settings-${e}-preview`),n=document.getElementById(`settings-${e}-url`)?.value.trim();t&&(t.innerHTML=n?`<img src="${n}" alt="" />`:``)}function u(e){let t=document.getElementById(`settings-${e}-url`),n=document.getElementById(`settings-${e}-upload-btn`),r=document.getElementById(`settings-${e}-file-input`),i=document.getElementById(`settings-branding-upload-error`);!t||!n||!r||(t.addEventListener(`input`,()=>l(e)),n.addEventListener(`click`,()=>r.click()),r.addEventListener(`change`,async()=>{let a=r.files?.[0];if(!a)return;i&&(i.hidden=!0),n.disabled=!0;let o=n.textContent;n.textContent=`در حال آپلود...`;try{let n=await Se(a);t.value=n,l(e)}catch(e){i&&(i.hidden=!1,i.textContent=e instanceof Error?e.message:`آپلود عکس ناموفق بود.`)}finally{r.value=``,n.disabled=!1,n.textContent=o}}))}u(`logo`),u(`favicon`);function d(){let e=s.site_name??{fa:``,en:``};document.getElementById(`settings-site-name-fa`).value=e.fa??``,document.getElementById(`settings-site-name-en`).value=e.en??``,document.getElementById(`settings-language-mode`).value=s.language_mode??`both`;let t=s.branding??{};document.getElementById(`settings-logo-url`).value=t.logoUrl??``,document.getElementById(`settings-favicon-url`).value=t.faviconUrl??``,l(`logo`),l(`favicon`);let n=s.footer??{seoParagraphs:[],copyright:{fa:``,en:``}},r=document.getElementById(`settings-footer-paragraphs`);r.innerHTML=n.seoParagraphs.map((e,t)=>`
        ...
        </div>`).join(``),Q(r),document.getElementById(`settings-copyright-fa`).value=n.copyright?.fa??``,document.getElementById(`settings-copyright-en`).value=n.copyright?.en??``;let i=s.hero_slogan??{};document.getElementById(`settings-hero-slogan-enabled`).checked=i.enabled!==!1,document.getElementById(`settings-hero-slogan-headline-fa`).value=i.headline?.fa??``,document.getElementById(`settings-hero-slogan-headline-en`).value=i.headline?.en??``,document.getElementById(`settings-hero-slogan-subtitle-fa`).value=i.subtitle?.fa??``,document.getElementById(`settings-hero-slogan-subtitle-en`).value=i.subtitle?.en??``}document.querySelector(`[data-save-setting="site_name"]`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{await V(`site_name`,{fa:document.getElementById(`settings-site-name-fa`).value,en:document.getElementById(`settings-site-name-en`).value}),a()}catch(e){o(e)}finally{t.disabled=!1}}),document.querySelector(`[data-save-setting="language_mode"]`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{await V(`language_mode`,document.getElementById(`settings-language-mode`).value),a()}catch(e){o(e)}finally{t.disabled=!1}}),document.querySelector(`[data-save-setting="branding"]`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{await V(`branding`,{logoUrl:document.getElementById(`settings-logo-url`).value.trim(),faviconUrl:document.getElementById(`settings-favicon-url`).value.trim()}),a()}catch(e){o(e)}finally{t.disabled=!1}}),document.querySelector(`[data-save-setting="footer"]`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{await V(`footer`,{seoParagraphs:Array.from(document.querySelectorAll(`[data-footer-paragraph]`)).map(e=>({fa:e.querySelector(`[data-field="fa"]`).value,en:e.querySelector(`[data-field="en"]`).value})),copyright:{fa:document.getElementById(`settings-copyright-fa`).value,en:document.getElementById(`settings-copyright-en`).value}}),a()}catch(e){o(e)}finally{t.disabled=!1}}),document.querySelector(`[data-save-setting="hero_slogan"]`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0;try{await V(`hero_slogan`,{enabled:document.getElementById(`settings-hero-slogan-enabled`).checked,headline:{fa:document.getElementById(`settings-hero-slogan-headline-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-headline-en`).value.trim()},subtitle:{fa:document.getElementById(`settings-hero-slogan-subtitle-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-subtitle-en`).value.trim()}}),a()}catch(e){o(e)}finally{t.disabled=!1}});let f=[],p={enabled:!1,links:[]},m={enabled:!1,badges:[]};function h(){let e=document.getElementById(`social-links-list`);e&&(e.innerHTML=f.map((e,t)=>`
      <div class="settings-form-grid" data-social-link-index="${t}" style="grid-template-columns: 140px 140px 1fr 1fr auto; align-items: end; gap: 8px;">
        <div class="form-field">
          ...
          <select data-field="platform">
            ${Li.map(t=>`<option value="${t.value}" ${t.value===e.platform?`selected`:``}>${t.label}</option>`).join(``)}
          </select>
        </div>
          ...
          <div class="settings-form-grid">
            <div class="form-field">
              ...
              <select id="setup-origin-province">
                ...
                ${Qi.map(e=>`<option value="${e.name}">${e.name}</option>`).join(``)}
              </select>
            </div>
            <div class="form-field">
  ...
  `}function ia(e,t){let n=document.querySelector(`.setup-wizard-card`),r=document.getElementById(`setup-progress-fill`),i=document.getElementById(`setup-progress-text`),a=document.getElementById(`setup-back`),o=document.getElementById(`setup-next`),s=document.getElementById(`setup-skip-all`),c=document.getElementById(`setup-general-error`),l=document.getElementById(`setup-vehicle-list`);if(!n||!r||!i||!a||!o||!s||!c||!l)return;let d=0,f={},p=$i;function m(){l.innerHTML=p.map((e,t)=>`
    ...
    <div class="testimonial-row" data-audit-edit="${e.id}" role="button" tabindex="0">
      ...
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${aa(e.title)}</strong>
          <span class="article-status-badge article-status-draft">فاقد ${t.join(` و `)}</span>
        </div>
        <div class="job-application-meta"><span dir="ltr">/magazine/${aa(e.slug)}</span></div>
      </div>
    </div>
  `}function sa(){return`
    <div class="view-header">
  ...
  `}function ua(){let e=document.getElementById(`account-security-status-card`),t=document.getElementById(`account-security-sms-setup-card`),n=document.getElementById(`account-security-sms-error`),r=document.getElementById(`account-security-sms-verifying`);async function i(e,t){n.hidden=!0,r.hidden=!1;try{await k(e),window.location.reload()}catch(e){r.hidden=!0,n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`,t?.reset()}}document.getElementById(`account-security-start-sms`)?.addEventListener(`click`,()=>{(async()=>{try{await ee(),e.hidden=!0,t.hidden=!1;let n=kt(`account-security-sms`,{onComplete:e=>void i(e,n),onResend:()=>void ee().catch(e=>window.alert(e instanceof Error?e.message:`ارسال دوباره‌ی کد ناموفق بود.`))})}catch(e){window.alert(e instanceof Error?e.message:`خطایی پیش آمد.`)}})()}),document.getElementById(`account-security-disable-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`account-security-disable-password`),n=document.getElementById(`account-security-disable-error`);(async()=>{n.hidden=!0;try{await A(t.value),window.location.reload()}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}})()})}function da(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var fa={salary:`حقوق`,bonus:`پاداش`,adjustment:`اصلاحیه`,payout:`تسویه`};function pa(){return`
    <div class="view-header">
      <h1>حقوق و دستمزد</h1>
    </div>
    <p class="settings-panel-hint">
  ...
  `}function ma(e){return`
    <tr>
      <td>${da(e.fullName)}${e.isActive?``:` <span class="settings-panel-hint">(غیرفعال)</span>`}</td>
      <td>${da(e.roleLabel)}</td>
      <td><strong>${J(e.balance)}</strong></td>
      <td>
        <div class="staff-table-actions">
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-view-tx="${e.staffId}" data-wallet-staff-name="${da(e.fullName)}">تراکنش‌ها</button>
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-adjust="${e.staffId}">ثبت اصلاحیه</button>
        </div>
      </td>
    </tr>
  `}function ha(e){let t=e.direction===`credit`?`+`:`−`,n=e.direction===`credit`?`var(--success)`:`var(--danger)`;return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${fa[e.type]??e.type}</span>
        <span class="activity-log-target">${da(e.description)}</span>
      </div>
  ...
  `}function ga(e){return`
    <div class="editor-sidebar-card">
      <div class="plugin-card-head">
        <h3>${da(e.staffName)} — ${J(e.amount)}</h3>
      </div>
      ${e.staffNote?`<p class="settings-panel-hint">${da(e.staffNote)}</p>`:``}
      <div class="staff-table-actions">
  ...
  `}function _a(e){return`
    <tr data-role-rate-row="${e.id}">
      <td>${da(e.label)}${e.isSystem?` <span class="settings-panel-hint">(سیستمی)</span>`:``}</td>
  ...
  `}function va(){document.querySelectorAll(`[data-payroll-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-payroll-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-payroll-panel]`).forEach(t=>{t.hidden=t.dataset.payrollPanel!==e.dataset.payrollTab})})});let e=document.getElementById(`balances-error`),t=document.getElementById(`balances-table-body`);async function n(){e.hidden=!0;try{let e=await bt();t.innerHTML=e.length?e.map(ma).join(``):`<tr><td colspan="4">کارمندی ثبت نشده.</td></tr>`}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}let r=document.getElementById(`wallet-tx-modal`),i=document.getElementById(`wallet-tx-modal-title`),a=document.getElementById(`wallet-tx-modal-list`);document.getElementById(`wallet-tx-modal-close`)?.addEventListener(`click`,()=>r.hidden=!0),t.addEventListener(`click`,e=>{let t=e.target.closest(`[data-wallet-view-tx]`);if(t){let e=Number(t.dataset.walletViewTx),n=t.dataset.walletStaffName??``;i.textContent=`تراکنش‌های ${n}`,a.innerHTML=`<p class="settings-panel-hint">در حال بارگذاری...</p>`,r.hidden=!1,xt(e,50,0).then(({transactions:e})=>{a.innerHTML=e.length?e.map(ha).join(``):`<p class="settings-panel-hint">تراکنشی ثبت نشده.</p>`});return}let n=e.target.closest(`[data-wallet-adjust]`);n&&(o.dataset.staffId=n.dataset.walletAdjust,o.hidden=!1)});let o=document.getElementById(`wallet-adjustment-modal`);document.getElementById(`wallet-adjustment-modal-close`)?.addEventListener(`click`,()=>o.hidden=!0),document.getElementById(`wallet-adjustment-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=Number(o.dataset.staffId),r=document.getElementById(`adjustment-direction`).value,i=Number(document.getElementById(`adjustment-amount`).value),a=document.getElementById(`adjustment-description`).value.trim(),s=document.getElementById(`adjustment-error`),c=document.getElementById(`adjustment-submit`);if(s.hidden=!0,!Number.isFinite(i)||i<=0||!a){s.hidden=!1,s.textContent=`مبلغ و توضیح را کامل وارد کنید.`;return}c.disabled=!0,St(t,r,i,a).then(()=>(o.hidden=!0,document.getElementById(`wallet-adjustment-form`).reset(),n())).catch(e=>{s.hidden=!1,s.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}).finally(()=>{c.disabled=!1})});let s=document.getElementById(`payroll-error`),c=document.getElementById(`payroll-preview-wrap`),l=document.getElementById(`payroll-preview-body`),u=document.getElementById(`payroll-result`),d=document.getElementById(`payroll-month`);d.value=new Date().toISOString().slice(0,7);function f(e){return`
    ...
    `}document.getElementById(`payroll-preview-btn`)?.addEventListener(`click`,()=>{s.hidden=!0,u.hidden=!0,Et(d.value).then(e=>{l.innerHTML=e.map(f).join(``),c.hidden=!1}).catch(e=>{s.hidden=!1,s.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`})}),document.getElementById(`payroll-confirm-btn`)?.addEventListener(`click`,()=>{let e=[];document.querySelectorAll(`[data-payroll-entry]`).forEach(t=>{let n=t.querySelector(`[data-field="include"]`),r=t.querySelector(`[data-field="amount"]`);n?.checked&&r&&Number(r.value)>0&&e.push({staffId:Number(t.dataset.payrollEntry),amount:Number(r.value)})}),e.length&&(s.hidden=!0,Dt(d.value,e).then(e=>{u.hidden=!1,u.textContent=`${e.processed} نفر پردازش شد.${e.skipped.length?` (${e.skipped.length} مورد رد شد — قبلاً واریز شده یا نامعتبر بود)`:``}`,n()}).catch(e=>{s.hidden=!1,s.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}))});let p=document.getElementById(`payouts-error`),m=document.getElementById(`payouts-list`);async function h(){p.hidden=!0;try{let e=await Ct(`pending`);m.innerHTML=e.length?e.map(ga).join(``):`<p class="settings-panel-hint">درخواست در انتظاری نیست.</p>`}catch(e){p.hidden=!1,p.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}m.addEventListener(`click`,e=>{let t=e.target.closest(`[data-payout-approve]`);if(t){wt(Number(t.dataset.payoutApprove)).then(()=>Promise.all([h(),n()])).catch(e=>{p.hidden=!1,p.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`});return}let r=e.target.closest(`[data-payout-reject]`);if(r){let e=window.prompt(`دلیل رد (اختیاری):`)??void 0;Tt(Number(r.dataset.payoutReject),e).then(()=>h()).catch(e=>{p.hidden=!1,p.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`})}});let g=document.getElementById(`rates-error`),_=document.getElementById(`rates-saved-note`),v=document.getElementById(`role-rates-body`);async function y(){g.hidden=!0;try{let{roles:e}=await re();v.innerHTML=e.map(_a).join(``)}catch(e){g.hidden=!1,g.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}v.addEventListener(`click`,e=>{let t=e.target.closest(`[data-role-rate-save]`);if(!t)return;let n=t.closest(`[data-role-rate-row]`),r=Number(n.dataset.roleRateRow),i=Number(n.querySelector(`[data-field="salary"]`).value),a=n.querySelector(`[data-field="bonusType"]`).value,o=Number(n.querySelector(`[data-field="bonusAmount"]`).value);g.hidden=!0,K(r,{defaultSalaryAmount:i,defaultBonusType:a,defaultBonusAmount:o}).then(()=>{_.hidden=!1,window.setTimeout(()=>_.hidden=!0,2500)}).catch(e=>{g.hidden=!1,g.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`})}),n(),h(),y()}function ya(e,t,n){return`
    <button type="button" class="home-tile" data-home-tile="${e}">
      <span class="home-tile-icon">${t}</span>
      <span class="home-tile-label">${n}</span>
    </button>
  `}function ba(e){let t=x(e,`content`)||x(e,`stories`)||x(e,`seo`)||x(e,`settings`),n=x(e,`staff`)||x(e,`recruitment`)||x(e,`roles`)||x(e,`wallet`),r=x(e,`settings`)||x(e,`homepage`),i=x(e,`pipeline`)||x(e,`map`),a=[];return i&&a.push(ya(`requests`,u.columns,`درخواست‌ها`)),x(e,`dashboard`)&&a.push(ya(`dashboard`,u.chart,`داشبورد`)),x(e,`chat`)&&a.push(ya(`chat`,u.chat,`چت پشتیبانی`)),t&&a.push(ya(`content`,u.grid,`مدیریت محتوا`)),n&&a.push(ya(`personnel`,u.users,`مدیریت پرسنل`)),x(e,`staff`)&&a.push(ya(`fleet`,u.truck,`مدیریت ناوگان حمل‌ونقل`)),x(e,`plugins`)&&a.push(ya(`plugins`,u.plugin,`افزونه‌ها`)),r&&a.push(ya(`settings`,u.settings,`تنظیمات سایت`)),`<div class="home-grid">${a.join(``)}</div>`}function xa(e){let t=[];return x(e,`pipeline`)&&t.push(ya(`pipeline`,u.columns,`مراحل درخواست‌ها`)),x(e,`map`)&&t.push(ya(`map`,u.map,`نقشه درخواست‌ها`)),`<div class="home-grid">${t.join(``)}</div>`}function Sa(e){let t=[];return x(e,`content`)&&t.push(ya(`magazine`,u.article,`مجله`)),x(e,`content`)&&t.push(ya(`testimonials`,u.message,`نظرات مشتریان`)),x(e,`stories`)&&t.push(ya(`stories`,u.story,`استوری‌ها`)),x(e,`seo`)&&t.push(ya(`seo`,u.seo,`مدیریت سئو`)),(x(e,`content`)||x(e,`settings`))&&t.push(ya(`media`,u.image,`مدیریت فایل`)),`<div class="home-grid">${t.join(``)}</div>`}function Ca(e){let t=[];return x(e,`staff`)&&t.push(ya(`staff`,u.users,`کارمندان`)),x(e,`recruitment`)&&t.push(ya(`jobApplications`,u.briefcase,`فرصت‌های شغلی`)),x(e,`roles`)&&t.push(ya(`roles`,u.lock,`نقش‌ها و اختیارات`)),(x(e,`staff`)||x(e,`roles`))&&t.push(ya(`activityLog`,u.history,`گزارش فعالیت`)),x(e,`wallet`)&&t.push(ya(`payroll`,u.wallet,`حقوق و دستمزد`)),`<div class="home-grid">${t.join(``)}</div>`}function wa(e,t){e.querySelectorAll(`[data-home-tile]`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.homeTile??``))})}async function Ta(){try{let e=(await Te()).site_name?.fa?.trim();if(!e||e===`بهبار`)return;document.querySelectorAll(`#login-brand-text, .admin-logo-title, #staff-portal-brand-text`).forEach(t=>{t.textContent?.includes(`بهبار`)&&(t.textContent=t.textContent.replace(/بهبار/g,e))})}catch{}}function Ea(e){return e===`home`?null:e===`requests`||e===`content`||e===`personnel`||e===`dashboard`?`home`:e===`pipeline`||e===`map`?`requests`:e===`magazine`||e===`testimonials`||e===`stories`||e===`seo`||e===`media`?`content`:e===`staff`||e===`jobApplications`||e===`roles`||e===`activityLog`||e===`payroll`?`personnel`:e===`staffHistory`?`staff`:e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`?`dashboard`:e===`magazine-editor`?`magazine`:e===`page-editor`||e===`pages`?`settings`:`home`}function Da(){let e=document.querySelector(`#app`);if(!e)throw Error(`#app not found`);return e}function Oa(){let e=Da();e.innerHTML=At(),jt(Ia),Ta()}var ka=`home`,Aa=null;function $(e,t=null){let n=document.getElementById(`view-container`),r=document.getElementById(`admin-back-btn`),i=g();if(!(!n||!i)){if(ka=e,r&&(r.hidden=e===`home`),v({screen:e,extra:e===`magazine-editor`||e===`page-editor`?t:e===`staffHistory`?Aa:void 0}),document.querySelectorAll(`#admin-topbar-nav .admin-topbar-tab`).forEach(t=>{let n=t.dataset.adminTab,r=n===e||n===`dashboard`&&(e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`)||n===`home`&&![`dashboard`,`dashboardOrders`,`dashboardVisitors`,`dashboardStaff`,`pipeline`,`map`,`fleet`].includes(e);t.classList.toggle(`is-active`,!!r)}),e===`home`)n.innerHTML=ba(i),wa(n,e=>$(e));else if(e===`requests`)n.innerHTML=xa(i),wa(n,e=>$(e));else if(e===`content`)n.innerHTML=Sa(i),wa(n,e=>$(e));else if(e===`personnel`)n.innerHTML=Ca(i),wa(n,e=>$(e));else if(e===`dashboard`)n.innerHTML=vn(),yn(e=>$(e));else if(e===`dashboardOrders`)n.innerHTML=bn();else if(e===`dashboardVisitors`)n.innerHTML=xn();else if(e===`dashboardStaff`)n.innerHTML=Sn();else if(e===`pipeline`)n.innerHTML=dn(),fn();else if(e===`map`)n.innerHTML=Dn(),On();else if(e===`staff`)n.innerHTML=Mn(),Nn(e=>{Aa=e,$(`staffHistory`)});else if(e===`staffHistory`){if(!Aa){$(`staff`);return}n.innerHTML=Fn(Aa),In(Aa)}else if(e===`fleet`)n.innerHTML=er(),tr();else if(e===`magazine`)n.innerHTML=_r(),vr(e=>$(`magazine-editor`,e));else if(e===`magazine-editor`)n.innerHTML=Fr(),Ir(t,()=>$(`magazine`));else if(e===`pages`){$(`settings`);return}else e===`page-editor`?(n.innerHTML=Hr(),Ur(t,()=>$(`settings`))):e===`testimonials`?(n.innerHTML=Jr(),Yr()):e===`chat`?(n.innerHTML=ni(),ri()):e===`stories`?(n.innerHTML=si(),ci()):e===`jobApplications`?(n.innerHTML=gi(),_i()):e===`settings`?(n.innerHTML=Ui(),Wi((e,t)=>$(e,t??null))):e===`plugins`?(n.innerHTML=qi(),Zi()):e===`seo`?(n.innerHTML=sa(),ca(e=>$(`magazine-editor`,e))):e===`media`?(n.innerHTML=Ln(),Rn()):e===`roles`?(n.innerHTML=Bn(),Vn()):e===`activityLog`?(n.innerHTML=bi(),xi()):e===`accountSecurity`?(n.innerHTML=la(),ua()):e===`myWallet`?(n.innerHTML=or(),lr()):e===`payroll`?(n.innerHTML=pa(),va()):(n.innerHTML=ba(i),wa(n,e=>$(e)))}}function ja(e,t=!1){let n=Da();n.innerHTML=Rt(e),document.getElementById(`admin-back-btn`)?.addEventListener(`click`,()=>{let e=Ea(ka);e&&$(e)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{j(),_(),Oa()}),document.getElementById(`admin-account-btn`)?.addEventListener(`click`,()=>$(`accountSecurity`)),document.getElementById(`admin-wallet-btn`)?.addEventListener(`click`,()=>$(`myWallet`)),document.querySelectorAll(`#admin-topbar-nav .admin-topbar-tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.adminTab;t&&$(t)})}),document.getElementById(`admin-logo-btn`)?.addEventListener(`click`,()=>{$(x(e,`dashboard`)?`dashboard`:`home`)}),x(e,`settings`)&&Na(),Ma(),Wn(),Ta(),x(e,`ai`)&&Ft();let r=t?y():null;r?.screen===`staffHistory`&&r.extra?(Aa=r.extra,$(`staffHistory`)):r?.screen===`magazine-editor`?$(`magazine-editor`,r.extra??null):r?.screen===`page-editor`?$(`page-editor`,r.extra??null):r?.screen?$(r.screen):$(x(e,`dashboard`)?`dashboard`:`home`)}async function Ma(){try{let e=await Te(),t=e.branding,n=t?.logoUrl;n&&document.querySelectorAll(`.admin-logo-mark`).forEach(e=>e.src=n);let r=t?.faviconUrl||n;r&&document.querySelectorAll(`link[rel="icon"]`).forEach(e=>e.href=r);let i=e.site_name;i?.fa?.trim()&&(document.title=`${i.fa.trim()} - پنل مدیریت`,document.querySelectorAll(`.admin-logo-title`).forEach(e=>e.textContent=i.fa.trim()))}catch{}}async function Na(){let e=document.getElementById(`admin-sidebar-version`);if(e)try{let t=await gt();e.textContent=t.updateAvailable?`نسخه ${t.current} · نسخه جدید موجود است`:`نسخه ${t.current}`,e.classList.toggle(`has-update`,t.updateAvailable),e.hidden=!1}catch{}}function Pa(e){let t=Da();t.innerHTML=pr(e),Ta(),hr(()=>{j(),_(),Oa()})}function Fa(e){let t=Da();t.innerHTML=ra(),Ta(),ia(e,()=>ja(e))}function Ia(e,t=!1){if(!S(e)){Pa(e);return}if(!x(e,`settings`)){ja(e,t);return}Te().then(n=>{ta(n)?Fa(e):ja(e,t)}).catch(()=>ja(e,t))}function La(){if(T(Oa),!b()){Oa();return}let e=g();e?Ia(e,!0):Oa(),te().then(t=>{let n=h();n&&(m(n,t),(!e||e.role!==t.role)&&Ia(t,!0))}).catch(()=>{})}La();