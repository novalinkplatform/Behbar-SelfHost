var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,o)=>(o=n==null?{}:e(i(n)),s(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=`viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"`,u={route:`<svg ${l}><circle cx="5.5" cy="6" r="2"/><circle cx="18.5" cy="18" r="2"/><path d="M5.5 8v3a3 3 0 0 0 3 3h7a3 3 0 0 1 3 3"/></svg>`,grid:`<svg ${l}><rect x="3.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="3.5" y="13.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="13.5" width="7" height="7" rx="1.5"/></svg>`,chart:`<svg ${l}><path d="M4 20V10M12 20V4M20 20v-7"/><path d="M2 20h20"/></svg>`,columns:`<svg ${l}><rect x="3.5" y="4" width="5" height="16" rx="1"/><rect x="9.5" y="4" width="5" height="10" rx="1"/><rect x="15.5" y="4" width="5" height="13" rx="1"/></svg>`,phone:`<svg ${l}><path d="M5.5 4h2.8l1.2 4-2 1.3a11 11 0 0 0 5.2 5.2l1.3-2 4 1.2v2.8c0 1-.9 1.7-1.8 1.5-6-1.1-10.6-5.7-11.7-11.7C4.3 5.4 5 4 5.5 4Z"/></svg>`,pin:`<svg ${l}><path d="M12 21s-6.5-5.6-6.5-11a6.5 6.5 0 0 1 13 0c0 5.4-6.5 11-6.5 11Z"/><circle cx="12" cy="10" r="2.3"/></svg>`,flag:`<svg ${l}><path d="M6 21V4"/><path d="M6 4.5h10.5L14 8l2.5 3.5H6"/></svg>`,calendar:`<svg ${l}><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 9.5h17M8 3v4M16 3v4"/></svg>`,logout:`<svg ${l}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/></svg>`,lock:`<svg ${l}><rect x="4.5" y="10.5" width="15" height="10" rx="2"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/></svg>`,close:`<svg ${l}><path d="m5 5 14 14M19 5 5 19"/></svg>`,chevronDown:`<svg ${l}><path d="m6 9 6 6 6-6"/></svg>`,refresh:`<svg ${l}><path d="M3.5 12a8.5 8.5 0 0 1 14.5-6M20.5 12a8.5 8.5 0 0 1-14.5 6"/><path d="M18 3v4h-4M6 21v-4h4"/></svg>`,map:`<svg ${l}><path d="M9 4 4 6v14l5-2 6 2 5-2V4l-5 2-6-2Z"/><path d="M9 4v14M15 6v14"/></svg>`,users:`<svg ${l}><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0 1 12 0"/><circle cx="17" cy="9" r="2.3"/><path d="M15.5 20a4.5 4.5 0 0 1 5.5-4.4"/></svg>`,plusCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="M12 8v8M8 12h8"/></svg>`,checkCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="m8.5 12.3 2.3 2.3 4.7-5"/></svg>`,user:`<svg ${l}><circle cx="12" cy="8" r="3.5"/><path d="M5 20a7 7 0 0 1 14 0"/></svg>`,article:`<svg ${l}><rect x="5" y="3.5" width="14" height="17" rx="1.5"/><path d="M8.5 8h7M8.5 12h7M8.5 16h4"/></svg>`,settings:`<svg ${l}><circle cx="12" cy="12" r="3.2"/><path d="M12 3v2.4M12 18.6V21M21 12h-2.4M5.4 12H3M18.4 5.6l-1.7 1.7M7.3 16.7l-1.7 1.7M18.4 18.4l-1.7-1.7M7.3 7.3 5.6 5.6"/></svg>`,message:`<svg ${l}><path d="M4 5.5h16a1 1 0 0 1 1 1V16a1 1 0 0 1-1 1H9l-4.5 3.5V17H4a1 1 0 0 1-1-1V6.5a1 1 0 0 1 1-1Z"/><path d="M7.5 9.5h9M7.5 13h6"/></svg>`,chat:`<svg ${l}><path d="M3.5 6.5A2.5 2.5 0 0 1 6 4h9a2.5 2.5 0 0 1 2.5 2.5v6A2.5 2.5 0 0 1 15 15H9l-4 3.5v-3.5H6a2.5 2.5 0 0 1-2.5-2.5v-6Z"/><circle cx="7.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="11.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="15" cy="9.5" r="0.9" fill="currentColor" stroke="none"/></svg>`,story:`<svg ${l}><rect x="7" y="3" width="10" height="17" rx="2.2"/><circle cx="12" cy="7.2" r="1.5" fill="currentColor" stroke="none"/></svg>`,briefcase:`<svg ${l}><rect x="3" y="7.5" width="18" height="12" rx="2"/><path d="M8.5 7.5V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1.5"/><path d="M3 12.5h18M10.5 12.5v2h3v-2"/></svg>`,download:`<svg ${l}><path d="M12 3.5v11M8 10.5l4 4 4-4"/><path d="M4.5 17v2a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-2"/></svg>`,truck:`<svg ${l}><rect x="2" y="7" width="11" height="7" rx="1"/><path d="M13 10h4l3 3v1h-2"/><path d="M7.8 17h6.9"/><circle cx="6" cy="17" r="1.8"/><circle cx="16.5" cy="17" r="1.8"/></svg>`,seo:`<svg ${l}><circle cx="10.5" cy="10.5" r="6.5"/><path d="m20 20-4.8-4.8"/><path d="M7.5 10.5h6M10.5 7.5v6"/></svg>`,ai:`<svg ${l}><path d="M11 3 12.7 8 17.5 9.7 12.7 11.4 11 16.4 9.3 11.4 4.5 9.7 9.3 8Z"/><path d="M18 15.5 18.8 17.7 21 18.5 18.8 19.3 18 21.5 17.2 19.3 15 18.5 17.2 17.7Z"/></svg>`,image:`<svg ${l}><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m5 17 5-5 3 3 3-4 3 6"/></svg>`,video:`<svg ${l}><rect x="3" y="6" width="12" height="12" rx="2"/><path d="m15 10 6-3v10l-6-3Z"/></svg>`,audio:`<svg ${l}><path d="M9 18V6l8-2v12"/><circle cx="7" cy="18" r="2.2"/><circle cx="17" cy="16" r="2.2"/></svg>`,arrowRight:`<svg ${l}><path d="M5 12h14M13 6l6 6-6 6"/></svg>`,arrowLeft:`<svg ${l}><path d="M19 12H5M11 18l-6-6 6-6"/></svg>`,maleAvatar:`<svg ${l}><circle cx="12" cy="8" r="4"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,femaleAvatar:`<svg ${l}><circle cx="12" cy="7.5" r="4"/><path d="M12 11.5v6M9 15h6"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,eye:`<svg ${l}><path d="M2 12s3.8-7 10-7 10 7 10 7-3.8 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>`,history:`<svg ${l}><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/><path d="M12 8v4l3 2"/></svg>`,link:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.6 4.9a3.7 3.7 0 0 1 5.2 5.2L16 12"/><path d="M13 17.5 11.4 19.1a3.7 3.7 0 0 1-5.2-5.2L8 12"/></svg>`,externalLink:`<svg ${l}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`,unlink:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.2 5.3a3.7 3.7 0 0 1 5.2 5.2L16.2 11.7"/><path d="M13 17.5 11.8 18.7a3.7 3.7 0 0 1-5.2-5.2L7.8 12.3"/><path d="m4 4 16 16"/></svg>`,quote:`<svg ${l}><path d="M7.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/><path d="M16.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/></svg>`,undo:`<svg ${l}><path d="M4 12a8 8 0 1 1 2.6 5.9"/><path d="M4 6.5V12h5.5"/></svg>`,redo:`<svg ${l}><path d="M20 12a8 8 0 1 0-2.6 5.9"/><path d="M20 6.5V12h-5.5"/></svg>`,minus:`<svg ${l}><path d="M4 12h16"/></svg>`,eraser:`<svg ${l}><path d="m17.5 8.5-9 9H4l-1-1L14 5.5a2 2 0 0 1 2.8 0l2 2a2 2 0 0 1-.3 2.9L9.5 19"/></svg>`,alignLeft:`<svg ${l}><path d="M4 6h16M4 12h10M4 18h13"/></svg>`,alignCenter:`<svg ${l}><path d="M4 6h16M7 12h10M5.5 18h13"/></svg>`,alignRight:`<svg ${l}><path d="M4 6h16M10 12h10M7 18h13"/></svg>`,listBullet:`<svg ${l}><circle cx="4.5" cy="6" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="18" r="1" fill="currentColor" stroke="none"/><path d="M9 6h11M9 12h11M9 18h11"/></svg>`,listNumber:`<svg ${l}><path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 5v3M3.3 5H4.7M3 11.5h1.6c.5 0 .9.4.9.9 0 .3-.2.5-.4.7L3 15h2.6M3.3 19h1.4c.5 0 .9-.4.9-.9s-.4-.9-.9-.9H3.3"/></svg>`,plugin:`<svg ${l}><path d="M12 3 4 7v10l8 4 8-4V7Z"/><path d="M4 7l8 4 8-4M12 11v10"/></svg>`,wallet:`<svg ${l}><path d="M3 7a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v1"/><path d="M3 7v10a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2H5"/><circle cx="16" cy="13" r="1.2" fill="currentColor" stroke="none"/></svg>`,finance:`<svg ${l}><rect x="2" y="6" width="20" height="12" rx="2"/><circle cx="12" cy="12" r="2.5"/><path d="M6 12h.01M18 12h.01"/></svg>`,fileSpreadsheet:`<svg ${l}><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/><path d="M8 13h8M8 17h8M12 13v8"/></svg>`,printer:`<svg ${l}><polyline points="6 9 6 2 18 2 18 9"/><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"/><rect x="6" y="14" width="12" height="8"/></svg>`,sun:`<svg ${l}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>`,moon:`<svg ${l}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>`},d=`behbar_admin_token`,f=`behbar_admin_staff`,p=`behbar_admin_screen`;function m(e,t){localStorage.setItem(d,e),localStorage.setItem(f,JSON.stringify(t))}function h(){return localStorage.getItem(d)}function g(){let e=localStorage.getItem(f);if(!e)return null;try{let t=JSON.parse(e);return Array.isArray(t.permissions)?t:(_(),null)}catch{return null}}function _(){localStorage.removeItem(d),localStorage.removeItem(f),localStorage.removeItem(p)}function v(e){localStorage.setItem(p,JSON.stringify(e))}function y(){let e=localStorage.getItem(p);if(!e)return null;try{return JSON.parse(e)}catch{return null}}function b(){return h()!==null&&g()!==null}function x(e,t){return(e.permissions??[]).includes(t)}function S(e){return(e.permissions??[]).some(e=>e!==`assignments`)}var C=class extends Error{},w=null;function T(e){w=e}async function E(e,t={}){let n=h(),r=await fetch(`${e}`,{...t,headers:{...t.headers,...n?{Authorization:`Bearer ${n}`}:{}}});if(r.status===401)throw _(),w?.(),new C(`نشست شما منقضی شده است.`);return r}async function D(e,t){let n=await fetch(`/api/staff/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ورود ناموفق بود.`);return r?.needsTwoFactor?{needsTwoFactor:!0,challengeToken:r.challengeToken}:{needsTwoFactor:!1,token:r.token,staff:r.staff}}async function O(e,t){let n=await fetch(`/api/staff/login/verify-2fa`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({challengeToken:e,code:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`کد نامعتبر است.`);return r}async function ee(){let e=await E(`/api/staff/2fa/sms/setup`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال کد ناموفق بود.`)}async function k(e){let t=await E(`/api/staff/2fa/sms/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({code:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید کد ناموفق بود.`)}async function A(e){let t=await E(`/api/staff/2fa/disable`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`غیرفعال‌سازی ناموفق بود.`)}async function j(){await E(`/api/staff/logout`,{method:`POST`}).catch(()=>{})}async function te(){let e=await E(`/api/staff/me`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات ناموفق بود.`);return{...t.staff,licenseLocked:!!t.licenseLocked,licenseSummary:t.licenseSummary}}async function M(e){let t=await E(`/api/admin/requests${e?`?status=${encodeURIComponent(e)}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌ها ناموفق بود.`);return n.requests??[]}async function N(e,t){let n=await E(`/api/admin/requests/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function P(e){let t=await E(`/api/admin/requests/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function F(){let e=await E(`/api/admin/requests/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت خروجی ناموفق بود.`)}let t=await e.blob(),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`behbar-requests-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)}async function I(){let e=await E(`/api/admin/activity-log`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گزارش فعالیت ناموفق بود.`);return t.entries??[]}async function R(e,t){let n=await E(`/api/admin/requests/${e}/assign`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({staffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اختصاص ناموفق بود.`)}async function z(){let e=await E(`/api/admin/stats`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار ناموفق بود.`);return t}async function B(){let e=await E(`/api/admin/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کارمندان ناموفق بود.`);return t.staff??[]}async function ne(e){let t=await E(`/api/admin/staff`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد کارمند ناموفق بود.`);return n.staff}async function re(){let e=await E(`/api/admin/roles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نقش‌ها ناموفق بود.`);return{roles:t.roles??[],permissions:t.permissions??[]}}async function ie(e){let t=await E(`/api/admin/roles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نقش ناموفق بود.`);return n.role}async function ae(e,t){let n=await E(`/api/admin/roles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نقش ناموفق بود.`);return r.role}async function oe(e){let t=await E(`/api/admin/roles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نقش ناموفق بود.`)}async function se(e,t){let n=await E(`/api/admin/staff/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی کارمند ناموفق بود.`);return r.staff}async function ce(e){let t=await E(`/api/admin/staff/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف کارمند ناموفق بود.`)}async function le(){let e=await E(`/api/staff/requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌ها ناموفق بود.`);return t.requests??[]}async function ue(e,t){let n=await E(`/api/staff/requests/${e}/status`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function de(){let e=await E(`/api/admin/articles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت مقالات ناموفق بود.`);return t.articles??[]}async function fe(e){let t=await E(`/api/admin/articles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد مقاله ناموفق بود.`);return n.article}async function pe(e,t){let n=await E(`/api/admin/articles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی مقاله ناموفق بود.`);return r.article}async function me(e,t){let n=await E(`/api/admin/articles/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.article}async function he(e){let t=await E(`/api/admin/articles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف مقاله ناموفق بود.`)}async function ge(){let e=await E(`/api/admin/pages`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت برگه‌ها ناموفق بود.`);return t.pages??[]}async function _e(e){let t=await E(`/api/admin/pages/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت برگه ناموفق بود.`);return n.page}async function ve(e){let t=await E(`/api/admin/pages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد برگه ناموفق بود.`);return n.page}async function ye(e,t){let n=await E(`/api/admin/pages/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی برگه ناموفق بود.`);return r.page}async function be(e,t){let n=await E(`/api/admin/pages/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت برگه ناموفق بود.`);return r.page}async function xe(e){let t=await E(`/api/admin/pages/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف برگه ناموفق بود.`)}async function Se(e){let t=h(),n=await fetch(`/api/admin/upload`,{method:`POST`,headers:{"Content-Type":e.type,...t?{Authorization:`Bearer ${t}`}:{}},body:e}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`آپلود تصویر ناموفق بود.`);return`${r.url}`}async function Ce(e){let t=await E(`/api/admin/media${e?`?folder=${e}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت فهرست فایل‌ها ناموفق بود.`);return n.files??[]}async function we(e){let t=await E(`/api/admin/media/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف فایل ناموفق بود.`)}async function Te(){let e=await fetch(`/api/settings`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت تنظیمات ناموفق بود.`);return t.settings??{}}async function V(e,t){let n=await E(`/api/admin/settings`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({key:e,value:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی تنظیمات ناموفق بود.`)}async function Ee(e,t,n){let r=await E(`/api/admin/ai/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,apiKey:t,model:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اتصال ناموفق بود.`);return i}async function De(e,t){let n=await E(`/api/admin/sms/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اتصال ناموفق بود.`);return r}async function Oe(){let e=await E(`/api/admin/testimonials`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نظرات ناموفق بود.`);return t.testimonials??[]}async function ke(e){let t=await E(`/api/admin/testimonials`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نظر ناموفق بود.`);return n.testimonial}async function Ae(e,t){let n=await E(`/api/admin/testimonials/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نظر ناموفق بود.`);return r.testimonial}async function je(e){let t=await E(`/api/admin/testimonials/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نظر ناموفق بود.`)}async function Me(){let e=await E(`/api/admin/license`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات لایسنس ناموفق بود.`);return t.license??null}async function Ne(e){let t=await E(`/api/admin/license/activate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({licenseKey:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`فعال‌سازی لایسنس ناموفق بود.`);return n.license}async function Pe(){let e=await E(`/api/admin/chat/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گفتگوها ناموفق بود.`);return t.conversations??[]}async function Fe(e){let t=await E(`/api/admin/chat/conversations/${e}/messages`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیام‌ها ناموفق بود.`);return n.messages??[]}async function Ie(e,t){let n=await E(`/api/admin/chat/conversations/${e}/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({text:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارسال پیام ناموفق بود.`)}async function Le(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`)}async function Re(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({assignedStaffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`واگذاری گفتگو ناموفق بود.`)}async function ze(e,t){let n=await E(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({archived:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`بایگانی گفتگو ناموفق بود.`)}async function Be(e){let t=await E(`/api/admin/chat/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function Ve(e){let t=await E(`/api/admin/requests?phone=${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های مرتبط ناموفق بود.`);return n.requests??[]}async function He(e){let t=await E(`/api/admin/requests?staffId=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.requests??[]}async function Ue(e){let t=await E(`/api/admin/requests/${e}/events`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.events??[]}async function We(){let e=await E(`/api/admin/chat/agents`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت پشتیبان‌ها ناموفق بود.`);return t.agents??[]}async function Ge(){let e=await E(`/api/admin/stories`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت استوری‌ها ناموفق بود.`);return t.stories??[]}async function Ke(e){let t=await E(`/api/admin/stories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد استوری ناموفق بود.`);return n.story}async function qe(e,t){let n=await E(`/api/admin/stories/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی استوری ناموفق بود.`);return r.story}async function H(e){let t=await E(`/api/admin/stories/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف استوری ناموفق بود.`)}async function Je(){let e=await E(`/api/admin/job-applications`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های همکاری ناموفق بود.`);return t.applications??[]}async function Ye(e,t){let n=await E(`/api/admin/job-applications/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.application}async function Xe(e){let t=await E(`/api/admin/job-applications/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function Ze(){let e=await E(`/api/admin/fleet-vehicles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت وسایل نقلیه ناموفق بود.`);return t.vehicles??[]}async function Qe(e){let t=await E(`/api/admin/fleet-vehicles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد وسیله نقلیه ناموفق بود.`);return n.vehicle}async function $e(e,t){let n=await E(`/api/admin/fleet-vehicles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وسیله نقلیه ناموفق بود.`);return r.vehicle}async function et(e){let t=await E(`/api/admin/fleet-vehicles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف وسیله نقلیه ناموفق بود.`)}async function tt(){let e=await E(`/api/admin/plugins`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت افزونه‌ها ناموفق بود.`);return t.plugins??{}}async function nt(e){let t=await E(`/api/admin/requests/${e}/reports`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت گزارش‌ها ناموفق بود.`);return n.reports??[]}async function rt(e,t){let n=await E(`/api/admin/requests/${e}/reports`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({message:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت گزارش ناموفق بود.`);return r}async function it(){let e=await E(`/api/admin/analytics`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار بازدید ناموفق بود.`);return t}async function at(){let e=await E(`/api/admin/backup/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت فایل پشتیبان ناموفق بود.`)}let t=(e.headers.get(`Content-Disposition`)??``).match(/filename="([^"]+)"/)?.[1]??`behbar-backup.sql`,n=await e.blob(),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function ot(e){let t=await E(`/api/admin/backup/import`,{method:`POST`,headers:{"Content-Type":`application/sql`},body:e}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`بازیابی پشتیبان ناموفق بود.`)}async function st(){let e=await E(`/api/admin/backup/drive-test`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال آزمایشی به گوگل درایو ناموفق بود.`)}async function ct(){let e=await E(`/api/admin/backup/drive-oauth/prepare`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`آماده‌سازی اتصال به گوگل ناموفق بود.`);return t.authUrl}async function lt(){let e=await E(`/api/admin/backup/drive-disconnect`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`قطع اتصال ناموفق بود.`)}async function ut(e,t){let n=await E(`/api/admin/ai/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,conversationId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارتباط با دستیار هوش مصنوعی ناموفق بود.`);return r}async function dt(e,t,n){let r=await E(`/api/admin/ai/execute`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,toolCallId:t.toolCallId,tool:t.tool,args:t.args,conversationId:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اجرای اقدام ناموفق بود.`);return i}async function ft(){let e=await E(`/api/admin/ai/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`فهرست گفتگوها دریافت نشد.`);return t.conversations??[]}async function pt(e){let t=await E(`/api/admin/ai/conversations/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`گفتگو دریافت نشد.`);return n}async function mt(){let e=await E(`/api/admin/ai/conversations`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ساخت گفتگوی جدید ناموفق بود.`);return t.id}async function ht(e){let t=await E(`/api/admin/ai/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function gt(){let e=await E(`/api/admin/version`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات نسخه ناموفق بود.`);return t}async function _t(){let e=await E(`/api/admin/selfhost/update`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`به‌روزرسانی ناموفق بود.`)}async function vt(){let e=await E(`/api/staff/wallet`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول ناموفق بود.`);return t}async function U(e,t){let n=await E(`/api/staff/wallet/transactions?limit=${e}&offset=${t}`),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:r.transactions??[],total:r.total??0}}async function W(){let e=await E(`/api/staff/wallet/payout-requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return t.payoutRequests??[]}async function yt(e,t){let n=await E(`/api/staff/wallet/payout-requests`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({amount:e,note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت درخواست تسویه ناموفق بود.`)}async function bt(){let e=await E(`/api/admin/wallet/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول‌ها ناموفق بود.`);return t.wallets??[]}async function xt(e,t,n){let r=await E(`/api/admin/wallet/staff/${e}/transactions?limit=${t}&offset=${n}`),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:i.transactions??[],total:i.total??0}}async function St(e,t,n,r){let i=await E(`/api/admin/wallet/staff/${e}/adjustments`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({direction:t,amount:n,description:r})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(typeof a?.error==`string`?a.error:`ثبت اصلاحیه ناموفق بود.`)}async function G(e,t){let n=await E(`/api/admin/wallet/staff/${e}/rate-override`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ ناموفق بود.`)}async function Ct(e,t){let n=await E(`/api/admin/roles/${e}/pay-rate`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ نقش ناموفق بود.`)}async function wt(e=`pending`){let t=await E(`/api/admin/wallet/payout-requests?status=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return n.payoutRequests??[]}async function Tt(e){let t=await E(`/api/admin/wallet/payout-requests/${e}/approve`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید درخواست ناموفق بود.`)}async function Et(e,t){let n=await E(`/api/admin/wallet/payout-requests/${e}/reject`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`رد درخواست ناموفق بود.`)}async function Dt(e){let t=await E(`/api/admin/wallet/payroll/preview?month=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیش‌نمایش حقوق ناموفق بود.`);return n.entries??[]}async function Ot(e,t){let n=await E(`/api/admin/wallet/payroll/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({month:e,entries:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`پردازش حقوق ناموفق بود.`);return r}function kt(e,t=6){return`
  ...
  `}function It(){let e=document.getElementById(`ai-widget-toggle`),t=document.getElementById(`ai-widget-close`),n=document.getElementById(`ai-widget-panel`),r=document.getElementById(`ai-widget-error`),i=document.getElementById(`ai-widget-messages`),a=document.getElementById(`ai-widget-form`),o=document.getElementById(`ai-widget-input`),s=document.getElementById(`ai-widget-send-btn`),c=document.getElementById(`ai-widget-new-chat-btn`),l=document.getElementById(`ai-widget-conversation-list`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l)return;let d=[],f=null,p=[],m=null,h=!1;function g(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}function _(){l.innerHTML=d.length?d.map(e=>`
        <div class="ai-widget-conversation-row ${e.id===f?`is-active`:``}" data-conversation-id="${e.id}">
          <button type="button" class="ai-widget-conversation-title" data-select-conversation="${e.id}">${Nt(e.title||`گفتگوی جدید`)}</button>
          <button type="button" class="ai-widget-conversation-delete" data-delete-conversation="${e.id}" title="حذف">حذف</button>
        </div>
      `).join(``):`<p class="ai-widget-empty-list">هنوز گفتگویی نداری.</p>`}function v(){let e=[];p.length||e.push(`<div class="chat-bubble-admin chat-bubble-admin-customer"><div class="chat-bubble-body"><p>${Nt(Pt)}</p></div></div>`);for(let t of p)t.role===`user`&&t.content?e.push(`<div class="chat-bubble-admin chat-bubble-admin-staff"><div class="chat-bubble-body"><p>${Nt(t.content)}</p></div></div>`):t.role===`assistant`&&t.content&&e.push(`<div class="chat-bubble-admin chat-bubble-admin-customer"><div class="chat-bubble-body"><p>${Nt(t.content)}</p></div></div>`);m&&e.push(`
  ...
  `}var Bt=[{id:`pending`,label:`در انتظار بررسی`,color:`var(--muted)`},{id:`contacted`,label:`تماس گرفته شده`,color:`var(--warning)`},{id:`scheduled`,label:`زمان‌بندی شده`,color:`var(--secondary)`},{id:`in_progress`,label:`در حال انجام`,color:`var(--primary)`},{id:`completed`,label:`انجام شده`,color:`var(--success)`},{id:`cancelled`,label:`لغو شده`,color:`var(--danger)`}],Vt=Object.fromEntries(Bt.map(e=>[e.id,e.label])),Ht=Object.fromEntries(Bt.map(e=>[e.id,e.color])),Ut=[`۰`,`۱`,`۲`,`۳`,`۴`,`۵`,`۶`,`۷`,`۸`,`۹`];function K(e){return String(e).replace(/[0-9]/g,e=>Ut[Number(e)])}function q(e){return`${K(Math.round(e).toLocaleString(`en-US`))} تومان`}function J(e,t){return~~(e/t)}function Y(e,t){return e-~~(e/t)*t}var Wt=[-61,9,38,199,426,686,756,818,1111,1181,1210,1635,2060,2097,2192,2262,2324,2394,2456,3178];function Gt(e){let t=Wt.length,n=e+621,r=-14,i=Wt[0];if(e<i||e>=Wt[t-1])throw Error(`Invalid Jalaali year ${e}`);let a=0;for(let n=1;n<t;n+=1){let t=Wt[n];if(a=t-i,e<t)break;r=r+J(a,33)*8+J(Y(a,33),4),i=t}let o=e-i;r=r+J(o,33)*8+J(Y(o,33)+3,4),Y(a,33)===4&&a-o===4&&(r+=1);let s=J(n,4)-J((J(n,100)+1)*3,4)-150,c=20+r-s;a-o<6&&(o=o-a+J(a,33)*33);let l=Y(Y(o+1,33)-1,4);return l===-1&&(l=4),{leap:l,gy:n,march:c}}function Kt(e,t,n){let r=J((e+J(t-8,6)+100100)*1461,4)+J(153*Y(t+9,12)+2,5)+n-34840408;return r=r-J(J(e+100100+J(t-8,6),100)*3,4)+752,r}function qt(e){let t=4*e+139361631;t=t+J(J(4*e+183187720,146097)*3,4)*4-3908;let n=J(Y(t,1461),4)*5+308,r=J(Y(n,153),5)+1,i=Y(J(n,153),12)+1;return{gy:J(t,1461)-100100+J(8-i,6),gm:i,gd:r}}function Jt(e){let t=qt(e).gy-621,n=Gt(t),r=e-Kt(n.gy,3,n.march),i,a;if(r>=0){if(r<=185)return i=1+J(r,31),a=Y(r,31)+1,{jy:t,jm:i,jd:a};r-=186}else--t,r+=179,n.leap===1&&(r+=1);return i=7+J(r,30),a=Y(r,30)+1,{jy:t,jm:i,jd:a}}function Yt(e){return Jt(Kt(e.getFullYear(),e.getMonth()+1,e.getDate()))}var Xt=[`فروردین`,`اردیبهشت`,`خرداد`,`تیر`,`مرداد`,`شهریور`,`مهر`,`آبان`,`آذر`,`دی`,`بهمن`,`اسفند`],Zt=[`۰`,`۱`,`۲`,`۳`,`۴`,`۵`,`۶`,`۷`,`۸`,`۹`];function Qt(e){return String(e).replace(/[0-9]/g,e=>Zt[Number(e)])}function $t(e){return`${Xt[e.jm-1]} ${Qt(e.jd)}، ${Qt(e.jy)}`}function en(e){return new Date(e.replace(` `,`T`)+`Z`)}function tn(e){let t=en(e),n=Yt(new Date),r=Yt(t),i=`${Qt(String(t.getHours()).padStart(2,`0`))}:${Qt(String(t.getMinutes()).padStart(2,`0`))}`;return n.jy===r.jy&&n.jm===r.jm&&n.jd===r.jd?`امروز، ${i}`:`${$t(r)}، ${i}`}var nn=3e4,rn=`pending`,an;function on(e){return Bt.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${t.label}</option>`).join(``)}function X(e,t){return`<option value="">اختصاص‌نیافته</option>${t.map(t=>{let n=t.onActiveService&&t.id!==e,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``)}`}function sn(e,t){return!t||`${e.trackingCode} ${e.phone} ${e.originCity} ${e.destinationCity} ${e.customerName}`.toLowerCase().includes(t.toLowerCase())}function cn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ln(e){return e?e.length?e.map(e=>`
  ...
  `:`<p class="pipeline-report-empty">هنوز رویدادی ثبت نشده است.</p>`:``}function dn(e,t,n,r,i,a,o){return`
    <div class="pipeline-card" data-card-id="${e.id}" style="--card-accent:${Ht[e.status]??`var(--muted)`}">
      <div class="pipeline-card-top">
        <span class="pipeline-tracking">#${K(e.trackingCode)}</span>
        <span class="pipeline-card-top-end">
          <span class="pipeline-estimate">${q(e.estimateAvg)}</span>
      ...
      <div class="pipeline-row pipeline-muted">
        ...
        <span>${e.scheduledDate} — ساعت ${K(e.scheduledTime)}</span>
    ...
    <div class="bar-chart">
      ${e.map(e=>`
            <div class="bar-chart-row">
              ...
              <span class="bar-chart-value">${K(e.value)}</span>
            </div>
          `).join(``)}
    </div>
  ...
  `}var gn={mobile:`موبایل`,desktop:`رایانه`};function _n(e){let t=e.split(`-`);return t.length===3?K(`${t[1]}/${t[2]}`):K(e)}function vn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function yn(){return`
    <div class="dash-view">
    ...
    `;try{let[n,r,i,a]=await Promise.allSettled([z(),it(),Ze(),M()]),o=n.status===`fulfilled`?n.value:null,s=r.status===`fulfilled`?r.value:null,c=i.status===`fulfilled`?i.value:[],l=a.status===`fulfilled`?a.value:[],d=o?.byStatus?.find(e=>e.status===`pending`)?.count??0,f=o?.byStatus?.find(e=>e.status===`in_progress`)?.count??0,p=o?.byStatus?.find(e=>e.status===`completed`)?.count??0,m=o?.completedRevenue??0,h=o?.avgOrderValue??0,g=c.filter(e=>e.status===`active`).length,_=c.length,v=s?.totalViews??0,y=s?.uniqueVisitors??0,b=s?.activeOnline??0,x=s?.conversionRate??0,S=l.slice(0,8),C=`
        ...
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card ${d>0?`is-alert`:``}">
            ...
            <div class="dash-kpi-value">${K(d)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(f)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(p)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value is-currency">${q(m)}</div>
            <div class="dash-kpi-sub">میانگین هر سفارش: ${q(h)}</div>
          </div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(b)}</div>
          ...
          <div class="dash-kpi-card">
            <div class="dash-kpi-header">
              ...
              <span class="dash-kpi-badge badge-primary">${K(x)}٪</span>
            </div>
            <div class="dash-kpi-value">${K(x)} <span class="dash-kpi-unit">درصد</span></div>
            <div class="dash-kpi-sub">از ${K(y)} بازدیدکننده ماه</div>
          </div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(g)} <span class="dash-kpi-unit">از ${K(_)}</span></div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(v)}</div>
            <div class="dash-kpi-sub">${K(y)} کاربر یکتا در ماه گذشته</div>
          </div>
        </div>
        ...
        <div class="dash-charts-grid">
          ...
          <div class="dash-card">
            ...
            <div class="dash-card-body">
              ${o?.byStatus?.length?mn(o.byStatus.map(e=>({label:Vt[e.status]??e.status,value:e.count}))):`<p class="dash-empty">داده‌ای ثبت نشده است.</p>`}
            </div>
          </div>
        </div>
        ...
        <div class="dash-section">
          <div class="dash-section-header">
            <div class="dash-section-title-group">
              ...
              <span class="dash-count-pill">${K(S.length)} سفارش آخر</span>
            </div>
            ...
            <div class="dash-table-wrapper">
              ${S.length===0?`<p class="dash-empty">هنوز سفارشی در سامانه بهبار ثبت نشده است.</p>`:`
                <table class="dash-table">
                  ...
                  <tbody>
                    ${S.map(e=>{let t=Ht[e.status]??`var(--muted)`,n=Vt[e.status]??e.status,r=`${vn(e.originCity||`—`)} به ${vn(e.destinationCity||`—`)}`;return`
                        <tr>
                          ...
                          <td>
                            <div class="dash-customer-cell">
                              ...
                              <span class="dash-customer-phone">${K(e.phone||``)}</span>
                            </div>
                          </td>
                          <td><span class="dash-service-tag">${vn(e.serviceLabel||`حمل بار`)}</span></td>
                          <td><span class="dash-route">${r}</span></td>
                          <td><span class="dash-price">${e.estimateAvg?q(e.estimateAvg):`توافقی`}</span></td>
                          <td>
    ...
    `;try{let e=await z(),n=e.byStatus.find(e=>e.status===`in_progress`)?.count??0,r=e.byStatus.find(e=>e.status===`completed`)?.count??0;t.innerHTML=`
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card">
            ...
            <span class="dash-kpi-value">${K(e.total)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">در حال انجام</span>
            <span class="dash-kpi-value">${K(n)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">انجام‌شده</span>
            <span class="dash-kpi-value">${K(r)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">درآمد سفارش‌های انجام‌شده</span>
            <span class="dash-kpi-value is-currency">${q(e.completedRevenue)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">میانگین ارزش هر سفارش</span>
            <span class="dash-kpi-value is-currency">${q(e.avgOrderValue)}</span>
          </div>
        </div>
        ...
        <div class="dash-charts-grid">
          ...
          <div class="dash-card">
            ...
            <div class="dash-card-body">${mn(e.byStatus.map(e=>({label:Vt[e.status]??e.status,value:e.count})))}</div>
          </div>
          <div class="dash-card">
    ...
    `;try{let e=await it();t.innerHTML=`
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(e.activeOnline??0)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(e.todayViews??0)}</div>
            <div class="dash-kpi-sub">${K(e.todayVisitors??0)} بازدیدکننده یکتای امروز</div>
          </div>

          <div class="dash-kpi-card">
            <div class="dash-kpi-header">
              <span class="dash-kpi-label">نرخ تبدیل به سفارش</span>
              <span class="dash-kpi-badge badge-primary">${K(e.conversionRate??0)}٪</span>
            </div>
            <div class="dash-kpi-value">${K(e.conversionRate??0)} <span class="dash-kpi-unit">درصد</span></div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${K(e.totalViews)}</div>
            <div class="dash-kpi-sub">${K(e.uniqueVisitors)} کاربر یکتا</div>
          </div>
        </div>
          ...
          <div class="dash-card-body">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: var(--space-3);">
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: var(--primary);">${K(e.funnel?.wizardStart??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: var(--text);">${K(e.funnel?.wizardStep??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: var(--success);">${K(e.funnel?.orders??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: #047857;">${K(e.funnel?.callClicks??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: #059669;">${K(e.funnel?.whatsappClicks??0)}</div>
              ...
              <tbody>
                ${e.staffPerformance.length?e.staffPerformance.map(e=>`
                    <tr>
                      ...
                      <td>${K(e.total)}</td>
                      <td><strong style="color: var(--success);">${K(e.completed)}</strong></td>
                    </tr>
  ...
  `}function kn(){let e=document.getElementById(`map-error`),t=document.getElementById(`map-refresh`),n=document.getElementById(`admin-map`);if(!e||!t||!n)return;let r=wn.default.map(`admin-map`,{center:Tn,zoom:11});wn.default.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`© OpenStreetMap contributors`,maxZoom:19}).addTo(r);let i=[];function a(e,t){let n=t.map(t=>{let n=t.onActiveService&&t.id!==e.assignedStaffId,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e.assignedStaffId?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``);return`
      <div class="admin-map-popup">
        <div class="admin-map-popup-title">#${K(e.trackingCode)} — ${e.serviceLabel}</div>
        ...
        <div class="admin-map-popup-row">${Vt[e.status]??e.status}</div>
  ...
  `}function Pn(e=()=>{}){let t=document.getElementById(`staff-add-toggle`),n=document.getElementById(`staff-form-card`),r=document.getElementById(`staff-form-title`),i=document.getElementById(`staff-form-cancel`),a=document.getElementById(`staff-form-error`),o=document.getElementById(`staff-form-submit`),s=document.getElementById(`staff-form-id`),c=document.getElementById(`staff-full-name`),l=document.getElementById(`staff-username`),d=document.getElementById(`staff-password`),f=document.getElementById(`staff-password-label`),p=document.getElementById(`staff-role`),m=document.getElementById(`staff-gender`),h=document.getElementById(`staff-read-only`),_=document.getElementById(`staff-phone`),v=document.getElementById(`staff-avatar-url`),y=document.getElementById(`staff-avatar-preview`),b=document.getElementById(`staff-avatar-upload-btn`),S=document.getElementById(`staff-avatar-file-input`),C=document.getElementById(`staff-avatar-upload-error`),w=document.getElementById(`staff-national-id`),T=document.getElementById(`staff-hire-date`),E=document.getElementById(`staff-address`),D=document.getElementById(`staff-emergency-name`),O=document.getElementById(`staff-emergency-phone`),ee=document.getElementById(`staff-notes`),k=document.getElementById(`staff-error`),A=document.getElementById(`staff-table-body`),j=document.getElementById(`staff-wallet-section`),te=document.getElementById(`staff-salary-override`),M=document.getElementById(`staff-bonus-type-override`),N=document.getElementById(`staff-bonus-amount-override`),P=x(g(),`wallet`);if(!t||!n||!r||!i||!a||!o||!s||!c||!l||!d||!f||!p||!m||!h||!_||!v||!y||!b||!S||!C||!w||!T||!E||!D||!O||!ee||!k||!A||!j||!te||!M||!N)return;let F=[],I=[];function R(){let e=v.value.trim();if(e){y.innerHTML=`<img src="${e}" alt="" />`;return}y.innerHTML=m.value===`female`?u.femaleAvatar:u.maleAvatar}function z(e){a.hidden=!0,C.hidden=!0,r.textContent=e?`ویرایش پروفایل ${e.fullName}`:`کارمند جدید`,s.value=e?String(e.id):``,c.value=e?.fullName??``,l.value=e?.username??``,l.disabled=!!e,d.value=``,d.required=!e,f.textContent=e?`رمز عبور جدید (اختیاری)`:`رمز عبور`,p.value=e?.role??F[0]?.key??``,m.value=e?.gender??``,h.checked=e?.isReadOnly??!1,_.value=e?.phone??``,v.value=e?.avatarUrl??``,w.value=e?.nationalId??``,T.value=e?.hireDate??``,E.value=e?.address??``,D.value=e?.emergencyContactName??``,O.value=e?.emergencyContactPhone??``,ee.value=e?.notes??``,j.hidden=!e||!P,te.value=e?.salaryAmountOverride==null?``:String(e.salaryAmountOverride),M.value=e?.bonusTypeOverride??``,N.value=e?.bonusAmountOverride==null?``:String(e.bonusAmountOverride),o.textContent=e?`ذخیره تغییرات`:`ایجاد کارمند`,R(),n.hidden=!1,n.scrollIntoView({behavior:`smooth`,block:`center`})}function ie(){n.hidden=!0}async function ae(){k.hidden=!0;try{let[e,t]=await Promise.all([B(),F.length?Promise.resolve({roles:F}):re()]);F=t.roles,I=e,p.innerHTML=F.map(e=>`<option value="${e.key}">${e.label}</option>`).join(``),A.innerHTML=e.map(e=>jn(e)).join(``),oe()}catch(e){k.hidden=!1,k.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function oe(){A.querySelectorAll(`[data-view-history]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=I.find(e=>e.id===Number(t.dataset.viewHistory));n&&e(n)})}),A.querySelectorAll(`[data-edit-staff]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=I.find(t=>t.id===Number(e.dataset.editStaff));t&&z(t)})}),A.querySelectorAll(`[data-toggle-active]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=Number(e.dataset.toggleActive),n=I.find(e=>e.id===t);if(n){e.disabled=!0;try{await se(t,{isActive:!n.isActive}),await ae()}catch(t){k.hidden=!1,k.textContent=t instanceof Error?t.message:`به‌روزرسانی ناموفق بود.`,e.disabled=!1}}})}),A.querySelectorAll(`[data-delete-staff]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=Number(e.dataset.deleteStaff);if(window.confirm(`این کارمند برای همیشه حذف شود؟ درخواست‌ها و محتوای قبلی او حذف نمی‌شود، فقط از او جدا می‌شود.`)){e.disabled=!0;try{await ce(t),await ae()}catch(t){k.hidden=!1,k.textContent=t instanceof Error?t.message:`حذف کارمند ناموفق بود.`,e.disabled=!1}}})})}t.addEventListener(`click`,()=>z(null)),i.addEventListener(`click`,ie),v.addEventListener(`input`,R),m.addEventListener(`change`,R),b.addEventListener(`click`,()=>S.click()),S.addEventListener(`change`,async()=>{let e=S.files?.[0];if(e){C.hidden=!0,b.textContent=`در حال آپلود...`,b.disabled=!0;try{let t=await Se(e);v.value=t,R()}catch(e){C.hidden=!1,C.textContent=e instanceof Error?e.message:`آپلود عکس ناموفق بود.`}finally{S.value=``,b.textContent=`آپلود عکس`,b.disabled=!1}}}),o.addEventListener(`click`,async()=>{a.hidden=!0;let e=c.value.trim(),t=l.value.trim(),n=d.value,r=!!s.value;if(!e){a.hidden=!1,a.textContent=`نام و نام خانوادگی الزامی است.`;return}if(!r&&(!t||!n)){a.hidden=!1,a.textContent=`نام کاربری و رمز عبور برای کارمند جدید الزامی است.`;return}let i={fullName:e,role:p.value,gender:m.value||null,phone:_.value.trim(),avatarUrl:v.value.trim(),nationalId:w.value.trim(),hireDate:T.value.trim(),address:E.value.trim(),emergencyContactName:D.value.trim(),emergencyContactPhone:O.value.trim(),notes:ee.value.trim(),isReadOnly:h.checked};o.disabled=!0,o.textContent=r?`در حال ذخیره...`:`در حال ایجاد...`;try{if(r){let e={...i};n&&(e.password=n);let t=Number(s.value);await se(t,e),P&&await G(t,{salaryAmountOverride:te.value.trim()?Number(te.value):null,bonusTypeOverride:M.value||null,bonusAmountOverride:N.value.trim()?Number(N.value):null})}else await ne({...i,username:t,password:n});ie(),await ae()}catch(e){a.hidden=!1,a.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`}finally{o.disabled=!1,o.textContent=r?`ذخیره تغییرات`:`ایجاد کارمند`}}),ae()}function Fn(e){return`
    <div class="portal-card">
      <div class="portal-card-top">
        <span class="pipeline-tracking">#${K(e.trackingCode)}</span>
        <span class="portal-status">${Vt[e.status]??e.status}</span>
      </div>
      ...
      <div class="pipeline-estimate">${q(e.estimateAvg)}</div>
    </div>
  ...
  `}function Ln(e){let t=document.getElementById(`staff-history-error`),n=document.getElementById(`staff-history-stats`),r=document.getElementById(`staff-history-list`),i=document.getElementById(`staff-history-refresh`);if(!t||!n||!r||!i)return;async function a(){t.hidden=!0;try{let t=await He(e.id),i=t.filter(e=>e.status===`completed`).length,a=t.filter(e=>e.status===`in_progress`).length;n.innerHTML=`
        <div class="stat-card">
          ...
          <span class="stat-card-value">${K(t.length)}</span>
        </div>
        <div class="stat-card">
          <span class="stat-card-label">انجام‌شده</span>
          <span class="stat-card-value">${K(i)}</span>
        </div>
        <div class="stat-card">
          <span class="stat-card-label">در حال انجام</span>
          <span class="stat-card-value">${K(a)}</span>
        </div>
  ...
  `}function Hn(){let e=document.getElementById(`roles-error`);if(!e)return;function t(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`,Bn(t instanceof Error?t.message:`خطایی پیش آمد.`,`error`)}let n=[],r=[],i=null;function a(e){let t=e.isSystem;return`
    ...
    <tr data-vehicle-row="${e.id}">
      ...
      <td>${e.model??`—`}</td>
      <td>${e.driverName??`—`}</td>
      <td><span class="article-status-badge ${Zn(e.status)}">${Xn[e.status]??e.status}</span></td>
      <td class="staff-table-actions">
      ...
      <div class="staff-form-grid">
        ...
        <div class="form-field">
          ...
          <select id="vehicle-status">
            ${Yn.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``)}
          </select>
        </div>
        <div class="form-field">
  ...
  `}function nr(){let e=document.getElementById(`vehicle-add-toggle`),t=document.getElementById(`vehicle-form-card`),n=document.getElementById(`vehicle-form-title`),r=document.getElementById(`vehicle-form-cancel`),i=document.getElementById(`vehicle-form-error`),a=document.getElementById(`vehicle-form-submit`),o=document.getElementById(`vehicle-form-id`),s=document.getElementById(`vehicle-label`),c=document.getElementById(`vehicle-type`),l=document.getElementById(`vehicle-plate`),u=document.getElementById(`vehicle-model`),d=document.getElementById(`vehicle-year`),f=document.getElementById(`vehicle-status`),p=document.getElementById(`vehicle-driver`),m=document.getElementById(`vehicle-notes`),h=document.getElementById(`vehicles-error`),g=document.getElementById(`vehicles-table-body`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!u||!d||!f||!p||!m||!h||!g)return;let _=[],v=[],y=Object.fromEntries(Jn.map(e=>[e.id,e.label])),b=[],x={},S=[],C={city:``,cityEn:``,province:``,provinceEn:``},w=`all`,T=!0,E=!0,D=!1;Gn().then(()=>Z(document.getElementById(`view-container`)??document.body)),document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-fleet-panel]`).forEach(t=>{t.hidden=t.dataset.fleetPanel!==e.dataset.fleetTab})})});function O(){let e=document.getElementById(`vehicle-types-list`);e&&(e.innerHTML=b.map((e,t)=>`
          ...
          <div class="settings-form-grid">
            ...
            <div class="form-field"><label>آیکون</label>
              <select data-field="icon">
                ${qn.map(t=>`<option value="${t}" ${t===e.icon?`selected`:``}>${t}</option>`).join(``)}
              </select>
            </div>
    ...
    `).join(``),Z(e))}function ee(){b=Array.from(document.querySelectorAll(`[data-vehicle-type-index]`)).map((e,t)=>({id:b[t]?.id??`vehicle-${crypto.randomUUID().slice(0,8)}`,label:e.querySelector(`[data-field="label"]`).value,labelEn:e.querySelector(`[data-field="labelEn"]`).value,icon:e.querySelector(`[data-field="icon"]`).value,basePrice:Number(e.querySelector(`[data-field="basePrice"]`).value)||0,perKmRate:Number(e.querySelector(`[data-field="perKmRate"]`).value)||0,floorCostExempt:b[t]?.floorCostExempt??!1,active:e.querySelector(`[data-field="active"]`).checked,sortOrder:t+1}))}document.getElementById(`vehicle-types-list`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-remove-vehicle-type]`);t&&(ee(),b.splice(Number(t.dataset.removeVehicleType),1),O())}),document.getElementById(`vehicle-type-add-btn`)?.addEventListener(`click`,()=>{ee(),b.push({id:`vehicle-${crypto.randomUUID().slice(0,8)}`,label:``,labelEn:``,icon:`van`,basePrice:0,perKmRate:0,floorCostExempt:!1,active:!0,sortOrder:b.length+1}),O()}),document.getElementById(`vehicle-type-save-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget,n=document.getElementById(`vehicle-types-saved-note`),r=document.getElementById(`vehicle-types-error`);r&&(r.hidden=!0);try{await Q(t,async()=>{ee(),await V(`vehicle_types`,b)}),n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`)}});function k(){let e=document.getElementById(`cities-list`);e.innerHTML=S.map((e,t)=>`
  ...
  `}function cr(e){let t=e.direction===`credit`?`+`:`−`,n=e.direction===`credit`?`var(--success)`:`var(--danger)`;return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${ar[e.type]??e.type}</span>
        <span class="activity-log-target">${ir(e.description)}</span>
      </div>
      <div class="activity-log-meta">
        <span style="color:${n}; font-weight:700;">${t} ${q(e.amount)}</span>
      </div>
    </div>
  `}function lr(e){let t=or[e.status];return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${q(e.amount)}</span>
        ${e.staffNote?`<span class="activity-log-target">${ir(e.staffNote)}</span>`:``}
        ${e.adminNote?`<span class="activity-log-target">پاسخ مدیر: ${ir(e.adminNote)}</span>`:``}
      </div>
      <div class="activity-log-meta"><span class="${t.badgeClass}">${t.label}</span></div>
    </div>
  `}function ur(){let e=document.getElementById(`my-wallet-summary-card`),t=document.getElementById(`my-wallet-tx-list`),n=document.getElementById(`my-wallet-load-more`),r=document.getElementById(`my-payout-requests-list`),i=0,a=0,o=[];async function s(){if(e)try{let t=await vt(),n=t.bonus.type===`percent`?`${t.bonus.amount}٪ برآورد هر درخواست`:q(t.bonus.amount);e.innerHTML=`
        <p class="settings-panel-hint">موجودی فعلی</p>
        <p style="font-size: 1.8rem; font-weight: 800; color: var(--primary);">${q(t.balance)}</p>
        <div class="settings-form-grid" style="margin-top: var(--space-3)">
          <div><p class="settings-panel-hint">حقوق ماهانه</p><p><strong>${q(t.salary.amount)}</strong></p></div>
          <div><p class="settings-panel-hint">پاداش هر درخواست تکمیل‌شده</p><p><strong>${n}</strong></p></div>
        </div>
      `}catch(t){e.innerHTML=`<p class="error-text">${t instanceof Error?t.message:`خطایی پیش آمد.`}</p>`}}async function c(){if(t)try{let{transactions:e,total:r}=await U(rr,i);o=[...o,...e],a=r,i+=e.length,t.innerHTML=o.length?o.map(cr).join(``):`<p class="settings-panel-hint">هنوز تراکنشی ثبت نشده.</p>`,n&&(n.hidden=i>=a)}catch(e){t.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}async function l(){if(r)try{let e=await W();r.innerHTML=e.length?e.map(lr).join(``):`<p class="settings-panel-hint">هنوز درخواستی ثبت نکرده‌اید.</p>`}catch(e){r.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}n?.addEventListener(`click`,()=>void c()),document.getElementById(`payout-request-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`payout-request-amount`),n=document.getElementById(`payout-request-note`),r=document.getElementById(`payout-request-error`),i=document.getElementById(`payout-request-success`),a=document.getElementById(`payout-request-submit`);r.hidden=!0,i.hidden=!0;let o=Number(t.value);if(!Number.isFinite(o)||o<=0){r.hidden=!1,r.textContent=`مبلغ نامعتبر است.`;return}a.disabled=!0,(async()=>{try{await yt(o,n.value.trim()||void 0),i.hidden=!1,t.value=``,n.value=``,await Promise.all([s(),l()])}catch(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}finally{a.disabled=!1}})()}),s(),c(),l()}var dr={pending:{next:`in_progress`,label:`شروع کار`},contacted:{next:`in_progress`,label:`شروع کار`},scheduled:{next:`in_progress`,label:`شروع کار`},in_progress:{next:`completed`,label:`پایان کار`}};function fr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function pr(e){let t=dr[e.status],n=e.originLat!=null&&e.originLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.originLat},${e.originLng}`:null,r=e.destinationLat!=null&&e.destinationLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.destinationLat},${e.destinationLng}`:null;return`
    <div class="portal-card" data-portal-card-id="${e.id}">
      ...
      ${e.originNotes?`<p class="pipeline-note"><strong>یادداشت مبدأ:</strong> ${fr(e.originNotes)}</p>`:``}
      ${e.destinationNotes?`<p class="pipeline-note"><strong>یادداشت مقصد:</strong> ${fr(e.destinationNotes)}</p>`:``}
  ...
  `}var hr=new Set([`pending`,`contacted`,`scheduled`,`in_progress`]);function gr(e){let t=document.getElementById(`portal-error`),n=document.getElementById(`portal-list`),r=document.getElementById(`portal-history-stats`),i=document.getElementById(`portal-history-list`),a=document.getElementById(`portal-refresh`),o=document.getElementById(`portal-logout-btn`);if(!t||!n||!r||!i||!a||!o)return;async function s(){t.hidden=!0;try{let e=await le(),t=e.filter(e=>hr.has(e.status)),a=e.filter(e=>!hr.has(e.status)),o=a.filter(e=>e.status===`completed`).length;n.innerHTML=t.length?t.map(pr).join(``):`<p class="portal-empty">در حال حاضر کاری در جریان ندارید.</p>`,r.innerHTML=`
        <div class="stat-card">
          <span class="stat-card-label">کل خدمات ارائه‌شده</span>
          <span class="stat-card-value">${K(e.length)}</span>
        </div>
        <div class="stat-card">
          <span class="stat-card-label">انجام‌شده</span>
          <span class="stat-card-value">${K(o)}</span>
        </div>
      `,i.innerHTML=a.length?a.map(pr).join(``):`<p class="portal-empty">هنوز کاری در تاریخچه‌ی شما ثبت نشده است.</p>`,c()}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function c(){n.querySelectorAll(`[data-advance-id]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=Number(e.dataset.advanceId),r=e.dataset.advanceStatus;e.disabled=!0;try{await ue(n,r),await s()}catch(n){t.hidden=!1,t.textContent=n instanceof Error?n.message:`به‌روزرسانی ناموفق بود.`,e.disabled=!1}})})}a.addEventListener(`click`,()=>void s()),o.addEventListener(`click`,e),s();let l=document.getElementById(`portal-jobs-container`),u=document.getElementById(`portal-wallet-container`),d=document.getElementById(`portal-wallet-mount`),f=document.getElementById(`portal-wallet-btn`),p=document.getElementById(`portal-back-to-jobs-btn`),m=!1;f?.addEventListener(`click`,()=>{!l||!u||!d||(l.hidden=!0,u.hidden=!1,m||(m=!0,d.innerHTML=sr(),ur()))}),p?.addEventListener(`click`,()=>{!l||!u||(u.hidden=!0,l.hidden=!1)})}function _r(e){return`
  ...
  `}function yr(e){let t=document.getElementById(`magazine-list-error`),n=document.getElementById(`magazine-table-body`),r=document.getElementById(`magazine-new-btn`);if(!t||!n||!r)return;async function i(){t.hidden=!0;try{let e=await de();n.innerHTML=e.length?e.map(_r).join(``):`<tr><td colspan="5" class="staff-table-empty">هنوز مقاله‌ای ثبت نشده است.</td></tr>`,a()}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function a(){n.querySelectorAll(`[data-edit-article]`).forEach(t=>{t.addEventListener(`click`,()=>e(Number(t.dataset.editArticle)))}),n.querySelectorAll(`[data-delete-article]`).forEach(e=>{e.addEventListener(`click`,async()=>{if(window.confirm(`این مقاله برای همیشه حذف شود؟`)){e.disabled=!0;try{await he(Number(e.dataset.deleteArticle)),await i()}catch(n){t.hidden=!1,t.textContent=n instanceof Error?n.message:`حذف ناموفق بود.`,e.disabled=!1}}})})}r.addEventListener(`click`,()=>e(null)),i()}var br=[{value:`P`,label:`متن ساده`,labelEn:`Paragraph`},{value:`H1`,label:`سرتیتر ۱`,labelEn:`Heading 1`},{value:`H2`,label:`سرتیتر ۲`,labelEn:`Heading 2`},{value:`H3`,label:`سرتیتر ۳`,labelEn:`Heading 3`},{value:`H4`,label:`سرتیتر ۴`,labelEn:`Heading 4`},{value:`H5`,label:`سرتیتر ۵`,labelEn:`Heading 5`},{value:`H6`,label:`سرتیتر ۶`,labelEn:`Heading 6`},{value:`BLOCKQUOTE`,label:`نقل‌قول`,labelEn:`Quote`}];function xr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Sr(e,t,n){return`
    <div class="rte">
      <div class="rte-toolbar">
        <div class="rte-format-select-wrap">
          <select class="rte-format-select" data-rte-format title="${n===`rtl`?`قالب متن`:`Text format`}">
            ${br.map(e=>`<option value="${e.value}">${n===`rtl`?e.label:e.labelEn}</option>`).join(``)}
          </select>
          <span class="rte-format-select-label" data-rte-format-label aria-hidden="true">${n===`rtl`?br[0].label:br[0].labelEn}</span>
        </div>
      ...
      <textarea data-field="${e}" hidden>${xr(t)}</textarea>
      <div class="rte-content" contenteditable="true" dir="${n}" data-rte-content>${t||`<p><br></p>`}</div>
    </div>
  `}var Cr=new WeakMap;function wr(e){return e?.closest(`.rte`)??null}function Tr(e){return e.querySelector(`[data-rte-content]`)}function Er(e){let t=window.getSelection();t&&t.rangeCount>0&&e.contains(t.anchorNode)&&Cr.set(e,t.getRangeAt(0).cloneRange())}function Dr(e){let t=Cr.get(e);if(!t)return;let n=window.getSelection();n?.removeAllRanges(),n?.addRange(t)}function Or(e){let t=Tr(e),n=e.querySelector(`textarea[data-field]`);t&&n&&(n.value=t.innerHTML===`<p><br></p>`?``:t.innerHTML)}function kr(e){let t=window.getSelection();if(!t||!t.anchorNode)return null;let n=(t.anchorNode.nodeType===3?t.anchorNode.parentElement:t.anchorNode)?.closest(`a`)??null;return n&&e.contains(n)?n:null}function Ar(e){e.addEventListener(`input`,e=>{let t=e.target.closest(`[data-rte-content]`);if(!t)return;let n=wr(t);n&&Or(n)}),e.addEventListener(`mouseup`,e=>{let t=e.target.closest(`[data-rte-content]`);t&&Er(t)}),e.addEventListener(`keyup`,e=>{let t=e.target.closest(`[data-rte-content]`);t&&Er(t)}),e.addEventListener(`mousedown`,e=>{let t=e.target;if(t.closest(`[data-rte-cmd], [data-rte-action]`)){e.preventDefault();return}let n=t.closest(`.rte-color-btn`);if(n){let e=wr(n),t=e&&Tr(e);t&&Er(t)}}),e.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-rte-cmd]`);if(n){let e=wr(n),t=e&&Tr(e);if(!t)return;t.focus(),document.execCommand(n.dataset.rteCmd,!1,n.dataset.rteCmdValue??void 0),Or(e);return}let r=t.closest(`[data-rte-link-cancel]`);if(r){wr(r)?.querySelector(`[data-rte-link-popover]`)?.setAttribute(`hidden`,``);return}let i=t.closest(`[data-rte-link-apply]`);if(i){let e=wr(i),t=e&&Tr(e),n=e?.querySelector(`[data-rte-link-popover]`);if(!e||!t||!n)return;let r=n.querySelector(`[data-rte-link-url]`),a=n.querySelector(`[data-rte-link-blank]`),o=n.querySelector(`[data-rte-link-nofollow]`),s=r.value.trim();if(n.hidden=!0,!s)return;t.focus(),Dr(t),document.execCommand(`createLink`,!1,s);let c=kr(t)??Array.from(t.querySelectorAll(`a[href]`)).find(e=>e.getAttribute(`href`)===s);if(c){let e=[];a.checked?(c.setAttribute(`target`,`_blank`),e.push(`noopener`)):c.removeAttribute(`target`),o.checked&&e.push(`nofollow`),e.length?c.setAttribute(`rel`,e.join(` `)):c.removeAttribute(`rel`)}Or(e);return}let a=t.closest(`[data-rte-action]`);if(a){let e=wr(a),t=e&&Tr(e);if(!e||!t)return;if(a.dataset.rteAction===`link`){Er(t);let n=e.querySelector(`[data-rte-link-popover]`),r=n.querySelector(`[data-rte-link-url]`),i=n.querySelector(`[data-rte-link-blank]`),a=n.querySelector(`[data-rte-link-nofollow]`),o=kr(t);r.value=o?.getAttribute(`href`)??``,i.checked=o?.getAttribute(`target`)===`_blank`,a.checked=(o?.getAttribute(`rel`)??``).includes(`nofollow`),n.hidden=!1,r.focus()}else a.dataset.rteAction===`image`&&(Er(t),e.querySelector(`[data-rte-image-input]`)?.click())}}),e.addEventListener(`change`,e=>{let t=e.target,n=t.closest(`[data-rte-format]`);if(n){let e=wr(n),t=e&&Tr(e);if(!t)return;let r=e.querySelector(`[data-rte-format-label]`);r&&(r.textContent=n.options[n.selectedIndex]?.textContent??``),t.focus(),Dr(t),document.execCommand(`formatBlock`,!1,`<${n.value}>`),Or(e);return}let r=t.closest(`[data-rte-color]`);if(r){let e=wr(r),t=e&&Tr(e);if(!t)return;t.focus(),Dr(t),document.execCommand(r.dataset.rteColor,!1,r.value),Or(e);return}let i=t.closest(`[data-rte-image-input]`);if(i){let e=wr(i),t=e&&Tr(e),n=i.files?.[0];if(!e||!t||!n)return;Se(n).then(n=>{t.focus(),Dr(t),document.execCommand(`insertImage`,!1,n),Or(e)}).finally(()=>{i.value=``})}})}var jr={richtext:`متن`,heading:`سرتیتر`,paragraph:`پاراگراف`,list:`لیست`,image:`تصویر`,video:`ویدئو`};function Mr(e){return e===`richtext`?{type:`richtext`,html:``,htmlEn:``}:e===`heading`?{type:`heading`,text:``,textEn:``}:e===`paragraph`?{type:`paragraph`,text:``,textEn:``}:e===`list`?{type:`list`,items:[],itemsEn:[]}:e===`image`?{type:`image`,url:``,caption:``,captionEn:``}:{type:`video`,url:``}}function Nr(e,t){let n=`
    <div class="block-editor-head">
      <span class="block-editor-type">${jr[e.type]}</span>
      <div class="block-editor-actions">
  ...
  `,r=``;return e.type===`richtext`?r=`
      <div data-i18n="fa">${Sr(`html`,e.html,`rtl`)}</div>
      <div data-i18n="en">${Sr(`htmlEn`,e.htmlEn,`ltr`)}</div>
    `:e.type===`heading`?r=`
      <input type="text" data-field="text" data-i18n="fa" placeholder="متن سرتیتر (فارسی)" value="${Fr(e.text)}" />
      <input type="text" data-field="textEn" data-i18n="en" dir="ltr" placeholder="Heading text (English)" value="${Fr(e.textEn)}" />
    `:e.type===`paragraph`?r=`
      <textarea data-field="text" data-i18n="fa" placeholder="متن پاراگراف (فارسی)" rows="3">${Pr(e.text)}</textarea>
      <textarea data-field="textEn" data-i18n="en" dir="ltr" placeholder="Paragraph text (English)" rows="3">${Pr(e.textEn)}</textarea>
    `:e.type===`list`?r=`
      <textarea data-field="items" data-i18n="fa" placeholder="هر مورد در یک خط (فارسی)" rows="4">${Pr(e.items.join(`
`))}</textarea>
      <textarea data-field="itemsEn" data-i18n="en" dir="ltr" placeholder="One item per line (English)" rows="4">${Pr(e.itemsEn.join(`
`))}</textarea>
    `:e.type===`image`?r=`
      <div class="block-image-upload">
        ${e.url?`<img src="${Fr(e.url)}" alt="" class="block-image-preview" />`:`<span class="block-image-placeholder">تصویری انتخاب نشده</span>`}
      ...
      <input type="hidden" data-field="url" value="${Fr(e.url)}" />
      <input type="text" data-field="caption" data-i18n="fa" placeholder="زیرنویس تصویر (فارسی)" value="${Fr(e.caption)}" />
      <input type="text" data-field="captionEn" data-i18n="en" dir="ltr" placeholder="Image caption (English)" value="${Fr(e.captionEn)}" />
    `:e.type===`video`&&(r=`
      <input type="url" data-field="url" dir="ltr" placeholder="https://www.youtube.com/watch?v=..." value="${Fr(e.url)}" />
    `),`<div class="block-editor" data-block-index="${t}" data-block-type="${e.type}">${n}<div class="block-editor-body">${r}</div></div>`}function Pr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Fr(e){return Pr(e).replace(/"/g,`&quot;`)}function Ir(){return`
    <div class="view-header">
...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function k(e){E=e,e?(x.src=e,x.hidden=!1,S.hidden=!0):(x.hidden=!0,S.hidden=!1)}function A(e){if(!e){i.hidden=!0,b.hidden=!0;return}i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,b.hidden=e!==`published`}async function j(){if(e===null){r.textContent=`مقاله جدید`,T=[Mr(`richtext`)],O(),A(null);return}try{let t=(await de()).find(t=>t.id===e);if(!t){n.hidden=!1,n.textContent=`مقاله پیدا نشد.`;return}D=t,r.textContent=t.title||`ویرایش مقاله`,o.value=t.title,s.value=t.titleEn,c.value=t.excerpt,l.value=t.excerptEn,u.value=t.category,d.value=t.categoryEn,f.value=t.slug,p.value=t.metaTitle??``,m.value=t.metaDescription??``,k(t.coverImageUrl),T=t.content.length?t.content:[Mr(`richtext`)],O(),A(t.status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function te(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),category:u.value.trim(),categoryEn:d.value.trim(),coverImageUrl:E,content:ee(),metaTitle:p.value.trim(),metaDescription:m.value.trim(),slug:f.value.trim()||void 0}}async function M(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان مقاله الزامی است.`,null;let t=te();try{let n=D?await pe(D.id,t):await fe(t);return D=n,e=n.id,f.value=n.slug,r.textContent=n.title,A(n.status),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`,null}}h.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;T=ee();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?T.splice(n,1):r===`up`&&n>0?[T[n-1],T[n]]=[T[n],T[n-1]]:r===`down`&&n<T.length-1&&([T[n+1],T[n]]=[T[n],T[n+1]]),O()}),h.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),h.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await Se(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود ناموفق بود.`}}),_.addEventListener(`click`,()=>{T=ee(),T.push(Mr(g.value)),O()}),w.addEventListener(`click`,()=>C.click()),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{k(await Se(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود ناموفق بود.`}}),v.addEventListener(`click`,async()=>{v.disabled=!0,v.textContent=`در حال ذخیره...`,await M(),v.disabled=!1,v.textContent=`ذخیره پیش‌نویس`}),y.addEventListener(`click`,async()=>{y.disabled=!0;let e=await M();if(e)try{A((await me(e.id,!0)).status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار ناموفق بود.`}y.disabled=!1}),b.addEventListener(`click`,async()=>{if(D){b.disabled=!0;try{A((await me(D.id,!1)).status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`به‌روزرسانی ناموفق بود.`}b.disabled=!1}}),a.addEventListener(`click`,t),j()}var Rr={richtext:`متن پیشرفته`,heading:`سرتیتر`,paragraph:`پاراگراف`,list:`لیست`,image:`تصویر`,video:`ویدئو`};function zr(e){return e===`richtext`?{type:`richtext`,html:``,htmlEn:``}:e===`heading`?{type:`heading`,text:``,textEn:``}:e===`paragraph`?{type:`paragraph`,text:``,textEn:``}:e===`list`?{type:`list`,items:[],itemsEn:[]}:e===`image`?{type:`image`,url:``,caption:``,captionEn:``}:{type:`video`,url:``}}function Br(e,t){let n=`
  ...
  `,r=``;return e.type===`richtext`?r=`
      ...
      <div data-i18n="en">${Sr(`htmlEn`,e.htmlEn,`ltr`)}</div>
    `:e.type===`heading`?r=`
      <input type="text" data-field="text" data-i18n="fa" placeholder="متن سرتیتر (فارسی)" value="${Hr(e.text)}" />
      <input type="text" data-field="textEn" data-i18n="en" dir="ltr" placeholder="Heading text (English)" value="${Hr(e.textEn)}" />
    `:e.type===`paragraph`?r=`
      <textarea data-field="text" data-i18n="fa" placeholder="متن پاراگراف (فارسی)" rows="3">${Vr(e.text)}</textarea>
      <textarea data-field="textEn" data-i18n="en" dir="ltr" placeholder="Paragraph text (English)" rows="3">${Vr(e.textEn)}</textarea>
    `:e.type===`list`?r=`
      <textarea data-field="items" data-i18n="fa" placeholder="هر مورد در یک خط (فارسی)" rows="4">${Vr(e.items.join(`
`))}</textarea>
      <textarea data-field="itemsEn" data-i18n="en" dir="ltr" placeholder="One item per line (English)" rows="4">${Vr(e.itemsEn.join(`
`))}</textarea>
    `:e.type===`image`?r=`
      <div class="block-image-upload">
        ${e.url?`<img src="${Hr(e.url)}" alt="" class="block-image-preview" />`:`<span class="block-image-placeholder">تصویری انتخاب نشده</span>`}
        <input type="file" accept="image/*" data-image-upload hidden />
        <button type="button" class="btn btn-secondary btn-sm" data-image-upload-btn>انتخاب تصویر</button>
      </div>
      <input type="hidden" data-field="url" value="${Hr(e.url)}" />
      <input type="text" data-field="caption" data-i18n="fa" placeholder="زیرنویس تصویر (فارسی)" value="${Hr(e.caption)}" />
      <input type="text" data-field="captionEn" data-i18n="en" dir="ltr" placeholder="Image caption (English)" value="${Hr(e.captionEn)}" />
    `:e.type===`video`&&(r=`
      <input type="url" data-field="url" dir="ltr" placeholder="https://www.aparat.com/v/... یا https://www.youtube.com/watch?v=..." value="${Hr(e.url)}" />
    `),`<div class="block-editor" data-block-index="${t}" data-block-type="${e.type}">${n}<div class="block-editor-body">${r}</div></div>`}function Vr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Hr(e){return Vr(e).replace(/"/g,`&quot;`)}function Ur(){return`
    <div class="view-header">
      <div>
...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function te(e){ee=e,e?(x.src=e,x.hidden=!1,S.hidden=!0,T&&(T.hidden=!1)):(x.hidden=!0,S.hidden=!1,T&&(T.hidden=!0))}function M(e,t){if(!e){i.hidden=!0,v.hidden=!0,y&&(y.hidden=!0);return}if(i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,v.hidden=e!==`published`,y&&b){let e=t||u.value.trim();if(e){y.hidden=!1;let t=`https://behbarapp.ir/p/${encodeURIComponent(e)}`;b.href=t,b.textContent=`/p/${e}`}else y.hidden=!0}}async function N(){if(e===null){r.textContent=`برگه جدید`,O=[zr(`richtext`)],A(),M(null),E&&(E.checked=!1),D&&(D.checked=!1);return}try{let t=await _e(e);if(!t){n.hidden=!1,n.textContent=`برگه پیدا نشد.`;return}k=t,r.textContent=t.title||`ویرایش برگه`,o.value=t.title,s.value=t.titleEn||``,c.value=t.excerpt||``,l.value=t.excerptEn||``,u.value=t.slug,d.value=t.metaTitle??``,f.value=t.metaDescription??``,E&&(E.checked=!!t.showInHeader),D&&(D.checked=!!t.showInFooter),te(t.coverImageUrl),O=t.content&&t.content.length?t.content:[zr(`richtext`)],A(),M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی در بارگذاری برگه پیش آمد.`}}function P(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),coverImageUrl:ee,content:j(),metaTitle:d.value.trim()||void 0,metaDescription:f.value.trim()||void 0,slug:u.value.trim()||void 0,showInHeader:E?.checked??!1,showInFooter:D?.checked??!1}}async function F(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان برگه الزامی است.`,null;let t=P();try{let n=k?await ye(k.id,t):await ve(t);return k=n,e=n.id,u.value=n.slug,r.textContent=n.title,M(n.status,n.slug),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره برگه ناموفق بود.`,null}}p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;O=j();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?O.splice(n,1):r===`up`&&n>0?[O[n-1],O[n]]=[O[n],O[n-1]]:r===`down`&&n<O.length-1&&([O[n+1],O[n]]=[O[n],O[n+1]]),A()}),p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),p.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await Se(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر ناموفق بود.`}}),h.addEventListener(`click`,()=>{O=j(),O.push(zr(m.value)),A()}),w.addEventListener(`click`,()=>C.click()),T&&T.addEventListener(`click`,()=>te(null)),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{te(await Se(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر شاخص ناموفق بود.`}}),g.addEventListener(`click`,async()=>{g.disabled=!0,g.textContent=`در حال ذخیره...`,await F(),g.disabled=!1,g.textContent=`ذخیره پیش‌نویس`}),_.addEventListener(`click`,async()=>{_.disabled=!0;let e=await F();if(e)try{let t=await be(e.id,!0);M(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار برگه ناموفق بود.`}_.disabled=!1}),v.addEventListener(`click`,async()=>{if(k){v.disabled=!0;try{let e=await be(k.id,!1);M(e.status,e.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`تغییر به پیش‌نویس ناموفق بود.`}v.disabled=!1}}),a.addEventListener(`click`,t),N()}function Gr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function Kr(e){return Array.from({length:5},(t,n)=>n<e?`★`:`☆`).join(``)}function qr(e){return`
  ...
  `}function Xr(){Gn().then(()=>Z(document.getElementById(`view-container`)??document.body));let e=document.getElementById(`testimonials-list-error`),t=document.getElementById(`testimonials-list`),n=document.getElementById(`testimonial-new-btn`),r=document.getElementById(`testimonial-form-card`),i=document.getElementById(`testimonial-form-title`),a=document.getElementById(`testimonial-form-error`),o=document.getElementById(`testimonial-cancel-btn`),s=document.getElementById(`testimonial-save-btn`);if(!e||!t||!n||!r||!i||!a||!o||!s)return;let c=[];function l(e){a.hidden=!0,i.textContent=e?`ویرایش نظر`:`نظر جدید`,document.getElementById(`testimonial-form-id`).value=e?String(e.id):``,document.getElementById(`testimonial-name`).value=e?.customerName??``,document.getElementById(`testimonial-name-en`).value=e?.customerNameEn??``,document.getElementById(`testimonial-text`).value=e?.text??``,document.getElementById(`testimonial-text-en`).value=e?.textEn??``,document.getElementById(`testimonial-rating`).value=String(e?.rating??5),document.getElementById(`testimonial-avatar`).value=e?.avatarUrl??``,document.getElementById(`testimonial-sort`).value=String(e?.sortOrder??0),document.getElementById(`testimonial-status`).value=e?.status??`published`,r.hidden=!1,r.scrollIntoView({behavior:`smooth`,block:`center`})}function u(){r.hidden=!0}async function d(){e.hidden=!0;try{c=await Oe(),t.innerHTML=c.length?c.map(qr).join(``):`<p class="pipeline-empty">هنوز نظری ثبت نشده است.</p>`,f()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function f(){t.querySelectorAll(`[data-edit-testimonial]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=c.find(t=>t.id===Number(e.dataset.editTestimonial));t&&l(t)})}),t.querySelectorAll(`[data-delete-testimonial]`).forEach(t=>{t.addEventListener(`click`,async()=>{if(window.confirm(`این نظر برای همیشه حذف شود؟`)){t.disabled=!0;try{await je(Number(t.dataset.deleteTestimonial)),await d()}catch(n){e.hidden=!1,e.textContent=n instanceof Error?n.message:`حذف ناموفق بود.`,t.disabled=!1}}})})}n.addEventListener(`click`,()=>l(null)),o.addEventListener(`click`,u),s.addEventListener(`click`,async()=>{a.hidden=!0;let e=document.getElementById(`testimonial-form-id`).value,t={customerName:document.getElementById(`testimonial-name`).value.trim(),customerNameEn:document.getElementById(`testimonial-name-en`).value.trim(),text:document.getElementById(`testimonial-text`).value.trim(),textEn:document.getElementById(`testimonial-text-en`).value.trim(),rating:Number(document.getElementById(`testimonial-rating`).value),avatarUrl:document.getElementById(`testimonial-avatar`).value.trim()||null,sortOrder:Number(document.getElementById(`testimonial-sort`).value)||0,status:document.getElementById(`testimonial-status`).value};if(!t.customerName||!t.text){a.hidden=!1,a.textContent=`نام مشتری و متن نظر الزامی است.`;return}s.disabled=!0;try{e?await Ae(Number(e),t):await ke(t),u(),await d()}catch(e){a.hidden=!1,a.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`}finally{s.disabled=!1}}),d()}var Zr=5e3,Qr;function $r(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ei(e){return e.lastMessageType===`image`?`📷 تصویر`:e.lastMessageType===`location`?`📍 موقعیت مکانی`:e.lastMessage||``}function ti(e){if(e.type===`image`){let t=`${e.text}`;return`<a href="${t}" target="_blank" rel="noopener"><img class="chat-bubble-image" src="${t}" alt="تصویر ارسالی" loading="lazy" /></a>`}if(e.type===`location`){let t=``;try{let n=JSON.parse(e.text);typeof n.lat==`number`&&typeof n.lng==`number`&&(t=`https://www.google.com/maps?q=${n.lat},${n.lng}`)}catch{}return t?`<a class="chat-bubble-location" href="${t}" target="_blank" rel="noopener"><span class="icon">${u.pin}</span><span>مشاهده موقعیت روی نقشه</span></a>`:`<p>موقعیت نامعتبر</p>`}return`<p>${$r(e.text)}</p>`}function ni(e,t,n=`sm`){let r=e??`؟`,i=`chat-avatar chat-avatar-${n}`;return t?`<img class="${i}" src="${t}" alt="${$r(r)}" />`:`<span class="${i} chat-avatar-fallback">${$r(r.trim().charAt(0)||`؟`)}</span>`}function ri(){return`
    <div class="view-header">
      <h1>چت پشتیبانی</h1>
    </div>
  ...
  `}function ii(){let e=document.getElementById(`chat-error`),t=document.getElementById(`chat-filter-tabs`),n=document.getElementById(`chat-conversation-list`),r=document.getElementById(`chat-thread-empty`),i=document.getElementById(`chat-thread-active`),a=document.getElementById(`chat-thread-name`),o=document.getElementById(`chat-thread-phone`),s=document.getElementById(`chat-assign-select`),c=document.getElementById(`chat-thread-status-btn`),l=document.getElementById(`chat-thread-archive-btn`),d=document.getElementById(`chat-thread-delete-btn`),f=document.getElementById(`chat-responders-row`),p=document.getElementById(`chat-info-panel`),m=document.getElementById(`chat-request-card`),h=document.getElementById(`chat-thread-messages`),_=document.getElementById(`chat-thread-form`),v=document.getElementById(`chat-thread-input`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!d||!f||!p||!m||!h||!_||!v)return;let y=g(),b=[],x=[],S=null,C=`all`;function w(){if(C===`archived`)return b.filter(e=>e.archivedAt!==null);let e=b.filter(e=>e.archivedAt===null);return C===`mine`?e.filter(e=>e.assignedStaffId===y?.id):C===`unassigned`?e.filter(e=>e.assignedStaffId===null):e}function T(){let t=w();n.innerHTML=t.length?t.map(e=>`
        <div class="chat-conversation-item ${e.id===S?`is-active`:``}" data-conversation-id="${e.id}" role="button" tabindex="0">
          <div class="chat-conversation-item-top">
            <span>${$r(e.customerName||`مهمان`)}</span>
          ...
          <p class="chat-conversation-preview">${$r(ei(e))}</p>
  ...
  `}function li(){Gn().then(()=>Z(document.getElementById(`view-container`)??document.body));let e=document.getElementById(`stories-list-error`),t=document.getElementById(`stories-list`),n=document.getElementById(`story-new-btn`),r=document.getElementById(`story-form-card`),i=document.getElementById(`story-form-title`),a=document.getElementById(`story-form-error`),o=document.getElementById(`story-cancel-btn`),s=document.getElementById(`story-save-btn`);if(!e||!t||!n||!r||!i||!a||!o||!s)return;let c=[];function l(e){a.hidden=!0,i.textContent=e?`ویرایش استوری`:`استوری جدید`,document.getElementById(`story-form-id`).value=e?String(e.id):``,document.getElementById(`story-image`).value=e?.imageUrl??``,document.getElementById(`story-caption`).value=e?.caption??``,document.getElementById(`story-caption-en`).value=e?.captionEn??``,document.getElementById(`story-link`).value=e?.linkUrl??``,document.getElementById(`story-sort`).value=String(e?.sortOrder??0),r.hidden=!1,r.scrollIntoView({behavior:`smooth`,block:`center`})}function u(){r.hidden=!0}async function d(){e.hidden=!0;try{c=await Ge(),t.innerHTML=c.length?c.map(oi).join(``):`<p class="pipeline-empty">هنوز استوری‌ای ثبت نشده است.</p>`,f()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function f(){t.querySelectorAll(`[data-edit-story]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=c.find(t=>t.id===Number(e.dataset.editStory));t&&l(t)})}),t.querySelectorAll(`[data-delete-story]`).forEach(t=>{t.addEventListener(`click`,async()=>{if(window.confirm(`این استوری برای همیشه حذف شود؟`)){t.disabled=!0;try{await H(Number(t.dataset.deleteStory)),await d()}catch(n){e.hidden=!1,e.textContent=n instanceof Error?n.message:`حذف ناموفق بود.`,t.disabled=!1}}})})}n.addEventListener(`click`,()=>l(null)),o.addEventListener(`click`,u),s.addEventListener(`click`,async()=>{a.hidden=!0;let e=document.getElementById(`story-form-id`).value,t={imageUrl:document.getElementById(`story-image`).value.trim(),caption:document.getElementById(`story-caption`).value.trim(),captionEn:document.getElementById(`story-caption-en`).value.trim(),linkUrl:document.getElementById(`story-link`).value.trim()||null,sortOrder:Number(document.getElementById(`story-sort`).value)||0};if(!t.imageUrl){a.hidden=!1,a.textContent=`لینک تصویر الزامی است.`;return}s.disabled=!0;try{e?await qe(Number(e),t):await Ke(t),u(),await d()}catch(e){a.hidden=!1,a.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`}finally{s.disabled=!1}}),d()}var ui=[{id:`driver`,title:`راننده با خودرو`,titleEn:`Driver`,description:`رانندگان وانت، نیسان، خاور و کامیون با خودرو شخصی`,requiresVehicle:!0,active:!0},{id:`worker`,title:`کارگر اسباب‌کشی و باربری`,titleEn:`Moving Specialist`,description:`نیروی متخصص بسته‌بندی، چیدمان و حمل بارهای سنگین`,requiresVehicle:!1,active:!0},{id:`support`,title:`کارشناس پشتیبانی و هماهنگی`,titleEn:`Customer Support`,description:`پاسخگویی به تماس‌ها و پیگیری امور مشتریان و رانندگان`,requiresVehicle:!1,active:!0},{id:`other`,title:`سایر زمینه‌های همکاری`,titleEn:`Other`,description:`تخصص‌های دیگر لجستیک، اداری و بازاریابی`,requiresVehicle:!1,active:!0}],di=[{id:`new`,label:`جدید`},{id:`reviewed`,label:`بررسی‌شده`},{id:`contacted`,label:`تماس گرفته شده`},{id:`hired`,label:`استخدام شده`},{id:`rejected`,label:`رد شده`}],fi=Object.fromEntries(di.map(e=>[e.id,e.label]));function pi(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function mi(e){return di.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${t.label}</option>`).join(``)}function hi(e){return`
    <div class="testimonial-row" data-application-row="${e.id}">
      <div class="testimonial-row-avatar"><span class="icon">${u.briefcase}</span></div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${pi(e.fullName)}</strong>
          <span class="article-status-badge article-status-${e.status}">${fi[e.status]??e.status}</span>
        </div>
        <div class="job-application-meta">
          <span>${pi(e.positionLabel)}</span>
          <a href="tel:${e.phone}" dir="ltr">${e.phone}</a>
          ${e.city?`<span>${pi(e.city)}</span>`:``}
          ${e.hasVehicle===!0?`<span>دارای وسیله نقلیه${e.vehicleType?` (${pi(e.vehicleType)})`:``}</span>`:``}
          ${e.hasVehicle===!1?`<span>بدون وسیله نقلیه</span>`:``}
          <span>${new Date(e.createdAt).toLocaleDateString(`fa-IR`)}</span>
        </div>
        ${e.message?`<p class="testimonial-row-text">${pi(e.message)}</p>`:``}
      </div>
      <div class="staff-table-actions">
        <select class="pipeline-status-select" data-status-select-id="${e.id}">
          ${mi(e.status)}
  ...
  `}function gi(e,t){return`
    <div class="testimonial-row" data-position-row="${pi(e.id)}">
      <div class="testimonial-row-avatar"><span class="icon">${u.briefcase}</span></div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
        ...
        <div class="job-application-meta">
          ${e.titleEn?`<span dir="ltr">${pi(e.titleEn)}</span>`:``}
          <span>${e.requiresVehicle?`نیاز به وسیله نقلیه دارد`:`بدون نیاز به وسیله نقلیه`}</span>
        </div>
        ${e.description?`<p class="testimonial-row-text">${pi(e.description)}</p>`:``}
      </div>
      <div class="staff-table-actions">
  ...
  `}function Si(){let e=document.getElementById(`activity-log-list`),t=document.getElementById(`activity-log-error`),n=document.getElementById(`activity-log-refresh`);if(!e||!t||!n)return;async function r(){t.hidden=!0;try{let t=await I();e.innerHTML=t.length?t.map(bi).join(``):`<p class="portal-empty">هنوز فعالیتی ثبت نشده است.</p>`}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}n.addEventListener(`click`,()=>void r()),r()}function Ci(){return`
    <div class="editor-sidebar-card">
      <h3>به‌روزرسانی</h3>
  ...
  `}var wi=`sudo bash install.sh`;function Ti(){return`
  ...
  `}function Ei(){return`
    <div class="update-manual-guide">
      ...
      <div class="update-manual-step">
        ...
        <p class="update-manual-cmd-plain" dir="ltr">${wi}</p>
      </div>
  ...
  `}function Di(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Oi(){let e=document.getElementById(`update-panel-current`),t=document.getElementById(`update-panel-current-changelog`),n=document.getElementById(`update-panel-result`),r=document.getElementById(`update-scan-btn`),i=document.getElementById(`update-panel-manual-guide`);!e||!t||!n||!r||!i||(gt().then(n=>{e.textContent=`نسخه‌ی فعلی: ${n.current}`,n.currentChangelog.length&&(t.innerHTML=`
          <h4>این نسخه شامل چه چیزهایی است؟</h4>
          <ul class="update-modal-changelog">${n.currentChangelog.map(e=>`<li>${Di(e)}</li>`).join(``)}</ul>
          ${Ti()}
        `,t.hidden=!1),i.innerHTML=Ei(),i.hidden=!1}).catch(()=>{e.textContent=``}),r.addEventListener(`click`,async()=>{r.disabled=!0;let t=r.textContent;r.textContent=`در حال بررسی...`,n.innerHTML=``;try{let t=await gt();if(e.textContent=`نسخه‌ی فعلی: ${t.current}`,!t.updateAvailable){Bn(`نسخه‌ی شما به‌روز است.`);return}let r=t.changelog.length?`<ul class="update-modal-changelog">${t.changelog.map(e=>`<li>${Di(e)}</li>`).join(``)}</ul>`:``;if(t.runtime!==`selfhost`){n.innerHTML=`
          <h4>نسخه‌ی جدید موجود است: ${Di(t.latest??``)}</h4>
          ${r}
      ...
      `,document.getElementById(`update-panel-backup-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.textContent=`در حال دانلود...`;try{await at()}catch(e){Bn(e instanceof Error?e.message:`دانلود پشتیبان ناموفق بود.`,`error`)}finally{t.disabled=!1,t.textContent=`دانلود نسخه پشتیبان`}}),document.getElementById(`update-panel-apply-btn`)?.addEventListener(`click`,async e=>{if(!window.confirm(`به‌روزرسانی سرویس را برای حدود یک دقیقه مختل می‌کند. آیا از پشتیبان‌گیری مطمئن هستید و می‌خواهید ادامه دهید؟`))return;let t=e.currentTarget,r=document.getElementById(`update-panel-error`);t.disabled=!0,t.textContent=`در حال اعمال...`;try{await _t(),n.innerHTML=`
            <h4>به‌روزرسانی آغاز شد</h4>
            <p>سرویس در حال بازسازی است — حدود یک دقیقه صبر کنید، سپس این صفحه را دوباره بارگذاری کنید.</p>
          `}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`به‌روزرسانی ناموفق بود.`),t.disabled=!1,t.textContent=`اعمال به‌روزرسانی`}})}catch(e){Bn(e instanceof Error?e.message:`بررسی به‌روزرسانی ناموفق بود.`,`error`)}finally{r.disabled=!1,r.textContent=t}}))}var ki={text:`متن ساده`,steps:`مراحل شماره‌دار`,accordion:`آکاردئونی (پرسش و پاسخ)`,grid:`شبکه‌ی آیکون/عنوان`,slider:`اسلایدر`,quote:`نقل‌قول`,testimonials:`نظرات مشتریان (خودکار)`,stats:`آمار و ارقام`},Ai=Object.keys(ki),ji=[{id:`hero`,type:`hero`,visible:!0}],Mi={about:{label:`صفحه درباره ما`,livePath:`/about`,hint:`ویرایش مشخصات، تاریخچه، اهداف و بخش‌های معرفی بهبار در نشانی /about`},terms:{label:`صفحه قوانین و مقررات`,livePath:`/terms`,hint:`مدیریت شرایط، ضوابط، تعهدات و مقررات استفاده از سامانه بهبار در نشانی /terms`},privacy:{label:`صفحه حریم خصوصی`,livePath:`/privacy`,hint:`تنظیم سیاست‌های حفاظت از داده‌ها و امنیت حریم خصوصی کاربران بهبار در نشانی /privacy`}};function Ni(e,t){let n=[...e];return t?.length&&n.push(...t.map(e=>`- ${e}`)),n.join(`
`)}function Pi(e){let t=e.split(`
`).map(e=>e.trim()).filter(Boolean),n=t.filter(e=>!e.startsWith(`- `)),r=t.filter(e=>e.startsWith(`- `)).map(e=>e.slice(2).trim());return{paragraphs:n,list:r.length?r:void 0}}function Fi(e){let t=`https://behbarapp.ir/p/${encodeURIComponent(e.slug)}`;return`
    ...
    <div class="settings-panel" data-page-panel="home">
      ...
      <div class="settings-panel-footer" style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
        <select id="homepage-section-add-type" style="height: 40px; padding: 0 12px; border-radius: var(--radius-md); border: 1px solid var(--border); background: var(--background);">
          ${Ai.map(e=>`<option value="${e}">${ki[e]}</option>`).join(``)}
        </select>
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Mi.about.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Mi.terms.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Mi.privacy.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
  ...
  `}function Li(e){let t=document.getElementById(`pages-global-error`),n=document.getElementById(`pages-global-saved`);function r(){n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}function i(e){t&&(t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی رخ داد.`,window.scrollTo({top:0,behavior:`smooth`}))}Gn().then(()=>Z(document.body));let a=document.querySelectorAll(`[data-page-nav-tab]`),o=document.querySelectorAll(`[data-page-panel]`);a.forEach(e=>{e.addEventListener(`click`,()=>{a.forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`);let t=e.dataset.pageNavTab;o.forEach(e=>{e.hidden=e.dataset.pagePanel!==t})})}),document.getElementById(`pages-top-add-btn`)?.addEventListener(`click`,()=>e(null)),document.getElementById(`page-custom-new-btn`)?.addEventListener(`click`,()=>e(null));let s={},c=[],l=!0,d={};function f(e,t,n){return`
    ...
    `}function p(e,t,n){let r=e.type===`hero`,i=e.layout??`text`,a=r?`هدر و بنر اصلی`:ki[i],o=!r&&i!==`text`&&i!==`testimonials`;return`
          ...
          <div class="block-editor-body">
            <div class="form-field">
              ...
              <select data-field="layout">
                ${Ai.map(e=>`<option value="${e}" ${e===i?`selected`:``}>${ki[e]}</option>`).join(``)}
              </select>
            </div>
        ...
        ${n.sections.map((t,n)=>`
          <div class="block-editor" data-legal-section="${n}">
            ...
            <div class="block-editor-body">
              ...
              <textarea data-field="body" data-i18n="fa" rows="4" placeholder="هر پاراگراف در یک خط؛ برای مورد لیستی خط را با «- » شروع کنید">${Ni(t.paragraphs,t.list)}</textarea>
              <textarea data-field="bodyEn" data-i18n="en" dir="ltr" rows="4" placeholder="One paragraph per line; prefix list items with '- '">${Ni(t.paragraphsEn,t.listEn)}</textarea>
            </div>
          </div>
        `).join(``)}
      </div>
    ...
    <div class="settings-panel" data-settings-panel="theme" ${n(`theme`)}>
      ...
      ${Array.from(new Set(Bi.map(e=>e.group))).map(e=>`
        <div class="editor-sidebar-card">
          <div class="card-header-action">
            <h3>${e}</h3>
            <button type="button" class="btn btn-primary btn-sm" data-save-setting="theme">ذخیره</button>
      ...
      <div class="settings-form-grid" data-social-link-index="${t}" style="grid-template-columns: 140px 140px 1fr 1fr auto; align-items: end; gap: 8px;">
        <div class="form-field">
          ...
          <select data-field="platform">
            ${Ri.map(t=>`<option value="${t.value}" ${t.value===e.platform?`selected`:``}>${t.label}</option>`).join(``)}
          </select>
        </div>
          ...
          <div class="settings-form-grid">
            <div class="form-field">
              ...
              <select id="setup-origin-province">
                ...
                ${ea.map(e=>`<option value="${e.name}">${e.name}</option>`).join(``)}
              </select>
            </div>
            <div class="form-field">
  ...
  `}function oa(e,t){let n=document.querySelector(`.setup-wizard-card`),r=document.getElementById(`setup-progress-fill`),i=document.getElementById(`setup-progress-text`),a=document.getElementById(`setup-back`),o=document.getElementById(`setup-next`),s=document.getElementById(`setup-skip-all`),c=document.getElementById(`setup-general-error`),l=document.getElementById(`setup-vehicle-list`);if(!n||!r||!i||!a||!o||!s||!c||!l)return;let d=0,f={},p=ta;function m(){l.innerHTML=p.map((e,t)=>`
    ...
    <div class="testimonial-row" data-audit-edit="${e.id}" role="button" tabindex="0">
      ...
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${sa(e.title)}</strong>
          <span class="article-status-badge article-status-draft">فاقد ${t.join(` و `)}</span>
        </div>
        <div class="job-application-meta"><span dir="ltr">/magazine/${sa(e.slug)}</span></div>
      </div>
    </div>
  `}function la(){return`
    <div class="view-header">
  ...
  `}function ua(e=()=>{}){let t=document.getElementById(`seo-error`),n=document.getElementById(`seo-audit-list`);if(!t||!n)return;let r=``;function i(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`,Bn(e instanceof Error?e.message:`ذخیره ناموفق بود.`,`error`)}async function a(){let e=(await Te()).seo??{};document.getElementById(`seo-search-console`).value=e.googleSiteVerification??``,document.getElementById(`seo-ga-id`).value=e.googleAnalyticsId??``,r=e.defaultOgImage??``}async function o(){let t=(await de()).filter(e=>!e.metaTitle||!e.metaDescription);n.innerHTML=t.length?t.map(ca).join(``):`<p class="pipeline-empty">همه‌ی مقاله‌ها عنوان و توضیحات سئو دارند.</p>`,n.querySelectorAll(`[data-audit-edit]`).forEach(t=>{t.addEventListener(`click`,()=>e(Number(t.dataset.auditEdit)))})}function s(){return{googleSiteVerification:document.getElementById(`seo-search-console`).value.trim(),googleAnalyticsId:document.getElementById(`seo-ga-id`).value.trim(),defaultOgImage:r}}function c(e){document.getElementById(e)?.addEventListener(`click`,async e=>{let n=e.currentTarget;t.hidden=!0;try{await Q(n,async()=>{await V(`seo`,s())}),Bn(`تنظیمات سئو ذخیره شد.`)}catch(e){i(e)}})}c(`seo-search-console-save-btn`),c(`seo-ga-save-btn`),Promise.all([a(),o()]).catch(i)}function da(){return`
    <div class="settings-view">
      <div class="settings-panel">
        <h2>امنیت حساب</h2>
  ...
  `}function fa(){let e=document.getElementById(`account-security-status-card`),t=document.getElementById(`account-security-sms-setup-card`),n=document.getElementById(`account-security-sms-error`),r=document.getElementById(`account-security-sms-verifying`);async function i(e,t){n.hidden=!0,r.hidden=!1;try{await k(e),window.location.reload()}catch(e){r.hidden=!0,n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`,t?.reset()}}document.getElementById(`account-security-start-sms`)?.addEventListener(`click`,()=>{(async()=>{try{await ee(),e.hidden=!0,t.hidden=!1;let n=At(`account-security-sms`,{onComplete:e=>void i(e,n),onResend:()=>void ee().catch(e=>window.alert(e instanceof Error?e.message:`ارسال دوباره‌ی کد ناموفق بود.`))})}catch(e){window.alert(e instanceof Error?e.message:`خطایی پیش آمد.`)}})()}),document.getElementById(`account-security-disable-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`account-security-disable-password`),n=document.getElementById(`account-security-disable-error`);(async()=>{n.hidden=!0;try{await A(t.value),window.location.reload()}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}})()})}function pa(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var ma={salary:`حقوق`,bonus:`پاداش`,adjustment:`اصلاحیه`,payout:`تسویه`};function ha(){return`
    <div class="view-header">
      <h1>حقوق و دستمزد</h1>
    </div>
    <p class="settings-panel-hint">
  ...
  `}function ga(e){return`
    <tr>
      <td>${pa(e.fullName)}${e.isActive?``:` <span class="settings-panel-hint">(غیرفعال)</span>`}</td>
      <td>${pa(e.roleLabel)}</td>
      <td><strong>${q(e.balance)}</strong></td>
      <td>
        <div class="staff-table-actions">
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-view-tx="${e.staffId}" data-wallet-staff-name="${pa(e.fullName)}">تراکنش‌ها</button>
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-adjust="${e.staffId}">ثبت اصلاحیه</button>
        </div>
      </td>
    </tr>
  `}function _a(e){let t=e.direction===`credit`?`+`:`−`,n=e.direction===`credit`?`var(--success)`:`var(--danger)`;return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${ma[e.type]??e.type}</span>
        <span class="activity-log-target">${pa(e.description)}</span>
      </div>
      <div class="activity-log-meta"><span style="color:${n}; font-weight:700;">${t} ${q(e.amount)}</span></div>
    </div>
  `}function va(e){return`
    <div class="editor-sidebar-card">
      <div class="plugin-card-head">
        <h3>${pa(e.staffName)} — ${q(e.amount)}</h3>
      </div>
      ${e.staffNote?`<p class="settings-panel-hint">${pa(e.staffNote)}</p>`:``}
      <div class="staff-table-actions">
  ...
  `}function ya(e){return`
    <tr data-role-rate-row="${e.id}">
      <td>${pa(e.label)}${e.isSystem?` <span class="settings-panel-hint">(سیستمی)</span>`:``}</td>
  ...
  `}function Oa(){let e=document.querySelectorAll(`[data-finance-tab]`),t=document.getElementById(`finance-tab-overview`),n=document.getElementById(`finance-tab-documents`);e.forEach(r=>{r.addEventListener(`click`,()=>{let i=r.dataset.financeTab;e.forEach(e=>e.classList.remove(`active`)),r.classList.add(`active`),i===`overview`?(t&&(t.style.display=`block`),n&&(n.style.display=`none`)):i===`documents`&&(t&&(t.style.display=`none`),n&&(n.style.display=`block`))})});let r=[],i=Sa();async function a(){try{let[e]=await Promise.allSettled([M(),z()]);e.status===`fulfilled`&&(r=e.value),i=Sa(),s(),c()}catch(e){Bn(e instanceof Error?e.message:`خطا در بارگذاری داده‌های مالی`,`error`)}}function o(){let e=[];for(let t of r){let n=`pending`;n=t.status===`completed`?`settled`:t.status===`canceled`?`canceled`:`pending`,e.push({id:t.id,isCustom:!1,trackingCode:t.trackingCode||`BB-${t.id}`,customerName:t.customerName||`مشتری سامانه`,phone:t.phone||`—`,serviceLabel:t.serviceLabel||`حمل بار`,originCity:t.originCity||`—`,destinationCity:t.destinationCity||`—`,amount:t.estimateAvg||t.estimateMin||0,settlementStatus:n,createdAt:t.createdAt||new Date().toISOString(),notes:t.originNotes||``})}for(let t of i)e.push({id:t.id,isCustom:!0,trackingCode:t.trackingCode,customerName:t.customerName,phone:t.phone,serviceLabel:t.serviceLabel,originCity:t.originCity,destinationCity:t.destinationCity,amount:t.amount,settlementStatus:t.settlementStatus,createdAt:t.createdAt,notes:t.notes});return e.sort((e,t)=>new Date(t.createdAt).getTime()-new Date(e.createdAt).getTime()),e}function s(){let e=o(),t=0,n=0,r=0,i=0,a={},s={settled:0,pending:0,credit:0,canceled:0};for(let o of e){let e=Number(o.amount)||0;t+=e,o.settlementStatus===`settled`?(n+=e,s.settled++):o.settlementStatus===`pending`?(r+=e,s.pending++):o.settlementStatus===`credit`?(i+=e,s.credit++):o.settlementStatus===`canceled`&&s.canceled++;let c=o.serviceLabel||`سایر`;a[c]||(a[c]={count:0,total:0}),a[c].count++,a[c].total+=e}let c=Math.max(0,n-i),l=document.getElementById(`kpi-gross-turnover`);l&&(l.textContent=Ta(t));let u=document.getElementById(`kpi-realized-revenue`);u&&(u.textContent=Ta(n));let d=document.getElementById(`kpi-pending-settlements`);d&&(d.textContent=Ta(r));let f=document.getElementById(`kpi-total-expenses`);f&&(f.textContent=Ta(i));let p=document.getElementById(`kpi-estimated-profit`);p&&(p.textContent=Ta(c));let m=document.getElementById(`kpi-docs-count`);m&&(m.textContent=wa(e.length));let h=document.getElementById(`finance-services-breakdown`);if(h){let e=Object.entries(a).sort((e,t)=>t[1].total-e[1].total);h.innerHTML=e.length?e.map(([e,n])=>{let r=t>0?Math.round(n.total/t*100):0;return`
        ...
        <div style="display: flex; flex-direction: column; gap: 10px;">
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-settled">تسویه‌شده: ${wa(s.settled)} سند</span>
              <span>%${wa(Math.round(s.settled/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
          ...
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-pending">در انتظار تسویه: ${wa(s.pending)} سند</span>
              <span>%${wa(Math.round(s.pending/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
          ...
          <div>
            <div style="display: flex; justify-content: space-between; font-size: 0.85rem; margin-bottom: 4px;">
              <span class="finance-badge finance-badge-credit">بستانکار / هزینه‌ها: ${wa(s.credit)} سند</span>
              <span>%${wa(Math.round(s.credit/t*100))}</span>
            </div>
            <div style="background: rgba(0,0,0,0.06); height: 7px; border-radius: 4px; overflow: hidden;">
      ...
      `;return}e.innerHTML=a.map(e=>{let t=Ea[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`},n=e.originCity&&e.destinationCity?`${e.originCity} ➔ ${e.destinationCity}`:`—`,r=e.createdAt?e.createdAt.slice(0,10):`—`;return`
          <tr data-doc-id="${e.id}">
            <td style="font-weight: 700; font-family: monospace; direction: ltr; text-align: right;">${e.trackingCode}</td>
            <td style="white-space: nowrap;">${wa(r)}</td>
            <td style="font-weight: 600;">${e.customerName}</td>
            <td style="direction: ltr; text-align: right;">${wa(e.phone)}</td>
            <td>${e.serviceLabel}</td>
            <td style="font-size: 0.8rem; color: var(--color-text-muted);">${n}</td>
            <td style="font-weight: 700; color: #059669;">${Ta(e.amount)}</td>
            <td>
        ...
        `}).join(``),e.querySelectorAll(`.btn-view-invoice`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.docCode,n=a.find(e=>e.trackingCode===t);n&&l(n)})}),e.querySelectorAll(`.btn-toggle-settlement`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=e.dataset.docId;if(e.dataset.isCustom===`true`){let e=i.find(e=>String(e.id)===t);e&&(e.settlementStatus=e.settlementStatus===`settled`?`pending`:`settled`,Ca(i),Bn(`وضعیت تسویه سند دستی به‌روزرسانی شد.`,`success`),s(),c())}else{let e=r.find(e=>String(e.id)===t);if(e){let t=e.status===`completed`?`in_progress`:`completed`;try{await N(e.id,t),e.status=t,Bn(`وضعیت تسویه سفارش به‌روزرسانی شد.`,`success`),s(),c()}catch{Bn(`خطا در به‌روزرسانی وضعیت تسویه`,`error`)}}}})})}function l(e){let t=document.getElementById(`finance-modal-container`);if(!t)return;let n=e.createdAt?e.createdAt.slice(0,10):new Date().toISOString().slice(0,10),r=Ea[e.settlementStatus]||{label:e.settlementStatus,badgeClass:`finance-badge-pending`};t.innerHTML=`
            ...
            <div class="behbar-invoice-sheet" id="behbar-printable-invoice">
              <div class="behbar-invoice-head">
                ...
                <div class="behbar-invoice-meta">
                  ...
                  <div><strong>تاریخ صدور:</strong> ${wa(n)}</div>
              ...
              <div class="behbar-invoice-parties">
                ...
                <div>
                  ...
                  <div style="color: #6b7280; font-size: 0.78rem;">شماره تماس: ${wa(e.phone)}</div>
                </div>
              </div>
              ...
              <div class="behbar-invoice-total">
                ...
                <span style="font-size: 1.25rem;">${Ta(e.amount)} تومان</span>
              </div>
    ...
    `,document.getElementById(`finance-add-modal-close`)?.addEventListener(`click`,t),document.getElementById(`btn-cancel-add-doc`)?.addEventListener(`click`,t),document.getElementById(`finance-add-modal-backdrop`)?.addEventListener(`click`,e=>{e.target===e.currentTarget&&t()}),document.getElementById(`finance-add-doc-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let n=document.getElementById(`doc-customer-input`).value.trim(),r=document.getElementById(`doc-phone-input`).value.trim()||`—`,a=document.getElementById(`doc-service-input`).value.trim(),o=document.getElementById(`doc-origin-input`).value.trim()||`تهران`,l=document.getElementById(`doc-dest-input`).value.trim()||`تهران`,u=Number(document.getElementById(`doc-amount-input`).value)||0,d=document.getElementById(`doc-status-select`).value,f=Math.floor(1e4+Math.random()*9e4),p={id:`custom_${Date.now()}`,trackingCode:`BB-FIN-${f}`,customerName:n,phone:r,serviceLabel:a,originCity:o,destinationCity:l,amount:u,settlementStatus:d,createdAt:new Date().toISOString()};i.push(p),Ca(i),Bn(`سند مالی جدید با موفقیت ثبت شد.`,`success`),t(),s(),c()});function t(){e&&(e.innerHTML=``)}}function f(){let e=o();if(!e.length){Bn(`سند مالی برای صدور فایل اکسل موجود نیست.`,`error`);return}let t=[`شماره سند مالی`,`تاریخ صدور`,`طرف حساب`,`شماره تماس`,`عنوان خدمت`,`شهر مبدا`,`شهر مقصد`,`مبلغ کل (تومان)`,`وضعیت تسویه`,`توضیحات`];function n(e){let t=e==null?``:String(e);return/[",\n]/.test(t)?`"${t.replace(/"/g,`""`)}"`:t}let r=[t.map(n).join(`,`)];for(let t of e){let e=Ea[t.settlementStatus]?.label||t.settlementStatus,i=t.createdAt?t.createdAt.slice(0,10):``;r.push([t.trackingCode,i,t.customerName,t.phone,t.serviceLabel,t.originCity,t.destinationCity,t.amount,e,t.notes||``].map(n).join(`,`))}let i=`﻿`+r.join(`\r
`),a=new Blob([i],{type:`text/csv;charset=utf-8;`}),s=URL.createObjectURL(a),c=document.createElement(`a`);c.href=s,c.download=`behbar-financial-report-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(c),c.click(),document.body.removeChild(c),URL.revokeObjectURL(s),Bn(`فایل اکسل گزارش مالی بهبار با موفقیت ایجاد و دانلود شد.`,`success`)}document.getElementById(`finance-export-excel-btn`)?.addEventListener(`click`,f),document.getElementById(`finance-add-doc-btn`)?.addEventListener(`click`,d),document.getElementById(`finance-refresh-btn`)?.addEventListener(`click`,()=>{a(),Bn(`اطلاعات مالی به‌روز شد.`,`success`)}),document.getElementById(`finance-search-input`)?.addEventListener(`input`,()=>c()),document.getElementById(`finance-status-filter`)?.addEventListener(`change`,()=>c()),a()}function ka(e,t,n){return`
    <button type="button" class="home-tile" data-home-tile="${e}">
      <span class="home-tile-icon">${t}</span>
      <span class="home-tile-label">${n}</span>
    </button>
  `}function Aa(e){let t=x(e,`content`)||x(e,`stories`)||x(e,`seo`)||x(e,`settings`),n=x(e,`staff`)||x(e,`recruitment`)||x(e,`roles`)||x(e,`wallet`),r=x(e,`settings`)||x(e,`homepage`),i=x(e,`pipeline`)||x(e,`map`),a=x(e,`dashboard`)||x(e,`wallet`)||x(e,`roles`)||x(e,`staff`),o=[];return o.push(ka(`dashboard`,u.chart,`داشبورد`)),i&&o.push(ka(`requests`,u.columns,`درخواست‌ها`)),a&&o.push(ka(`finance`,u.finance,`مدیریت مالی`)),x(e,`staff`)&&o.push(ka(`fleet`,u.truck,`مدیریت ناوگان حمل‌ونقل`)),r&&o.push(ka(`settings`,u.settings,`تنظیمات سایت`)),x(e,`chat`)&&o.push(ka(`chat`,u.chat,`چت پشتیبانی`)),t&&o.push(ka(`content`,u.grid,`مدیریت محتوا`)),n&&o.push(ka(`personnel`,u.users,`مدیریت پرسنل`)),x(e,`plugins`)&&o.push(ka(`plugins`,u.plugin,`افزونه‌ها`)),`<div class="home-grid">${o.join(``)}</div>`}function ja(e){let t=[];return x(e,`pipeline`)&&t.push(ka(`pipeline`,u.columns,`مراحل درخواست‌ها`)),x(e,`map`)&&t.push(ka(`map`,u.map,`نقشه درخواست‌ها`)),`<div class="home-grid">${t.join(``)}</div>`}function Ma(e){let t=[];return x(e,`content`)&&t.push(ka(`magazine`,u.article,`مجله`)),x(e,`content`)&&t.push(ka(`testimonials`,u.message,`نظرات مشتریان`)),x(e,`stories`)&&t.push(ka(`stories`,u.story,`استوری‌ها`)),x(e,`seo`)&&t.push(ka(`seo`,u.seo,`مدیریت سئو`)),(x(e,`content`)||x(e,`settings`))&&t.push(ka(`media`,u.image,`مدیریت فایل`)),`<div class="home-grid">${t.join(``)}</div>`}function Na(e){let t=[];return x(e,`staff`)&&t.push(ka(`staff`,u.users,`کارمندان`)),x(e,`recruitment`)&&t.push(ka(`jobApplications`,u.briefcase,`فرصت‌های شغلی`)),x(e,`roles`)&&t.push(ka(`roles`,u.lock,`نقش‌ها و اختیارات`)),(x(e,`staff`)||x(e,`roles`))&&t.push(ka(`activityLog`,u.history,`گزارش فعالیت`)),x(e,`wallet`)&&t.push(ka(`payroll`,u.wallet,`حقوق و دستمزد`)),`<div class="home-grid">${t.join(``)}</div>`}function Pa(e,t){e.querySelectorAll(`[data-home-tile]`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.homeTile??``))})}async function Fa(){try{let e=(await Te()).site_name?.fa?.trim();if(!e||e===`بهبار`)return;document.querySelectorAll(`#login-brand-text, .admin-logo-title, #staff-portal-brand-text`).forEach(t=>{t.textContent?.includes(`بهبار`)&&(t.textContent=t.textContent.replace(/بهبار/g,e))})}catch{}}function Ia(e){return e===`home`?null:e===`requests`||e===`content`||e===`personnel`||e===`dashboard`||e===`settings`||e===`plugins`||e===`chat`||e===`fleet`||e===`finance`?`home`:e===`pipeline`||e===`map`?`requests`:e===`magazine`||e===`testimonials`||e===`stories`||e===`seo`||e===`media`?`content`:e===`staff`||e===`jobApplications`||e===`roles`||e===`activityLog`||e===`payroll`?`personnel`:e===`staffHistory`?`staff`:e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`?`dashboard`:e===`magazine-editor`?`magazine`:e===`page-editor`||e===`pages`?`settings`:`home`}function La(){let e=document.querySelector(`#app`);if(!e)throw Error(`#app not found`);return e}function Ra(){let e=La();e.innerHTML=jt(),Mt(Xa),Fa()}var za={home:``,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,jobApplications:`job-applications`,activityLog:`activity-log`,accountSecurity:`account-security`,myWallet:`wallet`,payroll:`payroll`,finance:`finance`,magazine:`magazine`,"magazine-editor":`magazine-editor`,pages:`settings`,"page-editor":`page-editor`,dashboardOrders:`dashboard/orders`,dashboardVisitors:`dashboard/visitors`,dashboardStaff:`dashboard/staff`,staffHistory:`staff/history`},Ba={"":`home`,dashboard:`dashboard`,requests:`requests`,pipeline:`pipeline`,map:`map`,fleet:`fleet`,finance:`finance`,chat:`chat`,content:`content`,personnel:`personnel`,settings:`settings`,plugins:`plugins`,seo:`seo`,media:`media`,staff:`staff`,roles:`roles`,testimonials:`testimonials`,stories:`stories`,"job-applications":`jobApplications`,"activity-log":`activityLog`,"account-security":`accountSecurity`,wallet:`myWallet`,payroll:`payroll`,magazine:`magazine`,"magazine-editor":`magazine-editor`,"page-editor":`page-editor`,"dashboard/orders":`dashboardOrders`,"dashboard/visitors":`dashboardVisitors`,"dashboard/staff":`dashboardStaff`,"staff/history":`staffHistory`};function Va(){let e=window.location.pathname.replace(/^\/management\/?/,``).replace(/\/+$/,``);if(!e)return{screen:`home`};if(Ba[e])return{screen:Ba[e]};let t=e.split(`/`);if(t.length===2&&(t[0]===`magazine-editor`||t[0]===`page-editor`)){let e=t[0],n=parseInt(t[1],10);return{screen:e,detailId:isNaN(n)?null:n}}return null}function Ha(e,t=null){let n=za[e]??``,r=n;(e===`magazine-editor`||e===`page-editor`)&&t&&(r=`${n}/${t}`);let i=r?`/management/${r}`:`/management/`;window.location.pathname!==i&&window.history.pushState({screen:e,editingDetailId:t},``,i)}var Ua=`home`,Wa=null;function $(e,t=null,n=!0){let r=document.getElementById(`view-container`),i=document.getElementById(`admin-back-btn`),a=g();if(!(!r||!a)){if(Ua=e,i&&(i.hidden=e===`home`),v({screen:e,extra:e===`magazine-editor`||e===`page-editor`?t:e===`staffHistory`?Wa:void 0}),n&&Ha(e,t),e===`home`)r.innerHTML=Aa(a),Pa(r,e=>$(e));else if(e===`requests`)r.innerHTML=ja(a),Pa(r,e=>$(e));else if(e===`content`)r.innerHTML=Ma(a),Pa(r,e=>$(e));else if(e===`personnel`)r.innerHTML=Na(a),Pa(r,e=>$(e));else if(e===`dashboard`)r.innerHTML=yn(),bn(e=>$(e));else if(e===`dashboardOrders`)r.innerHTML=xn();else if(e===`dashboardVisitors`)r.innerHTML=Sn();else if(e===`dashboardStaff`)r.innerHTML=Cn();else if(e===`pipeline`)r.innerHTML=fn(),pn();else if(e===`map`)r.innerHTML=On(),kn();else if(e===`staff`)r.innerHTML=Nn(),Pn(e=>{Wa=e,$(`staffHistory`)});else if(e===`staffHistory`){if(!Wa){$(`staff`);return}r.innerHTML=In(Wa),Ln(Wa)}else if(e===`fleet`)r.innerHTML=tr(),nr();else if(e===`magazine`)r.innerHTML=vr(),yr(e=>$(`magazine-editor`,e));else if(e===`magazine-editor`)r.innerHTML=Ir(),Lr(t,()=>$(`magazine`));else if(e===`pages`){$(`settings`);return}else e===`page-editor`?(r.innerHTML=Ur(),Wr(t,()=>$(`settings`))):e===`testimonials`?(r.innerHTML=Yr(),Xr()):e===`chat`?(r.innerHTML=ri(),ii()):e===`stories`?(r.innerHTML=ci(),li()):e===`jobApplications`?(r.innerHTML=_i(),vi()):e===`settings`?(r.innerHTML=Wi(),Gi((e,t)=>$(e,t??null))):e===`plugins`?(r.innerHTML=Yi(),$i()):e===`seo`?(r.innerHTML=la(),ua(e=>$(`magazine-editor`,e))):e===`media`?(r.innerHTML=Rn(),zn()):e===`roles`?(r.innerHTML=Vn(),Hn()):e===`activityLog`?(r.innerHTML=xi(),Si()):e===`accountSecurity`?(r.innerHTML=da(),fa()):e===`myWallet`?(r.innerHTML=sr(),ur()):e===`payroll`?(r.innerHTML=ha(),ba()):e===`finance`?(r.innerHTML=Da(a),Oa()):(r.innerHTML=Aa(a),Pa(r,e=>$(e)))}}function Ga(e,t=!1){let n=La();n.innerHTML=zt(e),document.getElementById(`admin-back-btn`)?.addEventListener(`click`,()=>{let e=Ia(Ua);e&&$(e)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{j(),_(),Ra()}),document.getElementById(`admin-account-btn`)?.addEventListener(`click`,()=>$(`accountSecurity`));function r(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`,t=document.getElementById(`admin-theme-sun`),n=document.getElementById(`admin-theme-moon`);t&&n&&(t.hidden=!e,n.hidden=e)}r(),document.getElementById(`admin-theme-toggle-btn`)?.addEventListener(`click`,()=>{document.documentElement.getAttribute(`data-theme`)===`dark`?(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`behbar_admin_theme`,`light`)):(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`behbar_admin_theme`,`dark`)),r()}),document.getElementById(`admin-logo-btn`)?.addEventListener(`click`,()=>{$(`home`)}),window.addEventListener(`popstate`,e=>{let t=e.state;if(t?.screen)$(t.screen,t.editingDetailId??null,!1);else{let e=Va();e?$(e.screen,e.detailId??null,!1):$(`home`,null,!1)}}),x(e,`settings`)&&qa(),Ka(),Gn(),Fa(),x(e,`ai`)&&It();let i=Va(),a=t?y():null;i&&i.screen!==`home`?$(i.screen,i.detailId??null,!1):a?.screen===`staffHistory`&&a.extra?(Wa=a.extra,$(`staffHistory`)):a?.screen===`magazine-editor`?$(`magazine-editor`,a.extra??null):a?.screen===`page-editor`?$(`page-editor`,a.extra??null):a?.screen&&a.screen!==`home`?$(a.screen):$(`home`,null,!0)}async function Ka(){try{let e=await Te(),t=e.branding,n=t?.logoUrl;n&&document.querySelectorAll(`.admin-logo-mark`).forEach(e=>e.src=n);let r=t?.faviconUrl||n;r&&document.querySelectorAll(`link[rel="icon"]`).forEach(e=>e.href=r);let i=e.site_name;i?.fa?.trim()&&(document.title=`${i.fa.trim()} - پنل مدیریت`,document.querySelectorAll(`.admin-logo-title`).forEach(e=>e.textContent=i.fa.trim()))}catch{}}async function qa(){let e=document.getElementById(`admin-sidebar-version`);if(e)try{let t=await gt();e.textContent=t.updateAvailable?`نسخه ${t.current} · نسخه جدید موجود است`:`نسخه ${t.current}`,e.classList.toggle(`has-update`,t.updateAvailable),e.hidden=!1}catch{}}function Ja(e){let t=La();t.innerHTML=mr(e),Fa(),gr(()=>{j(),_(),Ra()})}function Ya(e){let t=La();t.innerHTML=aa(),Fa(),oa(e,()=>Ga(e))}function Xa(e,t=!1){if(!S(e)){Ja(e);return}if(!x(e,`settings`)){Ga(e,t);return}Te().then(n=>{ra(n)?Ya(e):Ga(e,t)}).catch(()=>Ga(e,t))}function Za(){if(T(Ra),!b()){Ra();return}let e=g();e?Xa(e,!0):Ra(),te().then(t=>{let n=h();n&&(m(n,t),(!e||e.role!==t.role)&&Xa(t,!0))}).catch(()=>{})}Za();