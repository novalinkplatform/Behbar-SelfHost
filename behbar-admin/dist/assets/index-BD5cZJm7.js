var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||(e((t={exports:{}}).exports,t),e=null),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,o)=>(o=n==null?{}:e(i(n)),s(r||!n||!n.__esModule||!a.call(n,`default`)?t(o,`default`,{value:n,enumerable:!0}):o,n));(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var l=`viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"`,u={route:`<svg ${l}><circle cx="5.5" cy="6" r="2"/><circle cx="18.5" cy="18" r="2"/><path d="M5.5 8v3a3 3 0 0 0 3 3h7a3 3 0 0 1 3 3"/></svg>`,grid:`<svg ${l}><rect x="3.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="3.5" width="7" height="7" rx="1.5"/><rect x="3.5" y="13.5" width="7" height="7" rx="1.5"/><rect x="13.5" y="13.5" width="7" height="7" rx="1.5"/></svg>`,chart:`<svg ${l}><path d="M4 20V10M12 20V4M20 20v-7"/><path d="M2 20h20"/></svg>`,columns:`<svg ${l}><rect x="3.5" y="4" width="5" height="16" rx="1"/><rect x="9.5" y="4" width="5" height="10" rx="1"/><rect x="15.5" y="4" width="5" height="13" rx="1"/></svg>`,phone:`<svg ${l}><path d="M5.5 4h2.8l1.2 4-2 1.3a11 11 0 0 0 5.2 5.2l1.3-2 4 1.2v2.8c0 1-.9 1.7-1.8 1.5-6-1.1-10.6-5.7-11.7-11.7C4.3 5.4 5 4 5.5 4Z"/></svg>`,pin:`<svg ${l}><path d="M12 21s-6.5-5.6-6.5-11a6.5 6.5 0 0 1 13 0c0 5.4-6.5 11-6.5 11Z"/><circle cx="12" cy="10" r="2.3"/></svg>`,flag:`<svg ${l}><path d="M6 21V4"/><path d="M6 4.5h10.5L14 8l2.5 3.5H6"/></svg>`,calendar:`<svg ${l}><rect x="3.5" y="5" width="17" height="15" rx="2"/><path d="M3.5 9.5h17M8 3v4M16 3v4"/></svg>`,logout:`<svg ${l}><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><path d="m16 17 5-5-5-5"/><path d="M21 12H9"/></svg>`,lock:`<svg ${l}><rect x="4.5" y="10.5" width="15" height="10" rx="2"/><path d="M8 10.5V7a4 4 0 0 1 8 0v3.5"/></svg>`,close:`<svg ${l}><path d="m5 5 14 14M19 5 5 19"/></svg>`,chevronDown:`<svg ${l}><path d="m6 9 6 6 6-6"/></svg>`,refresh:`<svg ${l}><path d="M3.5 12a8.5 8.5 0 0 1 14.5-6M20.5 12a8.5 8.5 0 0 1-14.5 6"/><path d="M18 3v4h-4M6 21v-4h4"/></svg>`,map:`<svg ${l}><path d="M9 4 4 6v14l5-2 6 2 5-2V4l-5 2-6-2Z"/><path d="M9 4v14M15 6v14"/></svg>`,users:`<svg ${l}><circle cx="9" cy="8" r="3"/><path d="M3 20a6 6 0 0 1 12 0"/><circle cx="17" cy="9" r="2.3"/><path d="M15.5 20a4.5 4.5 0 0 1 5.5-4.4"/></svg>`,plusCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="M12 8v8M8 12h8"/></svg>`,checkCircle:`<svg ${l}><circle cx="12" cy="12" r="8.5"/><path d="m8.5 12.3 2.3 2.3 4.7-5"/></svg>`,user:`<svg ${l}><circle cx="12" cy="8" r="3.5"/><path d="M5 20a7 7 0 0 1 14 0"/></svg>`,article:`<svg ${l}><rect x="5" y="3.5" width="14" height="17" rx="1.5"/><path d="M8.5 8h7M8.5 12h7M8.5 16h4"/></svg>`,settings:`<svg ${l}><circle cx="12" cy="12" r="3.2"/><path d="M12 3v2.4M12 18.6V21M21 12h-2.4M5.4 12H3M18.4 5.6l-1.7 1.7M7.3 16.7l-1.7 1.7M18.4 18.4l-1.7-1.7M7.3 7.3 5.6 5.6"/></svg>`,message:`<svg ${l}><path d="M4 5.5h16a1 1 0 0 1 1 1V16a1 1 0 0 1-1 1H9l-4.5 3.5V17H4a1 1 0 0 1-1-1V6.5a1 1 0 0 1 1-1Z"/><path d="M7.5 9.5h9M7.5 13h6"/></svg>`,chat:`<svg ${l}><path d="M3.5 6.5A2.5 2.5 0 0 1 6 4h9a2.5 2.5 0 0 1 2.5 2.5v6A2.5 2.5 0 0 1 15 15H9l-4 3.5v-3.5H6a2.5 2.5 0 0 1-2.5-2.5v-6Z"/><circle cx="7.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="11.5" cy="9.5" r="0.9" fill="currentColor" stroke="none"/><circle cx="15" cy="9.5" r="0.9" fill="currentColor" stroke="none"/></svg>`,story:`<svg ${l}><rect x="7" y="3" width="10" height="17" rx="2.2"/><circle cx="12" cy="7.2" r="1.5" fill="currentColor" stroke="none"/></svg>`,briefcase:`<svg ${l}><rect x="3" y="7.5" width="18" height="12" rx="2"/><path d="M8.5 7.5V6a2 2 0 0 1 2-2h3a2 2 0 0 1 2 2v1.5"/><path d="M3 12.5h18M10.5 12.5v2h3v-2"/></svg>`,download:`<svg ${l}><path d="M12 3.5v11M8 10.5l4 4 4-4"/><path d="M4.5 17v2a1.5 1.5 0 0 0 1.5 1.5h12a1.5 1.5 0 0 0 1.5-1.5v-2"/></svg>`,truck:`<svg ${l}><rect x="2" y="7" width="11" height="7" rx="1"/><path d="M13 10h4l3 3v1h-2"/><path d="M7.8 17h6.9"/><circle cx="6" cy="17" r="1.8"/><circle cx="16.5" cy="17" r="1.8"/></svg>`,seo:`<svg ${l}><circle cx="10.5" cy="10.5" r="6.5"/><path d="m20 20-4.8-4.8"/><path d="M7.5 10.5h6M10.5 7.5v6"/></svg>`,ai:`<svg ${l}><path d="M11 3 12.7 8 17.5 9.7 12.7 11.4 11 16.4 9.3 11.4 4.5 9.7 9.3 8Z"/><path d="M18 15.5 18.8 17.7 21 18.5 18.8 19.3 18 21.5 17.2 19.3 15 18.5 17.2 17.7Z"/></svg>`,image:`<svg ${l}><rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="8.5" cy="9.5" r="1.5"/><path d="m5 17 5-5 3 3 3-4 3 6"/></svg>`,video:`<svg ${l}><rect x="3" y="6" width="12" height="12" rx="2"/><path d="m15 10 6-3v10l-6-3Z"/></svg>`,audio:`<svg ${l}><path d="M9 18V6l8-2v12"/><circle cx="7" cy="18" r="2.2"/><circle cx="17" cy="16" r="2.2"/></svg>`,arrowRight:`<svg ${l}><path d="M5 12h14M13 6l6 6-6 6"/></svg>`,arrowLeft:`<svg ${l}><path d="M19 12H5M11 18l-6-6 6-6"/></svg>`,maleAvatar:`<svg ${l}><circle cx="12" cy="8" r="4"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,femaleAvatar:`<svg ${l}><circle cx="12" cy="7.5" r="4"/><path d="M12 11.5v6M9 15h6"/><path d="M4.5 20a7.5 7.5 0 0 1 15 0"/></svg>`,eye:`<svg ${l}><path d="M2 12s3.8-7 10-7 10 7 10 7-3.8 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>`,history:`<svg ${l}><path d="M3 12a9 9 0 1 0 3-6.7"/><path d="M3 4v5h5"/><path d="M12 8v4l3 2"/></svg>`,link:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.6 4.9a3.7 3.7 0 0 1 5.2 5.2L16 12"/><path d="M13 17.5 11.4 19.1a3.7 3.7 0 0 1-5.2-5.2L8 12"/></svg>`,externalLink:`<svg ${l}><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`,unlink:`<svg ${l}><path d="M9.5 14.5 14.5 9.5"/><path d="M11 6.5 12.2 5.3a3.7 3.7 0 0 1 5.2 5.2L16.2 11.7"/><path d="M13 17.5 11.8 18.7a3.7 3.7 0 0 1-5.2-5.2L7.8 12.3"/><path d="m4 4 16 16"/></svg>`,quote:`<svg ${l}><path d="M7.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/><path d="M16.5 8.5a3 3 0 0 0-3 3V16h5v-4.5h-2a3 3 0 0 1 2-3V8.5Z"/></svg>`,undo:`<svg ${l}><path d="M4 12a8 8 0 1 1 2.6 5.9"/><path d="M4 6.5V12h5.5"/></svg>`,redo:`<svg ${l}><path d="M20 12a8 8 0 1 0-2.6 5.9"/><path d="M20 6.5V12h-5.5"/></svg>`,minus:`<svg ${l}><path d="M4 12h16"/></svg>`,eraser:`<svg ${l}><path d="m17.5 8.5-9 9H4l-1-1L14 5.5a2 2 0 0 1 2.8 0l2 2a2 2 0 0 1-.3 2.9L9.5 19"/></svg>`,alignLeft:`<svg ${l}><path d="M4 6h16M4 12h10M4 18h13"/></svg>`,alignCenter:`<svg ${l}><path d="M4 6h16M7 12h10M5.5 18h13"/></svg>`,alignRight:`<svg ${l}><path d="M4 6h16M10 12h10M7 18h13"/></svg>`,listBullet:`<svg ${l}><circle cx="4.5" cy="6" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="12" r="1" fill="currentColor" stroke="none"/><circle cx="4.5" cy="18" r="1" fill="currentColor" stroke="none"/><path d="M9 6h11M9 12h11M9 18h11"/></svg>`,listNumber:`<svg ${l}><path d="M9 6h11M9 12h11M9 18h11"/><path d="M4 5v3M3.3 5H4.7M3 11.5h1.6c.5 0 .9.4.9.9 0 .3-.2.5-.4.7L3 15h2.6M3.3 19h1.4c.5 0 .9-.4.9-.9s-.4-.9-.9-.9H3.3"/></svg>`,plugin:`<svg ${l}><path d="M12 3 4 7v10l8 4 8-4V7Z"/><path d="M4 7l8 4 8-4M12 11v10"/></svg>`,wallet:`<svg ${l}><path d="M3 7a2 2 0 0 1 2-2h11a2 2 0 0 1 2 2v1"/><path d="M3 7v10a2 2 0 0 0 2 2h13a2 2 0 0 0 2-2v-7a2 2 0 0 0-2-2H5"/><circle cx="16" cy="13" r="1.2" fill="currentColor" stroke="none"/></svg>`,sun:`<svg ${l}><circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M6.34 17.66l-1.41 1.41M19.07 4.93l-1.41 1.41"/></svg>`,moon:`<svg ${l}><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z"/></svg>`},d=`https://api.behbarapp.ir`,f=`behbar_admin_token`,p=`behbar_admin_staff`,m=`behbar_admin_screen`;function h(e,t){localStorage.setItem(f,e),localStorage.setItem(p,JSON.stringify(t))}function g(){return localStorage.getItem(f)}function _(){let e=localStorage.getItem(p);if(!e)return null;try{let t=JSON.parse(e);return Array.isArray(t.permissions)?t:(v(),null)}catch{return null}}function v(){localStorage.removeItem(f),localStorage.removeItem(p),localStorage.removeItem(m)}function y(e){localStorage.setItem(m,JSON.stringify(e))}function b(){let e=localStorage.getItem(m);if(!e)return null;try{return JSON.parse(e)}catch{return null}}function x(){return g()!==null&&_()!==null}function S(e,t){return(e.permissions??[]).includes(t)}function C(e){return(e.permissions??[]).some(e=>e!==`assignments`)}var w=class extends Error{},T=null;function E(e){T=e}async function D(e,t={}){let n=g(),r=await fetch(`${d}${e}`,{...t,headers:{...t.headers,...n?{Authorization:`Bearer ${n}`}:{}}});if(r.status===401)throw v(),T?.(),new w(`نشست شما منقضی شده است.`);return r}async function O(e,t){let n=await fetch(`${d}/api/staff/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ورود ناموفق بود.`);return r?.needsTwoFactor?{needsTwoFactor:!0,challengeToken:r.challengeToken}:{needsTwoFactor:!1,token:r.token,staff:r.staff}}async function ee(e,t){let n=await fetch(`${d}/api/staff/login/verify-2fa`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({challengeToken:e,code:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`کد نامعتبر است.`);return r}async function k(){let e=await D(`/api/staff/2fa/sms/setup`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال کد ناموفق بود.`)}async function A(e){let t=await D(`/api/staff/2fa/sms/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({code:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید کد ناموفق بود.`)}async function j(e){let t=await D(`/api/staff/2fa/disable`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({password:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`غیرفعال‌سازی ناموفق بود.`)}async function M(){await D(`/api/staff/logout`,{method:`POST`}).catch(()=>{})}async function N(){let e=await D(`/api/staff/me`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات ناموفق بود.`);return{...t.staff,licenseLocked:!!t.licenseLocked,licenseSummary:t.licenseSummary}}async function P(e){let t=await D(`/api/admin/requests${e?`?status=${encodeURIComponent(e)}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌ها ناموفق بود.`);return n.requests??[]}async function F(e,t){let n=await D(`/api/admin/requests/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function I(e){let t=await D(`/api/admin/requests/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function R(){let e=await D(`/api/admin/requests/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت خروجی ناموفق بود.`)}let t=await e.blob(),n=URL.createObjectURL(t),r=document.createElement(`a`);r.href=n,r.download=`behbar-requests-${new Date().toISOString().slice(0,10)}.csv`,document.body.appendChild(r),r.click(),r.remove(),URL.revokeObjectURL(n)}async function z(){let e=await D(`/api/admin/activity-log`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گزارش فعالیت ناموفق بود.`);return t.entries??[]}async function B(e,t){let n=await D(`/api/admin/requests/${e}/assign`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({staffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اختصاص ناموفق بود.`)}async function V(){let e=await D(`/api/admin/stats`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار ناموفق بود.`);return t}async function te(){let e=await D(`/api/admin/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کارمندان ناموفق بود.`);return t.staff??[]}async function ne(e){let t=await D(`/api/admin/staff`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد کارمند ناموفق بود.`);return n.staff}async function re(){let e=await D(`/api/admin/roles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نقش‌ها ناموفق بود.`);return{roles:t.roles??[],permissions:t.permissions??[]}}async function ie(e){let t=await D(`/api/admin/roles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نقش ناموفق بود.`);return n.role}async function ae(e,t){let n=await D(`/api/admin/roles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نقش ناموفق بود.`);return r.role}async function oe(e){let t=await D(`/api/admin/roles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نقش ناموفق بود.`)}async function se(e,t){let n=await D(`/api/admin/staff/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی کارمند ناموفق بود.`);return r.staff}async function ce(e){let t=await D(`/api/admin/staff/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف کارمند ناموفق بود.`)}async function le(){let e=await D(`/api/staff/requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌ها ناموفق بود.`);return t.requests??[]}async function ue(e,t){let n=await D(`/api/staff/requests/${e}/status`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی ناموفق بود.`)}async function de(){let e=await D(`/api/admin/articles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت مقالات ناموفق بود.`);return t.articles??[]}async function fe(e){let t=await D(`/api/admin/articles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد مقاله ناموفق بود.`);return n.article}async function pe(e,t){let n=await D(`/api/admin/articles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی مقاله ناموفق بود.`);return r.article}async function me(e,t){let n=await D(`/api/admin/articles/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.article}async function he(e){let t=await D(`/api/admin/articles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف مقاله ناموفق بود.`)}async function ge(){let e=await D(`/api/admin/pages`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت برگه‌ها ناموفق بود.`);return t.pages??[]}async function _e(e){let t=await D(`/api/admin/pages/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت برگه ناموفق بود.`);return n.page}async function ve(e){let t=await D(`/api/admin/pages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد برگه ناموفق بود.`);return n.page}async function ye(e,t){let n=await D(`/api/admin/pages/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی برگه ناموفق بود.`);return r.page}async function be(e,t){let n=await D(`/api/admin/pages/${e}/${t?`publish`:`unpublish`}`,{method:`PATCH`}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت برگه ناموفق بود.`);return r.page}async function xe(e){let t=await D(`/api/admin/pages/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف برگه ناموفق بود.`)}async function Se(e){let t=g(),n=await fetch(`${d}/api/admin/upload`,{method:`POST`,headers:{"Content-Type":e.type,...t?{Authorization:`Bearer ${t}`}:{}},body:e}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`آپلود تصویر ناموفق بود.`);return`${d}${r.url}`}async function Ce(e){let t=await D(`/api/admin/media${e?`?folder=${e}`:``}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت فهرست فایل‌ها ناموفق بود.`);return n.files??[]}async function we(e){let t=await D(`/api/admin/media/${encodeURIComponent(e)}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف فایل ناموفق بود.`)}async function Te(){let e=await fetch(`${d}/api/settings`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت تنظیمات ناموفق بود.`);return t.settings??{}}async function H(e,t){let n=await D(`/api/admin/settings`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({key:e,value:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی تنظیمات ناموفق بود.`)}async function Ee(e,t,n){let r=await D(`/api/admin/ai/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,apiKey:t,model:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اتصال ناموفق بود.`);return i}async function De(e,t){let n=await D(`/api/admin/sms/test-connection`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`اتصال ناموفق بود.`);return r}async function Oe(){let e=await D(`/api/admin/testimonials`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت نظرات ناموفق بود.`);return t.testimonials??[]}async function ke(e){let t=await D(`/api/admin/testimonials`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد نظر ناموفق بود.`);return n.testimonial}async function Ae(e,t){let n=await D(`/api/admin/testimonials/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی نظر ناموفق بود.`);return r.testimonial}async function je(e){let t=await D(`/api/admin/testimonials/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف نظر ناموفق بود.`)}async function Me(){let e=await D(`/api/admin/license`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات لایسنس ناموفق بود.`);return t.license??null}async function Ne(e){let t=await D(`/api/admin/license/activate`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({licenseKey:e})}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`فعال‌سازی لایسنس ناموفق بود.`);return n.license}async function Pe(){let e=await D(`/api/admin/chat/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت گفتگوها ناموفق بود.`);return t.conversations??[]}async function Fe(e){let t=await D(`/api/admin/chat/conversations/${e}/messages`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیام‌ها ناموفق بود.`);return n.messages??[]}async function Ie(e,t){let n=await D(`/api/admin/chat/conversations/${e}/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({text:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارسال پیام ناموفق بود.`)}async function Le(e,t){let n=await D(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`)}async function Re(e,t){let n=await D(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({assignedStaffId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`واگذاری گفتگو ناموفق بود.`)}async function ze(e,t){let n=await D(`/api/admin/chat/conversations/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({archived:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`بایگانی گفتگو ناموفق بود.`)}async function Be(e){let t=await D(`/api/admin/chat/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function Ve(e){let t=await D(`/api/admin/requests?phone=${encodeURIComponent(e)}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های مرتبط ناموفق بود.`);return n.requests??[]}async function He(e){let t=await D(`/api/admin/requests?staffId=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.requests??[]}async function Ue(e){let t=await D(`/api/admin/requests/${e}/events`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت تاریخچه ناموفق بود.`);return n.events??[]}async function We(){let e=await D(`/api/admin/chat/agents`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت پشتیبان‌ها ناموفق بود.`);return t.agents??[]}async function Ge(){let e=await D(`/api/admin/stories`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت استوری‌ها ناموفق بود.`);return t.stories??[]}async function Ke(e){let t=await D(`/api/admin/stories`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد استوری ناموفق بود.`);return n.story}async function U(e,t){let n=await D(`/api/admin/stories/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی استوری ناموفق بود.`);return r.story}async function qe(e){let t=await D(`/api/admin/stories/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف استوری ناموفق بود.`)}async function Je(){let e=await D(`/api/admin/job-applications`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های همکاری ناموفق بود.`);return t.applications??[]}async function Ye(e,t){let n=await D(`/api/admin/job-applications/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify({status:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وضعیت ناموفق بود.`);return r.application}async function Xe(e){let t=await D(`/api/admin/job-applications/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف درخواست ناموفق بود.`)}async function Ze(){let e=await D(`/api/admin/fleet-vehicles`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت وسایل نقلیه ناموفق بود.`);return t.vehicles??[]}async function Qe(e){let t=await D(`/api/admin/fleet-vehicles`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`ایجاد وسیله نقلیه ناموفق بود.`);return n.vehicle}async function $e(e,t){let n=await D(`/api/admin/fleet-vehicles/${e}`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`به‌روزرسانی وسیله نقلیه ناموفق بود.`);return r.vehicle}async function et(e){let t=await D(`/api/admin/fleet-vehicles/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف وسیله نقلیه ناموفق بود.`)}async function tt(){let e=await D(`/api/admin/plugins`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت افزونه‌ها ناموفق بود.`);return t.plugins??{}}async function nt(e){let t=await D(`/api/admin/requests/${e}/reports`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت گزارش‌ها ناموفق بود.`);return n.reports??[]}async function rt(e,t){let n=await D(`/api/admin/requests/${e}/reports`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({message:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت گزارش ناموفق بود.`);return r}async function it(){let e=await D(`/api/admin/analytics`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت آمار بازدید ناموفق بود.`);return t}async function at(){let e=await D(`/api/admin/backup/export`);if(!e.ok){let t=await e.json().catch(()=>({}));throw Error(typeof t?.error==`string`?t.error:`دریافت فایل پشتیبان ناموفق بود.`)}let t=(e.headers.get(`Content-Disposition`)??``).match(/filename="([^"]+)"/)?.[1]??`behbar-backup.sql`,n=await e.blob(),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=t,document.body.appendChild(i),i.click(),i.remove(),URL.revokeObjectURL(r)}async function ot(e){let t=await D(`/api/admin/backup/import`,{method:`POST`,headers:{"Content-Type":`application/sql`},body:e}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`بازیابی پشتیبان ناموفق بود.`)}async function st(){let e=await D(`/api/admin/backup/drive-test`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ارسال آزمایشی به گوگل درایو ناموفق بود.`)}async function ct(){let e=await D(`/api/admin/backup/drive-oauth/prepare`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`آماده‌سازی اتصال به گوگل ناموفق بود.`);return t.authUrl}async function lt(){let e=await D(`/api/admin/backup/drive-disconnect`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`قطع اتصال ناموفق بود.`)}async function ut(e,t){let n=await D(`/api/admin/ai/chat`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,conversationId:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ارتباط با دستیار هوش مصنوعی ناموفق بود.`);return r}async function dt(e,t,n){let r=await D(`/api/admin/ai/execute`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({messages:e,toolCallId:t.toolCallId,tool:t.tool,args:t.args,conversationId:n})}),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`اجرای اقدام ناموفق بود.`);return i}async function ft(){let e=await D(`/api/admin/ai/conversations`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`فهرست گفتگوها دریافت نشد.`);return t.conversations??[]}async function pt(e){let t=await D(`/api/admin/ai/conversations/${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`گفتگو دریافت نشد.`);return n}async function mt(){let e=await D(`/api/admin/ai/conversations`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`ساخت گفتگوی جدید ناموفق بود.`);return t.id}async function ht(e){let t=await D(`/api/admin/ai/conversations/${e}`,{method:`DELETE`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`حذف گفتگو ناموفق بود.`)}async function gt(){let e=await D(`/api/admin/version`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت اطلاعات نسخه ناموفق بود.`);return t}async function _t(){let e=await D(`/api/admin/selfhost/update`,{method:`POST`}),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`به‌روزرسانی ناموفق بود.`)}async function W(){let e=await D(`/api/staff/wallet`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول ناموفق بود.`);return t}async function G(e,t){let n=await D(`/api/staff/wallet/transactions?limit=${e}&offset=${t}`),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:r.transactions??[],total:r.total??0}}async function vt(){let e=await D(`/api/staff/wallet/payout-requests`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return t.payoutRequests??[]}async function yt(e,t){let n=await D(`/api/staff/wallet/payout-requests`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({amount:e,note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ثبت درخواست تسویه ناموفق بود.`)}async function bt(){let e=await D(`/api/admin/wallet/staff`),t=await e.json().catch(()=>({}));if(!e.ok)throw Error(typeof t?.error==`string`?t.error:`دریافت کیف پول‌ها ناموفق بود.`);return t.wallets??[]}async function xt(e,t,n){let r=await D(`/api/admin/wallet/staff/${e}/transactions?limit=${t}&offset=${n}`),i=await r.json().catch(()=>({}));if(!r.ok)throw Error(typeof i?.error==`string`?i.error:`دریافت تراکنش‌ها ناموفق بود.`);return{transactions:i.transactions??[],total:i.total??0}}async function K(e,t,n,r){let i=await D(`/api/admin/wallet/staff/${e}/adjustments`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({direction:t,amount:n,description:r})}),a=await i.json().catch(()=>({}));if(!i.ok)throw Error(typeof a?.error==`string`?a.error:`ثبت اصلاحیه ناموفق بود.`)}async function q(e,t){let n=await D(`/api/admin/wallet/staff/${e}/rate-override`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ ناموفق بود.`)}async function St(e,t){let n=await D(`/api/admin/roles/${e}/pay-rate`,{method:`PATCH`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`ذخیره نرخ نقش ناموفق بود.`)}async function Ct(e=`pending`){let t=await D(`/api/admin/wallet/payout-requests?status=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت درخواست‌های تسویه ناموفق بود.`);return n.payoutRequests??[]}async function wt(e){let t=await D(`/api/admin/wallet/payout-requests/${e}/approve`,{method:`POST`}),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`تأیید درخواست ناموفق بود.`)}async function Tt(e,t){let n=await D(`/api/admin/wallet/payout-requests/${e}/reject`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({note:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`رد درخواست ناموفق بود.`)}async function Et(e){let t=await D(`/api/admin/wallet/payroll/preview?month=${e}`),n=await t.json().catch(()=>({}));if(!t.ok)throw Error(typeof n?.error==`string`?n.error:`دریافت پیش‌نمایش حقوق ناموفق بود.`);return n.entries??[]}async function Dt(e,t){let n=await D(`/api/admin/wallet/payroll/confirm`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({month:e,entries:t})}),r=await n.json().catch(()=>({}));if(!n.ok)throw Error(typeof r?.error==`string`?r.error:`پردازش حقوق ناموفق بود.`);return r}function J(e,t=6){return`
  ...
  `}function At(e){let t=document.getElementById(`login-form`),n=document.getElementById(`login-username`),r=document.getElementById(`login-password`),i=document.getElementById(`login-error`),a=document.getElementById(`login-submit`),o=document.getElementById(`login-2fa-form`),s=document.getElementById(`login-2fa-hint`),c=document.getElementById(`login-2fa-error`),l=document.getElementById(`login-2fa-verifying`),u=document.getElementById(`login-2fa-back`);if(!t||!n||!r||!i||!a||!o||!s||!c||!l||!u)return;new URLSearchParams(location.search).get(`demo`)===`1`&&(n.value=`test`,r.value=`12345678`,document.getElementById(`login-demo-notice`).hidden=!1);let d=``,f=null;async function p(t){c.hidden=!0,l.hidden=!1;try{let{token:n,staff:r}=await ee(d,t);h(n,r),e(r)}catch(e){l.hidden=!0,c.hidden=!1,c.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`,f?.reset()}}async function m(){try{let e=await O(n.value.trim(),r.value);e.needsTwoFactor&&(d=e.challengeToken)}catch(e){c.hidden=!1,c.textContent=e instanceof Error?e.message:`ارسال دوباره‌ی کد ناموفق بود.`}}function g(){t.hidden=!0,o.hidden=!1,s.textContent=`کد ۶رقمی که همین الان پیامک شد را وارد کنید.`,f=Ot(`login-2fa`,{onComplete:e=>void p(e),onResend:()=>void m()})}function _(){d=``,f?.stopWebOtp(),f=null,o.hidden=!0,t.hidden=!1,r.value=``,r.focus()}t.addEventListener(`submit`,async t=>{t.preventDefault(),i.hidden=!0,a.disabled=!0,a.textContent=`در حال ورود...`;try{let t=await O(n.value.trim(),r.value);t.needsTwoFactor?(d=t.challengeToken,g()):(h(t.token,t.staff),e(t.staff))}catch(e){i.hidden=!1,i.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}finally{a.disabled=!1,a.textContent=`ورود`}}),u.addEventListener(`click`,_)}function jt(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var Mt=`سلام! از من درباره‌ی مقاله‌ها، نظرات مشتریان، درخواست‌های همکاری، آمار یا تنظیمات سئو بپرس. برای هر تغییری، قبل از اجرا از تو تأیید می‌گیرم.`;function Nt(){return`
  ...
  `}function Pt(){let e=document.getElementById(`ai-widget-toggle`),t=document.getElementById(`ai-widget-close`),n=document.getElementById(`ai-widget-panel`),r=document.getElementById(`ai-widget-error`),i=document.getElementById(`ai-widget-messages`),a=document.getElementById(`ai-widget-form`),o=document.getElementById(`ai-widget-input`),s=document.getElementById(`ai-widget-send-btn`),c=document.getElementById(`ai-widget-new-chat-btn`),l=document.getElementById(`ai-widget-conversation-list`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l)return;let d=[],f=null,p=[],m=null,h=!1;function g(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}function _(){l.innerHTML=d.length?d.map(e=>`
        <div class="ai-widget-conversation-row ${e.id===f?`is-active`:``}" data-conversation-id="${e.id}">
          <button type="button" class="ai-widget-conversation-title" data-select-conversation="${e.id}">${jt(e.title||`گفتگوی جدید`)}</button>
          <button type="button" class="ai-widget-conversation-delete" data-delete-conversation="${e.id}" title="حذف">حذف</button>
        </div>
      `).join(``):`<p class="ai-widget-empty-list">هنوز گفتگویی نداری.</p>`}function v(){let e=[];p.length||e.push(`<div class="chat-bubble-admin chat-bubble-admin-customer"><div class="chat-bubble-body"><p>${jt(Mt)}</p></div></div>`);for(let t of p)t.role===`user`&&t.content?e.push(`<div class="chat-bubble-admin chat-bubble-admin-staff"><div class="chat-bubble-body"><p>${jt(t.content)}</p></div></div>`):t.role===`assistant`&&t.content&&e.push(`<div class="chat-bubble-admin chat-bubble-admin-customer"><div class="chat-bubble-body"><p>${jt(t.content)}</p></div></div>`);m&&e.push(`
  ...
  `}function Lt(e){let t=[];return S(e,`dashboard`)&&t.push(`
  ...
  `}var Rt=[{id:`pending`,label:`در انتظار بررسی`,color:`var(--muted)`},{id:`contacted`,label:`تماس گرفته شده`,color:`var(--warning)`},{id:`scheduled`,label:`زمان‌بندی شده`,color:`var(--secondary)`},{id:`in_progress`,label:`در حال انجام`,color:`var(--primary)`},{id:`completed`,label:`انجام شده`,color:`var(--success)`},{id:`cancelled`,label:`لغو شده`,color:`var(--danger)`}],zt=Object.fromEntries(Rt.map(e=>[e.id,e.label])),Bt=Object.fromEntries(Rt.map(e=>[e.id,e.color])),Vt=[`۰`,`۱`,`۲`,`۳`,`۴`,`۵`,`۶`,`۷`,`۸`,`۹`];function Y(e){return String(e).replace(/[0-9]/g,e=>Vt[Number(e)])}function X(e){return`${Y(Math.round(e).toLocaleString(`en-US`))} تومان`}function Z(e,t){return~~(e/t)}function Ht(e,t){return e-~~(e/t)*t}var Ut=[-61,9,38,199,426,686,756,818,1111,1181,1210,1635,2060,2097,2192,2262,2324,2394,2456,3178];function Wt(e){let t=Ut.length,n=e+621,r=-14,i=Ut[0];if(e<i||e>=Ut[t-1])throw Error(`Invalid Jalaali year ${e}`);let a=0;for(let n=1;n<t;n+=1){let t=Ut[n];if(a=t-i,e<t)break;r=r+Z(a,33)*8+Z(Ht(a,33),4),i=t}let o=e-i;r=r+Z(o,33)*8+Z(Ht(o,33)+3,4),Ht(a,33)===4&&a-o===4&&(r+=1);let s=Z(n,4)-Z((Z(n,100)+1)*3,4)-150,c=20+r-s;a-o<6&&(o=o-a+Z(a,33)*33);let l=Ht(Ht(o+1,33)-1,4);return l===-1&&(l=4),{leap:l,gy:n,march:c}}function Gt(e,t,n){let r=Z((e+Z(t-8,6)+100100)*1461,4)+Z(153*Ht(t+9,12)+2,5)+n-34840408;return r=r-Z(Z(e+100100+Z(t-8,6),100)*3,4)+752,r}function Kt(e){let t=4*e+139361631;t=t+Z(Z(4*e+183187720,146097)*3,4)*4-3908;let n=Z(Ht(t,1461),4)*5+308,r=Z(Ht(n,153),5)+1,i=Ht(Z(n,153),12)+1;return{gy:Z(t,1461)-100100+Z(8-i,6),gm:i,gd:r}}function qt(e){let t=Kt(e).gy-621,n=Wt(t),r=e-Gt(n.gy,3,n.march),i,a;if(r>=0){if(r<=185)return i=1+Z(r,31),a=Ht(r,31)+1,{jy:t,jm:i,jd:a};r-=186}else--t,r+=179,n.leap===1&&(r+=1);return i=7+Z(r,30),a=Ht(r,30)+1,{jy:t,jm:i,jd:a}}function Jt(e){return qt(Gt(e.getFullYear(),e.getMonth()+1,e.getDate()))}var Yt=[`فروردین`,`اردیبهشت`,`خرداد`,`تیر`,`مرداد`,`شهریور`,`مهر`,`آبان`,`آذر`,`دی`,`بهمن`,`اسفند`],Xt=[`۰`,`۱`,`۲`,`۳`,`۴`,`۵`,`۶`,`۷`,`۸`,`۹`];function Zt(e){return String(e).replace(/[0-9]/g,e=>Xt[Number(e)])}function Qt(e){return`${Yt[e.jm-1]} ${Zt(e.jd)}، ${Zt(e.jy)}`}function $t(e){return new Date(e.replace(` `,`T`)+`Z`)}function en(e){let t=$t(e),n=Jt(new Date),r=Jt(t),i=`${Zt(String(t.getHours()).padStart(2,`0`))}:${Zt(String(t.getMinutes()).padStart(2,`0`))}`;return n.jy===r.jy&&n.jm===r.jm&&n.jd===r.jd?`امروز، ${i}`:`${Qt(r)}، ${i}`}var tn=3e4,nn=`pending`,rn;function Q(e){return Rt.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${t.label}</option>`).join(``)}function an(e,t){return`<option value="">اختصاص‌نیافته</option>${t.map(t=>{let n=t.onActiveService&&t.id!==e,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``)}`}function on(e,t){return!t||`${e.trackingCode} ${e.phone} ${e.originCity} ${e.destinationCity} ${e.customerName}`.toLowerCase().includes(t.toLowerCase())}function sn(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function cn(e){return e?e.length?e.map(e=>`
  ...
  `:`<p class="pipeline-report-empty">هنوز رویدادی ثبت نشده است.</p>`:``}function un(e,t,n,r,i,a,o){return`
    <div class="pipeline-card" data-card-id="${e.id}" style="--card-accent:${Bt[e.status]??`var(--muted)`}">
      <div class="pipeline-card-top">
        <span class="pipeline-tracking">#${Y(e.trackingCode)}</span>
        <span class="pipeline-card-top-end">
          <span class="pipeline-estimate">${X(e.estimateAvg)}</span>
      ...
      <div class="pipeline-row pipeline-muted">
        ...
        <span>${e.scheduledDate} — ساعت ${Y(e.scheduledTime)}</span>
    ...
    <div class="bar-chart">
      ${e.map(e=>`
            <div class="bar-chart-row">
              ...
              <span class="bar-chart-value">${Y(e.value)}</span>
            </div>
          `).join(``)}
    </div>
  ...
  `}var hn={mobile:`موبایل`,desktop:`رایانه`};function gn(e){let t=e.split(`-`);return t.length===3?Y(`${t[1]}/${t[2]}`):Y(e)}function _n(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function vn(){return`
    <div class="dash-view">
  ...
  `}function yn(e){let t=document.getElementById(`dash-body`),n=document.getElementById(`dash-error`),r=document.getElementById(`dash-refresh-btn`),i=document.querySelectorAll(`#dash-subnav [data-dash-tab]`);if(!t)return;let a=`overview`;async function o(){if(t){t.innerHTML=`
    ...
    `;try{let[n,r,i,a]=await Promise.allSettled([V(),it(),Ze(),P()]),o=n.status===`fulfilled`?n.value:null,s=r.status===`fulfilled`?r.value:null,c=i.status===`fulfilled`?i.value:[],l=a.status===`fulfilled`?a.value:[],d=o?.byStatus?.find(e=>e.status===`pending`)?.count??0,f=o?.byStatus?.find(e=>e.status===`in_progress`)?.count??0,p=o?.byStatus?.find(e=>e.status===`completed`)?.count??0,m=o?.completedRevenue??0,h=o?.avgOrderValue??0,g=c.filter(e=>e.status===`active`).length,_=c.length,v=s?.totalViews??0,y=s?.uniqueVisitors??0,b=s?.activeOnline??0,x=s?.conversionRate??0,S=l.slice(0,8),C=`
        <!-- KPI Cards Grid -->
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card ${d>0?`is-alert`:``}">
            ...
            <div class="dash-kpi-value">${Y(d)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(f)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(p)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value is-currency">${X(m)}</div>
            <div class="dash-kpi-sub">میانگین هر سفارش: ${X(h)}</div>
          </div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(b)}</div>
          ...
          <div class="dash-kpi-card">
            <div class="dash-kpi-header">
              ...
              <span class="dash-kpi-badge badge-primary">${Y(x)}٪</span>
            </div>
            <div class="dash-kpi-value">${Y(x)} <span class="dash-kpi-unit">درصد</span></div>
            <div class="dash-kpi-sub">از ${Y(y)} بازدیدکننده ماه</div>
          </div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(g)} <span class="dash-kpi-unit">از ${Y(_)}</span></div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(v)}</div>
            <div class="dash-kpi-sub">${Y(y)} کاربر یکتا در ماه گذشته</div>
          </div>
        </div>
        ...
        <div class="dash-charts-grid">
          ...
          <div class="dash-card">
            ...
            <div class="dash-card-body">
              ${o?.byStatus?.length?pn(o.byStatus.map(e=>({label:zt[e.status]??e.status,value:e.count}))):`<p class="dash-empty">داده‌ای ثبت نشده است.</p>`}
            </div>
          </div>
        </div>
        ...
        <div class="dash-section">
          <div class="dash-section-header">
            <div class="dash-section-title-group">
              ...
              <span class="dash-count-pill">${Y(S.length)} سفارش آخر</span>
            </div>
            ...
            <div class="dash-table-wrapper">
              ${S.length===0?`<p class="dash-empty">هنوز سفارشی در سامانه بهبار ثبت نشده است.</p>`:`
                <table class="dash-table">
                  ...
                  <tbody>
                    ${S.map(e=>{let t=Bt[e.status]??`var(--muted)`,n=zt[e.status]??e.status,r=`${_n(e.originCity||`—`)} به ${_n(e.destinationCity||`—`)}`;return`
                        <tr>
                          ...
                          <td>
                            <div class="dash-customer-cell">
                              ...
                              <span class="dash-customer-phone">${Y(e.phone||``)}</span>
                            </div>
                          </td>
                          <td><span class="dash-service-tag">${_n(e.serviceLabel||`حمل بار`)}</span></td>
                          <td><span class="dash-route">${r}</span></td>
                          <td><span class="dash-price">${e.estimateAvg?X(e.estimateAvg):`توافقی`}</span></td>
                          <td>
    ...
    `;try{let e=await V(),n=e.byStatus.find(e=>e.status===`in_progress`)?.count??0,r=e.byStatus.find(e=>e.status===`completed`)?.count??0;t.innerHTML=`
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">کل درخواست‌ها</span>
            <span class="dash-kpi-value">${Y(e.total)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">در حال انجام</span>
            <span class="dash-kpi-value">${Y(n)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">انجام‌شده</span>
            <span class="dash-kpi-value">${Y(r)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">درآمد سفارش‌های انجام‌شده</span>
            <span class="dash-kpi-value is-currency">${X(e.completedRevenue)}</span>
          </div>
          <div class="dash-kpi-card">
            <span class="dash-kpi-label">میانگین ارزش هر سفارش</span>
            <span class="dash-kpi-value is-currency">${X(e.avgOrderValue)}</span>
          </div>
        </div>
        ...
        <div class="dash-charts-grid">
          ...
          <div class="dash-card">
            ...
            <div class="dash-card-body">${pn(e.byStatus.map(e=>({label:zt[e.status]??e.status,value:e.count})))}</div>
          </div>
          <div class="dash-card">
    ...
    `;try{let e=await it();t.innerHTML=`
        <div class="dash-kpi-grid">
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(e.activeOnline??0)}</div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(e.todayViews??0)}</div>
            <div class="dash-kpi-sub">${Y(e.todayVisitors??0)} بازدیدکننده یکتای امروز</div>
          </div>

          <div class="dash-kpi-card">
            <div class="dash-kpi-header">
              <span class="dash-kpi-label">نرخ تبدیل به سفارش</span>
              <span class="dash-kpi-badge badge-primary">${Y(e.conversionRate??0)}٪</span>
            </div>
            <div class="dash-kpi-value">${Y(e.conversionRate??0)} <span class="dash-kpi-unit">درصد</span></div>
          ...
          <div class="dash-kpi-card">
            ...
            <div class="dash-kpi-value">${Y(e.totalViews)}</div>
            <div class="dash-kpi-sub">${Y(e.uniqueVisitors)} کاربر یکتا</div>
          </div>
        </div>
          ...
          <div class="dash-card-body">
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: var(--space-3);">
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: var(--primary);">${Y(e.funnel?.wizardStart??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: var(--text);">${Y(e.funnel?.wizardStep??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: var(--success);">${Y(e.funnel?.orders??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: #047857;">${Y(e.funnel?.callClicks??0)}</div>
              ...
              <div style="padding: var(--space-3); border-radius: var(--radius-md); background: var(--surface-alt); border: 1px solid var(--border);">
                ...
                <div style="font-size: 1.4rem; font-weight: 700; color: #059669;">${Y(e.funnel?.whatsappClicks??0)}</div>
              ...
              <tbody>
                ${e.staffPerformance.length?e.staffPerformance.map(e=>`
                    <tr>
                      ...
                      <td>${Y(e.total)}</td>
                      <td><strong style="color: var(--success);">${Y(e.completed)}</strong></td>
                    </tr>
  ...
  `}function On(){let e=document.getElementById(`map-error`),t=document.getElementById(`map-refresh`),n=document.getElementById(`admin-map`);if(!e||!t||!n)return;let r=Cn.default.map(`admin-map`,{center:wn,zoom:11});Cn.default.tileLayer(`https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png`,{attribution:`© OpenStreetMap contributors`,maxZoom:19}).addTo(r);let i=[];function a(e,t){let n=t.map(t=>{let n=t.onActiveService&&t.id!==e.assignedStaffId,r=n?`${t.fullName} (${t.roleLabel} — در حال سرویس)`:`${t.fullName} (${t.roleLabel})`;return`<option value="${t.id}" ${t.id===e.assignedStaffId?`selected`:``} ${n?`disabled`:``}>${r}</option>`}).join(``);return`
      <div class="admin-map-popup">
        <div class="admin-map-popup-title">#${Y(e.trackingCode)} — ${e.serviceLabel}</div>
        ...
        <div class="admin-map-popup-row">${zt[e.status]??e.status}</div>
  ...
  `}function Nn(e=()=>{}){let t=document.getElementById(`staff-add-toggle`),n=document.getElementById(`staff-form-card`),r=document.getElementById(`staff-form-title`),i=document.getElementById(`staff-form-cancel`),a=document.getElementById(`staff-form-error`),o=document.getElementById(`staff-form-submit`),s=document.getElementById(`staff-form-id`),c=document.getElementById(`staff-full-name`),l=document.getElementById(`staff-username`),d=document.getElementById(`staff-password`),f=document.getElementById(`staff-password-label`),p=document.getElementById(`staff-role`),m=document.getElementById(`staff-gender`),h=document.getElementById(`staff-read-only`),g=document.getElementById(`staff-phone`),v=document.getElementById(`staff-avatar-url`),y=document.getElementById(`staff-avatar-preview`),b=document.getElementById(`staff-avatar-upload-btn`),x=document.getElementById(`staff-avatar-file-input`),C=document.getElementById(`staff-avatar-upload-error`),w=document.getElementById(`staff-national-id`),T=document.getElementById(`staff-hire-date`),E=document.getElementById(`staff-address`),D=document.getElementById(`staff-emergency-name`),O=document.getElementById(`staff-emergency-phone`),ee=document.getElementById(`staff-notes`),k=document.getElementById(`staff-error`),A=document.getElementById(`staff-table-body`),j=document.getElementById(`staff-wallet-section`),M=document.getElementById(`staff-salary-override`),N=document.getElementById(`staff-bonus-type-override`),P=document.getElementById(`staff-bonus-amount-override`),F=S(_(),`wallet`);if(!t||!n||!r||!i||!a||!o||!s||!c||!l||!d||!f||!p||!m||!h||!g||!v||!y||!b||!x||!C||!w||!T||!E||!D||!O||!ee||!k||!A||!j||!M||!N||!P)return;let I=[],R=[];function z(){let e=v.value.trim();if(e){y.innerHTML=`<img src="${e}" alt="" />`;return}y.innerHTML=m.value===`female`?u.femaleAvatar:u.maleAvatar}function B(e){a.hidden=!0,C.hidden=!0,r.textContent=e?`ویرایش پروفایل ${e.fullName}`:`کارمند جدید`,s.value=e?String(e.id):``,c.value=e?.fullName??``,l.value=e?.username??``,l.disabled=!!e,d.value=``,d.required=!e,f.textContent=e?`رمز عبور جدید (اختیاری)`:`رمز عبور`,p.value=e?.role??I[0]?.key??``,m.value=e?.gender??``,h.checked=e?.isReadOnly??!1,g.value=e?.phone??``,v.value=e?.avatarUrl??``,w.value=e?.nationalId??``,T.value=e?.hireDate??``,E.value=e?.address??``,D.value=e?.emergencyContactName??``,O.value=e?.emergencyContactPhone??``,ee.value=e?.notes??``,j.hidden=!e||!F,M.value=e?.salaryAmountOverride==null?``:String(e.salaryAmountOverride),N.value=e?.bonusTypeOverride??``,P.value=e?.bonusAmountOverride==null?``:String(e.bonusAmountOverride),o.textContent=e?`ذخیره تغییرات`:`ایجاد کارمند`,z(),n.hidden=!1,n.scrollIntoView({behavior:`smooth`,block:`center`})}function V(){n.hidden=!0}async function ie(){k.hidden=!0;try{let[e,t]=await Promise.all([te(),I.length?Promise.resolve({roles:I}):re()]);I=t.roles,R=e,p.innerHTML=I.map(e=>`<option value="${e.key}">${e.label}</option>`).join(``),A.innerHTML=e.map(e=>An(e)).join(``),ae()}catch(e){k.hidden=!1,k.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function ae(){A.querySelectorAll(`[data-view-history]`).forEach(t=>{t.addEventListener(`click`,()=>{let n=R.find(e=>e.id===Number(t.dataset.viewHistory));n&&e(n)})}),A.querySelectorAll(`[data-edit-staff]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=R.find(t=>t.id===Number(e.dataset.editStaff));t&&B(t)})}),A.querySelectorAll(`[data-toggle-active]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=Number(e.dataset.toggleActive),n=R.find(e=>e.id===t);if(n){e.disabled=!0;try{await se(t,{isActive:!n.isActive}),await ie()}catch(t){k.hidden=!1,k.textContent=t instanceof Error?t.message:`به‌روزرسانی ناموفق بود.`,e.disabled=!1}}})}),A.querySelectorAll(`[data-delete-staff]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=Number(e.dataset.deleteStaff);if(window.confirm(`این کارمند برای همیشه حذف شود؟ درخواست‌ها و محتوای قبلی او حذف نمی‌شود، فقط از او جدا می‌شود.`)){e.disabled=!0;try{await ce(t),await ie()}catch(t){k.hidden=!1,k.textContent=t instanceof Error?t.message:`حذف کارمند ناموفق بود.`,e.disabled=!1}}})})}t.addEventListener(`click`,()=>B(null)),i.addEventListener(`click`,V),v.addEventListener(`input`,z),m.addEventListener(`change`,z),b.addEventListener(`click`,()=>x.click()),x.addEventListener(`change`,async()=>{let e=x.files?.[0];if(e){C.hidden=!0,b.textContent=`در حال آپلود...`,b.disabled=!0;try{let t=await Se(e);v.value=t,z()}catch(e){C.hidden=!1,C.textContent=e instanceof Error?e.message:`آپلود عکس ناموفق بود.`}finally{x.value=``,b.textContent=`آپلود عکس`,b.disabled=!1}}}),o.addEventListener(`click`,async()=>{a.hidden=!0;let e=c.value.trim(),t=l.value.trim(),n=d.value,r=!!s.value;if(!e){a.hidden=!1,a.textContent=`نام و نام خانوادگی الزامی است.`;return}if(!r&&(!t||!n)){a.hidden=!1,a.textContent=`نام کاربری و رمز عبور برای کارمند جدید الزامی است.`;return}let i={fullName:e,role:p.value,gender:m.value||null,phone:g.value.trim(),avatarUrl:v.value.trim(),nationalId:w.value.trim(),hireDate:T.value.trim(),address:E.value.trim(),emergencyContactName:D.value.trim(),emergencyContactPhone:O.value.trim(),notes:ee.value.trim(),isReadOnly:h.checked};o.disabled=!0,o.textContent=r?`در حال ذخیره...`:`در حال ایجاد...`;try{if(r){let e={...i};n&&(e.password=n);let t=Number(s.value);await se(t,e),F&&await q(t,{salaryAmountOverride:M.value.trim()?Number(M.value):null,bonusTypeOverride:N.value||null,bonusAmountOverride:P.value.trim()?Number(P.value):null})}else await ne({...i,username:t,password:n});V(),await ie()}catch(e){a.hidden=!1,a.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`}finally{o.disabled=!1,o.textContent=r?`ذخیره تغییرات`:`ایجاد کارمند`}}),ie()}function Pn(e){return`
    <div class="portal-card">
      <div class="portal-card-top">
        <span class="pipeline-tracking">#${Y(e.trackingCode)}</span>
        <span class="portal-status">${zt[e.status]??e.status}</span>
      </div>
      ...
      <div class="pipeline-estimate">${X(e.estimateAvg)}</div>
    </div>
  ...
  `}function In(e){let t=document.getElementById(`staff-history-error`),n=document.getElementById(`staff-history-stats`),r=document.getElementById(`staff-history-list`),i=document.getElementById(`staff-history-refresh`);if(!t||!n||!r||!i)return;async function a(){t.hidden=!0;try{let t=await He(e.id),i=t.filter(e=>e.status===`completed`).length,a=t.filter(e=>e.status===`in_progress`).length;n.innerHTML=`
        <div class="stat-card">
          ...
          <span class="stat-card-value">${Y(t.length)}</span>
        </div>
        <div class="stat-card">
          <span class="stat-card-label">انجام‌شده</span>
          <span class="stat-card-value">${Y(i)}</span>
        </div>
        <div class="stat-card">
          <span class="stat-card-label">در حال انجام</span>
          <span class="stat-card-value">${Y(a)}</span>
        </div>
  ...
  `}function Vn(){let e=document.getElementById(`roles-error`);if(!e)return;function t(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`,zn(t instanceof Error?t.message:`خطایی پیش آمد.`,`error`)}let n=[],r=[],i=null;function a(e){let t=e.isSystem;return`
    ...
    <tr data-vehicle-row="${e.id}">
      ...
      <td>${e.model??`—`}</td>
      <td>${e.driverName??`—`}</td>
      <td><span class="article-status-badge ${Qn(e.status)}">${Zn[e.status]??e.status}</span></td>
      <td class="staff-table-actions">
      ...
      <div class="staff-form-grid">
        ...
        <div class="form-field">
          ...
          <select id="vehicle-status">
            ${Xn.map(e=>`<option value="${e.id}">${e.label}</option>`).join(``)}
          </select>
        </div>
        <div class="form-field">
  ...
  `}function rr(){let e=document.getElementById(`vehicle-add-toggle`),t=document.getElementById(`vehicle-form-card`),n=document.getElementById(`vehicle-form-title`),r=document.getElementById(`vehicle-form-cancel`),i=document.getElementById(`vehicle-form-error`),a=document.getElementById(`vehicle-form-submit`),o=document.getElementById(`vehicle-form-id`),s=document.getElementById(`vehicle-label`),c=document.getElementById(`vehicle-type`),l=document.getElementById(`vehicle-plate`),u=document.getElementById(`vehicle-model`),d=document.getElementById(`vehicle-year`),f=document.getElementById(`vehicle-status`),p=document.getElementById(`vehicle-driver`),m=document.getElementById(`vehicle-notes`),h=document.getElementById(`vehicles-error`),g=document.getElementById(`vehicles-table-body`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!u||!d||!f||!p||!m||!h||!g)return;let _=[],v=[],y=Object.fromEntries(Yn.map(e=>[e.id,e.label])),b=[],x={},S=[],C={city:``,cityEn:``,province:``,provinceEn:``},w=`all`,T=!0,E=!0,D=!1;Wn().then(()=>Kn(document.getElementById(`view-container`)??document.body)),document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-fleet-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-fleet-panel]`).forEach(t=>{t.hidden=t.dataset.fleetPanel!==e.dataset.fleetTab})})});function O(){let e=document.getElementById(`vehicle-types-list`);e&&(e.innerHTML=b.map((e,t)=>`
          ...
          <div class="settings-form-grid">
            ...
            <div class="form-field"><label>آیکون</label>
              <select data-field="icon">
                ${Jn.map(t=>`<option value="${t}" ${t===e.icon?`selected`:``}>${t}</option>`).join(``)}
              </select>
            </div>
    ...
    `).join(``),Kn(e))}function ee(){b=Array.from(document.querySelectorAll(`[data-vehicle-type-index]`)).map((e,t)=>({id:b[t]?.id??`vehicle-${crypto.randomUUID().slice(0,8)}`,label:e.querySelector(`[data-field="label"]`).value,labelEn:e.querySelector(`[data-field="labelEn"]`).value,icon:e.querySelector(`[data-field="icon"]`).value,basePrice:Number(e.querySelector(`[data-field="basePrice"]`).value)||0,perKmRate:Number(e.querySelector(`[data-field="perKmRate"]`).value)||0,floorCostExempt:b[t]?.floorCostExempt??!1,active:e.querySelector(`[data-field="active"]`).checked,sortOrder:t+1}))}document.getElementById(`vehicle-types-list`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-remove-vehicle-type]`);t&&(ee(),b.splice(Number(t.dataset.removeVehicleType),1),O())}),document.getElementById(`vehicle-type-add-btn`)?.addEventListener(`click`,()=>{ee(),b.push({id:`vehicle-${crypto.randomUUID().slice(0,8)}`,label:``,labelEn:``,icon:`van`,basePrice:0,perKmRate:0,floorCostExempt:!1,active:!0,sortOrder:b.length+1}),O()}),document.getElementById(`vehicle-type-save-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget,n=document.getElementById(`vehicle-types-saved-note`),r=document.getElementById(`vehicle-types-error`);r&&(r.hidden=!0);try{await qn(t,async()=>{ee(),await H(`vehicle_types`,b)}),n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`)}});function k(){let e=document.getElementById(`cities-list`);e.innerHTML=S.map((e,t)=>`
    ...
    `).join(``),Kn(e)}function A(){S=Array.from(document.querySelectorAll(`[data-city-index]`)).map(e=>({city:e.querySelector(`[data-field="city"]`).value,cityEn:e.querySelector(`[data-field="cityEn"]`).value,province:e.querySelector(`[data-field="province"]`).value,provinceEn:e.querySelector(`[data-field="provinceEn"]`).value}))}function j(){document.getElementById(`origin-city-fa`).value=C.city,document.getElementById(`origin-city-en`).value=C.cityEn,document.getElementById(`origin-province-fa`).value=C.province,document.getElementById(`origin-province-en`).value=C.provinceEn,document.getElementById(`coverage-mode`).value=w;let e=document.getElementById(`destination-cities-section`);e&&(e.hidden=w!==`selected`),k()}function M(){document.getElementById(`category-domestic-enabled`).checked=T,document.getElementById(`category-moving-enabled`).checked=E,document.getElementById(`international-shipping-enabled`).checked=D}document.getElementById(`coverage-mode`)?.addEventListener(`change`,e=>{w=e.currentTarget.value===`selected`?`selected`:`all`;let t=document.getElementById(`destination-cities-section`);t&&(t.hidden=w!==`selected`)}),document.getElementById(`cities-list`)?.addEventListener(`click`,e=>{let t=e.target.closest(`[data-remove-city]`);t&&(A(),S.splice(Number(t.dataset.removeCity),1),k())}),document.getElementById(`city-add-btn`)?.addEventListener(`click`,()=>{A(),S.push({city:``,cityEn:``,province:``,provinceEn:``}),k()}),document.querySelectorAll(`[data-save-setting="service_cities"]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=document.getElementById(`cities-saved-note`),n=document.getElementById(`cities-error`);n&&(n.hidden=!0);try{await qn(e,async()=>{A(),C={city:document.getElementById(`origin-city-fa`).value.trim(),cityEn:document.getElementById(`origin-city-en`).value.trim(),province:document.getElementById(`origin-province-fa`).value.trim(),provinceEn:document.getElementById(`origin-province-en`).value.trim()},S=S.filter(e=>e.city.trim()!==``);let e=x.service_cities??{},t={originCity:C.city?C:null,coverageMode:w,destinationCities:S,internationalShippingEnabled:!!e.internationalShippingEnabled};await H(`service_cities`,t),x.service_cities=t,k()}),t&&(t.hidden=!1,window.setTimeout(()=>t.hidden=!0,2500))}catch(e){n&&(n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`)}})}),document.querySelectorAll(`[data-save-setting="service_categories"]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=document.getElementById(`categories-saved-note`),n=document.getElementById(`categories-error`);n&&(n.hidden=!0);try{await qn(e,async()=>{T=document.getElementById(`category-domestic-enabled`).checked,E=document.getElementById(`category-moving-enabled`).checked,D=document.getElementById(`international-shipping-enabled`).checked,await H(`service_categories`,{domestic:T,moving:E});let e={...x.service_cities??{},internationalShippingEnabled:D};await H(`service_cities`,e),x.service_cities=e}),t&&(t.hidden=!1,window.setTimeout(()=>t.hidden=!0,2500))}catch(e){n&&(n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`)}})});function N(e){let t=b.filter(e=>e.active).map(e=>[e.id,e.label]);e&&!t.some(([t])=>t===e)&&t.push([e,`${y[e]??e} (غیرفعال)`]),c.innerHTML=t.map(([e,t])=>`<option value="${e}">${t}</option>`).join(``)}function P(e){i.hidden=!0,n.textContent=e?`ویرایش ${e.label}`:`وسیله جدید`,o.value=e?String(e.id):``,s.value=e?.label??``,N(e?.type),c.value=e?.type??c.options[0]?.value??``,l.value=e?.plateNumber??``,u.value=e?.model??``,d.value=e?.year?String(e.year):``,f.value=e?.status??`active`,p.value=e?.driverStaffId?String(e.driverStaffId):``,m.value=e?.notes??``,a.textContent=e?`ذخیره تغییرات`:`ایجاد وسیله`,t.hidden=!1,t.scrollIntoView({behavior:`smooth`,block:`center`})}function F(){t.hidden=!0}async function I(){h.hidden=!0;try{let[t,n,r]=await Promise.all([Ze(),te(),Te()]);_=t,v=n,x=r;let i=x.vehicle_types;i?.length&&(y=Object.fromEntries(i.map(e=>[e.id,e.label]))),b=i??[],O();let a=x.service_cities;if(Array.isArray(a))S=a,w=S.length?`selected`:`all`;else{let e=a??{};S=e.destinationCities??[],w=e.coverageMode===`selected`?`selected`:`all`,C=e.originCity??{city:``,cityEn:``,province:``,provinceEn:``},D=!!e.internationalShippingEnabled}j();let o=x.service_categories??{};T=typeof o.domestic!=`boolean`||o.domestic,E=typeof o.moving!=`boolean`||o.moving,M(),N(),p.innerHTML=[`<option value="">بدون راننده</option>`,...v.map(e=>`<option value="${e.id}">${e.fullName}</option>`)].join(``),g.innerHTML=_.length?_.map(e=>$n(e,y)).join(``):`<tr><td colspan="7" class="staff-table-empty">هنوز وسیله‌ای ثبت نشده است.</td></tr>`,R();let s=b.some(e=>e.active);e.disabled=!s,e.title=s?``:`ابتدا از تب «تعریف وسیله» دست‌کم یک نوع وسیله را فعال کنید.`}catch(e){h.hidden=!1,h.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function R(){g.querySelectorAll(`[data-edit-vehicle]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=_.find(t=>t.id===Number(e.dataset.editVehicle));t&&P(t)})}),g.querySelectorAll(`[data-delete-vehicle]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=_.find(t=>t.id===Number(e.dataset.deleteVehicle));if(t&&window.confirm(`«${t.label}» برای همیشه حذف شود؟`)){e.disabled=!0;try{await et(t.id),await I()}catch(t){h.hidden=!1,h.textContent=t instanceof Error?t.message:`حذف ناموفق بود.`,e.disabled=!1}}})})}e.addEventListener(`click`,()=>P(null)),r.addEventListener(`click`,F),a.addEventListener(`click`,async()=>{i.hidden=!0;let e=s.value.trim(),t=c.value;if(!e||!t){i.hidden=!1,i.textContent=`عنوان و نوع وسیله الزامی است.`;return}let n=!!o.value,r={type:t,label:e,plateNumber:l.value.trim(),model:u.value.trim(),year:d.value.trim()?Number(d.value):null,status:f.value,driverStaffId:p.value?Number(p.value):null,notes:m.value.trim()};a.disabled=!0,a.textContent=n?`در حال ذخیره...`:`در حال ایجاد...`;try{n?await $e(Number(o.value),r):await Qe(r),F(),await I()}catch(e){i.hidden=!1,i.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`}finally{a.disabled=!1,a.textContent=n?`ذخیره تغییرات`:`ایجاد وسیله`}}),I()}var ir=20;function ar(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var or={salary:`حقوق`,bonus:`پاداش`,adjustment:`اصلاحیه`,payout:`تسویه`},sr={pending:{label:`در انتظار بررسی`,badgeClass:`article-status-badge`},approved:{label:`تأیید شد`,badgeClass:`article-status-badge article-status-published`},rejected:{label:`رد شد`,badgeClass:`article-status-badge article-status-draft`}};function cr(){return`
  ...
  `}function lr(e){let t=e.direction===`credit`?`+`:`−`,n=e.direction===`credit`?`var(--success)`:`var(--danger)`;return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${or[e.type]??e.type}</span>
        <span class="activity-log-target">${ar(e.description)}</span>
      </div>
      <div class="activity-log-meta">
        <span style="color:${n}; font-weight:700;">${t} ${X(e.amount)}</span>
      </div>
    </div>
  `}function ur(e){let t=sr[e.status];return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${X(e.amount)}</span>
        ${e.staffNote?`<span class="activity-log-target">${ar(e.staffNote)}</span>`:``}
        ${e.adminNote?`<span class="activity-log-target">پاسخ مدیر: ${ar(e.adminNote)}</span>`:``}
      </div>
      <div class="activity-log-meta"><span class="${t.badgeClass}">${t.label}</span></div>
    </div>
  `}function dr(){let e=document.getElementById(`my-wallet-summary-card`),t=document.getElementById(`my-wallet-tx-list`),n=document.getElementById(`my-wallet-load-more`),r=document.getElementById(`my-payout-requests-list`),i=0,a=0,o=[];async function s(){if(e)try{let t=await W(),n=t.bonus.type===`percent`?`${t.bonus.amount}٪ برآورد هر درخواست`:X(t.bonus.amount);e.innerHTML=`
        <p class="settings-panel-hint">موجودی فعلی</p>
        <p style="font-size: 1.8rem; font-weight: 800; color: var(--primary);">${X(t.balance)}</p>
        <div class="settings-form-grid" style="margin-top: var(--space-3)">
          <div><p class="settings-panel-hint">حقوق ماهانه</p><p><strong>${X(t.salary.amount)}</strong></p></div>
          <div><p class="settings-panel-hint">پاداش هر درخواست تکمیل‌شده</p><p><strong>${n}</strong></p></div>
        </div>
      `}catch(t){e.innerHTML=`<p class="error-text">${t instanceof Error?t.message:`خطایی پیش آمد.`}</p>`}}async function c(){if(t)try{let{transactions:e,total:r}=await G(ir,i);o=[...o,...e],a=r,i+=e.length,t.innerHTML=o.length?o.map(lr).join(``):`<p class="settings-panel-hint">هنوز تراکنشی ثبت نشده.</p>`,n&&(n.hidden=i>=a)}catch(e){t.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}async function l(){if(r)try{let e=await vt();r.innerHTML=e.length?e.map(ur).join(``):`<p class="settings-panel-hint">هنوز درخواستی ثبت نکرده‌اید.</p>`}catch(e){r.innerHTML=`<p class="error-text">${e instanceof Error?e.message:`خطایی پیش آمد.`}</p>`}}n?.addEventListener(`click`,()=>void c()),document.getElementById(`payout-request-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`payout-request-amount`),n=document.getElementById(`payout-request-note`),r=document.getElementById(`payout-request-error`),i=document.getElementById(`payout-request-success`),a=document.getElementById(`payout-request-submit`);r.hidden=!0,i.hidden=!0;let o=Number(t.value);if(!Number.isFinite(o)||o<=0){r.hidden=!1,r.textContent=`مبلغ نامعتبر است.`;return}a.disabled=!0,(async()=>{try{await yt(o,n.value.trim()||void 0),i.hidden=!1,t.value=``,n.value=``,await Promise.all([s(),l()])}catch(e){r.hidden=!1,r.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}finally{a.disabled=!1}})()}),s(),c(),l()}var fr={pending:{next:`in_progress`,label:`شروع کار`},contacted:{next:`in_progress`,label:`شروع کار`},scheduled:{next:`in_progress`,label:`شروع کار`},in_progress:{next:`completed`,label:`پایان کار`}};function pr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function mr(e){let t=fr[e.status],n=e.originLat!=null&&e.originLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.originLat},${e.originLng}`:null,r=e.destinationLat!=null&&e.destinationLng!=null?`https://www.google.com/maps/dir/?api=1&destination=${e.destinationLat},${e.destinationLng}`:null;return`
    <div class="portal-card" data-portal-card-id="${e.id}">
      ...
      ${e.originNotes?`<p class="pipeline-note"><strong>یادداشت مبدأ:</strong> ${pr(e.originNotes)}</p>`:``}
      ${e.destinationNotes?`<p class="pipeline-note"><strong>یادداشت مقصد:</strong> ${pr(e.destinationNotes)}</p>`:``}
  ...
  `}var gr=new Set([`pending`,`contacted`,`scheduled`,`in_progress`]);function _r(e){let t=document.getElementById(`portal-error`),n=document.getElementById(`portal-list`),r=document.getElementById(`portal-history-stats`),i=document.getElementById(`portal-history-list`),a=document.getElementById(`portal-refresh`),o=document.getElementById(`portal-logout-btn`);if(!t||!n||!r||!i||!a||!o)return;async function s(){t.hidden=!0;try{let e=await le(),t=e.filter(e=>gr.has(e.status)),a=e.filter(e=>!gr.has(e.status)),o=a.filter(e=>e.status===`completed`).length;n.innerHTML=t.length?t.map(mr).join(``):`<p class="portal-empty">در حال حاضر کاری در جریان ندارید.</p>`,r.innerHTML=`
        <div class="stat-card">
          <span class="stat-card-label">کل خدمات ارائه‌شده</span>
          <span class="stat-card-value">${Y(e.length)}</span>
        </div>
        <div class="stat-card">
          <span class="stat-card-label">انجام‌شده</span>
          <span class="stat-card-value">${Y(o)}</span>
        </div>
      `,i.innerHTML=a.length?a.map(mr).join(``):`<p class="portal-empty">هنوز کاری در تاریخچه‌ی شما ثبت نشده است.</p>`,c()}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function c(){n.querySelectorAll(`[data-advance-id]`).forEach(e=>{e.addEventListener(`click`,async()=>{let n=Number(e.dataset.advanceId),r=e.dataset.advanceStatus;e.disabled=!0;try{await ue(n,r),await s()}catch(n){t.hidden=!1,t.textContent=n instanceof Error?n.message:`به‌روزرسانی ناموفق بود.`,e.disabled=!1}})})}a.addEventListener(`click`,()=>void s()),o.addEventListener(`click`,e),s();let l=document.getElementById(`portal-jobs-container`),u=document.getElementById(`portal-wallet-container`),d=document.getElementById(`portal-wallet-mount`),f=document.getElementById(`portal-wallet-btn`),p=document.getElementById(`portal-back-to-jobs-btn`),m=!1;f?.addEventListener(`click`,()=>{!l||!u||!d||(l.hidden=!0,u.hidden=!1,m||(m=!0,d.innerHTML=cr(),dr()))}),p?.addEventListener(`click`,()=>{!l||!u||(u.hidden=!0,l.hidden=!1)})}function vr(e){return`
  ...
  `}function br(e){let t=document.getElementById(`magazine-list-error`),n=document.getElementById(`magazine-table-body`),r=document.getElementById(`magazine-new-btn`);if(!t||!n||!r)return;async function i(){t.hidden=!0;try{let e=await de();n.innerHTML=e.length?e.map(vr).join(``):`<tr><td colspan="5" class="staff-table-empty">هنوز مقاله‌ای ثبت نشده است.</td></tr>`,a()}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function a(){n.querySelectorAll(`[data-edit-article]`).forEach(t=>{t.addEventListener(`click`,()=>e(Number(t.dataset.editArticle)))}),n.querySelectorAll(`[data-delete-article]`).forEach(e=>{e.addEventListener(`click`,async()=>{if(window.confirm(`این مقاله برای همیشه حذف شود؟`)){e.disabled=!0;try{await he(Number(e.dataset.deleteArticle)),await i()}catch(n){t.hidden=!1,t.textContent=n instanceof Error?n.message:`حذف ناموفق بود.`,e.disabled=!1}}})})}r.addEventListener(`click`,()=>e(null)),i()}var xr=[{value:`P`,label:`متن ساده`,labelEn:`Paragraph`},{value:`H1`,label:`سرتیتر ۱`,labelEn:`Heading 1`},{value:`H2`,label:`سرتیتر ۲`,labelEn:`Heading 2`},{value:`H3`,label:`سرتیتر ۳`,labelEn:`Heading 3`},{value:`H4`,label:`سرتیتر ۴`,labelEn:`Heading 4`},{value:`H5`,label:`سرتیتر ۵`,labelEn:`Heading 5`},{value:`H6`,label:`سرتیتر ۶`,labelEn:`Heading 6`},{value:`BLOCKQUOTE`,label:`نقل‌قول`,labelEn:`Quote`}];function Sr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Cr(e,t,n){return`
    <div class="rte">
      <div class="rte-toolbar">
        <div class="rte-format-select-wrap">
          <select class="rte-format-select" data-rte-format title="${n===`rtl`?`قالب متن`:`Text format`}">
            ${xr.map(e=>`<option value="${e.value}">${n===`rtl`?e.label:e.labelEn}</option>`).join(``)}
          </select>
          <span class="rte-format-select-label" data-rte-format-label aria-hidden="true">${n===`rtl`?xr[0].label:xr[0].labelEn}</span>
        </div>
      ...
      <textarea data-field="${e}" hidden>${Sr(t)}</textarea>
      <div class="rte-content" contenteditable="true" dir="${n}" data-rte-content>${t||`<p><br></p>`}</div>
    </div>
  `}var wr=new WeakMap;function Tr(e){return e?.closest(`.rte`)??null}function Er(e){return e.querySelector(`[data-rte-content]`)}function Dr(e){let t=window.getSelection();t&&t.rangeCount>0&&e.contains(t.anchorNode)&&wr.set(e,t.getRangeAt(0).cloneRange())}function Or(e){let t=wr.get(e);if(!t)return;let n=window.getSelection();n?.removeAllRanges(),n?.addRange(t)}function kr(e){let t=Er(e),n=e.querySelector(`textarea[data-field]`);t&&n&&(n.value=t.innerHTML===`<p><br></p>`?``:t.innerHTML)}function Ar(e){let t=window.getSelection();if(!t||!t.anchorNode)return null;let n=(t.anchorNode.nodeType===3?t.anchorNode.parentElement:t.anchorNode)?.closest(`a`)??null;return n&&e.contains(n)?n:null}function jr(e){e.addEventListener(`input`,e=>{let t=e.target.closest(`[data-rte-content]`);if(!t)return;let n=Tr(t);n&&kr(n)}),e.addEventListener(`mouseup`,e=>{let t=e.target.closest(`[data-rte-content]`);t&&Dr(t)}),e.addEventListener(`keyup`,e=>{let t=e.target.closest(`[data-rte-content]`);t&&Dr(t)}),e.addEventListener(`mousedown`,e=>{let t=e.target;if(t.closest(`[data-rte-cmd], [data-rte-action]`)){e.preventDefault();return}let n=t.closest(`.rte-color-btn`);if(n){let e=Tr(n),t=e&&Er(e);t&&Dr(t)}}),e.addEventListener(`click`,e=>{let t=e.target,n=t.closest(`[data-rte-cmd]`);if(n){let e=Tr(n),t=e&&Er(e);if(!t)return;t.focus(),document.execCommand(n.dataset.rteCmd,!1,n.dataset.rteCmdValue??void 0),kr(e);return}let r=t.closest(`[data-rte-link-cancel]`);if(r){Tr(r)?.querySelector(`[data-rte-link-popover]`)?.setAttribute(`hidden`,``);return}let i=t.closest(`[data-rte-link-apply]`);if(i){let e=Tr(i),t=e&&Er(e),n=e?.querySelector(`[data-rte-link-popover]`);if(!e||!t||!n)return;let r=n.querySelector(`[data-rte-link-url]`),a=n.querySelector(`[data-rte-link-blank]`),o=n.querySelector(`[data-rte-link-nofollow]`),s=r.value.trim();if(n.hidden=!0,!s)return;t.focus(),Or(t),document.execCommand(`createLink`,!1,s);let c=Ar(t)??Array.from(t.querySelectorAll(`a[href]`)).find(e=>e.getAttribute(`href`)===s);if(c){let e=[];a.checked?(c.setAttribute(`target`,`_blank`),e.push(`noopener`)):c.removeAttribute(`target`),o.checked&&e.push(`nofollow`),e.length?c.setAttribute(`rel`,e.join(` `)):c.removeAttribute(`rel`)}kr(e);return}let a=t.closest(`[data-rte-action]`);if(a){let e=Tr(a),t=e&&Er(e);if(!e||!t)return;if(a.dataset.rteAction===`link`){Dr(t);let n=e.querySelector(`[data-rte-link-popover]`),r=n.querySelector(`[data-rte-link-url]`),i=n.querySelector(`[data-rte-link-blank]`),a=n.querySelector(`[data-rte-link-nofollow]`),o=Ar(t);r.value=o?.getAttribute(`href`)??``,i.checked=o?.getAttribute(`target`)===`_blank`,a.checked=(o?.getAttribute(`rel`)??``).includes(`nofollow`),n.hidden=!1,r.focus()}else a.dataset.rteAction===`image`&&(Dr(t),e.querySelector(`[data-rte-image-input]`)?.click())}}),e.addEventListener(`change`,e=>{let t=e.target,n=t.closest(`[data-rte-format]`);if(n){let e=Tr(n),t=e&&Er(e);if(!t)return;let r=e.querySelector(`[data-rte-format-label]`);r&&(r.textContent=n.options[n.selectedIndex]?.textContent??``),t.focus(),Or(t),document.execCommand(`formatBlock`,!1,`<${n.value}>`),kr(e);return}let r=t.closest(`[data-rte-color]`);if(r){let e=Tr(r),t=e&&Er(e);if(!t)return;t.focus(),Or(t),document.execCommand(r.dataset.rteColor,!1,r.value),kr(e);return}let i=t.closest(`[data-rte-image-input]`);if(i){let e=Tr(i),t=e&&Er(e),n=i.files?.[0];if(!e||!t||!n)return;Se(n).then(n=>{t.focus(),Or(t),document.execCommand(`insertImage`,!1,n),kr(e)}).finally(()=>{i.value=``})}})}var Mr={richtext:`متن`,heading:`سرتیتر`,paragraph:`پاراگراف`,list:`لیست`,image:`تصویر`,video:`ویدئو`};function Nr(e){return e===`richtext`?{type:`richtext`,html:``,htmlEn:``}:e===`heading`?{type:`heading`,text:``,textEn:``}:e===`paragraph`?{type:`paragraph`,text:``,textEn:``}:e===`list`?{type:`list`,items:[],itemsEn:[]}:e===`image`?{type:`image`,url:``,caption:``,captionEn:``}:{type:`video`,url:``}}function Pr(e,t){let n=`
    <div class="block-editor-head">
      <span class="block-editor-type">${Mr[e.type]}</span>
      <div class="block-editor-actions">
  ...
  `,r=``;return e.type===`richtext`?r=`
      <div data-i18n="fa">${Cr(`html`,e.html,`rtl`)}</div>
      <div data-i18n="en">${Cr(`htmlEn`,e.htmlEn,`ltr`)}</div>
    `:e.type===`heading`?r=`
      <input type="text" data-field="text" data-i18n="fa" placeholder="متن سرتیتر (فارسی)" value="${Ir(e.text)}" />
      <input type="text" data-field="textEn" data-i18n="en" dir="ltr" placeholder="Heading text (English)" value="${Ir(e.textEn)}" />
    `:e.type===`paragraph`?r=`
      <textarea data-field="text" data-i18n="fa" placeholder="متن پاراگراف (فارسی)" rows="3">${Fr(e.text)}</textarea>
      <textarea data-field="textEn" data-i18n="en" dir="ltr" placeholder="Paragraph text (English)" rows="3">${Fr(e.textEn)}</textarea>
    `:e.type===`list`?r=`
      <textarea data-field="items" data-i18n="fa" placeholder="هر مورد در یک خط (فارسی)" rows="4">${Fr(e.items.join(`
`))}</textarea>
      <textarea data-field="itemsEn" data-i18n="en" dir="ltr" placeholder="One item per line (English)" rows="4">${Fr(e.itemsEn.join(`
`))}</textarea>
    `:e.type===`image`?r=`
      <div class="block-image-upload">
        ${e.url?`<img src="${Ir(e.url)}" alt="" class="block-image-preview" />`:`<span class="block-image-placeholder">تصویری انتخاب نشده</span>`}
      ...
      <input type="hidden" data-field="url" value="${Ir(e.url)}" />
      <input type="text" data-field="caption" data-i18n="fa" placeholder="زیرنویس تصویر (فارسی)" value="${Ir(e.caption)}" />
      <input type="text" data-field="captionEn" data-i18n="en" dir="ltr" placeholder="Image caption (English)" value="${Ir(e.captionEn)}" />
    `:e.type===`video`&&(r=`
      <input type="url" data-field="url" dir="ltr" placeholder="https://www.youtube.com/watch?v=..." value="${Ir(e.url)}" />
    `),`<div class="block-editor" data-block-index="${t}" data-block-type="${e.type}">${n}<div class="block-editor-body">${r}</div></div>`}function Fr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Ir(e){return Fr(e).replace(/"/g,`&quot;`)}function Lr(){return`
    <div class="view-header">
...
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function k(e){E=e,e?(x.src=e,x.hidden=!1,S.hidden=!0):(x.hidden=!0,S.hidden=!1)}function A(e){if(!e){i.hidden=!0,b.hidden=!0;return}i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,b.hidden=e!==`published`}async function j(){if(e===null){r.textContent=`مقاله جدید`,T=[Nr(`richtext`)],O(),A(null);return}try{let t=(await de()).find(t=>t.id===e);if(!t){n.hidden=!1,n.textContent=`مقاله پیدا نشد.`;return}D=t,r.textContent=t.title||`ویرایش مقاله`,o.value=t.title,s.value=t.titleEn,c.value=t.excerpt,l.value=t.excerptEn,u.value=t.category,d.value=t.categoryEn,f.value=t.slug,p.value=t.metaTitle??``,m.value=t.metaDescription??``,k(t.coverImageUrl),T=t.content.length?t.content:[Nr(`richtext`)],O(),A(t.status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}function M(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),category:u.value.trim(),categoryEn:d.value.trim(),coverImageUrl:E,content:ee(),metaTitle:p.value.trim(),metaDescription:m.value.trim(),slug:f.value.trim()||void 0}}async function N(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان مقاله الزامی است.`,null;let t=M();try{let n=D?await pe(D.id,t):await fe(t);return D=n,e=n.id,f.value=n.slug,r.textContent=n.title,A(n.status),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`,null}}h.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;T=ee();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?T.splice(n,1):r===`up`&&n>0?[T[n-1],T[n]]=[T[n],T[n-1]]:r===`down`&&n<T.length-1&&([T[n+1],T[n]]=[T[n],T[n+1]]),O()}),h.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),h.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await Se(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود ناموفق بود.`}}),_.addEventListener(`click`,()=>{T=ee(),T.push(Nr(g.value)),O()}),w.addEventListener(`click`,()=>C.click()),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{k(await Se(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود ناموفق بود.`}}),v.addEventListener(`click`,async()=>{v.disabled=!0,v.textContent=`در حال ذخیره...`,await N(),v.disabled=!1,v.textContent=`ذخیره پیش‌نویس`}),y.addEventListener(`click`,async()=>{y.disabled=!0;let e=await N();if(e)try{A((await me(e.id,!0)).status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار ناموفق بود.`}y.disabled=!1}),b.addEventListener(`click`,async()=>{if(D){b.disabled=!0;try{A((await me(D.id,!1)).status)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`به‌روزرسانی ناموفق بود.`}b.disabled=!1}}),a.addEventListener(`click`,t),j()}var zr={richtext:`متن پیشرفته`,heading:`سرتیتر`,paragraph:`پاراگراف`,list:`لیست`,image:`تصویر`,video:`ویدئو`};function Br(e){return e===`richtext`?{type:`richtext`,html:``,htmlEn:``}:e===`heading`?{type:`heading`,text:``,textEn:``}:e===`paragraph`?{type:`paragraph`,text:``,textEn:``}:e===`list`?{type:`list`,items:[],itemsEn:[]}:e===`image`?{type:`image`,url:``,caption:``,captionEn:``}:{type:`video`,url:``}}function Vr(e,t){let n=`
  ...
  `,r=``;return e.type===`richtext`?r=`
      ...
      <div data-i18n="en">${Cr(`htmlEn`,e.htmlEn,`ltr`)}</div>
    `:e.type===`heading`?r=`
      <input type="text" data-field="text" data-i18n="fa" placeholder="متن سرتیتر (فارسی)" value="${Ur(e.text)}" />
      <input type="text" data-field="textEn" data-i18n="en" dir="ltr" placeholder="Heading text (English)" value="${Ur(e.textEn)}" />
    `:e.type===`paragraph`?r=`
      <textarea data-field="text" data-i18n="fa" placeholder="متن پاراگراف (فارسی)" rows="3">${Hr(e.text)}</textarea>
      <textarea data-field="textEn" data-i18n="en" dir="ltr" placeholder="Paragraph text (English)" rows="3">${Hr(e.textEn)}</textarea>
    `:e.type===`list`?r=`
      <textarea data-field="items" data-i18n="fa" placeholder="هر مورد در یک خط (فارسی)" rows="4">${Hr(e.items.join(`
`))}</textarea>
      <textarea data-field="itemsEn" data-i18n="en" dir="ltr" placeholder="One item per line (English)" rows="4">${Hr(e.itemsEn.join(`
`))}</textarea>
    `:e.type===`image`?r=`
      <div class="block-image-upload">
        ${e.url?`<img src="${Ur(e.url)}" alt="" class="block-image-preview" />`:`<span class="block-image-placeholder">تصویری انتخاب نشده</span>`}
        <input type="file" accept="image/*" data-image-upload hidden />
        <button type="button" class="btn btn-secondary btn-sm" data-image-upload-btn>انتخاب تصویر</button>
      </div>
      <input type="hidden" data-field="url" value="${Ur(e.url)}" />
      <input type="text" data-field="caption" data-i18n="fa" placeholder="زیرنویس تصویر (فارسی)" value="${Ur(e.caption)}" />
      <input type="text" data-field="captionEn" data-i18n="en" dir="ltr" placeholder="Image caption (English)" value="${Ur(e.captionEn)}" />
    `:e.type===`video`&&(r=`
      <input type="url" data-field="url" dir="ltr" placeholder="https://www.aparat.com/v/... یا https://www.youtube.com/watch?v=..." value="${Ur(e.url)}" />
    `),`<div class="block-editor" data-block-index="${t}" data-block-type="${e.type}">${n}<div class="block-editor-body">${r}</div></div>`}function Hr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function Ur(e){return Hr(e).replace(/"/g,`&quot;`)}function Wr(){return`
    <div class="view-header">
      <div>
  ...
  `}function Gr(e,t){let n=document.getElementById(`page-editor-error`),r=document.getElementById(`page-editor-title-label`),i=document.getElementById(`page-editor-status-badge`),a=document.getElementById(`page-editor-back-btn`),o=document.getElementById(`page-editor-title`),s=document.getElementById(`page-editor-title-en`),c=document.getElementById(`page-editor-excerpt`),l=document.getElementById(`page-editor-excerpt-en`),u=document.getElementById(`page-editor-slug`),d=document.getElementById(`page-editor-meta-title`),f=document.getElementById(`page-editor-meta-description`),p=document.getElementById(`page-editor-blocks`),m=document.getElementById(`page-editor-add-block-type`),h=document.getElementById(`page-editor-add-block-btn`),g=document.getElementById(`page-editor-save-draft-btn`),_=document.getElementById(`page-editor-publish-btn`),v=document.getElementById(`page-editor-unpublish-btn`),y=document.getElementById(`page-live-link-container`),b=document.getElementById(`page-live-link`),x=document.getElementById(`page-editor-cover-preview`),S=document.getElementById(`page-editor-cover-placeholder`),C=document.getElementById(`page-editor-cover-upload`),w=document.getElementById(`page-editor-cover-upload-btn`),T=document.getElementById(`page-editor-cover-remove-btn`),E=document.getElementById(`page-editor-show-header`),D=document.getElementById(`page-editor-show-footer`);if(!n||!r||!i||!a||!o||!s||!c||!l||!u||!d||!f||!p||!m||!h||!g||!_||!v||!x||!S||!C||!w)return;let O=[],ee=null,k=null;Wn().then(()=>{Kn(document.getElementById(`view-container`)??document.body)}),jr(p);function A(){p.innerHTML=O.map(Vr).join(``)||`<p class="editor-empty-blocks">هنوز بلوکی اضافه نشده است. یک نوع بلوک را انتخاب و دکمه افزودن را بزنید.</p>`,Kn(p)}function j(){return Array.from(p.querySelectorAll(`[data-block-index]`)).map(e=>{let t=e.dataset.blockType,n=t=>e.querySelector(`[data-field="${t}"]`)?.value??``;return t===`richtext`?{type:t,html:n(`html`),htmlEn:n(`htmlEn`)}:t===`heading`||t===`paragraph`?{type:t,text:n(`text`),textEn:n(`textEn`)}:t===`list`?{type:t,items:n(`items`).split(`
`).map(e=>e.trim()).filter(Boolean),itemsEn:n(`itemsEn`).split(`
`).map(e=>e.trim()).filter(Boolean)}:t===`image`?{type:t,url:n(`url`),caption:n(`caption`),captionEn:n(`captionEn`)}:{type:`video`,url:n(`url`)}})}function M(e){ee=e,e?(x.src=e,x.hidden=!1,S.hidden=!0,T&&(T.hidden=!1)):(x.hidden=!0,S.hidden=!1,T&&(T.hidden=!0))}function N(e,t){if(!e){i.hidden=!0,v.hidden=!0,y&&(y.hidden=!0);return}if(i.hidden=!1,i.textContent=e===`published`?`منتشرشده`:`پیش‌نویس`,i.className=`article-status-badge article-status-${e}`,v.hidden=e!==`published`,y&&b){let e=t||u.value.trim();if(e){y.hidden=!1;let t=`https://behbarapp.ir/p/${encodeURIComponent(e)}`;b.href=t,b.textContent=`/p/${e}`}else y.hidden=!0}}async function P(){if(e===null){r.textContent=`برگه جدید`,O=[Br(`richtext`)],A(),N(null),E&&(E.checked=!1),D&&(D.checked=!1);return}try{let t=await _e(e);if(!t){n.hidden=!1,n.textContent=`برگه پیدا نشد.`;return}k=t,r.textContent=t.title||`ویرایش برگه`,o.value=t.title,s.value=t.titleEn||``,c.value=t.excerpt||``,l.value=t.excerptEn||``,u.value=t.slug,d.value=t.metaTitle??``,f.value=t.metaDescription??``,E&&(E.checked=!!t.showInHeader),D&&(D.checked=!!t.showInFooter),M(t.coverImageUrl),O=t.content&&t.content.length?t.content:[Br(`richtext`)],A(),N(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی در بارگذاری برگه پیش آمد.`}}function F(){return{title:o.value.trim(),titleEn:s.value.trim(),excerpt:c.value.trim(),excerptEn:l.value.trim(),coverImageUrl:ee,content:j(),metaTitle:d.value.trim()||void 0,metaDescription:f.value.trim()||void 0,slug:u.value.trim()||void 0,showInHeader:E?.checked??!1,showInFooter:D?.checked??!1}}async function I(){if(n.hidden=!0,!o.value.trim())return n.hidden=!1,n.textContent=`عنوان برگه الزامی است.`,null;let t=F();try{let n=k?await ye(k.id,t):await ve(t);return k=n,e=n.id,u.value=n.slug,r.textContent=n.title,N(n.status,n.slug),n}catch(e){return n.hidden=!1,n.textContent=e instanceof Error?e.message:`ذخیره برگه ناموفق بود.`,null}}p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-block-action]`);if(!t)return;O=j();let n=Number(t.dataset.index),r=t.dataset.blockAction;r===`remove`?O.splice(n,1):r===`up`&&n>0?[O[n-1],O[n]]=[O[n],O[n-1]]:r===`down`&&n<O.length-1&&([O[n+1],O[n]]=[O[n],O[n+1]]),A()}),p.addEventListener(`click`,e=>{let t=e.target.closest(`[data-image-upload-btn]`);t&&t.closest(`.block-editor`)?.querySelector(`[data-image-upload]`)?.click()}),p.addEventListener(`change`,async e=>{let t=e.target;if(!t.matches(`[data-image-upload]`))return;let r=t.files?.[0];if(!r)return;let i=t.closest(`.block-editor`);if(i)try{let e=await Se(r),t=i.querySelector(`[data-field="url"]`);t&&(t.value=e);let n=i.querySelector(`.block-image-preview`),a=i.querySelector(`.block-image-placeholder`);n?(n.src=e,n.hidden=!1):i.querySelector(`.block-image-upload`)?.insertAdjacentHTML(`afterbegin`,`<img src="${e}" alt="" class="block-image-preview" />`),a&&(a.hidden=!0)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر ناموفق بود.`}}),h.addEventListener(`click`,()=>{O=j(),O.push(Br(m.value)),A()}),w.addEventListener(`click`,()=>C.click()),T&&T.addEventListener(`click`,()=>M(null)),C.addEventListener(`change`,async()=>{let e=C.files?.[0];if(e)try{M(await Se(e))}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`آپلود تصویر شاخص ناموفق بود.`}}),g.addEventListener(`click`,async()=>{g.disabled=!0,g.textContent=`در حال ذخیره...`,await I(),g.disabled=!1,g.textContent=`ذخیره پیش‌نویس`}),_.addEventListener(`click`,async()=>{_.disabled=!0;let e=await I();if(e)try{let t=await be(e.id,!0);N(t.status,t.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`انتشار برگه ناموفق بود.`}_.disabled=!1}),v.addEventListener(`click`,async()=>{if(k){v.disabled=!0;try{let e=await be(k.id,!1);N(e.status,e.slug)}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`تغییر به پیش‌نویس ناموفق بود.`}v.disabled=!1}}),a.addEventListener(`click`,t),P()}function Kr(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function qr(e){return Array.from({length:5},(t,n)=>n<e?`★`:`☆`).join(``)}function Jr(e){return`
    <div class="testimonial-row" data-testimonial-row="${e.id}">
      <div class="testimonial-row-avatar">
        ${e.avatarUrl?`<img src="${Kr(e.avatarUrl)}" alt="" />`:`<span class="icon">${u.user}</span>`}
      </div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${Kr(e.customerName)||`(بدون نام)`}</strong>
          <span class="testimonial-row-stars">${qr(e.rating)}</span>
          <span class="article-status-badge article-status-${e.status}">${e.status===`published`?`منتشرشده`:`پیش‌نویس`}</span>
        </div>
        <p class="testimonial-row-text">${Kr(e.text)}</p>
      </div>
      <div class="staff-table-actions">
  ...
  `}function ai(){let e=document.getElementById(`chat-error`),t=document.getElementById(`chat-filter-tabs`),n=document.getElementById(`chat-conversation-list`),r=document.getElementById(`chat-thread-empty`),i=document.getElementById(`chat-thread-active`),a=document.getElementById(`chat-thread-name`),o=document.getElementById(`chat-thread-phone`),s=document.getElementById(`chat-assign-select`),c=document.getElementById(`chat-thread-status-btn`),l=document.getElementById(`chat-thread-archive-btn`),d=document.getElementById(`chat-thread-delete-btn`),f=document.getElementById(`chat-responders-row`),p=document.getElementById(`chat-info-panel`),m=document.getElementById(`chat-request-card`),h=document.getElementById(`chat-thread-messages`),g=document.getElementById(`chat-thread-form`),v=document.getElementById(`chat-thread-input`);if(!e||!t||!n||!r||!i||!a||!o||!s||!c||!l||!d||!f||!p||!m||!h||!g||!v)return;let y=_(),b=[],x=[],S=null,C=`all`;function w(){if(C===`archived`)return b.filter(e=>e.archivedAt!==null);let e=b.filter(e=>e.archivedAt===null);return C===`mine`?e.filter(e=>e.assignedStaffId===y?.id):C===`unassigned`?e.filter(e=>e.assignedStaffId===null):e}function T(){let t=w();n.innerHTML=t.length?t.map(e=>`
        <div class="chat-conversation-item ${e.id===S?`is-active`:``}" data-conversation-id="${e.id}" role="button" tabindex="0">
          <div class="chat-conversation-item-top">
            <span>${ei(e.customerName||`مهمان`)}</span>
          ...
          <p class="chat-conversation-preview">${ei(ti(e))}</p>
          <div class="chat-conversation-item-bottom">
            ...
            ${e.unreadCount>0?`<span class="chat-unread-badge">${Y(e.unreadCount)}</span>`:``}
            <span class="chat-conversation-agent">
              ${e.assignedStaffId?`${ri(e.assignedStaffName,e.assignedStaffAvatar,`sm`)}<span>${ei(e.assignedStaffName??``)}</span>`:`<span class="chat-conversation-unassigned">بدون پاسخگو</span>`}
            </span>
          </div>
        </div>
      `).join(``):`<p class="pipeline-empty">گفتگویی در این فهرست نیست.</p>`,n.querySelectorAll(`[data-conversation-id]`).forEach(e=>{e.addEventListener(`click`,t=>{t.target.closest(`[data-delete-conversation]`)||N(Number(e.dataset.conversationId))}),e.addEventListener(`keydown`,t=>{(t.key===`Enter`||t.key===` `)&&(t.preventDefault(),N(Number(e.dataset.conversationId)))})}),n.querySelectorAll(`[data-delete-conversation]`).forEach(t=>{t.addEventListener(`click`,async n=>{n.stopPropagation();let a=Number(t.dataset.deleteConversation);if(window.confirm(`این گفتگو برای همیشه حذف شود؟`)){t.disabled=!0;try{await Be(a),S===a&&(S=null,i.hidden=!0,r.hidden=!1),await O()}catch(n){e.hidden=!1,e.textContent=n instanceof Error?n.message:`حذف گفتگو ناموفق بود.`,t.disabled=!1}}})})}function E(e){let t=[`<option value="">بدون پاسخگو</option>`,...x.map(t=>`<option value="${t.id}" ${t.id===e?.assignedStaffId?`selected`:``}>${ei(t.fullName)}${t.id===y?.id?` (من)`:``}</option>`)];s.innerHTML=t.join(``),e?.assignedStaffId||(s.value=``)}async function D(){try{x=await We()}catch{}}async function O(){try{if(b=await Pe(),T(),S!==null){let e=b.find(e=>e.id===S);e&&(a.textContent=e.customerName||`مهمان`,o.textContent=e.customerPhone||``,c.textContent=e.status===`open`?`بستن گفتگو`:`بازکردن گفتگو`,l.textContent=e.archivedAt?`خروج از بایگانی`:`بایگانی`,E(e))}}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function ee(e){let t=b.find(e=>e.id===S)?.customerName||`مهمان`;h.innerHTML=e.map(e=>`
      <div class="chat-bubble-admin chat-bubble-admin-${e.sender}">
        <span class="chat-bubble-author">${e.sender===`staff`?`${ri(e.staffName,e.staffAvatar,`sm`)}<span>${ei(e.staffName??``)}</span>`:`<span>${ei(t)}</span>`}</span>
        ${ni(e)}
        <span class="chat-bubble-timestamp">${en(e.createdAt)}</span>
      </div>
    `).join(``),h.scrollTop=h.scrollHeight,k(e)}function k(e){let t=[],n=new Set;for(let r of e)r.sender!==`staff`||!r.staffName||n.has(r.staffName)||(n.add(r.staffName),t.push({name:r.staffName,avatar:r.staffAvatar}));if(!t.length){f.hidden=!0,f.innerHTML=``;return}f.hidden=!1,f.innerHTML=`<span class="chat-responders-label">پاسخ‌دهندگان:</span>`+t.map(e=>`<span class="chat-responder-chip">${ri(e.name,e.avatar,`sm`)}<span>${ei(e.name)}</span></span>`).join(``)}async function A(){if(S!==null)try{ee(await Fe(S))}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function j(e){if(!e.length){m.innerHTML=`<h3>درخواست‌های ثبت‌شده</h3><p class="chat-request-empty">درخواستی برای این شماره ثبت نشده است.</p>`;return}let[t,...n]=e;m.innerHTML=`
      <h3>درخواست‌های ثبت‌شده (${Y(e.length)})</h3>
      <div class="chat-request-latest">
        <div class="chat-request-row"><span>کد رهگیری</span><span dir="ltr">#${Y(t.trackingCode)}</span></div>
        <div class="chat-request-row"><span>خدمت</span><span>${ei(t.serviceLabel)}</span></div>
        <div class="chat-request-row"><span>مسیر</span><span>${ei(t.originCity)} ← ${ei(t.destinationCity)}</span></div>
        <div class="chat-request-row"><span>زمان</span><span>${ei(t.scheduledDate)} — ${Y(t.scheduledTime)}</span></div>
        <div class="chat-request-row"><span>وضعیت</span><span>${ei(zt[t.status]??t.status)}</span></div>
        <div class="chat-request-row"><span>برآورد هزینه</span><span>${X(t.estimateAvg)}</span></div>
      </div>
      ${n.length?`<div class="chat-request-older"><span>${Y(n.length)} درخواست قدیمی‌تر:</span>${n.map(e=>`<span class="chat-request-older-item" dir="ltr">#${Y(e.trackingCode)}</span>`).join(``)}</div>`:``}
    `}async function M(e){if(!e){j([]);return}try{j(await Ve(e))}catch{m.innerHTML=`<h3>درخواست‌های ثبت‌شده</h3><p class="chat-request-empty">دریافت اطلاعات ناموفق بود.</p>`}}function N(e){S=e,r.hidden=!0,i.hidden=!1,p.hidden=!1;let t=b.find(t=>t.id===e);a.textContent=t?.customerName||`مهمان`,o.textContent=t?.customerPhone||``,c.textContent=t?.status===`open`?`بستن گفتگو`:`بازکردن گفتگو`,l.textContent=t?.archivedAt?`خروج از بایگانی`:`بایگانی`,E(t),T(),A(),M(t?.customerPhone??null)}t.querySelectorAll(`[data-filter]`).forEach(e=>{e.addEventListener(`click`,()=>{C=e.dataset.filter,t.querySelectorAll(`[data-filter]`).forEach(t=>t.classList.toggle(`is-active`,t===e)),T()})}),s.addEventListener(`change`,async()=>{if(S===null)return;let t=s.value,n=t?Number(t):null;s.disabled=!0;try{await Re(S,n),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}finally{s.disabled=!1}}),c.addEventListener(`click`,async()=>{if(S===null)return;let t=b.find(e=>e.id===S)?.status===`open`?`closed`:`open`;try{await Le(S,t),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}),l.addEventListener(`click`,async()=>{if(S===null)return;let t=!b.find(e=>e.id===S)?.archivedAt;try{await ze(S,t),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}),d.addEventListener(`click`,async()=>{if(S!==null&&window.confirm(`این گفتگو برای همیشه حذف شود؟`))try{await Be(S),S=null,r.hidden=!1,i.hidden=!0,p.hidden=!0,await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`حذف ناموفق بود.`}}),g.addEventListener(`submit`,async t=>{if(t.preventDefault(),S===null)return;let n=v.value.trim();if(n){v.value=``;try{await Ie(S,n),await A(),await O()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`ارسال ناموفق بود.`}}}),D(),O(),$r!==void 0&&window.clearInterval($r),$r=window.setInterval(()=>{O(),S!==null&&A()},Qr)}function oi(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function si(e){return`
    <div class="testimonial-row" data-story-row="${e.id}">
      <div class="testimonial-row-avatar"><img src="${oi(e.imageUrl)}" alt="" /></div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head"><strong>${oi(e.caption)||`(بدون متن)`}</strong></div>
        <p class="testimonial-row-text">${oi(e.linkUrl??``)}</p>
      </div>
      <div class="staff-table-actions">
  ...
  `}function ui(){Wn().then(()=>Kn(document.getElementById(`view-container`)??document.body));let e=document.getElementById(`stories-list-error`),t=document.getElementById(`stories-list`),n=document.getElementById(`story-new-btn`),r=document.getElementById(`story-form-card`),i=document.getElementById(`story-form-title`),a=document.getElementById(`story-form-error`),o=document.getElementById(`story-cancel-btn`),s=document.getElementById(`story-save-btn`);if(!e||!t||!n||!r||!i||!a||!o||!s)return;let c=[];function l(e){a.hidden=!0,i.textContent=e?`ویرایش استوری`:`استوری جدید`,document.getElementById(`story-form-id`).value=e?String(e.id):``,document.getElementById(`story-image`).value=e?.imageUrl??``,document.getElementById(`story-caption`).value=e?.caption??``,document.getElementById(`story-caption-en`).value=e?.captionEn??``,document.getElementById(`story-link`).value=e?.linkUrl??``,document.getElementById(`story-sort`).value=String(e?.sortOrder??0),r.hidden=!1,r.scrollIntoView({behavior:`smooth`,block:`center`})}function u(){r.hidden=!0}async function d(){e.hidden=!0;try{c=await Ge(),t.innerHTML=c.length?c.map(si).join(``):`<p class="pipeline-empty">هنوز استوری‌ای ثبت نشده است.</p>`,f()}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}function f(){t.querySelectorAll(`[data-edit-story]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=c.find(t=>t.id===Number(e.dataset.editStory));t&&l(t)})}),t.querySelectorAll(`[data-delete-story]`).forEach(t=>{t.addEventListener(`click`,async()=>{if(window.confirm(`این استوری برای همیشه حذف شود؟`)){t.disabled=!0;try{await qe(Number(t.dataset.deleteStory)),await d()}catch(n){e.hidden=!1,e.textContent=n instanceof Error?n.message:`حذف ناموفق بود.`,t.disabled=!1}}})})}n.addEventListener(`click`,()=>l(null)),o.addEventListener(`click`,u),s.addEventListener(`click`,async()=>{a.hidden=!0;let e=document.getElementById(`story-form-id`).value,t={imageUrl:document.getElementById(`story-image`).value.trim(),caption:document.getElementById(`story-caption`).value.trim(),captionEn:document.getElementById(`story-caption-en`).value.trim(),linkUrl:document.getElementById(`story-link`).value.trim()||null,sortOrder:Number(document.getElementById(`story-sort`).value)||0};if(!t.imageUrl){a.hidden=!1,a.textContent=`لینک تصویر الزامی است.`;return}s.disabled=!0;try{e?await U(Number(e),t):await Ke(t),u(),await d()}catch(e){a.hidden=!1,a.textContent=e instanceof Error?e.message:`ذخیره ناموفق بود.`}finally{s.disabled=!1}}),d()}var di=[{id:`driver`,title:`راننده با خودرو`,titleEn:`Driver`,description:`رانندگان وانت، نیسان، خاور و کامیون با خودرو شخصی`,requiresVehicle:!0,active:!0},{id:`worker`,title:`کارگر اسباب‌کشی و باربری`,titleEn:`Moving Specialist`,description:`نیروی متخصص بسته‌بندی، چیدمان و حمل بارهای سنگین`,requiresVehicle:!1,active:!0},{id:`support`,title:`کارشناس پشتیبانی و هماهنگی`,titleEn:`Customer Support`,description:`پاسخگویی به تماس‌ها و پیگیری امور مشتریان و رانندگان`,requiresVehicle:!1,active:!0},{id:`other`,title:`سایر زمینه‌های همکاری`,titleEn:`Other`,description:`تخصص‌های دیگر لجستیک، اداری و بازاریابی`,requiresVehicle:!1,active:!0}],fi=[{id:`new`,label:`جدید`},{id:`reviewed`,label:`بررسی‌شده`},{id:`contacted`,label:`تماس گرفته شده`},{id:`hired`,label:`استخدام شده`},{id:`rejected`,label:`رد شده`}],pi=Object.fromEntries(fi.map(e=>[e.id,e.label]));function mi(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`)}function hi(e){return fi.map(t=>`<option value="${t.id}" ${t.id===e?`selected`:``}>${t.label}</option>`).join(``)}function gi(e){return`
    <div class="testimonial-row" data-application-row="${e.id}">
      <div class="testimonial-row-avatar"><span class="icon">${u.briefcase}</span></div>
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${mi(e.fullName)}</strong>
          <span class="article-status-badge article-status-${e.status}">${pi[e.status]??e.status}</span>
        </div>
        <div class="job-application-meta">
          <span>${mi(e.positionLabel)}</span>
          <a href="tel:${e.phone}" dir="ltr">${e.phone}</a>
          ${e.city?`<span>${mi(e.city)}</span>`:``}
          ${e.hasVehicle===!0?`<span>دارای وسیله نقلیه${e.vehicleType?` (${mi(e.vehicleType)})`:``}</span>`:``}
          ${e.hasVehicle===!1?`<span>بدون وسیله نقلیه</span>`:``}
          <span>${new Date(e.createdAt).toLocaleDateString(`fa-IR`)}</span>
        </div>
        ${e.message?`<p class="testimonial-row-text">${mi(e.message)}</p>`:``}
      </div>
      <div class="staff-table-actions">
        <select class="pipeline-status-select" data-status-select-id="${e.id}">
          ${hi(e.status)}
  ...
  `}function yi(){let e=document.getElementById(`job-applications-error`),t=document.getElementById(`job-applications-success`),n=document.getElementById(`btn-add-position`),r=document.getElementById(`career-positions-list`),i=document.getElementById(`job-applications-list`),a=document.getElementById(`career-position-editor`),o=document.querySelectorAll(`[data-career-tab]`),s=document.getElementById(`tab-career-positions`),c=document.getElementById(`tab-career-applications`);if(!e||!r||!i)return;let l=[],u=[];function d(n,r){n===`error`?(e.hidden=!1,e.textContent=r,t&&(t.hidden=!0)):(t&&(t.hidden=!1,t.textContent=r,setTimeout(()=>{t&&(t.hidden=!0)},4e3)),e.hidden=!0)}o.forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.careerTab;o.forEach(e=>{let n=e.dataset.careerTab===t;e.style.borderBottomColor=n?`var(--primary)`:`transparent`,e.style.color=n?`var(--primary)`:`var(--muted)`}),s&&(s.hidden=t!==`positions`),c&&(c.hidden=t!==`applications`),n&&(n.hidden=t!==`positions`)})});async function f(){try{let e=(await Te()).career_positions;l=Array.isArray(e)&&e.length?e:[...di],p()}catch{l=[...di],p()}}function p(){r&&(r.innerHTML=l.length?l.map(_i).join(``):`<p class="pipeline-empty">هیچ موقعیت شغلی‌ای تعریف نشده است.</p>`,h())}async function m(){try{await H(`career_positions`,l),d(`success`,`تغییرات موقعیت‌های شغلی با موفقیت ذخیره شد.`),p()}catch(e){d(`error`,e instanceof Error?e.message:`ذخیره موقعیت‌های شغلی ناموفق بود.`)}}function h(){r?.querySelectorAll(`[data-toggle-position]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=Number(e.dataset.togglePosition);l[t]&&(l[t].active=!l[t].active,await m())})}),r?.querySelectorAll(`[data-edit-position]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=Number(e.dataset.editPosition),n=l[t];!n||!a||(document.getElementById(`pos-edit-index`).value=String(t),document.getElementById(`pos-title`).value=n.title,document.getElementById(`pos-title-en`).value=n.titleEn??``,document.getElementById(`pos-desc`).value=n.description??``,document.getElementById(`pos-requires-vehicle`).checked=!!n.requiresVehicle,document.getElementById(`pos-active`).checked=n.active!==!1,document.getElementById(`position-editor-title`).textContent=`ویرایش موقعیت شغلی`,a.hidden=!1,a.scrollIntoView({behavior:`smooth`}))})}),r?.querySelectorAll(`[data-delete-position]`).forEach(e=>{e.addEventListener(`click`,async()=>{let t=Number(e.dataset.deletePosition);window.confirm(`این موقعیت شغلی حذف شود؟`)&&(l.splice(t,1),await m())})})}n&&(n.hidden=!1,n.addEventListener(`click`,()=>{a&&(document.getElementById(`pos-edit-index`).value=``,document.getElementById(`pos-title`).value=``,document.getElementById(`pos-title-en`).value=``,document.getElementById(`pos-desc`).value=``,document.getElementById(`pos-requires-vehicle`).checked=!1,document.getElementById(`pos-active`).checked=!0,document.getElementById(`position-editor-title`).textContent=`افزودن موقعیت شغلی جدید`,a.hidden=!1,document.getElementById(`pos-title`).focus())})),document.getElementById(`pos-cancel-btn`)?.addEventListener(`click`,()=>{a&&(a.hidden=!0)}),document.getElementById(`pos-save-btn`)?.addEventListener(`click`,async()=>{let e=document.getElementById(`pos-title`).value.trim();if(!e){d(`error`,`لطفاً عنوان موقعیت شغلی را وارد کنید.`);return}let t=document.getElementById(`pos-title-en`).value.trim(),n=document.getElementById(`pos-desc`).value.trim(),r=document.getElementById(`pos-requires-vehicle`).checked,i=document.getElementById(`pos-active`).checked,o=document.getElementById(`pos-edit-index`).value;if(o!==``){let a=Number(o);l[a]&&(l[a]={...l[a],title:e,titleEn:t||void 0,description:n||void 0,requiresVehicle:r,active:i})}else{let a=`pos_`+Date.now();l.push({id:a,title:e,titleEn:t||void 0,description:n||void 0,requiresVehicle:r,active:i})}a&&(a.hidden=!0),await m()});async function g(){e.hidden=!0;try{u=await Je(),i.innerHTML=u.length?u.map(gi).join(``):`<p class="pipeline-empty">هنوز درخواست همکاری‌ای ثبت نشده است.</p>`,_()}catch(e){d(`error`,e instanceof Error?e.message:`خطایی در دریافت درخواست‌ها پیش آمد.`)}}function _(){i.querySelectorAll(`[data-status-select-id]`).forEach(e=>{e.addEventListener(`change`,async()=>{let t=Number(e.dataset.statusSelectId);e.disabled=!0;try{await Ye(t,e.value),await g()}catch(t){d(`error`,t instanceof Error?t.message:`به‌روزرسانی وضعیت ناموفق بود.`),e.disabled=!1}})}),i.querySelectorAll(`[data-delete-application]`).forEach(e=>{e.addEventListener(`click`,async()=>{if(window.confirm(`این درخواست برای همیشه حذف شود؟`)){e.disabled=!0;try{await Xe(Number(e.dataset.deleteApplication)),await g()}catch(t){d(`error`,t instanceof Error?t.message:`حذف ناموفق بود.`),e.disabled=!1}}})})}f(),g()}function bi(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function xi(e){return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${bi(e.action)}</span>
        ${e.targetLabel?`<span class="activity-log-target">${bi(e.targetLabel)}</span>`:``}
      </div>
      <div class="activity-log-meta">
        <span>${bi(e.staffName)}</span>
  ...
  `}function Ci(){let e=document.getElementById(`activity-log-list`),t=document.getElementById(`activity-log-error`),n=document.getElementById(`activity-log-refresh`);if(!e||!t||!n)return;async function r(){t.hidden=!0;try{let t=await z();e.innerHTML=t.length?t.map(xi).join(``):`<p class="portal-empty">هنوز فعالیتی ثبت نشده است.</p>`}catch(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}n.addEventListener(`click`,()=>void r()),r()}function wi(){return`
    <div class="editor-sidebar-card">
      <h3>به‌روزرسانی</h3>
  ...
  `}var Ti=`sudo bash install.sh`;function Ei(){return`
  ...
  `}function Di(){return`
    <div class="update-manual-guide">
      ...
      <div class="update-manual-step">
        ...
        <p class="update-manual-cmd-plain" dir="ltr">${Ti}</p>
      </div>
  ...
  `}function Oi(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}function ki(){let e=document.getElementById(`update-panel-current`),t=document.getElementById(`update-panel-current-changelog`),n=document.getElementById(`update-panel-result`),r=document.getElementById(`update-scan-btn`),i=document.getElementById(`update-panel-manual-guide`);!e||!t||!n||!r||!i||(gt().then(n=>{e.textContent=`نسخه‌ی فعلی: ${n.current}`,n.currentChangelog.length&&(t.innerHTML=`
      ...
      `,document.getElementById(`update-panel-backup-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;t.disabled=!0,t.textContent=`در حال دانلود...`;try{await at()}catch(e){zn(e instanceof Error?e.message:`دانلود پشتیبان ناموفق بود.`,`error`)}finally{t.disabled=!1,t.textContent=`دانلود نسخه پشتیبان`}}),document.getElementById(`update-panel-apply-btn`)?.addEventListener(`click`,async e=>{if(!window.confirm(`به‌روزرسانی سرویس را برای حدود یک دقیقه مختل می‌کند. آیا از پشتیبان‌گیری مطمئن هستید و می‌خواهید ادامه دهید؟`))return;let t=e.currentTarget,r=document.getElementById(`update-panel-error`);t.disabled=!0,t.textContent=`در حال اعمال...`;try{await _t(),n.innerHTML=`
          ...
          `}catch(e){r&&(r.hidden=!1,r.textContent=e instanceof Error?e.message:`به‌روزرسانی ناموفق بود.`),t.disabled=!1,t.textContent=`اعمال به‌روزرسانی`}})}catch(e){zn(e instanceof Error?e.message:`بررسی به‌روزرسانی ناموفق بود.`,`error`)}finally{r.disabled=!1,r.textContent=t}}))}var Ai={text:`متن ساده`,steps:`مراحل شماره‌دار`,accordion:`آکاردئونی (پرسش و پاسخ)`,grid:`شبکه‌ی آیکون/عنوان`,slider:`اسلایدر`,quote:`نقل‌قول`,testimonials:`نظرات مشتریان (خودکار)`,stats:`آمار و ارقام`},ji=Object.keys(Ai),Mi=[{id:`hero`,type:`hero`,visible:!0}],Ni={about:{label:`صفحه درباره ما`,livePath:`/about`,hint:`ویرایش مشخصات، تاریخچه، اهداف و بخش‌های معرفی بهبار در نشانی /about`},terms:{label:`صفحه قوانین و مقررات`,livePath:`/terms`,hint:`مدیریت شرایط، ضوابط، تعهدات و مقررات استفاده از سامانه بهبار در نشانی /terms`},privacy:{label:`صفحه حریم خصوصی`,livePath:`/privacy`,hint:`تنظیم سیاست‌های حفاظت از داده‌ها و امنیت حریم خصوصی کاربران بهبار در نشانی /privacy`}};function Pi(e,t){let n=[...e];return t?.length&&n.push(...t.map(e=>`- ${e}`)),n.join(`
`)}function Fi(e){let t=e.split(`
`).map(e=>e.trim()).filter(Boolean),n=t.filter(e=>!e.startsWith(`- `)),r=t.filter(e=>e.startsWith(`- `)).map(e=>e.slice(2).trim());return{paragraphs:n,list:r.length?r:void 0}}function Ii(e){let t=`https://behbarapp.ir/p/${encodeURIComponent(e.slug)}`;return`
    ...
    <div class="settings-panel" data-page-panel="home">
      ...
      <div class="settings-panel-footer" style="display: flex; gap: 10px; flex-wrap: wrap; align-items: center;">
        <select id="homepage-section-add-type" style="height: 40px; padding: 0 12px; border-radius: var(--radius-md); border: 1px solid var(--border); background: var(--background);">
          ${ji.map(e=>`<option value="${e}">${Ai[e]}</option>`).join(``)}
        </select>
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Ni.about.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Ni.terms.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
      ...
      <div class="editor-sidebar-card" style="margin-bottom: var(--space-3);">
        <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
          <div>
            ...
            <p class="settings-panel-hint" style="margin: 4px 0 0 0;">${Ni.privacy.hint}</p>
          </div>
          <div style="display: flex; gap: 8px; align-items: center;">
  ...
  `}function Ri(e){let t=document.getElementById(`pages-global-error`),n=document.getElementById(`pages-global-saved`);function r(){n&&(n.hidden=!1,window.setTimeout(()=>n.hidden=!0,2500))}function i(e){t&&(t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی رخ داد.`,window.scrollTo({top:0,behavior:`smooth`}))}Wn().then(()=>Kn(document.body));let a=document.querySelectorAll(`[data-page-nav-tab]`),o=document.querySelectorAll(`[data-page-panel]`);a.forEach(e=>{e.addEventListener(`click`,()=>{a.forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`);let t=e.dataset.pageNavTab;o.forEach(e=>{e.hidden=e.dataset.pagePanel!==t})})}),document.getElementById(`pages-top-add-btn`)?.addEventListener(`click`,()=>e(null)),document.getElementById(`page-custom-new-btn`)?.addEventListener(`click`,()=>e(null));let s={},c=[],l=!0,d={};function f(e,t,n){return`
    ...
    `}function p(e,t,n){let r=e.type===`hero`,i=e.layout??`text`,a=r?`هدر و بنر اصلی`:Ai[i],o=!r&&i!==`text`&&i!==`testimonials`;return`
          ...
          <div class="block-editor-body">
            <div class="form-field">
              ...
              <select data-field="layout">
                ${ji.map(e=>`<option value="${e}" ${e===i?`selected`:``}>${Ai[e]}</option>`).join(``)}
              </select>
            </div>
        ...
        ${n.sections.map((t,n)=>`
          <div class="block-editor" data-legal-section="${n}">
            ...
            <div class="block-editor-body">
              ...
              <textarea data-field="body" data-i18n="fa" rows="4" placeholder="هر پاراگراف در یک خط؛ برای مورد لیستی خط را با «- » شروع کنید">${Pi(t.paragraphs,t.list)}</textarea>
              <textarea data-field="bodyEn" data-i18n="en" dir="ltr" rows="4" placeholder="One paragraph per line; prefix list items with '- '">${Pi(t.paragraphsEn,t.listEn)}</textarea>
            </div>
          </div>
        `).join(``)}
      </div>
    ...
    <div class="settings-panel" data-settings-panel="theme" ${n(`theme`)}>
      ...
      ${Array.from(new Set(Vi.map(e=>e.group))).map(e=>`
        <div class="editor-sidebar-card">
          <div class="card-header-action">
            <h3>${e}</h3>
            <button type="button" class="btn btn-primary btn-sm" data-save-setting="theme">ذخیره</button>
  ...
  `}function Ki(e,t){let n=document.getElementById(`settings-error`),r=document.getElementById(`settings-saved-note`);if(!n||!r)return;if(Ri(t=>e?.(`page-editor`,t)),t){let e=document.querySelector(`[data-settings-tab="${t}"]`);e&&(document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(e=>{e.hidden=e.dataset.settingsPanel!==t}))}let i=_();Wn().then(()=>Kn(document.body));function a(){r.hidden=!1,window.setTimeout(()=>r.hidden=!0,2500)}function o(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}document.querySelectorAll(`[data-settings-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-settings-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-settings-panel]`).forEach(t=>{t.hidden=t.dataset.settingsPanel!==e.dataset.settingsTab})})}),document.querySelectorAll(`[data-backup-subtab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-backup-subtab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-backup-subpanel]`).forEach(t=>{t.hidden=t.dataset.backupSubpanel!==e.dataset.backupSubtab})})});let s={},c={};function l(e){let t=document.getElementById(`settings-${e}-preview`),n=document.getElementById(`settings-${e}-url`)?.value.trim();t&&(t.innerHTML=n?`<img src="${n}" alt="" />`:``)}function u(e){let t=document.getElementById(`settings-${e}-url`),n=document.getElementById(`settings-${e}-upload-btn`),r=document.getElementById(`settings-${e}-file-input`),i=document.getElementById(`settings-branding-upload-error`);!t||!n||!r||(t.addEventListener(`input`,()=>l(e)),n.addEventListener(`click`,()=>r.click()),r.addEventListener(`change`,async()=>{let a=r.files?.[0];if(!a)return;i&&(i.hidden=!0),n.disabled=!0;let o=n.textContent;n.textContent=`در حال آپلود...`;try{let n=await Se(a);t.value=n,l(e)}catch(e){i&&(i.hidden=!1,i.textContent=e instanceof Error?e.message:`آپلود عکس ناموفق بود.`)}finally{r.value=``,n.disabled=!1,n.textContent=o}}))}u(`logo`),u(`favicon`);function d(){let e=s.site_name??{fa:``,en:``},t=e.fa?.trim()||``,n=e.en?.trim()||``,r=document.getElementById(`settings-site-name-fa`),i=document.getElementById(`settings-site-name-en`);r.value=t,i.value=n,document.getElementById(`settings-language-mode`).value=s.language_mode??`both`;let a=s.branding??{};document.getElementById(`settings-logo-url`).value=a.logoUrl??``,document.getElementById(`settings-favicon-url`).value=a.faviconUrl??``,l(`logo`),l(`favicon`);let o=s.footer??{seoParagraphs:[],copyright:{fa:``,en:``}},c=document.getElementById(`settings-footer-paragraphs`);c.innerHTML=o.seoParagraphs.map((e,t)=>`
        ...
        </div>`).join(``),Kn(c);let u=t?`همه حقوق برای ${t} محفوظ است.`:`همه حقوق محفوظ است.`,d=n?`All rights reserved for ${n}.`:`All rights reserved.`,f=document.getElementById(`settings-copyright-fa`),p=document.getElementById(`settings-copyright-en`);f.placeholder=u,p.placeholder=d;let m=o.copyright?.fa?.trim()??``,h=o.copyright?.en?.trim()??``;t&&t!==`بهبار`&&m&&m.includes(`بهبار`)&&(m=m.replace(/بهبار/g,t)),m||=u,n&&n!==`Behbar`&&h&&h.includes(`Behbar`)&&(h=h.replace(/Behbar/g,n)),h||=d,f.value=m,p.value=h,r.oninput=()=>{let e=r.value.trim(),t=e?`همه حقوق برای ${e} محفوظ است.`:`همه حقوق محفوظ است.`;f.placeholder=t;let n=f.value.trim();(!n||n.startsWith(`همه حقوق برای `)||n===`همه حقوق محفوظ است.`)&&(f.value=t)},i.oninput=()=>{let e=i.value.trim(),t=e?`All rights reserved for ${e}.`:`All rights reserved.`;p.placeholder=t;let n=p.value.trim();(!n||n.startsWith(`All rights reserved for `)||n===`All rights reserved.`)&&(p.value=t)};let g=s.hero_slogan??{};document.getElementById(`settings-hero-slogan-enabled`).checked=g.enabled!==!1,document.getElementById(`settings-hero-slogan-headline-fa`).value=g.headline?.fa??``,document.getElementById(`settings-hero-slogan-headline-en`).value=g.headline?.en??``,document.getElementById(`settings-hero-slogan-subtitle-fa`).value=g.subtitle?.fa??``,document.getElementById(`settings-hero-slogan-subtitle-en`).value=g.subtitle?.en??``}document.querySelectorAll(`[data-save-setting="site_name"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await qn(e,async()=>{let e=document.getElementById(`settings-site-name-fa`).value,t=document.getElementById(`settings-site-name-en`).value;await H(`site_name`,{fa:e,en:t}),s.site_name={fa:e,en:t}}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="language_mode"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await qn(e,async()=>{let e=document.getElementById(`settings-language-mode`).value;await H(`language_mode`,e),s.language_mode=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="branding"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await qn(e,async()=>{let e={logoUrl:document.getElementById(`settings-logo-url`).value.trim(),faviconUrl:document.getElementById(`settings-favicon-url`).value.trim()};await H(`branding`,e),s.branding=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="footer"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await qn(e,async()=>{let e={seoParagraphs:Array.from(document.querySelectorAll(`[data-footer-paragraph]`)).map(e=>({fa:e.querySelector(`[data-field="fa"]`).value,en:e.querySelector(`[data-field="en"]`).value})),copyright:{fa:document.getElementById(`settings-copyright-fa`).value,en:document.getElementById(`settings-copyright-en`).value}};await H(`footer`,e),s.footer=e}),a()}catch(e){o(e)}})}),document.querySelectorAll(`[data-save-setting="hero_slogan"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await qn(e,async()=>{let e={enabled:document.getElementById(`settings-hero-slogan-enabled`).checked,headline:{fa:document.getElementById(`settings-hero-slogan-headline-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-headline-en`).value.trim()},subtitle:{fa:document.getElementById(`settings-hero-slogan-subtitle-fa`).value.trim(),en:document.getElementById(`settings-hero-slogan-subtitle-en`).value.trim()}};await H(`hero_slogan`,e),s.hero_slogan=e}),a()}catch(e){o(e)}})});let f=[],p={enabled:!1,links:[]},m={enabled:!1,badges:[]};function h(){let e=document.getElementById(`social-links-list`);e&&(e.innerHTML=f.map((e,t)=>`
      <div class="settings-form-grid" data-social-link-index="${t}" style="grid-template-columns: 140px 140px 1fr 1fr auto; align-items: end; gap: 8px;">
        <div class="form-field">
          ...
          <select data-field="platform">
            ${zi.map(t=>`<option value="${t.value}" ${t.value===e.platform?`selected`:``}>${t.label}</option>`).join(``)}
          </select>
        </div>
    ...
    `}function D(){let e=c.googleDrive??{enabled:!1,clientId:``,clientSecret:``,folderId:``};document.getElementById(`backup-drive-enabled`).checked=!!e.enabled,document.getElementById(`backup-drive-client-id`).value=e.clientId??``,document.getElementById(`backup-drive-client-secret`).value=e.clientSecret??``,document.getElementById(`backup-drive-folder`).value=e.folderId??``,O(!!e.refreshToken)}function O(e){let t=document.getElementById(`drive-connection-status`),n=document.getElementById(`backup-drive-disconnect-btn`);t&&(t.innerHTML=e?`<span class="article-status-badge article-status-published">متصل به گوگل درایو</span>`:`<span class="article-status-badge">هنوز متصل نشده</span>`),n&&(n.hidden=!e)}function ee(e,t){let n=document.getElementById(`theme-${e}`),r=document.getElementById(`theme-${e}-picker`);n&&(n.value=t),r&&/^#[0-9a-fA-F]{6}$/.test(t)&&(r.value=t)}function k(){let e=s.theme??{};Vi.forEach(t=>ee(t.key,e[t.key]??Hi[t.key]))}document.querySelectorAll(`[data-theme-picker]`).forEach(e=>{e.addEventListener(`input`,()=>{let t=e.dataset.themePicker;ee(t,e.value)})}),document.getElementById(`theme-reset-btn`)?.addEventListener(`click`,()=>{Vi.forEach(e=>ee(e.key,Hi[e.key]))}),document.querySelectorAll(`[data-save-setting="theme"]`).forEach(e=>{e.addEventListener(`click`,async()=>{try{await qn(e,async()=>{let e={};Vi.forEach(t=>{let n=document.getElementById(`theme-${t.key}`).value.trim();e[t.key]=/^#[0-9a-fA-F]{6}$/.test(n)?n:Hi[t.key]}),e.quickActionsStyle=(s.theme??{}).quickActionsStyle===`fixed`?`fixed`:`floating`,await H(`theme`,e),s.theme=e}),a()}catch(e){o(e)}})}),Te().then(e=>{s=e,d(),v(),k(),x(),T()}).catch(o),i&&S(i,`plugins`)&&tt().then(e=>{c=e,D()}).catch(o),i&&S(i,`settings`)&&Me().then(e=>E(e)).catch(o);let A=document.getElementById(`license-key-input`),j=document.getElementById(`license-activate-btn`),M=document.getElementById(`license-activate-error`);j?.addEventListener(`click`,async()=>{if(!A||!M)return;let e=A.value.trim();if(M.hidden=!0,!e){M.hidden=!1,M.textContent=`کد لایسنس را وارد کنید.`;return}j.disabled=!0;try{let t=await Ne(e);A.value=``,E(t)}catch(e){M.hidden=!1,M.textContent=e instanceof Error?e.message:`فعال‌سازی لایسنس ناموفق بود.`}finally{j.disabled=!1}});let N=document.getElementById(`backup-download-btn`),P=document.getElementById(`backup-download-error`);N?.addEventListener(`click`,async()=>{if(P){P.hidden=!0,N.disabled=!0;try{await at()}catch(e){P.hidden=!1,P.textContent=e instanceof Error?e.message:`دریافت فایل پشتیبان ناموفق بود.`}finally{N.disabled=!1}}});let F=document.getElementById(`backup-restore-file`),I=document.getElementById(`backup-restore-btn`),R=document.getElementById(`backup-restore-error`),z=document.getElementById(`backup-restore-success`);F?.addEventListener(`change`,()=>{I&&(I.disabled=!F.files?.length),z&&(z.hidden=!0)}),I?.addEventListener(`click`,async()=>{if(!F||!R||!z)return;let e=F.files?.[0];if(e&&window.confirm(`با ادامه، تمام داده‌های فعلی سایت (درخواست‌ها، کارمندان، تنظیمات، محتوا و ...) با محتوای این فایل جایگزین می‌شود و این عمل غیرقابل‌بازگشت است. مطمئنید؟`)){R.hidden=!0,z.hidden=!0,I.disabled=!0;try{await ot(await e.text()),z.hidden=!1,F.value=``}catch(e){R.hidden=!1,R.textContent=e instanceof Error?e.message:`بازیابی پشتیبان ناموفق بود.`}finally{I.disabled=!F.files?.length}}});let B=document.getElementById(`drive-redirect-uri`);B&&(B.textContent=`https://api.behbarapp.ir/api/admin/backup/drive-oauth/callback`);let V=document.getElementById(`backup-drive-error`),te=document.getElementById(`backup-drive-save-btn`);te&&te.addEventListener(`click`,async()=>{if(V){V.hidden=!0;try{await qn(te,async()=>{let e=c.googleDrive??{};c={...c,googleDrive:{...e,enabled:document.getElementById(`backup-drive-enabled`).checked,clientId:document.getElementById(`backup-drive-client-id`).value.trim(),clientSecret:document.getElementById(`backup-drive-client-secret`).value.trim(),folderId:document.getElementById(`backup-drive-folder`).value.trim()}},await H(`plugins`,c)})}catch(e){V.hidden=!1,V.textContent=e instanceof Error?e.message:`ذخیره تنظیمات ناموفق بود.`}}}),document.getElementById(`backup-drive-test-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;if(V){V.hidden=!0,t.disabled=!0,t.textContent=`در حال ارسال...`;try{await st(),a()}catch(e){V.hidden=!1,V.textContent=e instanceof Error?e.message:`ارسال آزمایشی ناموفق بود.`}finally{t.disabled=!1,t.textContent=`ارسال آزمایشی الان`}}}),document.getElementById(`backup-drive-connect-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;if(V){V.hidden=!0,t.disabled=!0;try{let e=await ct();window.location.href=e}catch(e){V.hidden=!1,V.textContent=e instanceof Error?e.message:`آماده‌سازی اتصال ناموفق بود.`,t.disabled=!1}}}),document.getElementById(`backup-drive-disconnect-btn`)?.addEventListener(`click`,async e=>{let t=e.currentTarget;if(V&&window.confirm(`اتصال به گوگل درایو قطع شود؟ ارسال خودکار روزانه متوقف می‌شود.`)){V.hidden=!0,t.disabled=!0;try{await lt(),O(!1);let e=document.getElementById(`backup-drive-enabled`);e&&(e.checked=!1)}catch(e){V.hidden=!1,V.textContent=e instanceof Error?e.message:`قطع اتصال ناموفق بود.`}finally{t.disabled=!1}}}),i&&S(i,`settings`)&&ki()}var qi=[{id:`gemini`,label:`Google Gemini`,defaultModel:`gemini-1.5-flash`,docUrl:`https://aistudio.google.com/app/apikey`,placeholder:`AIzaSy...`},{id:`openai`,label:`OpenAI (ChatGPT)`,defaultModel:`gpt-4o-mini`,docUrl:`https://platform.openai.com/api-keys`,placeholder:`sk-proj-...`},{id:`claude`,label:`Anthropic Claude`,defaultModel:`claude-3-5-haiku-20241022`,docUrl:`https://console.anthropic.com/settings/keys`,placeholder:`sk-ant-...`},{id:`deepseek`,label:`DeepSeek`,defaultModel:`deepseek-chat`,docUrl:`https://platform.deepseek.com/api_keys`,placeholder:`sk-...`},{id:`groq`,label:`Groq`,defaultModel:`llama-3.1-70b-versatile`,docUrl:`https://console.groq.com/keys`,placeholder:`gsk_...`}];function Ji(e,t){let n=qi.find(t=>t.id===e),r=qi.findIndex(t=>t.id===e)+1||1;return t?.[e]??{enabled:!1,apiKey:``,model:n?.defaultModel??``,priority:r}}function Yi(e){return`
          ...
          <div class="settings-form-grid">
            <div class="form-field">
              ...
              <select id="setup-origin-province">
                ...
                ${ta.map(e=>`<option value="${e.name}">${e.name}</option>`).join(``)}
              </select>
            </div>
            <div class="form-field">
  ...
  `}function sa(e,t){let n=document.querySelector(`.setup-wizard-card`),r=document.getElementById(`setup-progress-fill`),i=document.getElementById(`setup-progress-text`),a=document.getElementById(`setup-back`),o=document.getElementById(`setup-next`),s=document.getElementById(`setup-skip-all`),c=document.getElementById(`setup-general-error`),l=document.getElementById(`setup-vehicle-list`);if(!n||!r||!i||!a||!o||!s||!c||!l)return;let d=0,f={},p=na;function m(){l.innerHTML=p.map((e,t)=>`
    ...
    <div class="testimonial-row" data-audit-edit="${e.id}" role="button" tabindex="0">
      ...
      <div class="testimonial-row-body">
        <div class="testimonial-row-head">
          <strong>${ca(e.title)}</strong>
          <span class="article-status-badge article-status-draft">فاقد ${t.join(` و `)}</span>
        </div>
        <div class="job-application-meta"><span dir="ltr">/magazine/${ca(e.slug)}</span></div>
      </div>
    </div>
  `}function ua(){return`
    <div class="view-header">
  ...
  `}function da(e=()=>{}){let t=document.getElementById(`seo-error`),n=document.getElementById(`seo-audit-list`);if(!t||!n)return;let r=``;function i(e){t.hidden=!1,t.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`,zn(e instanceof Error?e.message:`ذخیره ناموفق بود.`,`error`)}async function a(){let e=(await Te()).seo??{};document.getElementById(`seo-search-console`).value=e.googleSiteVerification??``,document.getElementById(`seo-ga-id`).value=e.googleAnalyticsId??``,r=e.defaultOgImage??``}async function o(){let t=(await de()).filter(e=>!e.metaTitle||!e.metaDescription);n.innerHTML=t.length?t.map(la).join(``):`<p class="pipeline-empty">همه‌ی مقاله‌ها عنوان و توضیحات سئو دارند.</p>`,n.querySelectorAll(`[data-audit-edit]`).forEach(t=>{t.addEventListener(`click`,()=>e(Number(t.dataset.auditEdit)))})}function s(){return{googleSiteVerification:document.getElementById(`seo-search-console`).value.trim(),googleAnalyticsId:document.getElementById(`seo-ga-id`).value.trim(),defaultOgImage:r}}function c(e){document.getElementById(e)?.addEventListener(`click`,async e=>{let n=e.currentTarget;t.hidden=!0;try{await qn(n,async()=>{await H(`seo`,s())}),zn(`تنظیمات سئو ذخیره شد.`)}catch(e){i(e)}})}c(`seo-search-console-save-btn`),c(`seo-ga-save-btn`),Promise.all([a(),o()]).catch(i)}function fa(){return`
    <div class="settings-view">
      <div class="settings-panel">
        <h2>امنیت حساب</h2>
  ...
  `}function pa(){let e=document.getElementById(`account-security-status-card`),t=document.getElementById(`account-security-sms-setup-card`),n=document.getElementById(`account-security-sms-error`),r=document.getElementById(`account-security-sms-verifying`);async function i(e,t){n.hidden=!0,r.hidden=!1;try{await A(e),window.location.reload()}catch(e){r.hidden=!0,n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`,t?.reset()}}document.getElementById(`account-security-start-sms`)?.addEventListener(`click`,()=>{(async()=>{try{await k(),e.hidden=!0,t.hidden=!1;let n=Ot(`account-security-sms`,{onComplete:e=>void i(e,n),onResend:()=>void k().catch(e=>window.alert(e instanceof Error?e.message:`ارسال دوباره‌ی کد ناموفق بود.`))})}catch(e){window.alert(e instanceof Error?e.message:`خطایی پیش آمد.`)}})()}),document.getElementById(`account-security-disable-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=document.getElementById(`account-security-disable-password`),n=document.getElementById(`account-security-disable-error`);(async()=>{n.hidden=!0;try{await j(t.value),window.location.reload()}catch(e){n.hidden=!1,n.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}})()})}function ma(e){return e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`)}var ha={salary:`حقوق`,bonus:`پاداش`,adjustment:`اصلاحیه`,payout:`تسویه`};function ga(){return`
    <div class="view-header">
      <h1>حقوق و دستمزد</h1>
    </div>
    <p class="settings-panel-hint">
  ...
  `}function _a(e){return`
    <tr>
      <td>${ma(e.fullName)}${e.isActive?``:` <span class="settings-panel-hint">(غیرفعال)</span>`}</td>
      <td>${ma(e.roleLabel)}</td>
      <td><strong>${X(e.balance)}</strong></td>
      <td>
        <div class="staff-table-actions">
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-view-tx="${e.staffId}" data-wallet-staff-name="${ma(e.fullName)}">تراکنش‌ها</button>
          <button type="button" class="btn btn-ghost btn-sm" data-wallet-adjust="${e.staffId}">ثبت اصلاحیه</button>
        </div>
      </td>
    </tr>
  `}function va(e){let t=e.direction===`credit`?`+`:`−`,n=e.direction===`credit`?`var(--success)`:`var(--danger)`;return`
    <div class="activity-log-row">
      <div class="activity-log-main">
        <span class="activity-log-action">${ha[e.type]??e.type}</span>
        <span class="activity-log-target">${ma(e.description)}</span>
      </div>
      <div class="activity-log-meta"><span style="color:${n}; font-weight:700;">${t} ${X(e.amount)}</span></div>
    </div>
  `}function ya(e){return`
    <div class="editor-sidebar-card">
      <div class="plugin-card-head">
        <h3>${ma(e.staffName)} — ${X(e.amount)}</h3>
      </div>
      ${e.staffNote?`<p class="settings-panel-hint">${ma(e.staffNote)}</p>`:``}
      <div class="staff-table-actions">
  ...
  `}function ba(e){return`
    <tr data-role-rate-row="${e.id}">
      <td>${ma(e.label)}${e.isSystem?` <span class="settings-panel-hint">(سیستمی)</span>`:``}</td>
  ...
  `}function xa(){document.querySelectorAll(`[data-payroll-tab]`).forEach(e=>{e.addEventListener(`click`,()=>{document.querySelectorAll(`[data-payroll-tab]`).forEach(e=>e.classList.remove(`is-active`)),e.classList.add(`is-active`),document.querySelectorAll(`[data-payroll-panel]`).forEach(t=>{t.hidden=t.dataset.payrollPanel!==e.dataset.payrollTab})})});let e=document.getElementById(`balances-error`),t=document.getElementById(`balances-table-body`);async function n(){e.hidden=!0;try{let e=await bt();t.innerHTML=e.length?e.map(_a).join(``):`<tr><td colspan="4">کارمندی ثبت نشده.</td></tr>`}catch(t){e.hidden=!1,e.textContent=t instanceof Error?t.message:`خطایی پیش آمد.`}}let r=document.getElementById(`wallet-tx-modal`),i=document.getElementById(`wallet-tx-modal-title`),a=document.getElementById(`wallet-tx-modal-list`);document.getElementById(`wallet-tx-modal-close`)?.addEventListener(`click`,()=>r.hidden=!0),t.addEventListener(`click`,e=>{let t=e.target.closest(`[data-wallet-view-tx]`);if(t){let e=Number(t.dataset.walletViewTx),n=t.dataset.walletStaffName??``;i.textContent=`تراکنش‌های ${n}`,a.innerHTML=`<p class="settings-panel-hint">در حال بارگذاری...</p>`,r.hidden=!1,xt(e,50,0).then(({transactions:e})=>{a.innerHTML=e.length?e.map(va).join(``):`<p class="settings-panel-hint">تراکنشی ثبت نشده.</p>`});return}let n=e.target.closest(`[data-wallet-adjust]`);n&&(o.dataset.staffId=n.dataset.walletAdjust,o.hidden=!1)});let o=document.getElementById(`wallet-adjustment-modal`);document.getElementById(`wallet-adjustment-modal-close`)?.addEventListener(`click`,()=>o.hidden=!0),document.getElementById(`wallet-adjustment-form`)?.addEventListener(`submit`,e=>{e.preventDefault();let t=Number(o.dataset.staffId),r=document.getElementById(`adjustment-direction`).value,i=Number(document.getElementById(`adjustment-amount`).value),a=document.getElementById(`adjustment-description`).value.trim(),s=document.getElementById(`adjustment-error`),c=document.getElementById(`adjustment-submit`);if(s.hidden=!0,!Number.isFinite(i)||i<=0||!a){s.hidden=!1,s.textContent=`مبلغ و توضیح را کامل وارد کنید.`;return}c.disabled=!0,K(t,r,i,a).then(()=>(o.hidden=!0,document.getElementById(`wallet-adjustment-form`).reset(),n())).catch(e=>{s.hidden=!1,s.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}).finally(()=>{c.disabled=!1})});let s=document.getElementById(`payroll-error`),c=document.getElementById(`payroll-preview-wrap`),l=document.getElementById(`payroll-preview-body`),u=document.getElementById(`payroll-result`),d=document.getElementById(`payroll-month`);d.value=new Date().toISOString().slice(0,7);function f(e){return`
    ...
    `}document.getElementById(`payroll-preview-btn`)?.addEventListener(`click`,()=>{s.hidden=!0,u.hidden=!0,Et(d.value).then(e=>{l.innerHTML=e.map(f).join(``),c.hidden=!1}).catch(e=>{s.hidden=!1,s.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`})}),document.getElementById(`payroll-confirm-btn`)?.addEventListener(`click`,()=>{let e=[];document.querySelectorAll(`[data-payroll-entry]`).forEach(t=>{let n=t.querySelector(`[data-field="include"]`),r=t.querySelector(`[data-field="amount"]`);n?.checked&&r&&Number(r.value)>0&&e.push({staffId:Number(t.dataset.payrollEntry),amount:Number(r.value)})}),e.length&&(s.hidden=!0,Dt(d.value,e).then(e=>{u.hidden=!1,u.textContent=`${e.processed} نفر پردازش شد.${e.skipped.length?` (${e.skipped.length} مورد رد شد — قبلاً واریز شده یا نامعتبر بود)`:``}`,n()}).catch(e=>{s.hidden=!1,s.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}))});let p=document.getElementById(`payouts-error`),m=document.getElementById(`payouts-list`);async function h(){p.hidden=!0;try{let e=await Ct(`pending`);m.innerHTML=e.length?e.map(ya).join(``):`<p class="settings-panel-hint">درخواست در انتظاری نیست.</p>`}catch(e){p.hidden=!1,p.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}m.addEventListener(`click`,e=>{let t=e.target.closest(`[data-payout-approve]`);if(t){wt(Number(t.dataset.payoutApprove)).then(()=>Promise.all([h(),n()])).catch(e=>{p.hidden=!1,p.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`});return}let r=e.target.closest(`[data-payout-reject]`);if(r){let e=window.prompt(`دلیل رد (اختیاری):`)??void 0;Tt(Number(r.dataset.payoutReject),e).then(()=>h()).catch(e=>{p.hidden=!1,p.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`})}});let g=document.getElementById(`rates-error`),_=document.getElementById(`rates-saved-note`),v=document.getElementById(`role-rates-body`);async function y(){g.hidden=!0;try{let{roles:e}=await re();v.innerHTML=e.map(ba).join(``)}catch(e){g.hidden=!1,g.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`}}v.addEventListener(`click`,e=>{let t=e.target.closest(`[data-role-rate-save]`);if(!t)return;let n=t.closest(`[data-role-rate-row]`),r=Number(n.dataset.roleRateRow),i=Number(n.querySelector(`[data-field="salary"]`).value),a=n.querySelector(`[data-field="bonusType"]`).value,o=Number(n.querySelector(`[data-field="bonusAmount"]`).value);g.hidden=!0,St(r,{defaultSalaryAmount:i,defaultBonusType:a,defaultBonusAmount:o}).then(()=>{_.hidden=!1,window.setTimeout(()=>_.hidden=!0,2500)}).catch(e=>{g.hidden=!1,g.textContent=e instanceof Error?e.message:`خطایی پیش آمد.`})}),n(),h(),y()}function Sa(e,t,n){return`
    <button type="button" class="home-tile" data-home-tile="${e}">
      <span class="home-tile-icon">${t}</span>
      <span class="home-tile-label">${n}</span>
    </button>
  `}function Ca(e){let t=S(e,`content`)||S(e,`stories`)||S(e,`seo`)||S(e,`settings`),n=S(e,`staff`)||S(e,`recruitment`)||S(e,`roles`)||S(e,`wallet`),r=S(e,`settings`)||S(e,`homepage`),i=S(e,`pipeline`)||S(e,`map`),a=[];return i&&a.push(Sa(`requests`,u.columns,`درخواست‌ها`)),S(e,`dashboard`)&&a.push(Sa(`dashboard`,u.chart,`داشبورد`)),S(e,`chat`)&&a.push(Sa(`chat`,u.chat,`چت پشتیبانی`)),t&&a.push(Sa(`content`,u.grid,`مدیریت محتوا`)),n&&a.push(Sa(`personnel`,u.users,`مدیریت پرسنل`)),S(e,`staff`)&&a.push(Sa(`fleet`,u.truck,`مدیریت ناوگان حمل‌ونقل`)),S(e,`plugins`)&&a.push(Sa(`plugins`,u.plugin,`افزونه‌ها`)),r&&a.push(Sa(`settings`,u.settings,`تنظیمات سایت`)),`<div class="home-grid">${a.join(``)}</div>`}function wa(e){let t=[];return S(e,`pipeline`)&&t.push(Sa(`pipeline`,u.columns,`مراحل درخواست‌ها`)),S(e,`map`)&&t.push(Sa(`map`,u.map,`نقشه درخواست‌ها`)),`<div class="home-grid">${t.join(``)}</div>`}function Ta(e){let t=[];return S(e,`content`)&&t.push(Sa(`magazine`,u.article,`مجله`)),S(e,`content`)&&t.push(Sa(`testimonials`,u.message,`نظرات مشتریان`)),S(e,`stories`)&&t.push(Sa(`stories`,u.story,`استوری‌ها`)),S(e,`seo`)&&t.push(Sa(`seo`,u.seo,`مدیریت سئو`)),(S(e,`content`)||S(e,`settings`))&&t.push(Sa(`media`,u.image,`مدیریت فایل`)),`<div class="home-grid">${t.join(``)}</div>`}function Ea(e){let t=[];return S(e,`staff`)&&t.push(Sa(`staff`,u.users,`کارمندان`)),S(e,`recruitment`)&&t.push(Sa(`jobApplications`,u.briefcase,`فرصت‌های شغلی`)),S(e,`roles`)&&t.push(Sa(`roles`,u.lock,`نقش‌ها و اختیارات`)),(S(e,`staff`)||S(e,`roles`))&&t.push(Sa(`activityLog`,u.history,`گزارش فعالیت`)),S(e,`wallet`)&&t.push(Sa(`payroll`,u.wallet,`حقوق و دستمزد`)),`<div class="home-grid">${t.join(``)}</div>`}function Da(e,t){e.querySelectorAll(`[data-home-tile]`).forEach(e=>{e.addEventListener(`click`,()=>t(e.dataset.homeTile??``))})}async function Oa(){try{let e=(await Te()).site_name?.fa?.trim();if(!e||e===`بهبار`)return;document.querySelectorAll(`#login-brand-text, .admin-logo-title, #staff-portal-brand-text`).forEach(t=>{t.textContent?.includes(`بهبار`)&&(t.textContent=t.textContent.replace(/بهبار/g,e))})}catch{}}function ka(e){return e===`home`?null:e===`requests`||e===`content`||e===`personnel`||e===`dashboard`?`home`:e===`pipeline`||e===`map`?`requests`:e===`magazine`||e===`testimonials`||e===`stories`||e===`seo`||e===`media`?`content`:e===`staff`||e===`jobApplications`||e===`roles`||e===`activityLog`||e===`payroll`?`personnel`:e===`staffHistory`?`staff`:e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`?`dashboard`:e===`magazine-editor`?`magazine`:e===`page-editor`||e===`pages`?`settings`:`home`}function Aa(){let e=document.querySelector(`#app`);if(!e)throw Error(`#app not found`);return e}function ja(){let e=Aa();e.innerHTML=kt(),At(za),Oa()}var Ma=`home`,Na=null;function $(e,t=null){let n=document.getElementById(`view-container`),r=document.getElementById(`admin-back-btn`),i=_();if(!(!n||!i)){if(Ma=e,r&&(r.hidden=e===`home`),y({screen:e,extra:e===`magazine-editor`||e===`page-editor`?t:e===`staffHistory`?Na:void 0}),document.querySelectorAll(`#admin-topbar-nav .admin-topbar-tab`).forEach(t=>{let n=t.dataset.adminTab,r=n===e||n===`dashboard`&&(e===`dashboardOrders`||e===`dashboardVisitors`||e===`dashboardStaff`)||n===`home`&&![`dashboard`,`dashboardOrders`,`dashboardVisitors`,`dashboardStaff`,`pipeline`,`map`,`fleet`].includes(e);t.classList.toggle(`is-active`,!!r)}),e===`home`)n.innerHTML=Ca(i),Da(n,e=>$(e));else if(e===`requests`)n.innerHTML=wa(i),Da(n,e=>$(e));else if(e===`content`)n.innerHTML=Ta(i),Da(n,e=>$(e));else if(e===`personnel`)n.innerHTML=Ea(i),Da(n,e=>$(e));else if(e===`dashboard`)n.innerHTML=vn(),yn(e=>$(e));else if(e===`dashboardOrders`)n.innerHTML=bn();else if(e===`dashboardVisitors`)n.innerHTML=xn();else if(e===`dashboardStaff`)n.innerHTML=Sn();else if(e===`pipeline`)n.innerHTML=dn(),fn();else if(e===`map`)n.innerHTML=Dn(),On();else if(e===`staff`)n.innerHTML=Mn(),Nn(e=>{Na=e,$(`staffHistory`)});else if(e===`staffHistory`){if(!Na){$(`staff`);return}n.innerHTML=Fn(Na),In(Na)}else if(e===`fleet`)n.innerHTML=nr(),rr();else if(e===`magazine`)n.innerHTML=yr(),br(e=>$(`magazine-editor`,e));else if(e===`magazine-editor`)n.innerHTML=Lr(),Rr(t,()=>$(`magazine`));else if(e===`pages`){$(`settings`);return}else e===`page-editor`?(n.innerHTML=Wr(),Gr(t,()=>$(`settings`))):e===`testimonials`?(n.innerHTML=Xr(),Zr()):e===`chat`?(n.innerHTML=ii(),ai()):e===`stories`?(n.innerHTML=li(),ui()):e===`jobApplications`?(n.innerHTML=vi(),yi()):e===`settings`?(n.innerHTML=Gi(),Ki((e,t)=>$(e,t??null))):e===`plugins`?(n.innerHTML=Xi(),ea()):e===`seo`?(n.innerHTML=ua(),da(e=>$(`magazine-editor`,e))):e===`media`?(n.innerHTML=Ln(),Rn()):e===`roles`?(n.innerHTML=Bn(),Vn()):e===`activityLog`?(n.innerHTML=Si(),Ci()):e===`accountSecurity`?(n.innerHTML=fa(),pa()):e===`myWallet`?(n.innerHTML=cr(),dr()):e===`payroll`?(n.innerHTML=ga(),xa()):(n.innerHTML=Ca(i),Da(n,e=>$(e)))}}function Pa(e,t=!1){let n=Aa();n.innerHTML=Lt(e),document.getElementById(`admin-back-btn`)?.addEventListener(`click`,()=>{let e=ka(Ma);e&&$(e)}),document.getElementById(`logout-btn`)?.addEventListener(`click`,()=>{M(),v(),ja()}),document.getElementById(`admin-account-btn`)?.addEventListener(`click`,()=>$(`accountSecurity`)),document.getElementById(`admin-wallet-btn`)?.addEventListener(`click`,()=>$(`myWallet`));function r(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`,t=document.getElementById(`admin-theme-sun`),n=document.getElementById(`admin-theme-moon`);t&&n&&(t.hidden=!e,n.hidden=e)}r(),document.getElementById(`admin-theme-toggle-btn`)?.addEventListener(`click`,()=>{document.documentElement.getAttribute(`data-theme`)===`dark`?(document.documentElement.removeAttribute(`data-theme`),localStorage.setItem(`behbar_admin_theme`,`light`)):(document.documentElement.setAttribute(`data-theme`,`dark`),localStorage.setItem(`behbar_admin_theme`,`dark`)),r()}),document.querySelectorAll(`#admin-topbar-nav .admin-topbar-tab`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.dataset.adminTab;t&&$(t)})}),document.getElementById(`admin-logo-btn`)?.addEventListener(`click`,()=>{$(S(e,`dashboard`)?`dashboard`:`home`)}),S(e,`settings`)&&Ia(),Fa(),Wn(),Oa(),S(e,`ai`)&&Pt();let i=t?b():null;i?.screen===`staffHistory`&&i.extra?(Na=i.extra,$(`staffHistory`)):i?.screen===`magazine-editor`?$(`magazine-editor`,i.extra??null):i?.screen===`page-editor`?$(`page-editor`,i.extra??null):i?.screen?$(i.screen):$(S(e,`dashboard`)?`dashboard`:`home`)}async function Fa(){try{let e=await Te(),t=e.branding,n=t?.logoUrl;n&&document.querySelectorAll(`.admin-logo-mark`).forEach(e=>e.src=n);let r=t?.faviconUrl||n;r&&document.querySelectorAll(`link[rel="icon"]`).forEach(e=>e.href=r);let i=e.site_name;i?.fa?.trim()&&(document.title=`${i.fa.trim()} - پنل مدیریت`,document.querySelectorAll(`.admin-logo-title`).forEach(e=>e.textContent=i.fa.trim()))}catch{}}async function Ia(){let e=document.getElementById(`admin-sidebar-version`);if(e)try{let t=await gt();e.textContent=t.updateAvailable?`نسخه ${t.current} · نسخه جدید موجود است`:`نسخه ${t.current}`,e.classList.toggle(`has-update`,t.updateAvailable),e.hidden=!1}catch{}}function La(e){let t=Aa();t.innerHTML=hr(e),Oa(),_r(()=>{M(),v(),ja()})}function Ra(e){let t=Aa();t.innerHTML=oa(),Oa(),sa(e,()=>Pa(e))}function za(e,t=!1){if(!C(e)){La(e);return}if(!S(e,`settings`)){Pa(e,t);return}Te().then(n=>{ia(n)?Ra(e):Pa(e,t)}).catch(()=>Pa(e,t))}function Ba(){if(E(ja),!x()){ja();return}let e=_();e?za(e,!0):ja(),N().then(t=>{let n=g();n&&(h(n,t),(!e||e.role!==t.role)&&za(t,!0))}).catch(()=>{})}Ba();