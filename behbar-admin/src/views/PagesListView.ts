...
const DEFAULT_HOMEPAGE_SECTIONS: HomepageSection[] = [{ id: 'hero', type: 'hero', visible: true }];
...
export function initPagesListView(onEdit: (id: number | null) => void): void {
  ...
  async function loadAll(): Promise<void> {
    try {
      ...
      homepageSections = data?.sections?.length ? data.sections : DEFAULT_HOMEPAGE_SECTIONS;
