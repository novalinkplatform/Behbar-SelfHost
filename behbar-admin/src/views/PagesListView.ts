...
const DEFAULT_HOMEPAGE_SECTIONS: HomepageSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        id: 'faq-1',
        title: 'سامانه دقیقاً چه خدماتی ارائه می‌دهد؟',
        titleEn: 'What services are offered exactly?',
        text: 'امکان ثبت آنلاین درخواست اسباب‌کشی، باربری و حمل بار را در سراسر کشور فراهم می‌کند. خدمات شامل جابه‌جایی با وانت، نیسان، خاور و کامیون، برای منازل مسکونی و همچنین واحدهای تجاری، اداری و انباری است.',
        textEn:
          'Online requests for moving, hauling, and freight services across the country. Services include moving by pickup, van, light truck, and truck, for residential homes as well as commercial, office, and warehouse units.',
      },
      {
        id: 'faq-2',
        ...
        text: 'خیر. عدد نمایش‌داده‌شده یک برآورد اولیه بر اساس اطلاعاتی است که در فرم وارد می‌کنید. قیمت نهایی پیش از شروع کار با کارشناسان هماهنگ و تأیید می‌شود.',
        textEn: 'No. The number shown is a preliminary estimate based on the information you enter in the form. The final price is confirmed before the work begins.',
      },
      {
        id: 'faq-3',
        title: 'چقدر طول می‌کشد تا با من تماس بگیرید؟',
        titleEn: 'How long until you contact me?',
        text: 'پس از ثبت درخواست، تیم پشتیبانی در کوتاه‌ترین زمان ممکن با شماره‌ای که وارد کرده‌اید تماس می‌گیرد تا جزئیات کار و زمان دقیق اجرا را هماهنگ کند.',
        textEn: 'After you submit a request, our team calls the number you provided as soon as possible to confirm the details and exact time of the job.',
      },
      {
        id: 'faq-4',
      ...
      },
      {
        ...
        text: 'بله. برای تغییر زمان یا لغو یک درخواست ثبت‌شده کافی است از طریق شماره تماس با تیم پشتیبانی در ارتباط باشید.',
        textEn: 'Yes. To reschedule or cancel a submitted request, simply reach the support team via phone.',
      },
      {
        id: 'faq-9',
      ...
      {
        id: 'faq-10',
        title: 'آیا اطلاعات من محفوظ می‌ماند؟',
        titleEn: 'Is my information kept safe?',
...
const LEGAL_CONFIG: Record<LegalSlug, { label: string; livePath: string; hint: string }> = {
  about: {
    ...
    livePath: '/about',
    hint: 'ویرایش مشخصات، تاریخچه، اهداف و بخش‌های معرفی بهبار در نشانی /about',
  },
  terms: {
    label: 'صفحه قوانین و مقررات',
    livePath: '/terms',
    hint: 'مدیریت شرایط، ضوابط، تعهدات و مقررات استفاده از سامانه بهبار در نشانی /terms',
  },
  privacy: {
    label: 'صفحه حریم خصوصی',
    livePath: '/privacy',
    hint: 'تنظیم سیاست‌های حفاظت از داده‌ها و امنیت حریم خصوصی کاربران بهبار در نشانی /privacy',
  },
};
...
export function initPagesListView(onEdit: (id: number | null) => void): void {
  ...
  async function loadAll(): Promise<void> {
    try {
      ...
      homepageSections = data?.sections && data.sections.length > 1 ? data.sections : DEFAULT_HOMEPAGE_SECTIONS;
