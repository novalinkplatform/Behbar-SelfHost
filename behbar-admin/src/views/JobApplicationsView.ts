...
const DEFAULT_POSITIONS: CareerPosition[] = [
  { id: 'driver', title: 'راننده با خودرو', titleEn: 'Driver', description: 'رانندگان وانت، نیسان، خاور و کامیون با خودرو شخصی', requiresVehicle: true, active: true },
  { id: 'worker', title: 'کارگر اسباب‌کشی و باربری', titleEn: 'Moving Specialist', description: 'نیروی متخصص بسته‌بندی، چیدمان و حمل بارهای سنگین', requiresVehicle: false, active: true },
  { id: 'support', title: 'کارشناس پشتیبانی و هماهنگی', titleEn: 'Customer Support', description: 'پاسخگویی به تماس‌ها و پیگیری امور مشتریان و رانندگان', requiresVehicle: false, active: true },
  { id: 'other', title: 'سایر زمینه‌های همکاری', titleEn: 'Other', description: 'تخصص‌های دیگر لجستیک، اداری و بازاریابی', requiresVehicle: false, active: true },
];
