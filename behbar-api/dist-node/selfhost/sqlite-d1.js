...
import { SELFHOST_MIGRATIONS, LATEST_SELFHOST_MIGRATION_VERSION } from "./migrations.js";
...
export async function bootstrapIfEmpty(db, projectRoot) {
...
export async function applyPendingSelfhostMigrations(db) {
...
export function ensureDataDir(filePath) {
