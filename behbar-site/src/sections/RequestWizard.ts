...
const STEPS = [
  { id: 'service', question: 'چه چیزی را می‌خواهید جابه‌جا کنید؟', questionEn: 'What do you want to move?' },
  { id: 'vehicle', question: 'چه نوع وسیله نقلیه‌ای نیاز دارید؟', questionEn: 'What type of vehicle do you need?' },
  { id: 'origin', question: 'مبدأ کجاست؟', questionEn: 'Where is the origin?' },
  { id: 'destination', question: 'مقصد کجاست؟', questionEn: 'Where is the destination?' },
  { id: 'origin-floor', question: 'طبقه مبدأ چندم است؟', questionEn: 'What floor is the origin on?' },
  { id: 'destination-floor', question: 'طبقه مقصد چندم است؟', questionEn: 'What floor is the destination on?' },
  { id: 'packing', question: 'به خدمات بسته‌بندی نیاز دارید؟', questionEn: 'Do you need packing services?' },
  { id: 'labor', question: 'به نیروی کارگر نیاز دارید؟', questionEn: 'Do you need loading labor?' },
  { id: 'schedule', question: 'چه زمانی جابه‌جایی انجام شود؟', questionEn: 'When should the move happen?' },
  { id: 'estimate', question: 'برآورد هزینه جابه‌جایی شما', questionEn: 'Your moving cost estimate' },
  { id: 'phone', question: 'برای ثبت نهایی، مشخصات خود را وارد کنید', questionEn: 'Enter your details to finalize the request' },
];
...
export function initRequestWizard(
  ...
  destinationMap = initLocationMap('wizard-destination-map', (lat, lng) => syncLocationFromMap(destination, lat, lng));
  ...
  wireChipGroup(card.querySelector('[data-panel="8"]') as Element, 'data-labor-choice', (value) => {
