    ...
    <div class="chat-widget-panel" id="chat-widget-panel" hidden>
      <div class="chat-widget-header">
        <div class="chat-widget-header-info">
          ...
          <span id="chat-widget-header-title">${pick('گفتگو با پشتیبانی بهبار', 'Chat with Behbar support')}</span>
        </div>
...
export function initChatWidget(): void {
  ...
  function renderHeader(assignedStaff: AssignedStaff | null): void {
    if (assignedStaff) {
      ...
      headerTitle!.textContent = pick('گفتگو با پشتیبانی بهبار', 'Chat with Behbar support');
    }
  }
