import{b as e,f as t,n,t as r}from"./appReady-D0myfZwC.js";import{C as i,S as a,T as o,_ as s,b as c,c as l,g as u,h as d,i as f,l as p,n as m,r as h,t as g,v as _,w as v,x as y,y as b}from"./languageMode-COrdPCfF.js";function x(n,r){let i=e(n.paragraphs,n.paragraphsEn).map(e=>`<p>${e}</p>`).join(``),a=n.list?`<ul class="legal-list">${e(n.list,n.listEn??n.list).map(e=>`<li>${e}</li>`).join(``)}</ul>`:``;return`
