import{S as e,b as t,i as n,n as r,t as i}from"./appReady-JFOdjg2Y.js";import{C as a,D as o,E as s,S as c,T as l,_ as u,b as d,c as f,g as p,h as m,i as h,l as g,n as _,r as v,t as y,v as b,w as x,x as S,y as C}from"./languageMode-BQU1S8Yk.js";import{n as w}from"./services-Fo1K9Hii.js";var T=[{id:`driver`,label:`راننده`,labelEn:`Driver`,requiresVehicle:!0},{id:`worker`,label:`کارگر`,labelEn:`Laborer`,requiresVehicle:!1},{id:`other`,label:`سایر`,labelEn:`Other`,requiresVehicle:!1}];function E(n=w,r,i){let a=Array.isArray(r)&&r.length?r.filter(e=>e.active!==!1).map(e=>({id:e.id,label:e.title,labelEn:e.titleEn||e.title,requiresVehicle:!!e.requiresVehicle})):T,o=a.length?a:T,s=i?.fa||`بهبار`,c=i?.en||`Behbar`;return`
  ...
  `}async function k(){r();let e=await m();y(e.language_mode),g(e.theme),f(e.seo),O(e),i(),v(e.branding),h(e.site_name),_(e.language_mode),l(e),a(e),S(),o(),u(),D()}p(()=>void k());