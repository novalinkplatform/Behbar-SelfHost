import{S as e,_ as t,b as n,f as r,g as i,h as a,m as o,v as s,x as c,y as l}from"./appReady-DVpveje2.js";var u={phoneDisplay:`021-200200`,phoneTelHref:`tel:+9821200200`,socialLinks:[{id:`wa1`,platform:`whatsapp`,label:`واتساپ`,url:`https://wa.me/9821200200`},{id:`tg1`,platform:`telegram`,label:`تلگرام`,url:`#`},{id:`ig1`,platform:`instagram`,label:`اینستاگرام`,url:`#`},{id:`em1`,platform:`mail`,label:`ایمیل`,url:`#`}]};function d(e){return e?{...e,socialLinks:e.socialLinks??u.socialLinks}:u}function f(e){return s(d(e).phoneDisplay)}function p(t){let r=d(t?.contact);return`
    ...
    <header class="site-header">
      <div class="header-group">
        ...
        <div class="header-pill">
          ...
          <a class="header-item" href="/orders#waybill" title="${n(`استعلام بارنامه و بیمه‌نامه`,`Waybill & Insurance`)}">
            <span class="icon">${e.shield}</span>
            <span class="header-label">${n(`بیمه‌نامه و بارنامه`,`Insurance & Waybill`)}</span>
          </a>
